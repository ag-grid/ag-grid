...
export const AI_AUTH_START = '/** AI AUTH START **/';
export const AI_AUTH_END = '/** AI AUTH END **/';
...
export const AI_AUTH_REGEX = getSnippetRegex({ startDelimiter: AI_AUTH_START, endDelimiter: AI_AUTH_END });
