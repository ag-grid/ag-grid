...
describe('getDependencies', () => {
    test.each`
        ...
        ${'react'}      | ${false}     | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/react', '@ag-grid-community/core']}
        ${'react'}      | ${true}      | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/react', '@ag-grid-enterprise/core']}
        ${'react'}      | ${false}     | ${true}        | ${'modules'}  | ${false}         | ${['@ag-grid-community/react', '@ag-grid-community/core']}
        ...
        ${'react'}      | ${false}     | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/react', '@ag-grid-community/core', 'ag-charts-community']}
        ${'react'}      | ${true}      | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/react', '@ag-grid-enterprise/core', 'ag-charts-community']}
        ${'react'}      | ${false}     | ${true}        | ${'modules'}  | ${true}          | ${['@ag-grid-community/react', '@ag-grid-community/core', 'ag-charts-enterprise']}
        ...
        ${'angular'}    | ${false}     | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/angular', '@ag-grid-community/core']}
        ${'angular'}    | ${true}      | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/angular', '@ag-grid-enterprise/core']}
        ${'angular'}    | ${false}     | ${true}        | ${'modules'}  | ${false}         | ${['@ag-grid-community/angular', '@ag-grid-community/core']}
        ...
        ${'angular'}    | ${false}     | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/angular', '@ag-grid-community/core', 'ag-charts-community']}
        ${'angular'}    | ${true}      | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/angular', '@ag-grid-enterprise/core', 'ag-charts-community']}
        ${'angular'}    | ${false}     | ${true}        | ${'modules'}  | ${true}          | ${['@ag-grid-community/angular', '@ag-grid-community/core', 'ag-charts-enterprise']}
        ...
        ${'vue'}        | ${false}     | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/vue3', '@ag-grid-community/core']}
        ${'vue'}        | ${true}      | ${false}       | ${'modules'}  | ${false}         | ${['@ag-grid-community/vue3', '@ag-grid-enterprise/core']}
        ${'vue'}        | ${false}     | ${true}        | ${'modules'}  | ${false}         | ${['@ag-grid-community/vue3', '@ag-grid-community/core']}
        ...
        ${'vue'}        | ${false}     | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/vue3', '@ag-grid-community/core', 'ag-charts-community']}
        ${'vue'}        | ${true}      | ${false}       | ${'modules'}  | ${true}          | ${['@ag-grid-community/vue3', '@ag-grid-enterprise/core', 'ag-charts-community']}
        ${'vue'}        | ${false}     | ${true}        | ${'modules'}  | ${true}          | ${['@ag-grid-community/vue3', '@ag-grid-community/core', 'ag-charts-enterprise']}
