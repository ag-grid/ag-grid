...
export interface AgChartThemeOverrides {
    ...
    /** Specifies defaults for heatmap charts. */
    heatmap?: AgCartesianThemeOptions<AgHeatmapSeriesOptions>;
...
export interface AgCartesianSeriesTheme {
    ...
    heatmap?: AgHeatmapSeriesOptions;
...
export interface AgCartesianChartOptions extends AgBaseChartOptions {
    ...
    type?: 'line' | 'bar' | 'column' | 'area' | 'scatter' | 'heatmap' | 'histogram';
    /** Axis configurations. */
