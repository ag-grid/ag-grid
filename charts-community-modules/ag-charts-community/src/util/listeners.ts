...
export class Listeners<Types extends string, Handler extends (...any: any[]) => any> {
    ...
    public addListener<T extends Types, H extends Handler>(
        type: T,
        cb: H
    ): Symbol {
    ...
    public cancellableDispatch(type: Types, cancelled: () => boolean, ...params: Parameters<Handler>): ReturnType<Handler>[] {
