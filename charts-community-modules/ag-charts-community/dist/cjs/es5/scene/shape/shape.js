...
var Shape = /** @class */ (function (_super) {
    ...
    Shape.prototype.updateGradient = function () {
        ...
        if ((fill === null || fill === void 0 ? void 0 : fill.startsWith('linear-gradient')) && (linearGradientMatch = fill.match(LINEAR_GRADIENT_REGEXP))) {
            ...
            this.gradient = new linearGradient_1.LinearGradient();
    ...
    __decorate([
        node_1.SceneChangeDetection({ redraw: node_1.RedrawType.MINOR, changeCb: function (s) { return s.updateGradient(); } })
