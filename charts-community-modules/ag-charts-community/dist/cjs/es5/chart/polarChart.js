...
var PolarChart = /** @class */ (function (_super) {
    ...
    PolarChart.prototype.performLayout = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, padding, _b, width, height, shrinkRect;
            return __generator(this, function (_c) {
                this.scene.root.visible = true;
                _a = this, padding = _a.padding, _b = _a.scene, width = _b.width, height = _b.height;
    ...
    PolarChart.prototype.computeSeriesRect = function (shrinkRect) {
        var _a = this, legend = _a.legend, seriesAreaPadding = _a.seriesAreaPadding;
