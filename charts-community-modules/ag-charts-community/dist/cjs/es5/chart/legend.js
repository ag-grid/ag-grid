...
var Legend = /** @class */ (function () {
    ...
    Legend.prototype.performLayout = function (width, height) {
        ...
        this.itemSelection.update(data, function (node) {
    ...
    Legend.prototype.handleLegendMouseMove = function (event) {
        ...
        if (datum && this.truncatedItems.has(datum.itemId || datum.id)) {
            this.tooltipManager.updateTooltip(this.id, { pageX: pageX, pageY: pageY, offsetX: offsetX, offsetY: offsetY, event: event }, tooltip_1.toTooltipHtml({ content: datum.label.text }));
        }
        else {
            this.tooltipManager.updateTooltip(this.id);
        }
