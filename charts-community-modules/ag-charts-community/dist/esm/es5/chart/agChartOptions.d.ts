...
export declare type AgCartesianSeriesOptions<TAddon = never> = AgLineSeriesOptions | AgScatterSeriesOptions | AgAreaSeriesOptions | AgBarSeriesOptions | AgHistogramSeriesOptions | TAddon;
...
export declare type AgChartOptions<TAddonType = never, TAddonSeries = never> = AgCartesianChartOptions<TAddonType, TAddonSeries> | AgPolarChartOptions | AgHierarchyChartOptions;
