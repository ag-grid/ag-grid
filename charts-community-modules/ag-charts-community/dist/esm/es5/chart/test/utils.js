...
export var IMAGE_SNAPSHOT_DEFAULTS = { failureThreshold: FAILURE_THRESHOLD, failureThresholdType: 'percent' };
export var CANVAS_TO_BUFFER_DEFAULTS = { compressionLevel: 6, filters: Canvas.PNG_NO_FILTERS };
...
export function prepareTestOptions(options, container) {
...
export function dateRange(start, end, step) {
...
export function waitForChartStability(chartOrProxy, timeoutMs) {
    var _a, _b;
...
export function mouseMoveEvent(_a) {
...
export function clickEvent(_a) {
    var offsetX = _a.offsetX, offsetY = _a.offsetY;
    var event = new MouseEvent('click', { bubbles: true });
    Object.assign(event, { offsetX: offsetX, offsetY: offsetY, pageX: offsetX, pageY: offsetY });
    return event;
}
export function doubleClickEvent(_a) {
    var offsetX = _a.offsetX, offsetY = _a.offsetY;
    var event = new MouseEvent('dblclick', { bubbles: true });
    Object.assign(event, { offsetX: offsetX, offsetY: offsetY, pageX: offsetX, pageY: offsetY });
    return event;
}
export function wheelEvent(_a) {
...
export function cartesianChartAssertions(params) {
    ...
    return function (chartOrProxy) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expect(chart.axes.map(function (a) { return a.type; })).toEqual(axisTypes);
            expect(chart.series.map(function (s) { return s.type; })).toEqual(seriesTypes);
            return [2 /*return*/];
        });
    }); };
}
...
export function extractImageData(_a) {
...
export function toMatchImage(actual, expected, _a) {
