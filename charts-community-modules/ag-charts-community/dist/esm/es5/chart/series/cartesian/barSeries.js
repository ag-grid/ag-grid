...
import { SeriesTooltip, SeriesNodePickMode, keyProperty, valueProperty, groupAccumulativeValueProperty, } from '../series';
...
import { NUMBER, OPT_FUNCTION, OPT_LINE_DASH, OPT_NUMBER, Validate, OPTIONAL, OPT_STRING, OPT_COLOR_STRING, } from '../../../util/validation';
                ...
                switch (_m.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dataController.request(this.id, data, {
                                ...
                                ], __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'normal', 'current', {
                                    id: "yValue-end",
                                    invalidValue: null,
                                    groupId: stackGroupName,
                                }))), __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'trailing', 'current', {
                                    id: "yValue-start",
                                    invalidValue: null,
                                    groupId: stackGroupTrailingName,
                                }))), __read((isContinuousX ? [SMALLEST_KEY_INTERVAL] : []))), __read(extraProps)),
                                groupByKeys: true,
