...
import { NUMBER, OPT_FUNCTION, OPT_LINE_DASH, OPT_STRING, Validate, OPT_NUMBER, COLOR_STRING, } from '../../../util/validation';
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dataController.request(this.id, data, {
                                ...
                                ], __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'window', 'current', {
                                    id: "yValue-end",
                                    invalidValue: null,
                                    groupId: ids[0],
                                }))), __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'window-trailing', 'current', {
                                    id: "yValue-start",
                                    invalidValue: null,
                                    groupId: ids[1],
                                }))), __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'window', 'last', {
                                    id: "yValue-previous-end",
                                    invalidValue: null,
                                    groupId: ids[2],
                                }))), __read(groupAccumulativeValueProperty(this, yKey, isContinuousY, 'window-trailing', 'last', {
