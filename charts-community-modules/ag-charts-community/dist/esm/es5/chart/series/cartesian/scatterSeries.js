                ...
                switch (_h.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dataController.request(this.id, data !== null && data !== void 0 ? data : [], {
                                ...
                                ], __read((sizeKey ? [valueProperty(this, sizeKey, true, { id: "sizeValue" })] : []))), __read((colorKey ? [valueProperty(this, colorKey, true, { id: "colorValue" })] : []))), __read((labelKey ? [valueProperty(this, labelKey, false, { id: "labelValue" })] : []))),
