...
var AreaSeries = /** @class */ (function (_super) {
    ...
    AreaSeries.prototype.processData = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, xKey, yKeys, seriesItemEnabled, xAxis, yAxis, normalizedTo, data, isContinuousX, isContinuousY, normalized, yData, xData, xValues, missingYKeys, _loop_1, data_1, data_1_1, datum, missingYKeysString, xyValid, yMin, yMax, i, total, yData_1, yData_1_1, seriesYs, y, normalizedTotal, yData_2, yData_2_1, seriesYs, normalizedY, domainWhitespaceAdjustment, isLogAxis;
            ...
            return __generator(this, function (_f) {
                ...
                _loop_1 = function (datum) {
                    // X datum
                    if (!(xKey in datum)) {
                        logger_1.Logger.warnOnce("the key '" + xKey + "' was not found in the data: ", datum);
                        return "continue";
                    }
                ...
                if (missingYKeys.size > 0) {
                    missingYKeysString = JSON.stringify(__spread(missingYKeys));
                    logger_1.Logger.warnOnce("yKeys " + missingYKeysString + " were not found in the data.");
                }
