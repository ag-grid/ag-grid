...
var Ng2ComponentFactory = (function (_super) {
    ...
    Ng2ComponentFactory.prototype.createRendererFromComponent = function (componentType, viewContainerRef, childDependencies, moduleImports) {
        ...
        return this.adaptComponentToRenderer(componentType, viewContainerRef, componentType.name, moduleImports, childDependencies);
    };
    Ng2ComponentFactory.prototype.createRendererFromTemplate = function (template, viewContainerRef, moduleImports) {
        ...
        return this.adaptComponentToRenderer(componentType, viewContainerRef, template, moduleImports, []);
    };
    Ng2ComponentFactory.prototype.createEditorFromComponent = function (componentType, viewContainerRef, childDependencies, moduleImports) {
        if (childDependencies === void 0) { childDependencies = []; }
        if (moduleImports === void 0) { moduleImports = []; }
        return this.adaptComponentToEditor(componentType, viewContainerRef, componentType.name, moduleImports, childDependencies);
    };
    Ng2ComponentFactory.prototype.createFilterFromComponent = function (componentType, viewContainerRef, childDependencies, moduleImports) {
        if (childDependencies === void 0) { childDependencies = []; }
        if (moduleImports === void 0) { moduleImports = []; }
        return this.adaptComponentToFilter(componentType, viewContainerRef, componentType.name, moduleImports, childDependencies);
    };
    Ng2ComponentFactory.prototype.adaptComponentToRenderer = function (componentType, viewContainerRef, name, moduleImports, childDependencies) {
        var that = this;
        var CellRenderer = (function (_super) {
            ...
            CellRenderer.prototype.createComponent = function () {
                return that.createComponent(componentType, viewContainerRef, name, moduleImports, childDependencies);
            };
            return CellRenderer;
        }(BaseGuiComponent));
        return CellRenderer;
    };
    Ng2ComponentFactory.prototype.adaptComponentToEditor = function (componentType, viewContainerRef, name, moduleImports, childDependencies) {
        var that = this;
    ...
    Ng2ComponentFactory.prototype.adaptComponentToFilter = function (componentType, viewContainerRef, name, moduleImports, childDependencies) {
        var that = this;
    ...
    Ng2ComponentFactory.prototype.createComponent = function (componentType, viewContainerRef, name, moduleImports, childDependencies) {
