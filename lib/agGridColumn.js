...
var AgGridColumn = (function () {
    ...
    AgGridColumn.prototype.toColDef = function () {
        var colDef = {};
        this.createColDefFromGridColumn(this, colDef);
        if (this.hasChildColumns()) {
            colDef.children = this.childColumns
    ...
    AgGridColumn.prototype.copyProperties = function (from, to) {
        Object.assign(to, from);
        delete to.childColumns;
        return to;
    };
    ;
    __decorate([
