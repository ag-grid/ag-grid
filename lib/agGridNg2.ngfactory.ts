...
export function viewFactory_AgGridNg20(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AgGridNg2> {
  if ((renderType_AgGridNg2 === (null as any))) { (renderType_AgGridNg2 = viewUtils.createRenderComponentType('/Users/sean/IdeaProjects/ag-grid/ag/ng2/ag-grid-ng2/lib/agGridNg2.d.ts class AgGridNg2 - inline template',0,import10.ViewEncapsulation.None,styles_AgGridNg2,{})); }
