...
export declare class RowComp extends BeanStub {
    ...
    constructor(parentScope: any, rowRenderer: RowRenderer, bodyContainerComp: RowContainerComponent, fullWidthContainerComp: RowContainerComponent, pinnedLeftContainerComp: RowContainerComponent, pinnedRightContainerComp: RowContainerComponent, node: RowNode, animateIn: boolean, previousElements: ContainerElements);
    ...
    ensureInDomAfter(containers: ContainerElements): void;
    ...
    private createRowContainer(rowContainerComp, slideRowIn, eElementBefore);
