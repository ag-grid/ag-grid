...
var RowRenderer = (function (_super) {
    ...
    RowRenderer.prototype.refreshFloatingRows = function (renderedRows, rowNodes, pinnedLeftContainerComp, pinnedRightContainerComp, bodyContainerComp, fullWidthContainerComp) {
        ...
        if (rowNodes) {
            rowNodes.forEach(function (node) {
                var renderedRow = new rowComp_1.RowComp(_this.$scope, _this, bodyContainerComp, fullWidthContainerComp, pinnedLeftContainerComp, pinnedRightContainerComp, node, false, TEMP_PREVIOUS_ELEMENTS);
    ...
    RowRenderer.prototype.redrawAfterModelUpdate = function (params) {
        ...
        var rowsUsingFlow = this.gridOptionsWrapper.isForPrint() || this.gridOptionsWrapper.isAutoHeight();
    ...
    RowRenderer.prototype.redraw = function (rowsToRecycle, animate) {
        ...
        var previousElements = { body: null, left: null, right: null, fullWidth: null };
        // add in new rows
        ...
        setTimeout(function () {
            nextVmTurnFunctions.forEach(function (func) { return func(); });
        }, 0);
    ...
    RowRenderer.prototype.createOrUpdateRowComp = function (rowIndex, rowsToRecycle, animate, previousElements) {
        ...
        if (!rowComp) {
            ...
            if (utils_1.Utils.exists(rowsToRecycle) && rowsToRecycle[rowNode.id]) {
    ...
    RowRenderer.prototype.destroyRowComps = function (rowCompsMap, animate) {
        ...
        utils_1.Utils.iterateObject(rowCompsMap, function (nodeId, rowComp) {
            ...
            rowComp.getAndClearDelayedDestroyFunctions().forEach(function (func) { return delayedFuncs.push(func); });
        });
        setTimeout(function () {
            delayedFuncs.forEach(function (func) { return func(); });
        }, 400);
    };
