...
export declare class RowContainerComponent {
    ...
    appendRowElement_old(eRow: HTMLElement, eRowBefore: HTMLElement): void;
    appendRowElement(eRow: HTMLElement, eRowBefore: HTMLElement): void;
    ensureDomOrder_old(eRow: HTMLElement, eRowBefore: HTMLElement): void;
