...
var RowComp = (function (_super) {
    ...
    function RowComp(parentScope, rowRenderer, bodyContainerComp, fullWidthContainerComp, pinnedLeftContainerComp, pinnedRightContainerComp, node, animateIn, previousElements) {
        ...
        _this.previousElements = previousElements;
        return _this;
    }
    ...
    RowComp.prototype.ensureInDomAfter = function (containers) {
    ...
    RowComp.prototype.createRowContainer = function (rowContainerComp, slideRowIn, eElementBefore) {
        var _this = this;
