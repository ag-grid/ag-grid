...
Both DEVELOPER APPLICATION LICENSE and DEVELOPER SITE LICENSE must be combined with one of OEM LICENSE and SAAS LICENSE if the built application is to be sold as a product or offered as part of a SAAS offering.
