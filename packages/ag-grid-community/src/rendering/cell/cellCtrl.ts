...
export class CellCtrl extends BeanStub {
    ...
    public onFirstRightPinnedChanged(): void {
        ...
        this.comp.updateCss(CSS_CELL_FIRST_RIGHT_PINNED, firstRightPinned);
    }
    ...
    public onLastLeftPinnedChanged(): void {
        ...
        this.comp.updateCss(CSS_CELL_LAST_LEFT_PINNED, lastLeftPinned);
    }
    ...
    public onCellFocused(event?: CellFocusedEvent): void {
        ...
        this.comp.updateCss(CSS_CELL_FOCUS, cellFocused);
    ...
    protected applyStaticCssClasses(): void {
        const { comp } = this;
        comp.updateCss(CSS_CELL, true);
        comp.updateCss(CSS_CELL_NOT_INLINE_EDITING, true);

        // normal cells fill the height of the row. autoHeight cells have no height to let them
        // fit the height of content.

        const autoHeight = this.column.isAutoHeight() == true;
        comp.updateCss(CSS_AUTO_HEIGHT, autoHeight);
        comp.updateCss(CSS_NORMAL_HEIGHT, !autoHeight);
    }
    ...
    private setWrapText(): void {
        ...
        this.comp.updateCss(CSS_CELL_WRAP_TEXT, value);
    }
