...
export interface GridOptions<TData = any> {
    ...
    /**
     * When `true`, column definitions are generated automatically from the first row of `rowData` whenever row data is set or updated.
     * @default false
     * @agModule `AutoGenerateColumnsModule`
     */
    autoGenerateColumnDefs?: boolean;
    /**
     * Callback fired after auto-generating column definitions and before they are applied to the grid.
     * Return the final `ColDef[]` to use.
     * @agModule `AutoGenerateColumnsModule`
     */
