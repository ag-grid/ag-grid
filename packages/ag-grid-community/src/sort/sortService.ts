...
export class SortService extends BeanStub implements NamedBean {
    ...
    public setupHeader(comp: Component, column: AgColumn, clickElement?: HTMLElement): void {
        ...
        const onSortingChanged = () => {
            ...
            comp.updateCss('ag-header-cell-sorted-asc', sort === 'asc');
            comp.updateCss('ag-header-cell-sorted-desc', sort === 'desc');
            comp.updateCss('ag-header-cell-sorted-none', !sort);
            ...
            if (column.getColDef().showRowGroup) {
                ...
                comp.updateCss('ag-header-cell-sorted-mixed', isMultiSorting);
            }
        };
