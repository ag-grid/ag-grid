...
export const AG_GRID_ERRORS = {
    ...
    295: () =>
        `'rowDragManaged' requires 'refreshAfterGroupEdit' to be true when row grouping columns are enabled. Set 'refreshAfterGroupEdit = true' or disable rowDragManaged.` as const,
};
