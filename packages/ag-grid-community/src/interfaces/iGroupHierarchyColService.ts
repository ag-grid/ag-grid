...
export interface IGroupHierarchyColService extends IColumnCollectionService {
    /**
     * Mutates the `columns` parameter, adding any virtual columns associated with the given source column, as well as the source column itself (last in the array)
     */
