 ...
 * - `'editing'`: Returns the current editing value, including live editor typing and pending batch values. This is the default value.
 ...
 */
export type CellValueResolveFrom = 'editing' | 'pending' | 'data';
