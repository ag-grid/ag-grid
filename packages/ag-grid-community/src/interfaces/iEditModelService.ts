...
export interface IEditModelService {
    ...
    getEditRow(rowNode: Required<IRowNode>, params?: GetEditsParams): EditRow | undefined;
    getEditRowDataValue(rowNode: Required<IRowNode>, params?: GetEditsParams): any;
    ...
    hasRowEdits(rowNode: Required<IRowNode>, params?: GetEditsParams): boolean;
