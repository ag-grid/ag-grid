...
export class CellCustomStyleFeature extends BeanStub {
    ...
    public applyCellClassRules(): void {
        ...
        processClassRules(
            ...
            cellClassRules,
            cellClassParams,
            (className) => cellComp.updateCss(className, true),
            (className) => cellComp.updateCss(className, false)
        );
    ...
    public applyClassesFromColDef() {
        ...
        this.staticClasses.forEach((className) => cellComp.updateCss(className, false));
        ...
        newStaticClasses.forEach((className) => cellComp.updateCss(className, true));
    }
