import { _isHorizontalScrollShowing, _isInDOM, _observeResize } from '../../agStack/utils/domUtils';
...
import { _getInnerWidth, _getScrollLeft, _setScrollLeft } from '../../utils/dom';
