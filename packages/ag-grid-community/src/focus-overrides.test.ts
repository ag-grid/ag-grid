...
describe('Focus override callbacks', () => {
    describe('FocusService', () => {
        ...
        let focusSvcAny: any;
        let gos: vi.Mocked<GridOptionsService>;
        let getOption: vi.Mock<unknown, [string]>;
        let getCallback: vi.Mock<unknown, [string]>;
        let focusProvidedHeaderPosition: vi.SpyInstance;
        ...
        beforeEach(() => {
            ...
            getOption = gos.get as unknown as vi.Mock<unknown, [string]>;
            getCallback = gos.getCallback as unknown as vi.Mock<unknown, [string]>;
    ...
    describe('GridHeaderCtrl', () => {
        ...
        let getOption: vi.Mock<unknown, [string]>;
        let gridCtrl: {
            focusNextInnerContainer: vi.Mock<boolean | undefined, [boolean]>;
            forceFocusOutOfContainer: vi.Mock<void, [boolean?]>;
            isDetailGrid: vi.Mock<boolean, []>;
            isFocusInsideGridBody: vi.Mock<boolean, []>;
        };
        let headerNavigation: {
            navigateHorizontally: vi.Mock<boolean, [string, boolean, KeyboardEvent]>;
        };
        let focusSvc: {
            focusOverlay: vi.Mock<boolean, [boolean?]>;
        };
