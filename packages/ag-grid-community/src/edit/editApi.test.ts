...
//     const rowNode1 = { rowIndex: 0, rowPinned: undefined, column1 } as unknown as IRowNode;
//     const rowNode2 = { rowIndex: 1, rowPinned: undefined, column2 } as unknown as IRowNode;

//     const cellCtrl1 = {
//         rowNode: rowNode1,
//         focusCell: jest.fn(),
//         onEditorAttachedFuncs: [],
//         refreshCell: jest.fn(),
//         createEvent: jest.fn(() => ({})),
...
//     let editModelSvc: IEditModelService;
...
//                 getCellCtrls: jest.fn(() => [cellCtrl1, cellCtrl2]),
...
//         editModelSvc = new EditModelService();
//         beans.editSvc = editSvc;
//         beans.editModelSvc = editModelSvc;
//         editSvc['beans'] = beans;
...
//         editSvc['strategy'].eventSvc = beans.eventSvc;
...
describe('Edit API', () => {
    test('temorary test to ensure the test suite runs', () => {
