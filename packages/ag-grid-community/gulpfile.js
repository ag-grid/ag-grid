...
const copyGridAllUmdFiles = (done) => {
    if(!fs.existsSync('./node_modules/@ag-community/grid-all-modules/dist')) {
        done("./node_modules/@ag-community/grid-all-modules/dist doesn't exist - exiting")
    }

    return gulp.src('./node_modules/@ag-community/grid-all-modules/dist/ag-grid-community*.js').pipe(gulp.dest('./dist/'));
};
