export default class PolymerComponentFactory {
  ...
  adaptComponentToEditor(componentType) {
    ...
    class CellEditor extends BaseGuiComponent {
      ...
      isPopup() {
        return this._agAwareComponent.isPopup ? this._agAwareComponent.isPopup() : false;
      }

      isCancelBeforeStart() {
        return this._agAwareComponent.isCancelBeforeStart ? this._agAwareComponent.isCancelBeforeStart() : false;
      }

      isCancelAfterEnd() {
        return this._agAwareComponent.isCancelAfterEnd ? this._agAwareComponent.isCancelAfterEnd() : false;
      }
