...
<div>
  ...
  <div class="row">
    ...
    <div class="col-sm"  style="text-align: center";>
            ...
            October 10th 2018
            <br>
            <a href="https://www.eventbrite.com/e/ag-grid-conf-london-tickets-49732217401" target="_blank"><button type="button" class="btn btn-primary btn-lg">Register for New York</button></a>
    </div>
  </div>
</div>
...
<hr>
    <h3 class="text-center">
        <strong>Schedule | London</strong><br>
