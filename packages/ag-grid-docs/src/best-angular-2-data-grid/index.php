         ...
         <div class="container">
            ...
            <div class="core">
                ...
                <div class="row" id="core-features" data-aos="fade-down">
                    <div class="col-md-3">
                        <p><a class="features-link" href="">Sorting</a><br>
                        <a class="features-link" href="">Row Spanning</a></p>
                    </div>
                    <div class="col-md-3">
                        <p><a class="features-link" href="">Pagination</a><br>
                        <a class="features-link" href="">Row Dragging</a></p>
                    </div>
                    <div class="col-md-3">
                        <p><a class="features-link" href="">Cell Editing</a><br>
                        <a class="features-link" href="">Cell Rendering</a></p>
                    </div>
                    <div class="col-md-3">
                        <p><a class="features-link" href="">Row Selection</a><br>
                        <a class="features-link" href="">Row Pinning</a></p>
                    </div>
                </div>
                <div class="container">
                    <div class="row" data-aos="fade-down">
                        ...
                        <video class="example" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;"><source src="/best-angular-2-data-grid/sorting.mp4" type="video/mp4" class="features">Your browser does not support the video tag.</video>
                        <br><br>
                        <p>
...
<hr>
    <div class="enterprise">
        <h3>
            ...
            <div class="row" id="core-features" data-aos="fade-down">
                <div class="col-md-3">
                    <p><a class="features-link" href="">Aggregation</a><br>
                    <a class="features-link" href="">Pivoting</a></p>
                </div>
                <div class="col-md-3">
                    <p><a class="features-link" href="">Grouping</a><br>
                    <a class="features-link" href="">Range Selection</a></p>
                </div>
                <div class="col-md-3">
                    <p><a class="features-link" href="">Tree Data</a><br>
                    <a class="features-link" href="">Clipboard</a></p>
                </div>
                <div class="col-md-3">
                    <p><a class="features-link" href="">Excel Export</a><br>
                    <a class="features-link" href="">Master / Detail</a></p>
                </div>
            </div>
            <div class="container">
...
<p class="lead">
It's easy to deeply customize many areas of our Angular Grid <component class=""></component>
...
Follow @ag_grid</a></li>
    ...
    <hr class="footer-legal">
    <div class="container footer-legal">
        <p class="small">ag-Grid Limited registered in the United Kingdom. Company No. 07318192.&copy; | ag-Grid Ltd. 2015-2019</p>
    </div>
</div>
</div>
  <script>
