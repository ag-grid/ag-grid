    ...
    <body>
        ...
        <section id="above-the-fold">
            <div id="head-top">
                <div class="container">
                <div class="logo">
                    <a><img alt="ag-Grid Angular Component" src="/best-angular-2-data-grid/assets/images/angular-grid.svg">
                    </a>
                </div>
                <div class="container">
                    ...
                    <div class="row" id="c2a-demo">
                        ...
                        <div class="col-md-6">
                            <a href="https://www.ag-grid.com/angular-getting-started/" id="c2a-top" target="_blank"><button type="button" class="btn btn-light">Get Started</button></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="example">
            <div class="container">
                ...
                <p id="angular-data-grid-overview">
                    ag-Grid is a feature-rich data grid built for Angular.
                    Integrate seamlessly with Angular 2,4,5,6,7<br> to deliver core and enterprise features with the performance you expect.
                    Discover key benefits and<br> resources available to quickly add an Angular Data Grid or
        ...
        <section id="versions">
            <div class="container">
                <h2 class="title">Fully Featured Angular Grid Table</h2>
                <p>
                ...
                <div class="core">
                    ...
                    <p id="core-intro"><strong>All the features you'd expect from a Angular grid.</strong><br>
                    ...
                    <div class="row" data-aos="fade-down">
                        <div class="col-md-6">
                            ...
                            <source src="/best-angular-2-data-grid/sorting.mp4" type="video/mp4" class="features">Your browser does not support the video tag.</video>
                            <br><br>
                            <p>
                        ...
                        <div class="col-md-6">
                            ...
                            <video class="example" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;"><source src="/best-angular-2-data-grid/sorting.mp4" type="video/mp4">Your browser does not support the video tag.</video>
                            <br><br>
                            <p>
                ...
                <div class="enterprise">
                    ...
                    <div class="row" data-aos="fade-down" data-aos-delay="200">
                        <div class="col-md-6">
                            ...
                            <video class="example" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;"><source src="/best-angular-2-data-grid/grouping-aggregation.mp4" type="video/mp4" class="features">Your browser does not support the video tag.</video>
                            <br><br>
                            <p>
                        ...
                        <div class="col-md-6">
                            ...
                            <video class="example" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;"><source src="/best-angular-2-data-grid/tree-data.mp4" type="video/mp4" class="features">Your browser does not support the video tag.</video>
                            <br><br>
                            <p>
                ...
                <div class="row performance-break">
                    <div class="col-md-6 performance-description">
                        ...
                        <p>
                            ...
                            <br><br>
                            <strong>Save work and development time with the best and fastest Angular Grid.</strong>
                        </p>
                        ...
                        <p>
                            ...
                            cutting-edge algorithms in our grid to justify the reputation of <strong>the best Angular datagrid in the
                            world.</strong>
                        </p>
                    </div>
        ...
        <section class="api" id="api">
            ...
            <p class="lead">
            It's easy to deeply customize many areas of our Angular Grid Component</p>
        ...
        <section id="customise">
            <div class="container">
                ...
                <p>
                    Most of the functionality of our Angular grid is already component based.<br>
                ...
                <div class="row">
                    <div class="col">
                        <a href="https://blog.ag-grid.com/learn-to-customize-angular-grid-in-less-than-10-minutes/" target="_blank"><button type="button" class="btn btn-primary">Read More</button></a>
                    </div>
                    <div class="col">
                        <a href="https://www.ag-grid.com/angular-getting-started/" target="_blank"><button type="button" class="btn btn-primary">Get Started</button></a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row"  data-aos="fade-down">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>
                        Test our Angular Grid component's core and enterprise features.</p>
                ...
                <div class="row" id="guide"  data-aos="fade-up">
                    <div class="col-md-4">
                        ...
                        <img class="icons" alt="Angular Overview Guide" src="/images/icons/overview.png">
                        <p>
                            Every feature of ag-Grid is available when using the ag-Grid Angular Component.
                        </p>
                        <a href="https://www.ag-grid.com/angular-more-details/"><p>
                            Read More
                        </p></a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="https://blog.ag-grid.com/tag/angular/"><p>
                            Browse Content
                        </p></a>
                    </div>
                </div>
        ...
        <section id="c2a">
            <div class="container">
                ...
                <div id="c2a-end">
                    <a href="../angular-getting-started/"><button type="button" class="btn btn-light">GET STARTED</button></a>
                </div>
            </div>
        </section>
    </body>
