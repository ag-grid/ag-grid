...
<h2>Tree Data</h2>
<p>
    Just like in the Client-side Row Model, it is possible to use Tree Data with the Server-side Row Model. Tree Data is defined
    as data that has parent / child relationships where the parent / child relationships are provided as part of the data.
</p>
