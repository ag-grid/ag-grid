...
// since it's mutated inside the function
    ...
    function createRowItem(row) {
        ...
        var totalWinnings = 0;
        months.forEach(function (month) {
            var value = (Math.round(pseudoRandom() * rowCount)) - 20;
    ...
    function booleanComparator(value1, value2) {
        var value1Cleaned = parseBoolean(value1);
        var value2Cleaned = parseBoolean(value2);
    ...
    function booleanCellRenderer(params) {
        var valueCleaned = parseBoolean(params.value);
