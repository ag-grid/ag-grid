...
?>
    ...
    <p>
        <img src="redux-file-view.png" width="90%" style="border: 1px solid grey" alt="Redux Integration File View" />
    </p>
    ...
    <img style="margin-left: 15%" src="redux-store.png" alt="Redux Store" />
...
<snippet language="js">
{
    ...
    <img style="margin-left: 2%" src="redux-data-flow.png" width="100%" alt="Redux Data Flow" />
