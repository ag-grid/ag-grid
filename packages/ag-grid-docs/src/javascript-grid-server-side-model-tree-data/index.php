...
<?= example('Tree Data', 'tree-data', 'generated', array("enterprise" => 1, "processVue" => true, "extras" => array('lodash'))) ?>
...
<?= example('Purging Tree Data', 'purging-tree-data', 'generated', array("enterprise" => 1, "processVue" => true, "extras" => array('lodash'))) ?>
