...
<p class="lead">
    After cell editing the grid you have the opportunity to parse the value before inserting
...
<ul class="content">
    ...
    <li>
        Column 'Good Number' is good because after an edit, teh value is converted to a number using
        the value parser.
    </li>
</ul>

<?= example('Example Parsers', 'example-parsers', 'generated', array('processVue' => true)) ?>

<h2 id="value-parser-params">Value Parser Return Value</h2>
...
<h2 id="value-parser-params">Value Parser Parameters</h2>
