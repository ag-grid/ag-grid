...
<div class="list-group" class="text-left">
  ...
  <a href="#data-disclosure" class="list-group-item list-group-item-action disabled">Disclosures Of Your Personal Data
</a>
  <a href="#intl-transfers" class="list-group-item list-group-item-action disabled">International Transfers
</a>
  <a href="#data-security" class="list-group-item list-group-item-action disabled">Data Security
</a>
  <a href="#data-retention" class="list-group-item list-group-item-action disabled">Data Retention
</a>
  <a href="#legal-rights" class="list-group-item list-group-item-action disabled">Your Legal Rights
</a>
  <a href="#third-party-links" class="list-group-item list-group-item-action disabled">Third-Party Links
</a>
  <a href="#cookies-privacy" class="list-group-item list-group-item-action disabled">Cookies
</a>
</div>
...
<ol class="text-left">
	<br><br>
		<h3 id="intro-privacy">1. Introduction</h3>
		<hr>
		<p>
...
<br>
<h4><strong>Contact Details</strong>
</h4>
<p>
...
<a href="mailto:info@ag-grid.com" target="_top">info@ag-grid.com</a>
	...
	<h3 id="data-what-why">2. What Data Do We Collect About You, For What Purpose And On What Ground We Process It</h3>
	<hr>
	<p> <h4>Personal data means any information capable of identifying an individual. It does not include anonymised data.</h4>
...
We do not carry out automated decision making or any type of automated profiling.
	...
	<br><br>
	<h3 id="data-how-we-collect">3. How We Collect Your Personal Data</h3>
	<hr>
	<p>We may collect data about you by you providing the data directly to us (for example by filling in forms on our site or by sending us emails). We may automatically collect certain data from you as you use our website by using cookies and similar technologies. Please see our <a href="cookies.php">Cookie Policy</a> for more details about this.
<br><br>
...
We may also receive data from publicly availably sources such as Companies House and the Electoral Register based inside the EU.
	...
	<br>
		<h3 id="marketing-comms">4. Marketing Communications</h3>
		<hr>
<p>Our lawful ground of processing your personal data to send you marketing communications is either your consent or our legitimate interests (namely to grow our business). 
<br><br>
Under the Privacy and Electronic Communications Regulations, we may send you marketing communications from us if 
<br><br>(i) you made a purchase or asked for information from us about our goods or services or 
<br><br>(ii) you agreed to receive marketing communications and in each case you have not opted out of receiving such communications since. Under these regulations, if you are a limited company, we may send you marketing emails without your consent. However you can still opt out of receiving marketing emails from us at any time. 
 <br><br>
...
If you opt out of receiving marketing communications this opt-out does not apply to personal data provided as a result of other transactions, such as purchases, warranty registrations etc. 
	...
	<br>
		<h3 id="data-disclosure">5. Disclosures Of Your Personal Data</h3>
		<hr>
<p><h4>We may have to share your personal data with the parties set out below:</h4>
 <br>
...
Many of our third parties service providers are based outside the European Economic Area <strong>(EEA)</strong> so their processing of your personal data will involve a transfer of data outside the EEA.
 <br><br>
Whenever we transfer your personal data out of the EEA, we do our best to ensure a similar degree of security of data by ensuring at least one of the following safeguards is in place:</h4>
 <br>
...
<br>
	<h3 id="legal-rights">9. Your Legal Rights</h3>
	<hr>
<p>Under data protection laws you have rights in relation to your personal data that include the right to request access, correction, erasure, restriction, transfer, to object to processing, to portability of data and (where the lawful ground of processing is consent) to withdraw consent.
 <br><br>
...
<br><br>
If you wish to exercise any of the rights set out above, please email us at <a href="mailto:info@ag-grid.com" target="_top">info@ag-grid.com</a>.
<br><br>
...
<br><br>
If you are not happy with any aspect of how we collect and use your data, you have the right to complain to the Information Commissioner’s Office (ICO), the UK supervisory authority for data protection issues <a href="www.ico.org.uk">(www.ico.org.uk)</a>. We should be grateful if you would contact us first if you do have a complaint so that we can try to resolve it for you.</p>
</li>
<br>
	<h3 id="third-party-links">10. Third-Party Links</h3>
	<hr>
<p>This website may include links to third-party websites, plug-ins and applications. Clicking on those links or enabling those connections may allow third parties to collect or share data about you. We do not control these third-party websites and are not responsible for their privacy statements. When you leave our website, we encourage you to read the privacy notice of every website you visit.</p>
</li>
<br>
	<h3 id="cookies-privacy">11. Cookies</h3>
	<hr>
<p>You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please see
<a href="cookies.php">Our Cookies Policy</a>.
</p>
</li>
</ol>
</p>
