...
&lt;/ag-grid-column&gt;</snippet>
        ...
        <p>Give it a go - Aurelia is a fun framework and now you can use it with the best Enterprise Data Grid around! Take a look at our <a href="https://ag-grid.github.io/ag-grid-aurelia-example/#/rich-grid" target="_blank" class="fa fa-external-link-alt"> live examples site</a>. Feedback is always welcome! </p>
        <!-- end of content -->
