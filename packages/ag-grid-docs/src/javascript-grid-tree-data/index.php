...
autoGroupColumnDef: {
    ...
    <?= example('Org Hierarchy', 'org-hierarchy', 'generated', array("enterprise" => 1, "exampleHeight" => 375, 'processVue' => true)) ?>
...
var rowData = [
    ...
    <?= example('Filler Nodes', 'filler-nodes', 'generated', array("enterprise" => 1, "exampleHeight" => 300, 'processVue' => true)) ?>
    ...
    <?= example('File Browser', 'file-browser', 'generated', array('enterprise' => true, 'extras' => array('fontawesome'), 'processVue' => true) ) ?>
