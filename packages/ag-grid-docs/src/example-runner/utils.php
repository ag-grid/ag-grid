...
if (USE_LOCAL) {
    ...
    $systemJsMap = array(
        ...
        "@ag-enterprise/rich-select" => "$prefix/@ag-enterprise/rich-select",
        "@ag-enterprise/row-grouping" => "$prefix/@ag-enterprise/row-grouping",
        "@ag-enterprise/server-side-row-model" => "$prefix/@ag-enterprise/server-side-row-model",
        "@ag-enterprise/set-filter" => "$prefix/@ag-enterprise/set-filter",
        "@ag-enterprise/side-bar" => "$prefix/@ag-enterprise/side-bar",
...
// production mode, return from unpkg
    ...
    $systemJsMap = array(
        ...
        "@ag-enterprise/rich-select" => "https://unpkg.com/@ag-enterprise/rich-select@" . AG_GRID_ENTERPRISE_VERSION . "/",
        "@ag-enterprise/row-grouping" => "https://unpkg.com/@ag-enterprise/row-grouping@" . AG_GRID_ENTERPRISE_VERSION . "/",
        "@ag-enterprise/server-side-row-model" => "https://unpkg.com/@ag-enterprise/server-side-row-model@" . AG_GRID_ENTERPRISE_VERSION . "/",
        "@ag-enterprise/set-filter" => "https://unpkg.com/@ag-enterprise/set-filter@" . AG_GRID_ENTERPRISE_VERSION . "/",
        "@ag-enterprise/side-bar" => "https://unpkg.com/@ag-enterprise/side-bar@" . AG_GRID_ENTERPRISE_VERSION . "/",
