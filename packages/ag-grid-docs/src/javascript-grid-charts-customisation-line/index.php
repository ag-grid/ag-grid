...
interface LineTooltipRendererParams {
    ...
    datum: any;
    // The key of the datum object that contains the category name of the highlighted marker
    xKey: string;
    // The column name of the category
    xName: string;
    // The key of the datum object that contains the series value of the highlighted marker
    yKey: string;
