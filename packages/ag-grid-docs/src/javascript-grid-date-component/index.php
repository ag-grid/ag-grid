...
<p>
    ...
    and will collapse the your floating filter element. To prevent this behavior, you must add the <code>ag-floating-filter-picker</code>
    class to every floating component generated by your custom field.
</p>

<?= example('Advanced Custom Component', 'advanced-custom-date', 'generated', array('onlyShow' => 'react', 'extras' => array("blueprint"))) ?>
