...
<h2>Advanced Custom Date Example</h2>
<p>
    The example below shows how to register a custom date component that contains an extra floating calendar picker rendered
    from the filter field. The problem with this approach is that <strong>ag-Grid</strong> needs to know that extra floating
    element belongs to the custom field, otherwise, once you click on it, this click will be detected as being outside component 
    and will collapse the your floating filter element. To prevent this behavior, you must add the <code>ag-grid-floating-picker</code>
    class to every floating component generated by your custom field.
</p>

<?= example('Advanced Custom Component', 'advanced-custom-date', 'generated', array('enterprise' => 1, 'onlyShow' => 'react', 'extras' => array("includeBlueprint"))) ?>
