...
updates$.subscribe((updates) =&gt; {
    ...
    <?= example('RxJS - Row Updates', 'rxjs-updates', 'generated', array("enterprise" => 1, "processVue" => true, "extras" => array("lodash", "rxjs"))) ?>
...
const gridOptions = {
    ...
    <?= example('RxJS - Full Updates', 'rxjs-full', 'generated', array("enterprise" => 1, "processVue" => true, "extras" => array("lodash", "rxjs"))) ?>
