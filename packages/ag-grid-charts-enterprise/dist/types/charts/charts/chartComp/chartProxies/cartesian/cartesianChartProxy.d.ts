import type { AgAreaSeriesOptions, AgCartesianAxisOptions, AgCartesianChartOptions, AgCartesianSeriesOptions, AgLineSeriesOptions } from 'ag-charts-community';
...
export declare abstract class CartesianChartProxy<TSeries extends 'area' | 'bar' | 'histogram' | 'line' | 'scatter' | 'bubble' | 'waterfall' | 'box-plot' | 'range-area' | 'range-bar'> extends ChartProxy<AgCartesianChartOptions, TSeries> {
    ...
    protected getXAxisType(params: UpdateParams): "number" | "category" | "grouped-category" | "time";
