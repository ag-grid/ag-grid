import type { AgEventType, FuncColsService, GridOptionsService, IEventEmitter, IEventListener, RowNode, SetFilterModelValue, SetFilterParams, ValueFormatterParams, ValueService } from 'ag-grid-community';
...
export declare class SetValueModel<V> implements IEventEmitter<SetValueModelEvent> {
    ...
    addEventListener<T extends SetValueModelEvent>(eventType: T, listener: IEventListener<T>, async?: boolean): void;
    removeEventListener<T extends SetValueModelEvent>(eventType: T, listener: IEventListener<T>, async?: boolean): void;
