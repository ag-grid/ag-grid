...
<!-- Check whether this is still an issue in the most recent ag-grid-aurelia version -->
...
<!-- Check whether this is still an issue in the most recent Aurelia version -->
