  ...
  waitForInstance(reactComponent, resolve, startTime = Date.now()) {
    ...
    if (reactComponent.rendered()) {
      ...
      if (Date.now() - startTime >= this.maxComponentCreationTimeMs && !this.hasPendingPortalUpdate) {
        (0, import_ag_grid_community7._errorOnce)(
...
var HeaderCellComp = (props) => {
  ...
  const setRef2 = (0, import_react13.useCallback)((e) => {
    ...
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? (0, import_ag_grid_community13._setAriaSort)(eGui.current, sort) : (0, import_ag_grid_community13._removeAriaSort)(eGui.current);
        }
      },
...
var HeaderFilterCellComp = (props) => {
  ...
  const setRef2 = (0, import_react14.useCallback)((e) => {
    ...
    userCompPromise.current = new import_ag_grid_community14.AgPromise((resolve) => {
...
var HeaderRowComp = (props) => {
  ...
  const createCellJsx = (0, import_react12.useCallback)((cellCtrl) => {
    switch (ctrl.getType()) {
      case import_ag_grid_community12.HeaderRowType.COLUMN_GROUP:
      ...
      case import_ag_grid_community12.HeaderRowType.FLOATING_FILTER:
...
var HeaderRowContainerComp = (props) => {
  ...
  const setRef2 = (0, import_react11.useCallback)((e) => {
    ...
    headerRowCtrlRef.current = context.createBean(new import_ag_grid_community11.HeaderRowContainerCtrl(props.pinned));
...
var CellComp = (props) => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_ag_grid_community17.CssClassManager(() => eGui.current);
  }
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            context.destroyBean(comp);
            (0, import_ag_grid_community17._removeFromParent)(eGui2);
          });
        }
        return comp;
      };
  ...
  return /* @__PURE__ */ import_react19.default.createElement("div", { ref: setRef2, style: userStyles, tabIndex, role: cellAriaRole, "col-id": colId }, showCellWrapper ? /* @__PURE__ */ import_react19.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents());
};
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerOptions = (0, import_react17.useMemo)(() => (0, import_ag_grid_community15._getRowContainerOptions)(name), [name]);
...
var GridBodyComp = () => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_ag_grid_community9.CssClassManager(() => eRoot.current);
  }
  ...
  const setRef2 = (0, import_react9.useCallback)((e) => {
    ...
    addComp(eRoot.current, import_ag_grid_community9.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRoot.current, import_ag_grid_community9.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
      addComp(eBody.current, import_ag_grid_community9.FakeVScrollComp, " AG Fake Vertical Scroll ");
    }
    const compProxy = {
      setRowAnimationCssOnBodyViewport: setRowAnimationClass,
      setColumnCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community9._setAriaColCount)(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community9._setAriaRowCount)(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
    ...
    const ctrl = context.createBean(new import_ag_grid_community9.GridBodyCtrl());
  ...
  const setupCtrl = (0, import_react23.useCallback)(() => {
    ...
    if (topTabGuardRef.current && bottomTabGuardRef.current) {
      ...
      tabGuardCtrlRef.current = context.createBean(
        new import_ag_grid_community19.TabGuardCtrl({
          comp: compProxy,
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react8.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_ag_grid_community8.GridCtrl());
