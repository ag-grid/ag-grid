  ...
  waitForInstance(reactComponent, resolve, startTime = Date.now()) {
    ...
    if (reactComponent.rendered()) {
      ...
      if (Date.now() - startTime >= this.maxComponentCreationTimeMs && !this.hasPendingPortalUpdate) {
        (0, import_ag_grid_community6._errorOnce)(
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react11.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_ag_grid_community11.GridHeaderCtrl());
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            context.destroyBean(comp);
            (0, import_ag_grid_community13._removeFromParent)(eGui2);
          });
        }
        return comp;
      };
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerOptions = (0, import_react18.useMemo)(() => (0, import_ag_grid_community15._getRowContainerOptions)(name), [name]);
...
var GridBodyComp = () => {
  ...
  const setRef2 = (0, import_react19.useCallback)((e) => {
    ...
    addComp(eRoot.current, import_ag_grid_community16.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRoot.current, import_ag_grid_community16.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
      addComp(eBody.current, import_ag_grid_community16.FakeVScrollComp, " AG Fake Vertical Scroll ");
    }
    const compProxy = {
      setRowAnimationCssOnBodyViewport: setRowAnimationClass,
      setColumnCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community16._setAriaColCount)(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community16._setAriaRowCount)(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
  ...
  const setupCtrl = (0, import_react20.useCallback)(() => {
    ...
    if (topTabGuardRef.current && bottomTabGuardRef.current) {
      ...
      tabGuardCtrlRef.current = context.createBean(
        new import_ag_grid_community17.TabGuardCtrl({
          comp: compProxy,
...
var AgGridReactUi = (props) => {
  ...
  const setRef2 = (0, import_react22.useCallback)((e) => {
    ...
    const mergedGridOps = (0, import_ag_grid_community20._combineAttributesAndGridOptions)(props.gridOptions, props);
    ...
    const gridCoreCreator = new import_ag_grid_community20.GridCoreCreator();
  ...
  (0, import_react22.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        (0, import_ag_grid_community20._processOnChange)(changes, apiRef.current);
      }
    });
  }, [props]);
...
var ReactFrameworkComponentWrapper = class extends import_ag_grid_community20.BaseComponentWrapper {
...
var DetailCellRenderer = (0, import_react22.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react22.useMemo)(() => import_ag_grid_community20.ModuleRegistry.__getGridRegisteredModules(props.api.getGridId()), [props]);
  ...
  if (props.template) {
    (0, import_ag_grid_community20._warnOnce)(
...
var ReactFrameworkOverrides = class extends import_ag_grid_community20.VanillaFrameworkOverrides {
  constructor() {
    super("react");
