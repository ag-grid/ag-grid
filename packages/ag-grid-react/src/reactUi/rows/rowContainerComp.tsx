...
const RowContainerComp = ({
    ...
    }, [shouldRenderViewport, isSpanning, requiresExternalViewport, viewportElement]);
    ...
    }, [areElementsReady, areElementsRemoved, context, name, requiresExternalViewport, viewportElement]);
