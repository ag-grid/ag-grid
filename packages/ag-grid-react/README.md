...
<blockquote>
    <p>ℹ️ <b>Note:</b></p>
    <span>Visit the <a href="https://www.ag-grid.com/license-pricing/?utm_source=@ag-grid-community/react-readme&utm_medium=repository&utm_campaign=github">Pricing</a> page for a full comparison.</span>
</blockquote>
...
```sh
$ npm install --save ag-grid-community @ag-grid-community/react
```
...
<blockquote>
    <p>ℹ️ <b>Note:</b></p>
    <span>For more information on building Data Grids with AG Grid, refer to our <a href="https://www.ag-grid.com/react-data-grid/getting-started/?utm_source=@ag-grid-community/react-readme&utm_medium=repository&utm_campaign=githu">Documentation</a>.</span>
</blockquote>
...
If you've made it this far, you may be interested in our latest project: [AG Charts](https://ag-grid.com/charts?utm_source=@ag-grid-community/react-readme&utm_medium=repository&utm_campaign=github) - The best React Charting library in the world.
