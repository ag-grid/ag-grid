...
function getGridPropertiesAndEventsTs() {
    const eventsSrc = getJavascript('./node_modules/@ag-community/grid-core/src/ts/eventKeys.ts');
    const propertyKeysSrc = getJavascript('./node_modules/@ag-community/grid-core/src/ts/propertyKeys.ts');
...
function getGridColumnPropertiesTs() {
    const js = getJavascript('./node_modules/@ag-community/grid-core/src/ts/components/colDefUtil.ts');
    eval(js);
