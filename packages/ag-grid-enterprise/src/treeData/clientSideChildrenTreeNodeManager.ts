import { _cloneObject, _exists, _getRowIdCallback, _iterateObject, _missingOrEmpty } from 'ag-grid-community';
import type {
    ...
    implements IClientSideNodeManager<TData>, NamedBean
{
    ...
    private executeUpdate(
        ...
        if (!this.gos.get('treeData')) {
            this.setMasterForAllRows(rowNodeTransaction.update as RowNode<TData>[] | null | undefined, false);
        }
    }
