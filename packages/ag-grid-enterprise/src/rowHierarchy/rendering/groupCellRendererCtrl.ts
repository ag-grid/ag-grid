...
export class GroupCellRendererCtrl extends BeanStub implements IGroupCellRendererCtrl {
    ...
    private setupExpand(): void {
        ...
        const setupListeners = () => {
            // Cell double clicked — only suppress expand when a group-edit feature is active
            const isDoubleClickEdit = !suppressDoubleClickExpand && this.isGroupCellEditable(this.displayedNode);
