...
import type { AgChartInstance, AgChartOptions, AgChartTheme, AgChartThemeOverrides, AgChartThemePalette } from 'ag-charts-community';
...
export declare abstract class ChartProxy<TOptions extends AgChartOptions = AgChartOptions, TSeries extends ChartSeriesType = ChartSeriesType> {
    ...
    getChartRef(): AgChartInstance<AgChartOptions>;
