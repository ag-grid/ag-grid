...
// packages/ag-grid-vue3/src/VueFrameworkComponentWrapper.ts
var VueFrameworkComponentWrapper = class _VueFrameworkComponentWrapper extends import_ag_grid_community2.BaseComponentWrapper {
...
var ALWAYS_SYNC_GLOBAL_EVENTS = /* @__PURE__ */ new Set([import_ag_grid_community4.Events.EVENT_GRID_PRE_DESTROYED]);
...
var AgGridVue = (0, import_vue2.defineComponent)({
  ...
  methods: {
    ...
    processChanges(propertyName, currentValue, previousValue) {
      if (this.gridCreated) {
        ...
        import_ag_grid_community4.ComponentUtil.processOnChange(options, this.api);
      }
    },
  ...
  mounted() {
    ...
    const gridOptions = markRaw(import_ag_grid_community4.ComponentUtil.combineAttributesAndGridOptions(toRaw(this.gridOptions), this));
