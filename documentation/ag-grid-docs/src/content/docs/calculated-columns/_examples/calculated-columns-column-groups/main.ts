    ...
    { field: 'product', pinned: 'left', minWidth: 180, flex: 1.4 },
    {
        ...
        children: [
            ...
            quarterColumn('q4_2025'),
            {
                ...
                calculatedExpression: '[2025 Q1] + [2025 Q2] + [2025 Q3] + [2025 Q4]',
                cellDataType: 'number',
                valueFormatter: currencyFormatter,
            },
        ],
    },
    {
        ...
        children: [
            ...
            quarterColumn('q4_2026'),
            {
                ...
                headerName: 'Total',
                columnGroupShow: 'closed',
                calculatedExpression: '[2026 Q1] + [2026 Q2] + [2026 Q3] + [2026 Q4]',
                cellDataType: 'number',
                valueFormatter: currencyFormatter,
            },
        ],
        ...
        children: [
            {
                ...
                calculatedExpression: 'ROUND((([2026 Q4] - [2025 Q4]) / [2025 Q4]) * 100, 1)',
                cellDataType: 'number',
                sortable: true,
            ...
            },
            {
                ...
                calculatedExpression:
                    '([2026 Q1] + [2026 Q2] + [2026 Q3] + [2026 Q4]) - ([2025 Q1] + [2025 Q2] + [2025 Q3] + [2025 Q4])',
                cellDataType: 'number',
                sortable: true,
                filter: 'agNumberColumnFilter',
                valueFormatter: currencyFormatter,
