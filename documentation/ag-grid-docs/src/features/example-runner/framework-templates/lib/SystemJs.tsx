...
const publishedConfiguration: Configuration = {
    ...
    gridEnterprisePaths: {
        'ag-charts-react': `${NPM_CDN}/ag-charts-react@9.3.1/`,
        'ag-charts-angular': `${NPM_CDN}/ag-charts-angular@9.3.1/`,
        'ag-charts-vue': `${NPM_CDN}/ag-charts-vue@9.3.1/`,
        'ag-charts-vue3': `${NPM_CDN}/ag-charts-vue3@9.3.1/`,
        'ag-charts-community': `${NPM_CDN}/ag-charts-community@9.3.1/dist/package/main.cjs.js`,
        'ag-charts-enterprise': `${NPM_CDN}/ag-charts-enterprise@9.3.1/dist/package/main.cjs.js`,
        '@ag-grid-community/client-side-row-model': `https://cdn.jsdelivr.net/npm/@ag-grid-community/client-side-row-model@${agGridVersion}/dist/package/main.cjs.js`,
        '@ag-grid-community/core': `https://cdn.jsdelivr.net/npm/@ag-grid-community/core@${agGridVersion}/dist/package/main.cjs.js`,
