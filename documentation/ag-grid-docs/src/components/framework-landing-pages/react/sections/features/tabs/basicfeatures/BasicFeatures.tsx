                ...
                <div className={styles.featureContainer}>
                    ...
                    <div className={styles.feature}>
                        ...
                        <span className={styles.featureDetail}>
                            Add a React Table with less than 20 lines of code. Choose a <a>theme</a>, add your data, and
                            define your column structure. View the <a>Quick Start</a> to learn more.
                        </span>
                    </div>
                    <div className={styles.feature}>
                    ...
                    <div className={styles.feature}>
                        ...
                        <span className={styles.featureDetail}>
                            Enable complex features with single properties, including: <a>Sorting</a>, <a>Filtering</a>,{' '}
                            <a>Cell Editing</a>, <a>CSV Export</a>, <a>Pagination</a>, <a>Row Selection</a>,{' '}
                            <a>Server Side Data</a>, and <a>Accessibility</a>.
                        </span>
                    </div>
                </div>
            </div>
