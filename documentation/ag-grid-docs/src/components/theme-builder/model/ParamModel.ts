...
// Generated by the build pipeline (generate-doc-references task). Loaded via glob so that the
// module still initialises gracefully when the file has not been built yet (e.g. direct test runs).
const _themingApiGlob = import.meta.glob<Record<string, { meta?: { comment?: string } }>>(
    '../../../../../../dist/documentation/reference/theming-api.AUTO.json',
    { eager: true, import: 'default' }
);
const themingApi: Record<string, { meta?: { comment?: string } }> = Object.values(_themingApiGlob)[0] ?? {};
