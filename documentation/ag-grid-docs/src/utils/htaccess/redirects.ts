...
export const SITE_301_REDIRECTS: Redirect[] = [
    ...
    { from: '/ag-grid-building-amd/', to: '/javascript-data-grid/building-amd/' },
    { from: '/ag-grid-building-rollup/', to: '/javascript-data-grid/building-rollup/' },
    { from: '/ag-grid-building-typescript/', to: '/javascript-data-grid/building-typescript/' },
    { from: '/ag-grid-building/', to: '/javascript-data-grid/building/' },
    {
    ...
    { from: '/angular-grid-cell-rendering/', to: '/angular-data-grid/cell-rendering/' },
    ...
    { from: '/angular-grid-header-rendering/', to: '/angular-data-grid/component-header/' },
    ...
    { from: '/angular-grid-model/', to: '/angular-data-grid/client-side-model/' },
    ...
    { from: '/angular-grid-range-selection/', to: '/angular-data-grid/range-selection/' },
    ...
    { from: '/documentation/angular/cell-rendering/', to: '/angular-data-grid/cell-rendering/' },
    ...
    { from: '/documentation/angular/client-side-model/', to: '/angular-data-grid/client-side-model/' },
    ...
    { from: '/documentation/angular/component-cell-editor/', to: '/angular-data-grid/component-cell-editor/' },
    { from: '/documentation/angular/component-cell-renderer/', to: '/angular-data-grid/component-cell-renderer/' },
    { from: '/documentation/angular/component-communication/', to: '/angular-data-grid/component-communication/' },
    { from: '/documentation/angular/component-date/', to: '/angular-data-grid/component-date/' },
    ...
    { from: '/documentation/angular/component-header/', to: '/angular-data-grid/component-header/' },
    {
        from: '/documentation/angular/component-loading-cell-renderer/',
        to: '/angular-data-grid/component-loading-cell-renderer/',
    },
    { from: '/documentation/angular/component-overlay/', to: '/angular-data-grid/component-overlay/' },
    { from: '/documentation/angular/component-status-bar/', to: '/angular-data-grid/component-status-bar/' },
    { from: '/documentation/angular/component-tool-panel/', to: '/angular-data-grid/component-tool-panel/' },
    { from: '/documentation/angular/component-tooltip/', to: '/angular-data-grid/component-tooltip/' },
    ...
    { from: '/documentation/angular/expressions-and-context/', to: '/angular-data-grid/expressions-and-context/' },
    ...
    { from: '/documentation/angular/flashing-cells/', to: '/angular-data-grid/flashing-cells/' },
    ...
    { from: '/documentation/angular/group-cell-renderer/', to: '/angular-data-grid/group-cell-renderer/' },
    ...
    { from: '/documentation/angular/integrated-charts-toolbar/', to: '/angular-data-grid/integrated-charts-toolbar/' },
    ...
    { from: '/documentation/angular/modules-building/', to: '/angular-data-grid/modules-building/' },
    ...
    { from: '/documentation/angular/packages-modules/', to: '/angular-data-grid/packages-modules/' },
    { from: '/documentation/angular/packages/', to: '/angular-data-grid/packages/' },
    ...
    { from: '/documentation/angular/provided-cell-editors/', to: '/angular-data-grid/provided-cell-editors/' },
    {
        ...
        to: '/angular-data-grid/range-selection-fill-handle/',
    },
    ...
    { from: '/documentation/angular/scrolling-scenarios/', to: '/angular-data-grid/scrolling-scenarios/' },
    ...
    { from: '/documentation/javascript/building-amd/', to: '/javascript-data-grid/building-amd/' },
    { from: '/documentation/javascript/building-rollup/', to: '/javascript-data-grid/building-rollup/' },
    { from: '/documentation/javascript/building-typescript/', to: '/javascript-data-grid/building-typescript/' },
    { from: '/documentation/javascript/building/', to: '/javascript-data-grid/building/' },
    ...
    { from: '/documentation/javascript/cell-rendering/', to: '/javascript-data-grid/cell-rendering/' },
    ...
    { from: '/documentation/javascript/client-side-model/', to: '/javascript-data-grid/client-side-model/' },
    ...
    { from: '/documentation/javascript/component-cell-editor/', to: '/javascript-data-grid/component-cell-editor/' },
    {
        from: '/documentation/javascript/component-cell-renderer/',
        to: '/javascript-data-grid/component-cell-renderer/',
    },
    { from: '/documentation/javascript/component-date/', to: '/javascript-data-grid/component-date/' },
    ...
    { from: '/documentation/javascript/component-header/', to: '/javascript-data-grid/component-header/' },
    {
        from: '/documentation/javascript/component-loading-cell-renderer/',
        to: '/javascript-data-grid/component-loading-cell-renderer/',
    },
    { from: '/documentation/javascript/component-overlay/', to: '/javascript-data-grid/component-overlay/' },
    { from: '/documentation/javascript/component-status-bar/', to: '/javascript-data-grid/component-status-bar/' },
    { from: '/documentation/javascript/component-tool-panel/', to: '/javascript-data-grid/component-tool-panel/' },
    { from: '/documentation/javascript/component-tooltip/', to: '/javascript-data-grid/component-tooltip/' },
    ...
    { from: '/documentation/javascript/download/', to: '/javascript-data-grid/download/' },
    ...
    { from: '/documentation/javascript/export/', to: '/javascript-data-grid/excel-export/' },
    {
        ...
        to: '/javascript-data-grid/expressions-and-context/',
    },
    ...
    { from: '/documentation/javascript/flashing-cells/', to: '/javascript-data-grid/flashing-cells/' },
    ...
    { from: '/documentation/javascript/group-cell-renderer/', to: '/javascript-data-grid/group-cell-renderer/' },
    ...
    },
    {
        ...
        to: '/javascript-data-grid/integrated-charts-toolbar/',
    },
    ...
    { from: '/documentation/javascript/modules-building/', to: '/javascript-data-grid/modules-building/' },
    ...
    { from: '/documentation/javascript/npm/', to: '/javascript-data-grid/npm/' },
    { from: '/documentation/javascript/overlays/', to: '/javascript-data-grid/overlays/' },
    { from: '/documentation/javascript/packages-modules/', to: '/javascript-data-grid/packages-modules/' },
    { from: '/documentation/javascript/packages/', to: '/javascript-data-grid/packages/' },
    ...
    { from: '/documentation/javascript/provided-cell-editors/', to: '/javascript-data-grid/provided-cell-editors/' },
    {
        ...
        to: '/javascript-data-grid/range-selection-fill-handle/',
    },
    ...
    { from: '/documentation/javascript/scrolling-scenarios/', to: '/javascript-data-grid/scrolling-scenarios/' },
    ...
    { from: '/documentation/react/cell-rendering/', to: '/react-data-grid/cell-rendering/' },
    ...
    { from: '/documentation/react/client-side-model/', to: '/react-data-grid/client-side-model/' },
    ...
    { from: '/documentation/react/component-cell-editor/', to: '/react-data-grid/component-cell-editor/' },
    { from: '/documentation/react/component-cell-renderer/', to: '/react-data-grid/component-cell-renderer/' },
    { from: '/documentation/react/component-date/', to: '/react-data-grid/component-date/' },
    ...
    { from: '/documentation/react/component-header/', to: '/react-data-grid/component-header/' },
    {
        from: '/documentation/react/component-loading-cell-renderer/',
        to: '/react-data-grid/component-loading-cell-renderer/',
    },
    { from: '/documentation/react/component-overlay/', to: '/react-data-grid/component-overlay/' },
    { from: '/documentation/react/component-status-bar/', to: '/react-data-grid/component-status-bar/' },
    ...
    { from: '/documentation/react/component-tooltip/', to: '/react-data-grid/component-tooltip/' },
    ...
    { from: '/documentation/react/expressions-and-context/', to: '/react-data-grid/expressions-and-context/' },
    ...
    { from: '/documentation/react/flashing-cells/', to: '/react-data-grid/flashing-cells/' },
    { from: '/documentation/react/floating-filters/', to: '/react-data-grid/floating-filters/' },
    { from: '/documentation/react/framework-hoc/', to: '/react-data-grid/framework-hoc/' },
    ...
    { from: '/documentation/react/group-cell-renderer/', to: '/react-data-grid/group-cell-renderer/' },
    ...
    { from: '/documentation/react/integrated-charts-toolbar/', to: '/react-data-grid/integrated-charts-toolbar/' },
    ...
    { from: '/documentation/react/modules-building/', to: '/react-data-grid/modules-building/' },
    ...
    { from: '/documentation/react/packages-modules/', to: '/react-data-grid/packages-modules/' },
    { from: '/documentation/react/packages/', to: '/react-data-grid/packages/' },
    ...
    { from: '/documentation/react/range-selection-fill-handle/', to: '/react-data-grid/range-selection-fill-handle/' },
    { from: '/documentation/react/range-selection-handle/', to: '/react-data-grid/range-selection-handle/' },
    { from: '/documentation/react/range-selection/', to: '/react-data-grid/range-selection/' },
    { from: '/documentation/react/react-hooks/', to: '/react-data-grid/react-hooks/' },
    { from: '/documentation/react/redux-integration-pt1/', to: '/react-data-grid/redux-integration-pt1/' },
    { from: '/documentation/react/redux-integration-pt2/', to: '/react-data-grid/redux-integration-pt2/' },
    ...
    { from: '/documentation/react/scrolling-scenarios/', to: '/react-data-grid/scrolling-scenarios/' },
    ...
    { from: '/documentation/vue/cell-rendering/', to: '/vue-data-grid/cell-rendering/' },
    ...
    { from: '/documentation/vue/client-side-model/', to: '/vue-data-grid/client-side-model/' },
    ...
    { from: '/documentation/vue/component-cell-editor/', to: '/vue-data-grid/component-cell-editor/' },
    { from: '/documentation/vue/component-cell-renderer/', to: '/vue-data-grid/component-cell-renderer/' },
    { from: '/documentation/vue/component-communication/', to: '/vue-data-grid/component-communication/' },
    { from: '/documentation/vue/component-date/', to: '/vue-data-grid/component-date/' },
    ...
    { from: '/documentation/vue/component-header/', to: '/vue-data-grid/component-header/' },
    {
        from: '/documentation/vue/component-loading-cell-renderer/',
        to: '/vue-data-grid/component-loading-cell-renderer/',
    },
    { from: '/documentation/vue/component-overlay/', to: '/vue-data-grid/component-overlay/' },
    { from: '/documentation/vue/component-status-bar/', to: '/vue-data-grid/component-status-bar/' },
    { from: '/documentation/vue/component-tool-panel/', to: '/vue-data-grid/component-tool-panel/' },
    { from: '/documentation/vue/component-tooltip/', to: '/vue-data-grid/component-tooltip/' },
    ...
    { from: '/documentation/vue/expressions-and-context/', to: '/vue-data-grid/expressions-and-context/' },
    ...
    { from: '/documentation/vue/flashing-cells/', to: '/vue-data-grid/flashing-cells/' },
    ...
    { from: '/documentation/vue/framework-misc/', to: '/vue-data-grid/framework-misc/' },
    ...
    { from: '/documentation/vue/group-cell-renderer/', to: '/vue-data-grid/group-cell-renderer/' },
    ...
    { from: '/documentation/vue/integrated-charts-toolbar/', to: '/vue-data-grid/integrated-charts-toolbar/' },
    ...
    { from: '/documentation/vue/modules-building/', to: '/vue-data-grid/modules-building/' },
    ...
    { from: '/documentation/vue/packages-modules/', to: '/vue-data-grid/packages-modules/' },
    { from: '/documentation/vue/packages/', to: '/vue-data-grid/packages/' },
    ...
    { from: '/documentation/vue/range-selection-fill-handle/', to: '/vue-data-grid/range-selection-fill-handle/' },
    ...
    { from: '/documentation/vue/scrolling-scenarios/', to: '/vue-data-grid/scrolling-scenarios/' },
    ...
    { from: '/example-expressions-and-context/', to: '/javascript-data-grid/expressions-and-context/' },
    { from: '/example-react-redux/', to: '/react-data-grid/redux-integration-pt1/' },
    ...
    { from: '/javascript-grid-cell-editor/', to: '/javascript-data-grid/component-cell-editor/' },
    ...
    { from: '/javascript-grid-cell-rendering/', to: '/javascript-data-grid/cell-rendering/' },
    ...
    { from: '/javascript-grid-client-side-model/', to: '/javascript-data-grid/client-side-model/' },
    ...
    { from: '/javascript-grid-date-component/', to: '/javascript-data-grid/component-date/' },
    { from: '/javascript-grid-dom-virtualisation/', to: '/javascript-data-grid/dom-virtualisation/' },
    { from: '/javascript-grid-download/', to: '/javascript-data-grid/download/' },
    ...
    { from: '/javascript-grid-flashing-cells/', to: '/javascript-data-grid/flashing-cells/' },
    ...
    { from: '/javascript-grid-header-rendering/', to: '/javascript-data-grid/component-header/' },
    ...
    { from: '/javascript-grid-model/', to: '/javascript-data-grid/client-side-model/' },
    { from: '/javascript-grid-modules-building/', to: '/javascript-data-grid/modules-building/' },
    ...
    { from: '/javascript-grid-npm/', to: '/javascript-data-grid/npm/' },
    { from: '/javascript-grid-openfin-dashboard/', to: 'https://www.ag-grid.com/' },
    { from: '/javascript-grid-overlay-component/', to: '/javascript-data-grid/component-overlay/' },
    { from: '/javascript-grid-overlays/', to: '/javascript-data-grid/overlays/' },
    { from: '/javascript-grid-packages-modules/', to: '/javascript-data-grid/packages-modules/' },
    { from: '/javascript-grid-packages/', to: '/javascript-data-grid/packages/' },
    ...
    { from: '/javascript-grid-provided-renderer-group/', to: '/javascript-data-grid/group-cell-renderer/' },
    ...
    { from: '/javascript-grid-range-selection/', to: '/javascript-data-grid/range-selection/' },
    ...
    { from: '/javascript-grid-scrolling-scenarios/', to: '/javascript-data-grid/scrolling-scenarios/' },
    ...
    { from: '/javascript-grid-status-bar-component/', to: '/javascript-data-grid/component-status-bar/' },
    ...
    { from: '/javascript-grid-tooltip-component/', to: '/javascript-data-grid/component-tooltip/' },
    ...
    { from: '/javascript-grid/column-state/', to: '/javascript-data-grid/column-state/' },
    { from: '/javascript-grid/column-updating-definitions/', to: '/javascript-data-grid/column-updating-definitions/' },
    { from: '/javascript-grid/component-cell-editor/', to: '/javascript-data-grid/component-cell-editor/' },
    { from: '/javascript-grid/component-cell-renderer/', to: '/javascript-data-grid/component-cell-renderer/' },
    { from: '/javascript-grid/component-date/', to: '/javascript-data-grid/component-date/' },
    ...
    { from: '/javascript-grid/component-header/', to: '/javascript-data-grid/component-header/' },
    {
        from: '/javascript-grid/component-loading-cell-renderer/',
        to: '/javascript-data-grid/component-loading-cell-renderer/',
    },
    { from: '/javascript-grid/component-overlay/', to: '/javascript-data-grid/component-overlay/' },
    { from: '/javascript-grid/component-status-bar/', to: '/javascript-data-grid/component-status-bar/' },
    { from: '/javascript-grid/component-tool-panel/', to: '/javascript-data-grid/component-tool-panel/' },
    { from: '/javascript-grid/component-tooltip/', to: '/javascript-data-grid/component-tooltip/' },
    { from: '/javascript-grid/component-types/', to: '/javascript-data-grid/components/' },
    { from: '/javascript-grid/components/', to: '/javascript-data-grid/components/' },
    { from: '/javascript-grid/context/', to: '/javascript-data-grid/context/' },
    { from: '/javascript-grid/context-menu/', to: '/javascript-data-grid/context-menu/' },
    ...
    { from: '/javascript-grid/expressions-and-context/', to: '/javascript-data-grid/expressions-and-context/' },
    { from: '/javascript-grid/filter-api/', to: '/javascript-data-grid/filter-api/' },
    { from: '/javascript-grid/filter-custom/', to: '/javascript-data-grid/component-filter/' },
    { from: '/javascript-grid/filter-date/', to: '/javascript-data-grid/filter-date/' },
    { from: '/javascript-grid/filter-external/', to: '/javascript-data-grid/filter-external/' },
    ...
    { from: '/javascript-grid/group-cell-renderer/', to: '/javascript-data-grid/group-cell-renderer/' },
    { from: '/javascript-grid/grouping/', to: '/javascript-data-grid/grouping/' },
    { from: '/javascript-grid/immutable-data/', to: 'https://www.ag-grid.com/' },
    { from: '/javascript-data-grid/immutable-data/', to: 'https://www.ag-grid.com/' },
    ...
    { from: '/javascript-grid/integrated-charts-toolbar/', to: '/javascript-data-grid/integrated-charts-toolbar/' },
    { from: '/javascript-grid/keyboard-navigation/', to: '/javascript-data-grid/keyboard-navigation/' },
    ...
    { from: '/angular-grid/client-side-model/', to: '/angular-data-grid/client-side-model/' },
    { from: '/angular-grid/clipboard/', to: '/angular-data-grid/clipboard/' },
    { from: '/angular-grid/column-api/', to: '/angular-data-grid/column-api/' },
    { from: '/angular-grid/column-definitions/', to: '/angular-data-grid/column-definitions/' },
    ...
    { from: '/angular-grid/component-cell-editor/', to: '/angular-data-grid/component-cell-editor/' },
    { from: '/angular-grid/component-cell-renderer/', to: '/angular-data-grid/component-cell-renderer/' },
    { from: '/angular-grid/component-date/', to: '/angular-data-grid/component-date/' },
    ...
    { from: '/angular-grid/component-header/', to: '/angular-data-grid/component-header/' },
    {
        from: '/angular-grid/component-loading-cell-renderer/',
        to: '/angular-data-grid/component-loading-cell-renderer/',
    },
    { from: '/angular-grid/component-overlay/', to: '/angular-data-grid/component-overlay/' },
    { from: '/angular-grid/component-status-bar/', to: '/angular-data-grid/component-status-bar/' },
    { from: '/angular-grid/component-tool-panel/', to: '/angular-data-grid/component-tool-panel/' },
    { from: '/angular-grid/component-tooltip/', to: '/angular-data-grid/component-tooltip/' },
    ...
    { from: '/angular-grid/expressions-and-context/', to: '/angular-data-grid/expressions-and-context/' },
    ...
    { from: '/angular-grid/flashing-cells/', to: '/angular-data-grid/flashing-cells/' },
    ...
    { from: '/angular-grid/group-cell-renderer/', to: '/angular-data-grid/group-cell-renderer/' },
    { from: '/angular-grid/grouping/', to: '/angular-data-grid/grouping/' },
    ...
    { from: '/angular-grid/integrated-charts-toolbar/', to: '/angular-data-grid/integrated-charts-toolbar/' },
    { from: '/angular-grid/keyboard-navigation/', to: '/angular-data-grid/keyboard-navigation/' },
    ...
    { from: '/angular-grid/modules-building/', to: '/angular-data-grid/modules-building/' },
    { from: '/angular-grid/modules-more-details/', to: '/angular-data-grid/modules/' },
    { from: '/angular-data-grid/modules-more-details/', to: '/angular-data-grid/modules/' },
    { from: '/angular-grid/overlays/', to: '/angular-data-grid/overlays/' },
    { from: '/angular-grid/packages/', to: '/angular-data-grid/packages/' },
    { from: '/angular-grid/packages-modules/', to: '/angular-data-grid/packages-modules/' },
    ...
    { from: '/angular-grid/scrolling-scenarios/', to: '/angular-data-grid/scrolling-scenarios/' },
    ...
    { from: '/react-grid/cell-rendering/', to: '/react-data-grid/cell-rendering/' },
    ...
    { from: '/react-grid/client-side-model/', to: '/react-data-grid/client-side-model/' },
    ...
    { from: '/react-grid/component-cell-editor/', to: '/react-data-grid/component-cell-editor/' },
    { from: '/react-grid/component-cell-renderer/', to: '/react-data-grid/component-cell-renderer/' },
    { from: '/react-grid/component-date/', to: '/react-data-grid/component-date/' },
    ...
    { from: '/react-grid/component-header/', to: '/react-data-grid/component-header/' },
    { from: '/react-grid/component-loading-cell-renderer/', to: '/react-data-grid/component-loading-cell-renderer/' },
    { from: '/react-grid/component-overlay/', to: '/react-data-grid/component-overlay/' },
    { from: '/react-grid/component-status-bar/', to: '/react-data-grid/component-status-bar/' },
    ...
    { from: '/react-grid/component-tooltip/', to: '/react-data-grid/component-tooltip/' },
    ...
    { from: '/react-grid/expressions-and-context/', to: '/react-data-grid/expressions-and-context/' },
    ...
    { from: '/react-grid/flashing-cells/', to: '/react-data-grid/flashing-cells/' },
    { from: '/react-grid/floating-filters/', to: '/react-data-grid/floating-filters/' },
    { from: '/react-grid/framework-hoc/', to: '/react-data-grid/framework-hoc/' },
    ...
    { from: '/react-grid/group-cell-renderer/', to: '/react-data-grid/group-cell-renderer/' },
    ...
    { from: '/react-grid/integrated-charts-toolbar/', to: '/react-data-grid/integrated-charts-toolbar/' },
    ...
    { from: '/react-grid/modules-building/', to: '/react-data-grid/modules-building/' },
    { from: '/react-grid/modules-more-details/', to: '/react-data-grid/modules/' },
    { from: '/react-data-grid/modules-more-details/', to: '/react-data-grid/modules/' },
    { from: '/react-grid/overlays/', to: '/react-data-grid/overlays/' },
    { from: '/react-grid/packages/', to: '/react-data-grid/packages/' },
    { from: '/react-grid/packages-modules/', to: '/react-data-grid/packages-modules/' },
    ...
    { from: '/react-grid/range-selection/', to: '/react-data-grid/range-selection/' },
    { from: '/react-grid/range-selection-fill-handle/', to: '/react-data-grid/range-selection-fill-handle/' },
    { from: '/react-grid/range-selection-handle/', to: '/react-data-grid/range-selection-handle/' },
    { from: '/react-grid/react-hooks/', to: '/react-data-grid/react-hooks/' },
    { from: '/react-grid/redux-integration-pt1/', to: '/react-data-grid/redux-integration-pt1/' },
    { from: '/react-grid/redux-integration-pt2/', to: '/react-data-grid/redux-integration-pt2/' },
    ...
    { from: '/react-grid/scrolling-scenarios/', to: '/react-data-grid/scrolling-scenarios/' },
    ...
    { from: '/vue-grid/cell-rendering/', to: '/vue-data-grid/cell-rendering/' },
    ...
    { from: '/vue-grid/client-side-model/', to: '/vue-data-grid/client-side-model/' },
    ...
    { from: '/vue-grid/component-cell-editor/', to: '/vue-data-grid/component-cell-editor/' },
    { from: '/vue-grid/component-cell-renderer/', to: '/vue-data-grid/component-cell-renderer/' },
    { from: '/vue-grid/component-date/', to: '/vue-data-grid/component-date/' },
    ...
    { from: '/vue-grid/component-header/', to: '/vue-data-grid/component-header/' },
    { from: '/vue-grid/component-loading-cell-renderer/', to: '/vue-data-grid/component-loading-cell-renderer/' },
    { from: '/vue-grid/component-overlay/', to: '/vue-data-grid/component-overlay/' },
    { from: '/vue-grid/component-status-bar/', to: '/vue-data-grid/component-status-bar/' },
    { from: '/vue-grid/component-tool-panel/', to: '/vue-data-grid/component-tool-panel/' },
    { from: '/vue-grid/component-tooltip/', to: '/vue-data-grid/component-tooltip/' },
    ...
    { from: '/vue-grid/expressions-and-context/', to: '/vue-data-grid/expressions-and-context/' },
    ...
    { from: '/vue-grid/flashing-cells/', to: '/vue-data-grid/flashing-cells/' },
    ...
    { from: '/vue-grid/group-cell-renderer/', to: '/vue-data-grid/group-cell-renderer/' },
    ...
    { from: '/vue-grid/integrated-charts-toolbar/', to: '/vue-data-grid/integrated-charts-toolbar/' },
    ...
    { from: '/vue-grid/modules-building/', to: '/vue-data-grid/modules-building/' },
    { from: '/vue-grid/modules-more-details/', to: '/vue-data-grid/modules/' },
    { from: '/vue-data-grid/modules-more-details/', to: '/vue-data-grid/modules/' },
    { from: '/vue-grid/overlays/', to: '/vue-data-grid/overlays/' },
    { from: '/vue-grid/packages/', to: '/vue-data-grid/packages/' },
    { from: '/vue-grid/packages-modules/', to: '/vue-data-grid/packages-modules/' },
    ...
    { from: '/vue-grid/range-selection/', to: '/vue-data-grid/range-selection/' },
    ...
    { from: '/vue-grid/scrolling-scenarios/', to: '/vue-data-grid/scrolling-scenarios/' },
    ...
    { from: '/react-redux-integration-pt1/', to: '/react-data-grid/redux-integration-pt1/' },
    { from: '/react-redux-integration-pt2/', to: '/react-data-grid/redux-integration-pt2/' },
    {
    ...
    { from: '/vuejs-misc/', to: '/vue-data-grid/framework-misc/' },
