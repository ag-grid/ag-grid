...
export const SITE_301_REDIRECTS: Redirect[] = [
    ...
    ...pageForAllFrameworks('upgrading-to-ag-grid-32-2', 'ag-grid-32-2-1-release-notes'),

    ...pageForAllFrameworks('upgrading-to-ag-grid-26', 'ag-grid-26-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-27', 'ag-grid-27-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-28', 'ag-grid-28-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-29', 'ag-grid-29-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-30', 'ag-grid-30-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-31-1', 'ag-grid-31-1-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-31-2', 'ag-grid-31-2-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-31-3', 'ag-grid-31-3-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-31', 'ag-grid-31-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-32-1', 'ag-grid-32-1-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-32-2-1', 'ag-grid-32-2-1-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-32-3', 'ag-grid-32-3-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-32', 'ag-grid-32-release-notes'),
    ...pageForAllFrameworks('upgrading-to-ag-grid-33-1', 'ag-grid-33-1-release-notes'),
