...
export const SITE_301_REDIRECTS: Redirect[] = [
    ...
    { from: '/ag-grid-building-amd/', to: '/javascript-data-grid/npm/' },
    { from: '/javascript-data-grid/building-amd/', to: '/javascript-data-grid/npm/' },
    { from: '/ag-grid-building-rollup/', to: '/javascript-data-grid/npm/' },
    { from: '/javascript-data-grid/building-rollup/', to: '/javascript-data-grid/npm/' },
    { from: '/ag-grid-building-typescript/', to: '/javascript-data-grid/npm/' },
    { from: '/javascript-data-grid/building-typescript/', to: '/javascript-data-grid/npm/' },
    { from: '/ag-grid-building/', to: '/javascript-data-grid/npm/' },
    ...
    { from: '/documentation/javascript/building-amd/', to: '/javascript-data-grid/npm/' },
    { from: '/documentation/javascript/building-rollup/', to: '/javascript-data-grid/npm/' },
    { from: '/documentation/javascript/building-typescript/', to: '/javascript-data-grid/npm/' },
    { from: '/documentation/javascript/building/', to: '/javascript-data-grid/npm/' },
