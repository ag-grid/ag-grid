...
export const SITE_301_REDIRECTS: Redirect[] = [
    ...
    { from: '/javascript-data-grid/building/', to: '/javascript-data-grid/packages-modules/' },
    { from: '/angular-data-grid/building/', to: '/angular-data-grid/packages-modules/' },
    { from: '/react-data-grid/building/', to: '/react-data-grid/packages-modules/' },
    { from: '/vue-data-grid/building/', to: '/vue-data-grid/packages-modules/' },
