...
${SITE_SINGLE_HOP_REWRITES.map((r) => {
    ...
    # The 410s are deliberate: those posts are gone, not moved.
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?whats-new-in-ag-grid-v24(?:/amp)?/?$ - [R=410,L]

    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/react(?:/amp)?/?$ https://www.ag-grid.com/blog/tag/react-data-grid/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?conferences-ag-grid-amsterdam-june-2022(?:/amp)?/?$ https://www.ag-grid.com/blog/js-nation-and-react-summit-june-2022-overview/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?getting-more-from-your-datagrid-introducing-adaptable(?:/amp)?/?$ https://www.ag-grid.com/blog/adaptable-tools-demo-and-interview/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?javascript-grid-comparison-column-pinning-ag-grid(?:/amp)?/?$ https://www.ag-grid.com/blog/heres-why-column-pinning-in-react-datagrid-by-ag-grid-wins-over-competition/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?whats-new-in-ag-studio-2(?:-0)?(?:/amp)?/?$ https://www.ag-grid.com/blog/whats-new-in-ag-studio-2-0-javascript-embedded-analytics/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?whats-new-in-ag-studio-2-1(?:/amp)?/?$ https://www.ag-grid.com/blog/whats-new-in-ag-studio-2-1-javascript-embedded-analytics/ [R=301,L]

    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?showcase(?:/amp)?/?$ https://www.ag-grid.com/blog/ag-grid-showcase-examples-demos-samples-and-extensions/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?using-playwright-to-test-ag-grid-react-apps(?:/amp)?/?$ https://www.ag-grid.com/blog/writing-e2e-tests-for-ag-grid-react-tables-with-playwright/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?using-ag-grid-with-react-and-next-js(?:/amp)?/?$ https://www.ag-grid.com/blog/using-ag-grid-with-next-js-to-build-a-react-table/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?condtional-formatting-for-cells-in-ag-grid(?:/amp)?/?$ https://www.ag-grid.com/blog/conditional-formatting-for-cells-in-ag-grid/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?angular-2-0-web-components-and-ag-grid(?:/amp)?/?$ https://www.ag-grid.com/angular-data-grid/getting-started/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    ...
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?ag-grid-vs-datatables(?:/amp)?/?$ - [R=410,L]

    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?private/?$ https://www.ag-grid.com/blog/ [R=301,L]

    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:angular-grid|angular-table)/rss/?$ https://www.ag-grid.com/blog/tag/angular/rss/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:angular-grid|angular-table)(?:/amp|/page/[0-9]+)?/?$ https://www.ag-grid.com/blog/tag/angular/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:react-grid|react-table)/rss/?$ https://www.ag-grid.com/blog/tag/react-data-grid/rss/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:react-grid|react-table)(?:/amp|/page/[0-9]+)?/?$ https://www.ag-grid.com/blog/tag/react-data-grid/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:vue-grid|vue-table)/rss/?$ https://www.ag-grid.com/blog/tag/vuejs/rss/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:vue-grid|vue-table)(?:/amp|/page/[0-9]+)?/?$ https://www.ag-grid.com/blog/tag/vuejs/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:enzyme|jest)/rss/?$ https://www.ag-grid.com/blog/tag/testing/rss/ [R=301,L]
    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:enzyme|jest)(?:/amp|/page/[0-9]+)?/?$ https://www.ag-grid.com/blog/tag/testing/ [R=301,L]

    RewriteCond %{HTTP_HOST} ^blog\\.ag-grid\\.com$ [NC]
    RewriteRule ^/?tag/(?:ag-grid|column-header|columns|data-grid|data-table|date|datepicker|detail|editing|export|filtering|formatting|graphql|localstorage|master|mongodb|multi-line|pdf|range-selection|range-selection-styles|redux|row-background-color|row-selection|row-styling|server-side-row-model|sorting|state|styling-table-rows|tabs|vuex|web-development)(?:/amp|/rss|/page/[0-9]+)?/?$ - [R=410,L]
