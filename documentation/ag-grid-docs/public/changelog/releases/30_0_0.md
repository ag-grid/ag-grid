...
- Cell Rendering
  * AG-2396 - Allow the formatted cell value to be used with copy / fill handle / copy range down (See [Value Formatter](https://www.ag-grid.com/archive/30.0.0/javascript-data-grid/value-formatters/#formating-for-export))
...
- Export
  * AG-3427 - Allow exporting the formatted cell value instead of the underlying cell value (See [Value Formatter](https://www.ag-grid.com/archive/30.0.0/javascript-data-grid/value-formatters/#formating-for-export))
