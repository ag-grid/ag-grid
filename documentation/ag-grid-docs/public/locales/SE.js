const AG_GRID_LOCALE_SE = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "Sammanfogningsoperatorer inom ett villkor måste vara samma",
  advancedFilterValidationInvalidJoinOperator:
    "Sammanfogningsoperator hittades inte",
  ...
  advancedFilterBuilderValidationAlreadyApplied:
    "Nuvarande filter redan tillämpat.",
  ...
  pivotChartRequiresPivotMode:
    "Pivotdiagram kräver att Pivotläge är aktiverat.",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Nivå ${variable}. Tryck på ENTER för att redigera.",
  ...
  ariaDropZoneColumnValueItemDescription:
    "Tryck på ENTER för att ändra aggregationstyp",
  ...
  ariaLabelAdvancedFilterBuilderAddField:
    "Lägg till fält i avancerad filterbyggare",
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Välj kolumn i avancerad filterbyggare",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Välj alternativ i avancerad filterbyggare",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Välj sammanfogningsoperator i avancerad filterbyggare",
