const AG_GRID_LOCALE_DE = {
  ...
  advancedFilterBuilderValidationIncomplete:
    "Nicht alle Bedingungen sind abgeschlossen.",
  ...
  ariaRowSelectAll:
    "Drücken Sie LEERTASTE, um die Auswahl aller Reihen umschalten",
  ariaRowToggleSelection:
    "Drücken Sie LEERTASTE, um die Reihenauswahl umschalten",
  ...
  ariaDropZoneColumnComponentDescription:
    "Drücken Sie ENTFERNEN, um zu entfernen",
  ...
  ariaLabelAdvancedFilterBuilderAddField:
    "Erweiterter Filter-Ersteller Feld hinzufügen",
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Erweiterter Filter-Ersteller Spalte auswählen",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Erweiterter Filter-Ersteller Option auswählen",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Erweiterter Filter-Ersteller Verknüpfungsoperator auswählen",
