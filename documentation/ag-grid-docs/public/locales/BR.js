const AG_GRID_LOCALE_BR = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "Os operadores de junção dentro de uma condição devem ser iguais",
  ...
  advancedFilterValidationMessage:
    "A expressão contém um erro. ${variable} - ${variable}.",
  advancedFilterValidationMessageAtEnd:
    "A expressão contém um erro. ${variable} no final da expressão.",
  ...
  advancedFilterBuilderValidationSelectColumn:
    "É necessário selecionar uma coluna.",
  ...
  pivotChartRequiresPivotMode:
    "O gráfico dinâmico requer o modo dinâmico habilitado.",
  ...
  ariaRowSelectionDisabled:
    "A seleção de linha está desabilitada para esta linha",
  ariaSearch: "Procurar",
  ...
  ariaLabelAdvancedFilterBuilderAddField:
    "Adicionar campo ao construtor de filtro avançado",
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Selecionar coluna no construtor de filtro avançado",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Selecionar opção no construtor de filtro avançado",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Selecionar operador de junção no construtor de filtro avançado",
