const AG_GRID_LOCALE_PL = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "Operatory łączenia w warunku muszą być takie same",
  advancedFilterValidationInvalidJoinOperator:
    "Operator łączenia nieznaleziony",
  ...
  advancedFilterValidationMessage:
    "Wyrażenie zawiera błąd. ${variable} - ${variable}.",
  advancedFilterValidationMessageAtEnd:
    "Wyrażenie zawiera błąd. ${variable} na końcu wyrażenia.",
  ...
  advancedFilterBuilderValidationAlreadyApplied:
    "Aktualny filtr już zastosowany.",
  advancedFilterBuilderValidationIncomplete:
    "Nie wszystkie warunki są spełnione.",
  ...
  pivotChartRequiresPivotMode:
    "Wykres przestawny wymaga włączenia trybu przestawnego.",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Poziom ${variable}. Naciśnij ENTER, aby edytować.",
  ...
  ariaDropZoneColumnValueItemDescription:
    "Naciśnij ENTER, aby zmienić typ agregacji",
  ...
  ariaLabelAdvancedFilterAutocomplete:
    "Automatyczne uzupełnianie zaawansowanego filtra",
  ariaLabelAdvancedFilterBuilderAddField:
    "Dodaj pole do kreatora zaawansowanego filtra",
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Wybierz kolumnę w kreatorze zaawansowanego filtra",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Wybierz opcję w kreatorze zaawansowanego filtra",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Wybierz operator łączenia w kreatorze zaawansowanego filtra",
