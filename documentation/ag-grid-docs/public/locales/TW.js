const AG_GRID_LOCALE_TW = {
    ...
    addCurrentSelectionToFilter: '將目前選擇添加到篩選器',
    searchOoo: '搜尋...',
    blanks: '(空白)',
    noMatches: '無匹配項',
    ...
    advancedFilterTrue: '是',
    advancedFilterFalse: '否',
    advancedFilterAnd: '且',
    advancedFilterOr: '或',
    advancedFilterApply: '應用',
    advancedFilterBuilder: '建置',
    ...
    advancedFilterBuilderValidationAlreadyApplied: '目前篩選已應用。',
    advancedFilterBuilderValidationIncomplete: '並非所有條件都已完成。',
    advancedFilterBuilderValidationSelectColumn: '必須選擇欄位。',
    ...
    pivotMode: '樞紐模式',
    groups: '列分組',
    rowGroupColumnsEmptyMessage: '拖動到此處設置列分組',
    values: '值',
    ...
    noAggregation: '無',
    autosizeThisColumn: '自動調整此欄位大小',
    autosizeAllColumns: '自動調整所有欄位大小',
    groupBy: '按此分組',
    ungroupBy: '取消分組',
    ungroupAll: '取消所有分組',
    ...
    pivotChartAndPivotMode: '樞紐圖和樞紐模式',
    pivotChart: '樞紐圖',
    chartRange: '圖表範圍',
    ...
    ariaAdvancedFilterBuilderList: '進階篩選生成器列表',
    ariaAdvancedFilterBuilderFilterItem: '篩選條件',
    ariaAdvancedFilterBuilderGroupItem: '篩選群組',
    ariaAdvancedFilterBuilderColumn: '欄位',
    ...
    ariaChecked: '已選中',
    ariaColumn: '欄位',
    ariaColumnGroup: '欄位群組',
    ariaColumnFiltered: '欄位已篩選',
    ariaColumnSelectAll: '切換選擇所有欄位',
    ariaDateFilterInput: '日期篩選輸入',
    ariaDefaultListName: '列表',
    ariaFilterColumnsInput: '欄位篩選輸入',
    ...
    ariaRowGroupDropZonePanelLabel: '列分組',
    ariaValuesDropZonePanelLabel: '值',
    ariaPivotDropZonePanelLabel: '欄位標籤',
    ...
    ariaLabelAdvancedFilterAutocomplete: '進階篩選自動完成',
    ariaLabelAdvancedFilterBuilderAddField: '將欄位添加到進階篩選生成器',
    ariaLabelAdvancedFilterBuilderColumnSelectField: '在進階篩選生成器中選擇欄位',
    ariaLabelAdvancedFilterBuilderOptionSelectField: '在進階篩選生成器中選擇選項',
    ariaLabelAdvancedFilterBuilderJoinSelectField: '在進階篩選生成器中選擇連接運算符',
