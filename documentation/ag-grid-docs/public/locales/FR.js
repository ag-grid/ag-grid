const AG_GRID_LOCALE_FR = {
  ...
  advancedFilterBuilderValidationIncomplete:
    "Toutes les conditions ne sont pas complètes.",
  ...
  pivotColumnsEmptyMessage:
    "Faites glisser ici pour définir des étiquettes de colonnes",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Niveau ${variable}. Appuyez sur ENTRER pour éditer.",
  ...
  ariaRowSelectionDisabled:
    "La sélection de la ligne est désactivée pour cette ligne",
  ...
  ariaDropZoneColumnValueItemDescription:
    "Appuyez sur ENTRER pour changer le type d'agrégation",
  ...
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "Sélectionner une colonne dans le constructeur de filtre avancé",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Sélectionner une option dans le constructeur de filtre avancé",
