const AG_GRID_LOCALE_IR = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "عملگرهای پیوند در یک شرط باید یکسان باشند",
  ...
  pivotChartRequiresPivotMode:
    "نمودار محوری نیاز به فعال بودن حالت محوری دارد.",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. سطح ${variable}. برای ویرایش ENTER را فشار دهید.",
  ...
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "انتخاب ستون در سازنده فیلتر پیشرفته",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "انتخاب گزینه در سازنده فیلتر پیشرفته",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "انتخاب عملگر پیوند در سازنده فیلتر پیشرفته",
