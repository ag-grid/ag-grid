...
<?php
function gridFeature($enterprise, $name, $url, $image, $description, $snippet) {

    // we pass id's to the function for lazy loading the images.
    // the image is loaded when the feature is scrolled into view
    $id = str_replace(' ', '', $name);
    $imageId = 'img-'.$id;
    $featureId = 'parent-'.$id;
...
//        : '<img src="../images/svg/docs/features.svg" class="feature-enterprise-image"/>';
    ...
    print('  <h2 class="feature-title"><a href="'.$url.'">'.$enterpriseImage.$name.'</a></h2>');
    if (isset($image)) {
...
gridFeature(false, 'Column Groups', '../javascript-grid-grouping-headers/', 'columnGroups.gif',
...
gridFeature(false, 'Column Resizing', '../javascript-grid-resizing/', 'columnResize.gif',
...
<div class="feature-item">
    ...
    <div class="row half-width-child-features">
        <div class="col-md-6">
            <?php gridFeature(false, 'Text Filter', '../javascript-grid-filter-text/', 'textFilter.gif',
...
'); ?>
        ...
        <div class="col-md-6">
            <?php gridFeature(false, 'Number Filter', '../javascript-grid-filter-number/', 'numberFilter.gif',
...
'); ?>
    ...
    <div class="row half-width-child-features">
        <div class="col-md-6">
            <?php gridFeature(false, 'Date Filter', '../javascript-grid-filter-date/', 'dateFilter.gif',
...
gridFeature(true, 'Range Selection', '../javascript-grid-range-selection/', 'rangeSelection.gif',
...
gridFeature(false, 'Grid Size', '../javascript-grid-width-and-height/', 'gridSize.gif',
...
gridFeature(false, 'Column Spanning', '../javascript-grid-column-spanning/', 'columnSpanning.gif',
...
gridFeature(false, 'Column Pinning', '../javascript-grid-pinning/', 'columnPinning.gif',
...
gridFeature(false, 'Row Height', '../javascript-grid-row-height/', 'rowHeight.gif',
...
<div class="feature-item">
    ...
    <div class="row half-width-child-features">
        <div class="col-md-6">
            <?php gridFeature(false, 'Value Getters & Value Formatters', '../javascript-grid-value-getters/', null,
...
edited values, e.g. removing formatting before storing into the data.',
    ...
    // strings, so we convert the string to a number
    {
        ...
        <div class="col-md-6">
            <?php gridFeature(false, 'Expressions', '../javascript-grid-cell-expressions/', null,
...
gridFeature(false, 'Cell Rendering', '../javascript-grid-cell-rendering/', 'cellRendering.gif',
...
gridFeature(false, 'Keyboard Navigation', '../javascript-grid-keyboard-navigation/', 'keyboardNavigation.gif',
...
gridFeature(false, 'Animation', '../javascript-grid-animation/', 'animation.gif',
...
gridFeature(false, 'Accessing Data', '../javascript-grid-accessing-data/', 'accessingData.gif',
...
gridFeature(false, 'Pagination', '../javascript-grid-pagination/', 'pagination.gif',
...
gridFeature(false, 'View Refresh', '../javascript-grid-refresh/', 'viewRefresh.gif',
...
gridFeature(false, 'Internationalisation', '../javascript-grid-internationalisation/', 'internationalisation.gif',
...
gridFeature(false, 'Accessibility', '../javascript-grid-accessibility/', '.gif',
...
gridFeature(false, 'Full Width Rows', '../javascript-grid-full-width-rows/', 'fullWidth.gif',
...
gridFeature(false, 'RTL', '../javascript-grid-rtl/', 'rtl.gif',
...
?>
    ...
    <?php
    gridFeature(true, 'Grouping Rows', '../javascript-grid-grouping/', 'rowGroup.gif',
...
gridFeature(true, 'Clipboard', '../javascript-grid-clipboard/', 'clipboard.gif',
...
gridFeature(true, 'Column Menu', '../javascript-grid-column-menu/', 'columnMenu.gif',
...
gridFeature(true, 'Context Menu', '../javascript-grid-context-menu/', 'contextMenu.gif',
...
gridFeature(true, 'License Key', '../javascript-grid-set-license/', null,
