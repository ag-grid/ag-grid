...
declare -a subfolders=("ag-grid-angular-example/systemjs_aot" "ag-grid-angular-example/webpack" "ag-grid-angular-example/webpack2" "ag-grid-angular-example/angular-cli")
