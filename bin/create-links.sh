...
ln -s "$current_dir/ag-grid" ag-grid-react-example/node_modules/ag-grid
ln -s "$current_dir/ag-grid-enterprise" ag-grid-react-example/node_modules/ag-grid-enterprise
ln -s "$current_dir/ag-grid-react" ag-grid-react-example/node_modules/ag-grid-react
