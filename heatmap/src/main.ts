import { AgBaseSeriesOptions, AgSeriesListeners, AgCartesianSeriesMarker, AgSeriesTooltip, AgCartesianSeriesTooltipRendererParams, AgTooltipRendererResult, CssColor, PixelSize } from 'ag-charts-community';
...
declare module 'ag-charts-community' {
    ...
    export interface AgHeatmapSeriesMarker<DatumType> extends AgCartesianSeriesMarker<DatumType> {
