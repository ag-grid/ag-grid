(function() {
    ...
    gridsModule.controller('mainController', function($scope) {
        ...
        var angularGrid = {
            ...
            //dontUseScrolls: true,
            rowClass: function(row, pinnedRow) {
                return (row.country === 'Ireland') ? "theClass" : null;
            },
            ...
            cellClicked: function(row, colDef, event) {
                    console.log("Callback cellClicked: " + row + " - " + colDef.field + ' - ' + event);
