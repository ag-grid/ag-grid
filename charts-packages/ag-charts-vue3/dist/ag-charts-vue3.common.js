...
var AgChartsVue_AgChartsVue = /** @class */ (function (_super) {
    ...
    AgChartsVue.prototype.render = function () {
        return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])('div', { style: { height: '100%' }, ref: 'agChartRef' });
    };
    ...
    AgChartsVue.prototype.processChanges = function (currentValue, previousValue) {
        if (this.isCreated) {
            external_agCharts_["AgChart"].update(this.chart, toRaw(this.applyContainerIfNotSet(toRaw(this.options))));
        }
    };
