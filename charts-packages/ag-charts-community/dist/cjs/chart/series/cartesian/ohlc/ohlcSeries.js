    ...
    OHLCSeries.prototype.getTooltipHtml = function (nodeDatum) {
        ...
        if (tooltipRenderer) {
            ...
            var contentHtml = "<b>" + dateName + "</b>: " + this.dateFormatter(dateValue)
                + ("<br><b>" + openName + "</b>: " + number_1.toFixed(openValue))
                + ("<br><b>" + highName + "</b>: " + number_1.toFixed(highValue))
                + ("<br><b>" + lowName + "</b>: " + number_1.toFixed(lowValue))
                + ("<br><b>" + closeName + "</b>: " + number_1.toFixed(closeValue));
            if (labelKey) {
...
var OHLCSeriesMarker = /** @class */ (function (_super) {
    ...
    function OHLCSeriesMarker() {
         ...
         */
        _this.type = candlestick_1.Candlestick;
        _this.upFill = '#33ae5b';
    ...
    __decorate([
        observable_1.reactive('styleChange')
...
exports.OHLCSeriesMarker = OHLCSeriesMarker;
