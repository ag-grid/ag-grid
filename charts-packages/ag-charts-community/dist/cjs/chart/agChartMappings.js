...
exports.mappings = (_a = {},
    _a[cartesianChart_1.CartesianChart.type] = __assign(__assign({ meta: __assign(__assign({ constructor: cartesianChart_1.CartesianChart }, chartMeta), { defaults: __assign(__assign({}, chartDefaults), { axes: [{
            ...
            _b[logAxis_1.LogAxis.type] = __assign({ meta: __assign(__assign({ constructor: logAxis_1.LogAxis, setAsIs: ['gridStyle', 'visibleRange'] }, axisDefaults), { base: 10 }) }, axisMappings),
            ...
            _c[barSeries_1.BarSeries.type] = __assign(__assign(__assign(__assign({ meta: {
                    constructor: barSeries_1.BarSeries,
                    setAsIs: ['lineDash', 'yNames'],
                    defaults: __assign(__assign({ flipXY: true }, seriesDefaults), columnSeriesDefaults)
                } }, highlightStyleMapping), tooltipMapping), barLabelMapping), shadowMapping),
            _c[lineSeries_1.LineSeries.type] = __assign(__assign(__assign({ meta: {
            ...
            _c[scatterSeries_1.ScatterSeries.type] = __assign(__assign(__assign({ meta: {
            ...
            _c[areaSeries_1.AreaSeries.type] = __assign(__assign(__assign(__assign({ meta: {
            ...
            _c[histogramSeries_1.HistogramSeries.type] = __assign(__assign(__assign(__assign({ meta: {
    ...
    _a[polarChart_1.PolarChart.type] = __assign(__assign({ meta: __assign(__assign({ constructor: polarChart_1.PolarChart }, chartMeta), { defaults: __assign(__assign({}, chartDefaults), { padding: {
            ...
            _d[pieSeries_1.PieSeries.type] = __assign(__assign(__assign(__assign({ meta: {
    ...
    _a[hierarchyChart_1.HierarchyChart.type] = __assign(__assign({ meta: __assign(__assign({ constructor: hierarchyChart_1.HierarchyChart }, chartMeta), { defaults: __assign({}, chartDefaults) }) }, commonChartMappings), { series: (_e = {},
            _e[treemapSeries_1.TreemapSeries.type] = __assign(__assign(__assign({ meta: {
...
// Amend the `mappings` object with aliases for different chart types.
{
    ...
    var _loop_1 = function (type) {
        typeToAliases[type].forEach(function (alias) {
            exports.mappings[alias] = exports.mappings[type];
        });
    };
...
exports.mappings['scatter'] =
    exports.mappings['histogram'] = __assign(__assign({}, exports.mappings.cartesian), { meta: __assign(__assign({}, exports.mappings.cartesian.meta), { defaults: __assign(__assign({}, chartDefaults), { axes: [{
                        type: 'number',
                        position: 'bottom'
                    }, {
                        type: 'number',
...
exports.mappings['bar'] = __assign(__assign({}, exports.mappings.cartesian), { meta: __assign(__assign({}, exports.mappings.cartesian.meta), { defaults: __assign(__assign({}, chartDefaults), { axes: [
                {
                    type: 'number',
                    position: 'bottom'
                },
...
var groupedCategoryChartMapping = Object.create(exports.mappings[cartesianChart_1.CartesianChart.type]);
...
exports.mappings[groupedCategoryChart_1.GroupedCategoryChart.type] = groupedCategoryChartMapping;
