...
var HighlightStyle = /** @class */ (function () {
    ...
    __decorate([
        deprecation_1.Deprecated('Use item.fill instead.')
    ], HighlightStyle.prototype, "fill", void 0);
    __decorate([
        deprecation_1.Deprecated('Use item.stroke instead.')
    ], HighlightStyle.prototype, "stroke", void 0);
    __decorate([
        deprecation_1.Deprecated('Use item.strokeWidth instead.')
...
var Series = /** @class */ (function (_super) {
    ...
    function Series(_a) {
        ...
        _this.backgroundGroup = group.appendChild(new group_1.Group({
        ...
        if (useLabelLayer) {
            _this.labelGroup = group.appendChild(new group_1.Group({
