...
var Series = /** @class */ (function (_super) {
    ...
    Series.prototype.pickNode = function (x, y, limitPickModes) {
        var e_1, _a;
    ...
    Series.prototype.pickNodeExactShape = function (x, y) {
        var match = this.pickGroup.pickNode(x, y);
        if (match) {
            return {
                datum: match.datum,
                distance: 0,
    ...
    Series.prototype.pickNodeClosestDatum = function (_x, _y) {
        // Override point for sub-classes - but if this is invoked, the sub-class specified it wants
        // to use this feature.
        throw new Error('AG Charts - Series.pickNodeClosestDatum() not implemented');
    };
    Series.prototype.pickNodeMainAxisFirst = function (_x, _y, _requireCategoryAxis) {
        // Override point for sub-classes - but if this is invoked, the sub-class specified it wants
        // to use this feature.
