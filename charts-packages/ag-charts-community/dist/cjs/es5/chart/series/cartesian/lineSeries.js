...
var LineSeries = /** @class */ (function (_super) {
    ...
    LineSeries.prototype.processData = function () {
        ...
        try {
            for (var data_1 = __values(data), data_1_1 = data_1.next(); !data_1_1.done; data_1_1 = data_1.next()) {
                ...
                var x = datum[xKey];
                var y = datum[yKey];
                var xDatum = value_1.checkDatum(x, isContinuousX);
                ...
                var yDatum = value_1.checkDatum(y, isContinuousY);
                yData.push(yDatum);
            }
        }
    ...
    LineSeries.prototype.createNodeData = function () {
        ...
        for (var i = 0; i < xData.length; i++) {
            ...
            if (xyDatums[1] === undefined) {
                ...
                var _e = __read(xyDatums, 2), xDatum = _e[0], yDatum = _e[1];
    ...
    LineSeries.prototype.updateLabelSelection = function (opts) {
        ...
        var enterTextSelection = updateTextSelection.enter.append(text_1.Text);
