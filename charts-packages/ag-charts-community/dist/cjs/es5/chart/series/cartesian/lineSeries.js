...
var LineSeries = /** @class */ (function (_super) {
    ...
    LineSeries.prototype.processData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, xAxis, yAxis, xKey, yKey, xData, yData, data, isContinuousX, isContinuousY, data_1, data_1_1, datum, x, y, xDatum, yDatum;
            var e_1, _b;
            return __generator(this, function (_c) {
                _a = this, xAxis = _a.xAxis, yAxis = _a.yAxis, xKey = _a.xKey, yKey = _a.yKey, xData = _a.xData, yData = _a.yData;
    ...
    LineSeries.prototype.createNodeData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, xAxis, yAxis, _b, markerEnabled, markerSize, strokeWidth, _c, xData, yData, label, xKey, yKey, xScale, yScale, xOffset, yOffset, nodeData, size, moveTo, prevXInRange, nextXYDatums, actualLength, i, xyDatums, _d, xDatum, yDatum, x, tolerance, xInRange, nextXInRange, y, labelText, seriesDatum;
            var _e;
            return __generator(this, function (_f) {
                _a = this, data = _a.data, xAxis = _a.xAxis, yAxis = _a.yAxis, _b = _a.marker, markerEnabled = _b.enabled, markerSize = _b.size, strokeWidth = _b.strokeWidth;
                if (!data || !xAxis || !yAxis) {
                    return [2 /*return*/, []];
                }
                _c = this, xData = _c.xData, yData = _c.yData, label = _c.label, xKey = _c.xKey, yKey = _c.yKey;
                xScale = xAxis.scale;
                yScale = yAxis.scale;
                ...
                nextXYDatums = undefined;
                actualLength = 0;
                for (i = 0; i < xData.length; i++) {
                    xyDatums = nextXYDatums || [xData[i], yData[i]];
                    if (xyDatums[1] === undefined) {
                        prevXInRange = undefined;
                        moveTo = true;
                    }
                    else {
                        _d = __read(xyDatums, 2), xDatum = _d[0], yDatum = _d[1];
                        ...
                        nextXInRange = nextXYDatums && xAxis.inRangeEx(xScale.convert(nextXYDatums[0]) + xOffset, 0, tolerance);
                        ...
                        seriesDatum = (_e = {}, _e[xKey] = xDatum, _e[yKey] = yDatum, _e);
    ...
    LineSeries.prototype.updateMarkerNodes = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var markerSelection, isDatumHighlighted, _a, marker, markerFillOpacity, xKey, yKey, lineStroke, strokeOpacity, _b, deprecatedFill, deprecatedStroke, deprecatedStrokeWidth, _c, _d, highlightedFill, _e, highlightFillOpacity, _f, highlightedStroke, _g, highlightedDatumStrokeWidth, size, formatter, markerStrokeWidth;
