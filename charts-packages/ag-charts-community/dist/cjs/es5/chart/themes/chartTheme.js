...
var ChartTheme = /** @class */ (function () {
            ...
            if (overrides_1) {
                if (object_1.isObject(overrides_1.common)) {
                    ChartTheme.seriesTypes.concat(['cartesian', 'polar', 'hierarchy']).forEach(function (seriesType) {
                        defaults[seriesType] = object_1.deepMerge(defaults[seriesType], overrides_1.common, exports.mergeOptions);
                    });
                }
                if (overrides_1.cartesian) {
                    defaults.cartesian = object_1.deepMerge(defaults.cartesian, overrides_1.cartesian, exports.mergeOptions);
                    ChartTheme.cartesianSeriesTypes.forEach(function (seriesType) {
                        defaults[seriesType] = object_1.deepMerge(defaults[seriesType], overrides_1.cartesian, exports.mergeOptions);
                    });
                }
                if (overrides_1.polar) {
                    defaults.polar = object_1.deepMerge(defaults.polar, overrides_1.polar, exports.mergeOptions);
                    ChartTheme.polarSeriesTypes.forEach(function (seriesType) {
                        defaults[seriesType] = object_1.deepMerge(defaults[seriesType], overrides_1.polar, exports.mergeOptions);
                    });
                }
                if (overrides_1.hierarchy) {
                    defaults.hierarchy = object_1.deepMerge(defaults.hierarchy, overrides_1.hierarchy, exports.mergeOptions);
                    ChartTheme.hierarchySeriesTypes.forEach(function (seriesType) {
                        defaults[seriesType] = object_1.deepMerge(defaults[seriesType], overrides_1.hierarchy, exports.mergeOptions);
                    });
                }
    ...
    ChartTheme.prototype.mergeWithParentDefaults = function (defaults) {
        ...
        if (proto === Object.prototype) {
            var config = object_1.deepMerge({}, ChartTheme.defaults, exports.mergeOptions);
    ...
    ChartTheme.cartesianDefaults = __assign(__assign({}, ChartTheme.getChartDefaults()), { axes: {
            ...
            area: __assign(__assign({}, ChartTheme.getSeriesDefaults()), { title: undefined, xKey: '', xName: '', yKeys: [], yNames: [], normalizedTo: undefined, fillOpacity: 0.8, strokeOpacity: 1, strokeWidth: 2, lineDash: [0], lineDashOffset: 0, shadow: {
                    enabled: false,
                    color: 'rgba(0, 0, 0, 0.5)',
                    xOffset: 3,
                    yOffset: 3,
            ...
            histogram: __assign(__assign({}, ChartTheme.getSeriesDefaults()), { title: undefined, xKey: '', yKey: '', xName: '', yName: '', strokeWidth: 1, fillOpacity: 1, strokeOpacity: 1, lineDash: [0], lineDashOffset: 0, areaPlot: false, binCount: 10, bins: undefined, aggregation: 'sum', label: {
                    enabled: false,
                    fontStyle: undefined,
                    fontWeight: undefined,
                    fontSize: 12,
