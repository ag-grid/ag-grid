...
var ChartTheme = /** @class */ (function () {
    function ChartTheme(options) {
        options = object_1.deepMerge({}, options || {}, mergeOptions);
        ...
        if (overrides) {
            ...
            var applyOverrides = function (type, seriesTypes, overrideOpts) {
                if (overrideOpts) {
                    defaults[type] = object_1.deepMerge(defaults[type], overrideOpts, mergeOptions);
                    seriesTypes.forEach(function (seriesType) {
                        defaults[seriesType] = object_1.deepMerge(defaults[seriesType], overrideOpts, mergeOptions);
                    });
                }
            };
            ...
            ChartTheme.seriesTypes.forEach(function (seriesType) {
                ...
                if (chartConfig) {
                    ...
                    defaults[seriesType] = object_1.deepMerge(defaults[seriesType], chartConfig, mergeOptions);
                }
            });
        }
    ...
    ChartTheme.prototype.createChartConfigPerChartType = function (config) {
        ...
        Object.entries(typeToAliases).forEach(function (_a) {
            ...
            aliases.forEach(function (alias) {
                if (!config[alias]) {
                    config[alias] = object_1.deepMerge({}, config[type], mergeOptions);
                }
            });
        });
        return config;
    ...
    ChartTheme.prototype.getConfig = function (path, defaultValue) {
        ...
        if (Array.isArray(value)) {
            return object_1.deepMerge([], value, mergeOptions);
        }
    ...
    ChartTheme.prototype.getDefaults = function () {
        return object_1.deepMerge({}, ChartTheme.defaults, mergeOptions);
    };
