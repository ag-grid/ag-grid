...
var CrossLine = /** @class */ (function () {
    ...
    CrossLine.prototype.createNodeData = function () {
        ...
        var clippedRangeClamper = continuousScale_1.clamper(clippedRange);
        ...
        if (this.label.enabled) {
            ...
            var _m = (_h = crossLineLabelPosition_1.labeldDirectionHandling[position], (_h !== null && _h !== void 0 ? _h : {})).c, c = _m === void 0 ? crossLineLabelPosition_1.POSITION_TOP_COORDINATES : _m;
