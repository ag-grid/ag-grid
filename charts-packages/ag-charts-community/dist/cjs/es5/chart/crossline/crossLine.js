...
var CrossLine = /** @class */ (function () {
    ...
    CrossLine.prototype.createNodeData = function () {
        ...
        var _g, _h;
        var _j = this, scale = _j.scale, gridLength = _j.gridLength, sideFlag = _j.sideFlag, direction = _j.direction, _k = _j.label.position, position = _k === void 0 ? 'top' : _k;
        if (!scale) {
            return false;
        }
        ...
        if (this.label.enabled) {
            ...
            var _l = (_h = crossLineLabelPosition_1.labeldDirectionHandling[position], (_h !== null && _h !== void 0 ? _h : {})).c, c = _l === void 0 ? crossLineLabelPosition_1.POSITION_TOP_COORDINATES : _l;
            var _m = c({ yDirection: yDirection, xStart: xStart, xEnd: xEnd, yStart: clampedYStart, yEnd: clampedYEnd }), labelX = _m.x, labelY = _m.y;
            this.labelPoint = {
                x: labelX,
                y: labelY,
            };
