...
exports.SceneFontChangeDetection = SceneFontChangeDetection;
var Text = /** @class */ (function (_super) {
    ...
    Text.prototype.getPreciseBBox = function () {
        var metrics = hdpiCanvas_1.HdpiCanvas.measureText(this.text, this.font, this.textBaseline, this.textAlign);
    ...
    Text.prototype.getApproximateBBox = function () {
        var size = hdpiCanvas_1.HdpiCanvas.getTextSize(this.text, this.font);
