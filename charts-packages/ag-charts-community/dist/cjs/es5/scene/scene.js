...
var Scene = /** @class */ (function () {
    ...
    Scene.prototype.render = function (opts) {
        ...
        if (root && canvasCleared) {
            if (this.debug.consoleLog) {
                console.log('before', { redrawType: node_1.RedrawType[root.dirty], canvasCleared: canvasCleared, tree: this.buildTree(root) });
            }
            if (root.visible) {
                ctx.save();
    ...
    Scene.prototype.buildTree = function (node) {
        ...
        return __assign({ name: name,
            node: node, dirty: node_1.RedrawType[node.dirty] }, node.children.map(function (c) { return _this.buildTree(c); })
    ...
    Scene.prototype.buildDirtyTree = function (node) {
        ...
        return {
            dirtyTree: __assign({ name: name,
                node: node, dirty: node_1.RedrawType[node.dirty] }, childrenDirtyTree.map(function (c) { return c.dirtyTree; })
