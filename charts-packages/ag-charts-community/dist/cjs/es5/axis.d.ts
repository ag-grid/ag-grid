...
declare type TimeTickCount = number | CountableTimeInterval;
declare type NumberTickCount = number;
declare type TickCountType<S> = S extends TimeScale ? TimeTickCount : NumberTickCount;
