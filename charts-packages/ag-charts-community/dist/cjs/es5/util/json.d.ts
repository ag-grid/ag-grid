 ...
 */
export declare function jsonDiff<T extends any>(source: T, target: T, opts?: {
    stringify: string[];
}): Partial<T> | null;
/**
 ...
 */
export declare function classify(value: any): 'array' | 'object' | 'function' | 'primitive' | 'class-instance' | null;
export {};
