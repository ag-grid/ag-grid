 ...
 * @param s
 */
export declare const requote: (s: string) => string;
/**
 * Returns a RegExp that matches any string that starts with any of the given names (case insensitive).
 * @param names
 */
export declare const formatRe: (names: string[]) => RegExp;
export declare function pad(value: number, fill: string, width: number): string;
/**
