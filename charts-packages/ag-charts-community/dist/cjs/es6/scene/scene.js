...
class Scene {
    ...
    sortLayers() {
        this.layers.sort((a, b) => {
            var _a, _b;
            return compare_1.compoundAscending([a.zIndex, ...(_a = a.zIndexSubOrder, (_a !== null && _a !== void 0 ? _a : [undefined, undefined])), a.id], [b.zIndex, ...(_b = b.zIndexSubOrder, (_b !== null && _b !== void 0 ? _b : [undefined, undefined])), b.id], compare_1.ascendingStringNumberUndefined);
        });
    }
    markDirty() {
        this._dirty = true;
