...
exports.arcIntersections = exports.cubicSegmentIntersections = exports.segmentIntersection = void 0;
...
function arcIntersections(cx, cy, r, startAngle, endAngle, counterClockwise, x1, y1, x2, y2) {
    ...
    [i1x, i2x].forEach((x) => {
        ...
        const y = k * x;
        const a1 = angle_1.normalizeAngle360(counterClockwise ? endAngle : startAngle);
        let a2 = angle_1.normalizeAngle360(counterClockwise ? startAngle : endAngle);
        let intersectionAngle = angle_1.normalizeAngle360(Math.atan2(y, x));
...
exports.arcIntersections = arcIntersections;
