...
class AgChartInternal {
    static createOrUpdate(userOptions, proxy) {
        ...
        let processedOptions = prepare_1.prepareOptions(userOptions, mixinOpts);
...
function applyChartOptions(chart, processedOptions, userOptions) {
    ...
    const updateType = forceNodeDataRefresh ? chart_1.ChartUpdateType.PROCESS_DATA : chart_1.ChartUpdateType.PERFORM_LAYOUT;
