...
class Legend {
    ...
    performLayout(width, height) {
        ...
        itemSelection.each((markerLabel, datum) => {
            ...
            const text = (_a = datum.label.text) !== null && _a !== void 0 ? _a : '<unknown>';
    ...
    checkLegendClick(event) {
        ...
        legendItemClick === null || legendItemClick === void 0 ? void 0 : legendItemClick({ enabled: newEnabled, itemId, seriesId: series.id });
    }
