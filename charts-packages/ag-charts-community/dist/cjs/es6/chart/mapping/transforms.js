...
function labelMapping(p) {
    ...
    const { placement } = p;
    return Object.assign(Object.assign({}, p), { placement: placement === 'inside' ? barSeries_1.BarLabelPlacement.Inside :
            placement === 'outside' ? barSeries_1.BarLabelPlacement.Outside :
                undefined });
}
