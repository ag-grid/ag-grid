    ...
    mergedOptions.series = prepareSeries_1.processSeriesOptions((mergedOptions.series || []).map((s) => {
        const type = s.type
            ...
            : isSeriesOptionType(userSuppliedOptionsType)
                ...
                : defaultSeriesType;
        const mergedSeries = json_1.jsonMerge(seriesThemes[type] || {}, Object.assign(Object.assign({}, s), { type }));
        if (type === 'pie') {
...
function prepareMainOptions(defaultOverrides, options) {
    ...
    const mergedOptions = json_1.jsonMerge(defaultOverrides, cleanedTheme, options);
