...
class Chart extends observable_1.Observable {
    constructor(document = window.document) {
        ...
        this.lastTooltipEvent = undefined;
    ...
    pickSeriesNode(x, y) {
        ...
        this.extraDebugStats['pickSeriesNode'] = Math.round((_a = this.extraDebugStats['pickSeriesNode'], (_a !== null && _a !== void 0 ? _a : 0)) +
    ...
    pickClosestSeriesNodeDatum(x, y) {
        ...
        for (const series of allSeries) {
            ...
            const contexts = (_a = nodeDataMap.get(series), (_a !== null && _a !== void 0 ? _a : []));
            for (const context of contexts) {
                for (const datum of context.nodeData) {
                    ...
                    const { x, y } = point;
                    const isInRange = ((_b = xAxis) === null || _b === void 0 ? void 0 : _b.inRange(x)) && ((_c = yAxis) === null || _c === void 0 ? void 0 : _c.inRange(y));
                    if (!isInRange) {
                        continue;
                    }
                    // No need to use Math.sqrt() since x < y implies Math.sqrt(x) < Math.sqrt(y) for
                    // values > 1 
                    const distance = Math.pow((hitPoint.x - x), 2) + Math.pow((hitPoint.y - y), 2);
