...
declare class LegendListeners implements Required<AgChartLegendListeners> {
...
export declare class Legend {
    ...
    }, interactionManager: InteractionManager, cursorManager: CursorManager, highlightManager: HighlightManager);
    onMarkerShapeChange(): void;
    /**
