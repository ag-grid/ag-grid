...
class HistogramSeries extends cartesianSeries_1.CartesianSeries {
    ...
    deriveBins() {
        ...
        const xDomain = this.fixNumericExtent(array_1.extent(xData, value_1.isContinuous));
        const binStarts = ticks_1.default(xDomain[0], xDomain[1], this.binCount || defaultBinCount);
        const binSize = ticks_1.tickStep(xDomain[0], xDomain[1], this.binCount || defaultBinCount);
    ...
    processData() {
        ...
        const yMinMax = array_1.extent(yData, value_1.isContinuous);
    ...
    updateDatumNodes(opts) {
        ...
        const { fillOpacity, strokeOpacity, shadow, highlightStyle: { fill: deprecatedFill, stroke: deprecatedStroke, strokeWidth: deprecatedStrokeWidth, item: { fill: highlightedFill = deprecatedFill, stroke: highlightedStroke = deprecatedStroke, strokeWidth: highlightedDatumStrokeWidth = deprecatedStrokeWidth, }, }, } = this;
    ...
    updateLabelSelection(opts) {
        ...
        const enterTexts = updateTexts.enter.append(text_1.Text).each((text) => {
