...
class HistogramSeries extends cartesianSeries_1.CartesianSeries {
    constructor() {
        ...
        this.textGroup = this.group.appendChild(new group_1.Group());
        this.rectSelection = selection_1.Selection.select(this.rectGroup).selectAll();
        this.textSelection = selection_1.Selection.select(this.textGroup).selectAll();
        this.binnedData = [];
        this.xDomain = [];
        this.yDomain = [];
    ...
    deriveBins() {
        ...
        const xDomain = this.fixNumericExtent(array_1.extent(xData, value_1.isContinuous), 'x');
