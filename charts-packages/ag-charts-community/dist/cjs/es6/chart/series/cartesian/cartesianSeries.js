...
exports.CartesianSeriesMarker = exports.CartesianSeries = exports.CartesianSeriesNodeClickEvent = void 0;
...
class CartesianSeriesNodeClickEvent extends series_1.SeriesNodeClickEvent {
...
class CartesianSeries extends series_1.Series {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (totalGroups > subGroups.length) {
                ...
                subGroups.push({
                    ...
                    datumSelection: selection_1.Selection.select(dataNodeGroup).selectAll(),
    ...
    validateXYData(xKey, yKey, data, xAxis, yAxis, xData, yData, yDepth = 1) {
        ...
        if (isContinuousX && !hasNumber(xData)) {
            function_1.doOnce(() => console.warn(`AG Charts - The number axis has no numeric data supplied for xKey: [${xKey}].`), 'series has no numeric data on number axis - ' + xKey);
            validationResult = false;
        }
        if (isContinuousY && !hasNumber(yData, 0, yDepth - 1)) {
            function_1.doOnce(() => console.warn(`AG Charts - The number axis has no numeric data supplied for yKey: [${yKey}].`), 'series has no numeric data on number axis - ' + yKey);
            validationResult = false;
        }
