...
class PieSeries extends polarSeries_1.PolarSeries {
    constructor() {
        ...
        this.calloutLabelSelection = selection_1.Selection.select(pieCalloutLabels).selectAll();
    ...
    updateGroupSelection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const enterCalloutLabels = updateCalloutLabels.enter.append(group_1.Group);
            enterCalloutLabels.append(line_1.Line).each((node) => {
                node.tag = PieNodeTag.Callout;
                node.pointerEvents = node_1.PointerEvents.None;
            });
            enterCalloutLabels.append(text_1.Text).each((node) => {
