...
exports.POSITION_TOP_LEFT_COORDINATES = ({ yDirection, xStart, xEnd, yStart, yEnd }) => {
    if (yDirection) {
...
exports.POSITION_BOTTOM_LEFT_COORDINATES = ({ xStart, yStart }) => {
    return { x: xStart, y: yStart };
};
exports.POSITION_TOP_RIGHT_COORDINATES = ({ xEnd, yStart, yEnd }) => {
