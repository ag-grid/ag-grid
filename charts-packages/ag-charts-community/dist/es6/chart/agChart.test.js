...
describe('update', function () {
    ...
    test('axes', function () {
        ...
        var leftAxis = axes.find(function (axis) { return axis.position === ChartAxisPosition.Left; });
        expect(axes.find(function (axis) { return axis.position === ChartAxisPosition.Bottom; })).toBeDefined();
