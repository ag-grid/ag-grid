...
describe('interpolate', function () {
    it('should substitute #{key} with values from the given object', function () {
        var name = 'first name';
        var result = interpolate("My " + name + " is #{name} and I live in #{place}", {
            name: 'Vitaly',
            place: 'London'
        });
    ...
    it('should format numbers (using Intl.NumberFormat) and dates', function () {
        ...
        var result1 = interpolate('I drank #{amount1:liters} of beer and #{amount2:liters} of vodka on #{day:date}', {
            amount1: amount1,
            amount2: amount2,
            day: date
        }, {
