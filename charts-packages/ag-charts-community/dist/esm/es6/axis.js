    ...
    update(primaryTickCount) {
        ...
        while (labelOverlap) {
            ...
            while (unchanged) {
                ...
                const filteredTicks = !avoidCollisions || (continuous && this.tick.count === undefined) || i === 0
                    ? undefined
                ...
                if (filteredTicks) {
                    ...
                    scale.tickCount = (_a = this.tick.count) !== null && _a !== void 0 ? _a : defaultTickCount - i;
                    ticks = scale.ticks();
                }
