...
export function jsonApply(target, source, params = {}) {
    var _a;
    const { path = undefined, matcherPath = path ? path.replace(/(\[[0-9+]+\])/i, '[]') : undefined, skip = [], constructors = {}, allowedTypes = {}, } = params;
    if (target == null) {
...
export function jsonWalk(json, visit, opts, ...jsons) {
    ...
    if (jsonType === 'array') {
        json.forEach((element, index) => {
            jsonWalk(element, visit, opts, ...jsons === null || jsons === void 0 ? void 0 : jsons.map((o) => o === null || o === void 0 ? void 0 : o[index]));
        });
        return;
    }
