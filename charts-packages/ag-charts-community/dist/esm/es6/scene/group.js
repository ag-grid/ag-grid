...
export class Group extends Node {
    constructor(opts) {
        ...
        if (((_a = this.opts) === null || _a === void 0 ? void 0 : _a.zIndex) !== undefined) {
            this.zIndex = this.opts.zIndex;
        }
        if ((_b = this.opts) === null || _b === void 0 ? void 0 : _b.optimiseDirtyTracking) {
            this.visibleChildren = {};
            this.dirtyChildren = {};
        }
        this.name = (_c = this.opts) === null || _c === void 0 ? void 0 : _c.name;
    }
    opacityChanged() {
        if (this.layer) {
    ...
    basicRender(renderCtx) {
        ...
        const renderContextChanged = forceRender !== renderCtx.forceRender ||
            ...
            ctx !== renderCtx.ctx;
        const childRenderContext = renderContextChanged ? Object.assign(Object.assign({}, renderCtx), { ctx, forceRender, clipBBox }) :
            renderCtx;
