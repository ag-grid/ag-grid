...
import { BOOLEAN, Deprecated, OPT_BOOLEAN, OPT_NUMBER, OPT_COLOR_STRING, STRING, Validate, } from '../../util/validation';
...
export class Series extends Observable {
    constructor({ useSeriesGroupLayer = true, useLabelLayer = false, pickModes = [SeriesNodePickMode.NEAREST_BY_MAIN_AXIS_FIRST], } = {}) {
        ...
        const { group } = this;
        this.backgroundGroup = group.appendChild(new Group({
        ...
        if (useLabelLayer) {
            this.labelGroup = group.appendChild(new Group({
