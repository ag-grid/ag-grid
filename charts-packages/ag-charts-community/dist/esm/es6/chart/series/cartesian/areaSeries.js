...
export class AreaSeries extends CartesianSeries {
    constructor() {
        ...
        this.areaGroup = this.group.insertBefore(new Group, this.pickGroup);
        this.strokeGroup = this.group.insertBefore(new Group, this.pickGroup);
        this.markerGroup = this.pickGroup.appendChild(new Group);
        this.labelGroup = this.group.appendChild(new Group);
        this.fillSelection = Selection.select(this.areaGroup).selectAll();
        this.strokeSelection = Selection.select(this.strokeGroup).selectAll();
        this.markerSelection = Selection.select(this.markerGroup).selectAll();
