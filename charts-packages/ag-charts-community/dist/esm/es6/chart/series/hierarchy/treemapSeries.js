...
class TreemapSeriesNodeClickEvent extends SeriesNodeClickEvent {
...
function validateColor(color) {
    if (typeof color === 'string' && !Color.validColorString(color)) {
        ...
        doOnce(() => console.warn(`AG Charts - Invalid Treemap tile colour string "${color}". Affected treemap tiles will be coloured ${fallbackColor}.`), 'treemap node color invalid');
        return 'black';
    }
    return color;
}
