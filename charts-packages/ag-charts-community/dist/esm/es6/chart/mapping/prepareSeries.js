...
const ARRAY_REDUCER = (prop) => (result, next) => {
    var _a;
    return result.concat(...(_a = next[prop], (_a !== null && _a !== void 0 ? _a : [])));
};
const BOOLEAN_OR_REDUCER = (prop, activationValue) => (result, next) => {
    var _a;
    if (next[prop] === activationValue) {
        return result || (_a = next[prop], (_a !== null && _a !== void 0 ? _a : false));
    }
    return result;
};
const DEFAULTING_ARRAY_REDUCER = (prop, defaultValue) => (result, next, idx, length) => {
    ...
    const nextValue = (_a = next[prop], (_a !== null && _a !== void 0 ? _a : defaultValue));
    if (nextValue === FAIL) {
...
export function reduceSeries(series) {
    ...
    series.forEach((s, idx) => {
        Object.keys(s).forEach((prop) => {
            ...
            options[outputProp] = reducer((_a = options[outputProp], (_a !== null && _a !== void 0 ? _a : start)), s, idx, series.length);
        });
    });
    return options;
}
