...
export const DEFAULT_CARTESIAN_CHART_OPTIONS = {
    type: 'cartesian',
    autoSize: true,
...
export const DEFAULT_POLAR_CHART_OPTIONS = {
    type: 'polar',
    autoSize: true,
    background: DEFAULT_BACKGROUND,
    height: 300,
...
export const DEFAULT_HIERARCHY_CHART_OPTIONS = {
    type: 'hierarchy',
    autoSize: true,
    background: DEFAULT_BACKGROUND,
    height: 300,
...
export const DEFAULT_AXES_OPTIONS = {
