...
export class GroupedCategoryAxis extends ChartAxis {
    constructor() {
        ...
        this.gridLineSelection = Selection.select(gridlineGroup).selectAll();
        this.axisLineSelection = Selection.select(axisGroup).selectAll();
        this.separatorSelection = Selection.select(axisGroup).selectAll();
        this.labelSelection = Selection.select(axisGroup).selectAll();
    }
