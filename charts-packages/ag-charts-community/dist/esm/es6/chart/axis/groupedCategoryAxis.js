...
export class GroupedCategoryAxis extends ChartAxis {
    constructor() {
        ...
        this.gridLineSelection = Selection.select(group).selectAll();
        this.axisLineSelection = Selection.select(group).selectAll();
        this.separatorSelection = Selection.select(group).selectAll();
        this.labelSelection = Selection.select(group).selectAll();
