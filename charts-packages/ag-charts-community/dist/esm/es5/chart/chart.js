...
var Chart = /** @class */ (function (_super) {
    ...
    function Chart(document, overrideDevicePixelRatio) {
        ...
        _this.updateContext = { firstRenderComplete: false, firstResizeReceived: false };
    ...
    Object.defineProperty(Chart.prototype, "pendingFactoryUpdates", {
        get: function () {
    ...
    Chart.prototype.requestFactoryUpdate = function (cb) {
        ...
        var processCallbacks = function () { return __awaiter(_this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this._pendingFactoryUpdates.length > 0)) return [3 /*break*/, 7];
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this._pendingFactoryUpdates[0]()];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    Chart.prototype.performUpdate = function (count) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, performUpdateType, extraDebugStats, _b, firstRenderComplete, firstResizeReceived, splits, _c, seriesUpdates, end;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this, performUpdateType = _a._performUpdateType, extraDebugStats = _a.extraDebugStats, _b = _a.updateContext, firstRenderComplete = _b.firstRenderComplete, firstResizeReceived = _b.firstResizeReceived;
                    ...
                    case 3:
                        if (!firstRenderComplete && !firstResizeReceived) {
                            this.log({ firstRenderComplete: firstRenderComplete, firstResizeReceived: firstResizeReceived });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(this.pendingFactoryUpdates > 0 || this.updatePending)) return [3 /*break*/, 3];
