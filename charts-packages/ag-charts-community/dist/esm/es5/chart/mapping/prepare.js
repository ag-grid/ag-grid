...
export function prepareOptions(newOptions) {
    ...
    var _a;
    var options = fallbackOptions == null ? newOptions : jsonMerge.apply(void 0, __spread(fallbackOptions, [newOptions]));
    ...
    mergedOptions.series = processSeriesOptions((mergedOptions.series || []).map(function (s) {
        var type = s.type
            ...
            : isSeriesOptionType(userSuppliedOptionsType)
                ...
                : defaultSeriesType;
        var mergedSeries = jsonMerge(seriesThemes[type] || {}, __assign(__assign({}, s), { type: type }));
        if (type === 'pie') {
