...
var Chart = /** @class */ (function (_super) {
    ...
    function Chart(document, overrideDevicePixelRatio, resources) {
        ...
        _this.background = new background_1.Background();
        _this._debug = false;
        ...
        _this.legend = new legend_1.Legend(_this, _this.interactionManager, _this.cursorManager, _this.highlightManager);
