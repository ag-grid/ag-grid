...
function applyModules(chart, options) {
    ...
    try {
        for (var REGISTERED_MODULES_1 = __values(module_support_1.REGISTERED_MODULES), REGISTERED_MODULES_1_1 = REGISTERED_MODULES_1.next(); !REGISTERED_MODULES_1_1.done; REGISTERED_MODULES_1_1 = REGISTERED_MODULES_1.next()) {
            var next = REGISTERED_MODULES_1_1.value;
