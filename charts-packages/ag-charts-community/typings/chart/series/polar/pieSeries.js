...
var PieSeries = /** @class */ (function (_super) {
    ...
    function PieSeries() {
        ...
        _this.calloutLabelSelection = selection_1.Selection.select(pieCalloutLabels).selectAll();
    ...
    PieSeries.prototype.updateGroupSelection = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                enterCalloutLabels = updateCalloutLabels.enter.append(group_1.Group);
                enterCalloutLabels.append(line_1.Line).each(function (node) {
                    node.tag = PieNodeTag.Callout;
                    node.pointerEvents = node_1.PointerEvents.None;
                });
                enterCalloutLabels.append(text_1.Text).each(function (node) {
