...
export const POSITION_INSIDE_TOP_LEFT_COORDINATES: CoordinatesFn = ({ yDirection, xStart, xEnd, yStart, yEnd }) => {
    if (yDirection) {
...
export const POSITION_INSIDE_BOTTOM_LEFT_COORDINATES: CoordinatesFn = ({ xStart, yStart }) => {
    return { x: xStart, y: yStart }
}

export const POSITION_INSIDE_TOP_RIGHT_COORDINATES: CoordinatesFn = ({ xEnd, yStart, yEnd }) => {
    return { x: xEnd, y: !isNaN(yEnd) ? yEnd : yStart }
}

export const POSITION_INSIDE_BOTTOM_RIGHT_COORDINATES: CoordinatesFn = ({ yDirection, xStart, xEnd, yStart, yEnd }) => {
    if (yDirection) {
        return { x: xEnd, y: yStart }
    } else {
...
export const labeldDirectionHandling: Record<CrossLineLabelPosition, PositionCalcFns> = {
    ...
    insideTopLeft: { c: POSITION_INSIDE_TOP_LEFT_COORDINATES },
    insideBottomLeft: { c: POSITION_INSIDE_BOTTOM_LEFT_COORDINATES },
    insideTopRight: { c: POSITION_INSIDE_TOP_RIGHT_COORDINATES },
    insideBottomRight: { c: POSITION_INSIDE_BOTTOM_RIGHT_COORDINATES },
}