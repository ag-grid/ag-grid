...
var FiltersToolPanelListPanel = /** @class */ (function (_super) {
    ...
    FiltersToolPanelListPanel.prototype.init = function (params) {
        ...
        this.addManagedListener(this.eventService, core_1.Events.EVENT_DRAG_STARTED, function () {
            _this.suppressOnColumnsChanged = true;
        });
        this.addManagedListener(this.eventService, core_1.Events.EVENT_DRAG_STOPPED, function () {
            _this.suppressOnColumnsChanged = false;
    ...
    FiltersToolPanelListPanel.prototype.recursivelyAddComps = function (tree, depth, expansionState) {
        ...
        return core_1._.flatten(tree.map(function (child) {
            ...
            var filterComp = new toolPanelFilterComp_1.ToolPanelFilterComp(hideFilterCompHeader, function () { return _this.onFilterExpanded(); });
    ...
    FiltersToolPanelListPanel.prototype.refreshAriaLabel = function () {
        ...
        core_1._.setAriaLabel(this.getAriaElement(), "".concat(filterListName, " ").concat(totalVisibleItems, " ").concat(localeFilters));
    };
