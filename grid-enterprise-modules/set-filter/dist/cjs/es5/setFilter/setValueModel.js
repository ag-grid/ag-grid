...
var SetValueModel = /** @class */ (function () {
    ...
    SetValueModel.prototype.updateOnParamsChange = function (filterParams) {
        ...
        return new core_1.AgPromise(function (resolve) {
            ...
            _this.formatter = textFormatter || core_1.TextFilter.DEFAULT_FORMATTER;
        ...
        this.allValuesPromise = new core_1.AgPromise(function (resolve) {
            switch (_this.valuesType) {
                ...
                case SetFilterModelValuesType.PROVIDED_CALLBACK: {
                    ...
                    var _a = _this.filterParams, columnApi = _a.columnApi, api = _a.api, column = _a.column, colDef = _a.colDef;
                    var context = _this.gridOptionsService.context;
                    var params_1 = {
