/**
          * @ag-grid-enterprise/set-filter - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v29.2.0
...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.resetUiToActiveModel = function (currentModel) {
        var _this = this;
        // override the default behaviour as we don't want to clear the mini filter
        this.setModelAndRefresh(currentModel == null ? null : currentModel.values).then(function () { return _this.onUiChanged(false, 'prevent'); });
    };
