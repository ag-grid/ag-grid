...
class AreaSparkline extends sparkline_1.Sparkline {
    constructor() {
        ...
        this.strokePath = new ag_charts_community_1._Scene.Path();
        this.fillPath = new ag_charts_community_1._Scene.Path();
        this.xCrosshairLine = new ag_charts_community_1._Scene.Line();
        this.yCrosshairLine = new ag_charts_community_1._Scene.Line();
        this.areaSparklineGroup = new ag_charts_community_1._Scene.Group();
        this.xAxisLine = new ag_charts_community_1._Scene.Line();
