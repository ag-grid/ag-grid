...
class ToolPanelContextMenu extends core_1.Component {
    ...
    displayContextMenu() {
        ...
        menuList.addManagedListener(menuList, core_1.AgMenuItemComponent.EVENT_MENU_ITEM_SELECTED, () => {
            this.parentEl.focus();
            hideFunc();
        });
        ...
        for (const val of this.menuItemMap.values()) {
            ...
            if (isInactive) {
                ret.push({
                    ...
                    icon: core_1._.createIconNoSpan(val.addIcon, this.gridOptionsService, null),
            ...
            if (isActive) {
                ret.push({
                    ...
                    icon: core_1._.createIconNoSpan(val.removeIcon, this.gridOptionsService, null),
