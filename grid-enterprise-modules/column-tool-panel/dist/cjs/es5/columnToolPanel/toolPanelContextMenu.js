...
var ToolPanelContextMenu = /** @class */ (function (_super) {
    ...
    ToolPanelContextMenu.prototype.displayContextMenu = function (menuItemsMapped) {
        ...
        menuList.addManagedListener(menuList, core_1.AgMenuItemComponent.EVENT_CLOSE_MENU, function () {
        ...
        var _loop_1 = function (val) {
            ...
            if (isInactive) {
                ret.push({
                    ...
                    icon: core_1._.createIconNoSpan(val.addIcon, this_1.gridOptionsService, null),
            ...
            if (isActive) {
                ret.push({
                    ...
                    icon: core_1._.createIconNoSpan(val.removeIcon, this_1.gridOptionsService, null),
