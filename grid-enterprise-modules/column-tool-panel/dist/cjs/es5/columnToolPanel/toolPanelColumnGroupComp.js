...
var ToolPanelColumnGroupComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnGroupComp.prototype.init = function () {
        ...
        this.addManagedListener(this.cbSelect, core_1.Events.EVENT_FIELD_VALUE_CHANGED, this.onCheckboxChanged.bind(this));
        ...
        this.setupTooltip();
        var classes = core_1.CssClassApplier.getToolPanelClassesFromColDef(this.columnGroup.getColGroupDef(), this.gridOptionsService, null, this.columnGroup);
