...
var LazyBlockLoader = /** @class */ (function (_super) {
    __extends$c(LazyBlockLoader, _super);
    ...
    LazyBlockLoader.prototype.getBlocksToLoad = function () {
        ...
        this.cache.getNodeMapEntries().forEach(function (_a) {
            var _b = __read$5(_a, 2), stringIndex = _b[0]; _b[1];
        ...
        return __spread$4(indexesToLoad);
    };
    ...
    LazyBlockLoader.prototype.getNextBlockToLoad = function () {
        ...
        toLoad.sort(function (_a, _b) {
            var _c = __read$5(_a, 2), aStart = _c[0], aEnd = _c[1];
            var _d = __read$5(_b, 2), bStart = _d[0], bEnd = _d[1];
    ...
    LazyBlockLoader.prototype.queueLoadAction = function () {
        ...
        if (!this.nextBlockToLoad || (this.nextBlockToLoad[0] !== nextBlockToLoad[0] && this.nextBlockToLoad[1] !== nextBlockToLoad[1])) {
            ...
            window.clearTimeout(this.loaderTimeout);
            var _b = __read$5(this.nextBlockToLoad, 2), startRowString = _b[0], endRow_1 = _b[1];
...
var LazyCache = /** @class */ (function (_super) {
    ...
    LazyCache.prototype.getRowByDisplayIndex = function (displayIndex) {
        ...
        for (var i = 0; i < nodeMapEntries.length; i++) {
            var _b = __read$4(nodeMapEntries[i], 2), stringIndex = _b[0], node = _b[1];
    ...
    LazyCache.prototype.setDisplayIndexes = function (displayIndexSeq, nextRowTop) {
        ...
        nodeEntries.forEach(function (_a) {
            var _b = __read$4(_a, 2), stringIndex = _b[0], node = _b[1];
            var numericIndex = Number(stringIndex);
    ...
    LazyCache.prototype.getDisplayIndexFromStoreIndex = function (storeIndex) {
        ...
        for (var i = 0; i < allNodes.length; i++) {
            var _b = __read$4(allNodes[i], 2), stringNodeStoreIndex = _b[0], node = _b[1];
    ...
    LazyCache.prototype.createRowAtIndex = function (atStoreIndex, data, createNodeCallback) {
        ...
        if (data && usingRowIds) {
            ...
            if (existingNodeDetails) {
                var _a = __read$4(existingNodeDetails, 2), existingStringIndex = _a[0], existingNode = _a[1];
    ...
    LazyCache.prototype.getBlockStates = function () {
        ...
        this.getNodeMapEntries().forEach(function (_a) {
            var _b;
            var _c = __read$4(_a, 2), stringIndex = _c[0], node = _c[1];
    ...
    LazyCache.prototype.getBlocksDistanceFromRow = function (nodes, otherDisplayIndex) {
        ...
        nodes.forEach(function (_a) {
            var _b = __read$4(_a, 2), storeIndexString = _b[0], node = _b[1];
            var _c = __read$4(_this.rowLoader.getBlockBoundsForIndex(Number(storeIndexString)), 2), blockStart = _c[0], blockEnd = _c[1];
    ...
    LazyCache.prototype.insertRowNodes = function (inserts, indexToAdd) {
        ...
        for (var i = allNodes.length - 1; i >= 0; i--) {
            var _a = __read$4(allNodes[i], 2), stringStoreIndex = _a[0], node = _a[1];
...
var ServerSideRowModel = /** @class */ (function (_super) {
    ...
    ServerSideRowModel.prototype.onColumnEverything = function () {
        ...
        var sortModelDifferent = !core._.jsonEquals(this.storeParams.sortModel, this.sortListener.extractSortModel());
...
var GroupSelectsChildrenStrategy = /** @class */ (function (_super) {
    ...
    GroupSelectsChildrenStrategy.prototype.init = function () {
        ...
        this.addManagedListener(this.eventService, core.Events.EVENT_COLUMN_ROW_GROUP_CHANGED, function () { return _this.selectionService.reset(); });
    };
