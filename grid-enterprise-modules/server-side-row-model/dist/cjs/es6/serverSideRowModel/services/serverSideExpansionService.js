...
let ServerSideExpansionService = class ServerSideExpansionService extends core_1.ExpansionService {
    constructor() {
        super(...arguments);
    ...
    postConstruct() {
        super.postConstruct();
        this.addManagedListener(this.eventService, core_1.Events.EVENT_COLUMN_ROW_GROUP_CHANGED, () => {
