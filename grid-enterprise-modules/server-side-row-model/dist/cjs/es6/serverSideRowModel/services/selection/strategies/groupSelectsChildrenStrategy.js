...
class GroupSelectsChildrenStrategy extends core_1.BeanStub {
    constructor() {
        super(...arguments);
    ...
    init() {
        ...
        this.addManagedListener(this.eventService, core_1.Events.EVENT_MODEL_UPDATED, () => this.removeRedundantState());
