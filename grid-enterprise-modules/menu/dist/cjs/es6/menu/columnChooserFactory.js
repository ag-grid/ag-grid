...
let ColumnChooserFactory = class ColumnChooserFactory extends core_1.BeanStub {
    createColumnSelectPanel(parent, column, draggable, params) {
        var _a, _b;
        const columnSelectPanel = parent.createManagedBean(new column_tool_panel_1.PrimaryColsPanel());
