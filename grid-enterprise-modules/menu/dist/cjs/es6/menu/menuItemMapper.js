...
let MenuItemMapper = class MenuItemMapper extends core_1.BeanStub {
    ...
    getStockMenuItem(key, column, sourceElement) {
        ...
        switch (key) {
            ...
            case 'columnFilter':
                if (column) {
                    return {
                        ...
                        icon: core_1._.createIconNoSpan('filter', this.gridOptionsService, null),
            ...
            case 'columnChooser':
                if (core_1.ModuleRegistry.__isRegistered(core_1.ModuleNames.ColumnsToolPanelModule, this.context.getGridId())) {
                    return {
                        name: localeTextFunc('columnChooser', 'Choose Columns'),
                        icon: core_1._.createIconNoSpan('columns', this.gridOptionsService, null),
            ...
            case 'sortAscending':
                return {
                    ...
                    icon: core_1._.createIconNoSpan('sortAscending', this.gridOptionsService, null),
            ...
            case 'sortDescending':
                return {
                    ...
                    icon: core_1._.createIconNoSpan('sortDescending', this.gridOptionsService, null),
                    action: () => this.sortController.setSortForColumn(column, 'desc', false, 'columnMenu')
                };
            case 'sortUnSort':
                return {
                    name: localeTextFunc('sortUnSort', 'Clear Sort'),
                    icon: core_1._.createIconNoSpan('sortUnSort', this.gridOptionsService, null),
