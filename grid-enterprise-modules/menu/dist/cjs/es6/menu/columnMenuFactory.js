...
let ColumnMenuFactory = ColumnMenuFactory_1 = class ColumnMenuFactory extends core_1.BeanStub {
    createMenu(parent, column, sourceElement) {
        const menuList = parent.createManagedBean(new core_1.AgMenuList(0, {
    ...
    getMenuItems(column) {
        ...
        core_1._.removeRepeatsFromArray(result, ColumnMenuFactory_1.MENU_ITEM_SEPARATOR);
        return result;
    }
...
ColumnMenuFactory = ColumnMenuFactory_1 = __decorate([
    (0, core_1.Bean)('columnMenuFactory')
], ColumnMenuFactory);
