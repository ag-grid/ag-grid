/**
          * @ag-grid-enterprise/range-selection - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v31.0.3
...
var RangeService = /** @class */ (function (_super) {
    ...
    RangeService.prototype.updateValuesOnMove = function (eventTarget) {
        var cellCtrl = core._.getCtrlForEventTarget(this.gridOptionsService, eventTarget, core.CellCtrl.DOM_DATA_KEY_CELL_CTRL);
