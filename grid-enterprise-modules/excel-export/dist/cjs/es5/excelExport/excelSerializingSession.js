...
var ExcelSerializingSession = /** @class */ (function (_super) {
    ...
    ExcelSerializingSession.prototype.addCustomContent = function (customContent) {
        ...
        customContent.forEach(function (row) {
            ...
            var rowObj = {
                height: (0, excelUtils_1.getHeightFromProperty)(rowLen, row.height || _this.config.rowHeight),
    ...
    ExcelSerializingSession.prototype.onNewHeaderGroupingRow = function () {
        ...
        this.rows.push({
            cells: currentCells,
            height: (0, excelUtils_1.getHeightFromProperty)(this.rows.length + 1, this.config.headerRowHeight)
        });
        return {
            onColumn: function (columnGroup, header, index, span, collapsibleRanges) {
                var styleIds = _this.config.styleLinker({ rowType: csv_export_1.RowType.HEADER_GROUPING, rowIndex: 1, value: "grouping-".concat(header), columnGroup: columnGroup });
    ...
    ExcelSerializingSession.prototype.getCellValue = function (type, value) {
        ...
        if (type === 's') {
            ...
            value = excelXlsxFactory_1.ExcelXlsxFactory.getStringPosition(value).toString();
        }
        else if (type === 'f') {
            value = value.slice(1);
        }
                ...
                try {
                    for (var _c = (e_2 = void 0, __values(this.excelStyles)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        if (excelStyle.id === styleId) {
                            core_1._.mergeDeep(resultantStyle, this.deepCloneObject(excelStyle));
                        }
                    }
                }
