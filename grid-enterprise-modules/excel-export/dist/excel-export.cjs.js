/**
          * @ag-grid-enterprise/excel-export - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v30.2.1
...
var processHeaderFooterContent = function (content) {
    return content.reduce(function (prev, curr) {
        ...
        return "" + output + core._.escapeString(core._.utf8_encode(replaceHeaderFooterTokens(curr.value)));
    }, '');
};
