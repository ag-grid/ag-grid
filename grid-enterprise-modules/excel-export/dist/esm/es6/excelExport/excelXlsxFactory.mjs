...
import coreFactory from './files/ooxml/core.mjs';
import contentTypesFactory from './files/ooxml/contentTypes.mjs';
import drawingFactory from './files/ooxml/drawing.mjs';
import officeThemeFactory from './files/ooxml/themes/office.mjs';
import sharedStringsFactory from './files/ooxml/sharedStrings.mjs';
import stylesheetFactory, { registerStyles } from './files/ooxml/styles/stylesheet.mjs';
import workbookFactory from './files/ooxml/workbook.mjs';
import worksheetFactory from './files/ooxml/worksheet.mjs';
