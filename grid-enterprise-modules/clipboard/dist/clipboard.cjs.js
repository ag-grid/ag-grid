/**
          * @ag-grid-enterprise/clipboard - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v31.0.0
...
var ClipboardService = /** @class */ (function (_super) {
    ...
    ClipboardService.prototype.cutToClipboard = function (params, source) {
        ...
        var startEvent = {
            type: core.Events.EVENT_CUT_START,
            source: source
        };
        this.eventService.dispatchEvent(startEvent);
        this.copyOrCutToClipboard(params, true);
        var endEvent = {
            type: core.Events.EVENT_CUT_END,
            source: source
        };
