...
var PolarAxisPanel = /** @class */ (function (_super) {
    ...
    PolarAxisPanel.prototype.initRadiusAxis = function () {
        ...
        if (!(0, seriesTypeMapper_1.isRadial)(chartType))
            return;
        var paddingPanelComp = this.createBean(new core_1.AgGroupComponent({
    ...
    PolarAxisPanel.prototype.initSlider = function (config) {
        ...
        var slider = this.createManagedBean(new core_1.AgSlider());
        slider
    ...
    PolarAxisPanel.prototype.initSelect = function (config) {
        ...
        var select = this.createManagedBean(new core_1.AgSelect());
        select
            .setLabel(this.translate(label))
