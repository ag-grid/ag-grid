...
var capsPanel_1 = require("./capsPanel");
var connectorLinePanel_1 = require("./connectorLinePanel");
var whiskersPanel_1 = require("./whiskersPanel");
var seriesItemsPanel_1 = require("./seriesItemsPanel");
var tileSpacingPanel_1 = require("./tileSpacingPanel");
var SeriesPanel = /** @class */ (function (_super) {
    ...
    SeriesPanel.prototype.initLineColor = function () {
        ...
        var seriesLineColorPicker = this.createBean(new agColorPicker_1.AgColorPicker());
    ...
    SeriesPanel.prototype.initLabels = function () {
        var _this = this;
        var isPieChart = (0, seriesTypeMapper_1.isPieChartSeries)(this.seriesType);
        ...
        var labelParams = (0, fontPanelParams_1.initFontPanelParams)({
            labelName: labelName,
        ...
        if (this.seriesType === 'range-bar') {
            ...
            var placementSelect = labelPanelComp.createManagedBean(new core_1.AgSelect());
            placementSelect
            ...
            var paddingSlider = labelPanelComp.createManagedBean(new core_1.AgSlider());
    ...
    SeriesPanel.prototype.initWhiskers = function () {
        var _this = this;
        var whiskersPanelComp = this.createBean(new whiskersPanel_1.WhiskersPanel(this.chartOptionsService, function () { return _this.seriesType; }));
        this.addWidget(whiskersPanelComp);
    };
    SeriesPanel.prototype.initCaps = function () {
        var _this = this;
        var capsPanelComp = this.createBean(new capsPanel_1.CapsPanel(this.chartOptionsService, function () { return _this.seriesType; }));
        this.addWidget(capsPanelComp);
    };
    SeriesPanel.prototype.initConnectorLine = function () {
        var _this = this;
        var connectorLinePanelComp = this.createBean(new connectorLinePanel_1.ConnectorLinePanel(this.chartOptionsService, function () { return _this.seriesType; }));
        this.addWidget(connectorLinePanelComp);
    };
    SeriesPanel.prototype.initSeriesItemsPanel = function () {
        var _this = this;
        var seriesItemsPanelComp = this.createBean(new seriesItemsPanel_1.SeriesItemsPanel(this.chartOptionsService, function () { return _this.seriesType; }));
        this.addWidget(seriesItemsPanelComp);
    };
    SeriesPanel.prototype.initTileSpacingPanel = function () {
        var _this = this;
        var tileSpacingPanelComp = this.createBean(new tileSpacingPanel_1.TileSpacingPanel(this.chartOptionsService, function () { return _this.seriesType; }));
    ...
    SeriesPanel.prototype.getSeriesSelectOptions = function () {
        ...
        this.chartController.getActiveSeriesChartTypes().forEach(function (s) {
            var chartType = (0, seriesTypeMapper_1.getSeriesType)(s.chartType);
    ...
    SeriesPanel.prototype.updateSeriesType = function () {
        var activeChartTypes = this.chartController.getActiveSeriesChartTypes().map(function (s) { return (0, seriesTypeMapper_1.getSeriesType)(s.chartType); });
