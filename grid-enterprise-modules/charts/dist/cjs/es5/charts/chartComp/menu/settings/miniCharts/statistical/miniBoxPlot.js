...
var MiniBoxPlot = /** @class */ (function (_super) {
    ...
    function MiniBoxPlot(container, fills, strokes, themeTemplateParameters, isCustomTheme) {
        ...
        _this.boxPlotGroups = data.map(function (datum, i) {
            ...
            var boxPlotGroup = new ag_charts_community_1._Scene.Group();
            var box = new ag_charts_community_1._Scene.Rect();
            var median = new ag_charts_community_1._Scene.Line();
            var topWhisker = new ag_charts_community_1._Scene.Line();
            var bottomWhisker = new ag_charts_community_1._Scene.Line();
            var topCap = new ag_charts_community_1._Scene.Line();
            var bottomCap = new ag_charts_community_1._Scene.Line();
            box.x = left;
            box.y = top;
            box.width = bandwidth;
    ...
    MiniBoxPlot.prototype.updateColors = function (fills, strokes, themeTemplateParameters, isCustomTheme) {
        var _a;
        var themeBackgroundColor = themeTemplateParameters === null || themeTemplateParameters === void 0 ? void 0 : themeTemplateParameters.properties.get(ag_charts_community_1._Theme.DEFAULT_BACKGROUND_COLOUR);
        ...
        this.boxPlotGroups.forEach(function (group, i) {
            ...
            (_a = group.children) === null || _a === void 0 ? void 0 : _a.forEach(function (node) {
                ...
                node.fill = isCustomTheme ? fill : ag_charts_community_1._Util.Color.interpolate(fill, backgroundFill)(0.7);
