...
var ChartDataPanel = /** @class */ (function (_super) {
    ...
    ChartDataPanel.prototype.createCategoriesGroup = function (columns) {
        ...
        var supportsMultipleCategoryColumns = (0, seriesTypeMapper_1.isHierarchical)(chartType);
        columns.forEach(function (col) {
            var comp = _this.categoriesGroupComp.createManagedBean(supportsMultipleCategoryColumns
                ? (function () {
                    var checkboxComp = new core_1.AgCheckbox();
        ...
        if (supportsMultipleCategoryColumns) {
            ...
            var dropTarget_1 = {
                getIconName: function () { return core_1.DragAndDropService.ICON_MOVE; },
    ...
    ChartDataPanel.prototype.createSeriesChartTypeGroup = function (columns, index) {
        ...
        columns.forEach(function (col) {
            ...
            var seriesItemGroup = _this.seriesChartTypeGroupComp.createManagedBean(new core_1.AgGroupComponent({
            ...
            var chartTypeComp = seriesItemGroup.createManagedBean(new core_1.AgSelect());
            chartTypeComp
                .setLabelAlignment('left')
                .setLabelWidth("flex")
    ...
    ChartDataPanel.prototype.addDragHandle = function (comp, col) {
        var _this = this;
        var eDragHandle = core_1._.createIconNoSpan('columnDrag', this.gridOptionsService);
    ...
    ChartDataPanel.prototype.generateGetSeriesLabel = function () {
        if (!this.chartController.isActiveXYChart()) {
            return function (col) { return core_1._.escapeString(col.displayName); };
        }
        ...
        return function (col) {
            var escapedLabel = core_1._.escapeString(col.displayName);
            if (!col.selected) {
                return escapedLabel;
            }
            var axisLabel;
