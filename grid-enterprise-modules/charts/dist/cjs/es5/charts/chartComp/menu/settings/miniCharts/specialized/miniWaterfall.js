...
var MiniWaterfall = /** @class */ (function (_super) {
    ...
    MiniWaterfall.prototype.updateColors = function (fills, strokes, themeTemplate, isCustomTheme) {
        ...
        var positive = isCustomTheme ? palettePositive : (_a = properties === null || properties === void 0 ? void 0 : properties.get(ag_charts_community_1._Theme.DEFAULT_WATERFALL_SERIES_POSITIVE_COLOURS)) !== null && _a !== void 0 ? _a : palettePositive;
        var negative = isCustomTheme ? paletteNegative : (_b = properties === null || properties === void 0 ? void 0 : properties.get(ag_charts_community_1._Theme.DEFAULT_WATERFALL_SERIES_NEGATIVE_COLOURS)) !== null && _b !== void 0 ? _b : paletteNegative;
    ...
    MiniWaterfall.prototype.createWaterfall = function (root, data, size, padding, direction) {
        ...
        var _a = (0, miniChartHelpers_1.accumulateData)(data.map(function (d) { return [d]; })), processedData = _a.processedData, min = _a.min, max = _a.max;
        ...
        var connectorLine = new ag_charts_community_1._Scene.Path();
