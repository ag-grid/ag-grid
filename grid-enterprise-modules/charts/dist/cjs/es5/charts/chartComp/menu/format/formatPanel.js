...
var cartesianAxisPanel_1 = require("./axis/cartesianAxisPanel");
var polarAxisPanel_1 = require("./axis/polarAxisPanel");
...
var gradientLegendPanel_1 = require("./legend/gradientLegendPanel");
...
var FormatPanel = /** @class */ (function (_super) {
    ...
    FormatPanel.prototype.createPanels = function (reuse) {
        ...
        var seriesType = (0, seriesTypeMapper_1.getSeriesType)(chartType);
        ...
        (_a = this.getFormatPanelDef().groups) === null || _a === void 0 ? void 0 : _a.forEach(function (groupDef) {
            ...
            if (group === 'chart') {
                ...
                var panel = (0, seriesTypeMapper_1.hasGradientLegend)(chartType) ? new gradientLegendPanel_1.GradientLegendPanel(opts) : new legendPanel_1.LegendPanel(opts);
                _this.addComponent(panel);
            }
            else if (group === 'axis') {
                // Polar charts have different axis options from cartesian charts, so choose the appropriate panel
                var panel = (0, seriesTypeMapper_1.isPolar)(chartType) ? new polarAxisPanel_1.PolarAxisPanel(opts) : new cartesianAxisPanel_1.CartesianAxisPanel(opts);
                _this.addComponent(panel);
            }
