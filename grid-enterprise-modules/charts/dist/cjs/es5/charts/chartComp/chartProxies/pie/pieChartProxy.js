...
var PieChartProxy = /** @class */ (function (_super) {
    ...
    PieChartProxy.prototype.extractCrossFilterSeries = function (series) {
        ...
        var filteredOutOptions = function (seriesOptions, angleKey) {
            var _a, _b;
            return __assign(__assign({}, (0, object_1.deepMerge)({}, primaryOpts)), { radiusKey: angleKey + '-filtered-out', fills: (0, color_1.changeOpacity)((_a = seriesOptions.fills) !== null && _a !== void 0 ? _a : palette.fills, 0.3), strokes: (0, color_1.changeOpacity)((_b = seriesOptions.strokes) !== null && _b !== void 0 ? _b : palette.strokes, 0.3), showInLegend: false });
        };
