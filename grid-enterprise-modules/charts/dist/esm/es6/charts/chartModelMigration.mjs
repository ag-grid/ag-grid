...
// @ts-ignore
import { getCanonicalChartType, getSeriesType, isPieChartSeries } from './chartComp/utils/seriesTypeMapper.mjs';
// @ts-ignore
import { ALL_AXIS_TYPES, getLegacyAxisType } from './chartComp/utils/axisTypeMapper.mjs';
// @ts-ignore
