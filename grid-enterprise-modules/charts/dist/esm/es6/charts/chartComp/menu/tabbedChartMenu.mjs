...
import { ChartDataPanel } from "./data/chartDataPanel.mjs";
import { FormatPanel } from "./format/formatPanel.mjs";
import { ChartSettingsPanel } from "./settings/chartSettingsPanel.mjs";
