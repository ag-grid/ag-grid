export const CATEGORY_LABEL_KEY = 'AG-GRID-DEFAULT-LABEL-KEY';
export function createCategoryHierarchy(data, categoryKeys) {
...
export function createAutoGroupHierarchy(data, getItemLabels) {
