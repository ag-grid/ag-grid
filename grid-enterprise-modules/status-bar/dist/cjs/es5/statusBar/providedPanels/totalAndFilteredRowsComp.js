...
var TotalAndFilteredRowsComp = /** @class */ (function (_super) {
    ...
    TotalAndFilteredRowsComp.prototype.onDataChanged = function () {
        ...
        var rowCount = core_1._.formatNumberCommas(this.getFilteredRowCountValue(), thousandSeparator, decimalSeparator);
        var totalRowCount = core_1._.formatNumberCommas(this.getTotalRowCount(), thousandSeparator, decimalSeparator);
