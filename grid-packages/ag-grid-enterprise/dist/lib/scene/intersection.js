...
function arcIntersections(cx, cy, r, startAngle, endAngle, counterClockwise, x1, y1, x2, y2) {
    ...
    [i1x, i2x].forEach(function (x) {
        ...
        var y = k * x;
        var a1 = angle_1.normalizeAngle360(counterClockwise ? endAngle : startAngle);
        var a2 = angle_1.normalizeAngle360(counterClockwise ? startAngle : endAngle);
        var intersectionAngle = angle_1.normalizeAngle360(Math.atan2(y, x));
