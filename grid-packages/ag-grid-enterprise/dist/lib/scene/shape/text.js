...
function SceneFontChangeDetection(opts) {
    var _a = opts || {}, _b = _a.redraw, redraw = _b === void 0 ? node_1.RedrawType.MAJOR : _b, changeCb = _a.changeCb;
...
var Text = /** @class */ (function (_super) {
    ...
    Text.prototype.getPreciseBBox = function () {
        ...
        for (var i = 0; i < this.lines.length; i++) {
            var metrics = hdpiCanvas_1.HdpiCanvas.measureText(this.lines[i], this.font, this.textBaseline, this.textAlign);
    ...
    Text.prototype.getApproximateBBox = function () {
        ...
        if (this.lines.length > 0) {
            var lineSize = hdpiCanvas_1.HdpiCanvas.getTextSize(this.lines[0], this.font);
            width = lineSize.width;
            firstLineHeight = lineSize.height;
        }
        for (var i = 1; i < this.lines.length; i++) {
            var lineSize = hdpiCanvas_1.HdpiCanvas.getTextSize(this.lines[i], this.font);
    ...
    __decorate([
        node_1.SceneChangeDetection({ redraw: node_1.RedrawType.MAJOR, changeCb: function (o) { return o._splitText(); } })
