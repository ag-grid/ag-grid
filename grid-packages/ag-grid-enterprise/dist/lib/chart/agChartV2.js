...
function applyChartOptions(chart, processedOptions, userOptions) {
    ...
    else if (prepare_1.isAgPolarChartOptions(processedOptions)) {
        applyOptionValues(chart, processedOptions, {
    ...
    chart.processedOptions = json_1.jsonMerge([chart.processedOptions || {}, processedOptions], prepare_1.noDataCloneMergeOptions);
    ...
    debug('chart update type', { updateType: chart_1.ChartUpdateType[updateType] });
