...
var HierarchyChart = /** @class */ (function (_super) {
    ...
    HierarchyChart.prototype.performLayout = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, width, height, legend, padding, seriesAreaPadding, shrinkRect, legendPadding, seriesRoot;
            return __generator(this, function (_c) {
                this.scene.root.visible = true;
                _a = this, _b = _a.scene, width = _b.width, height = _b.height, legend = _a.legend, padding = _a.padding, seriesAreaPadding = _a.seriesAreaPadding;
