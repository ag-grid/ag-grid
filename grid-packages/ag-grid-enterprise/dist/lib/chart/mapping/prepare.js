...
function isAgCartesianChartOptions(input) {
    ...
    if (specifiedType === 'cartesian') {
        function_1.doOnce(function () { return console.warn("AG Charts - type '" + specifiedType + "' is deprecated, use a series type instead"); }, "factory options type " + specifiedType);
        return true;
    }
