...
<?php createDocumentationFromFile('../javascript-grid-callbacks/callbacks.json', 'callbacks', ['paginationNumberFormatter(params)']) ?>

<h2>Pagination Events</h2>

<?php createDocumentationFromFile('../javascript-grid-events/events.json', 'miscellaneous', ['paginationChanged']) ?>
