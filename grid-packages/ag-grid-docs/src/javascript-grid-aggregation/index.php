...
colDef = {
    ...
    <?= grid_example('Built-In Functions', 'built-in-functions', 'generated', array("enterprise" => 1)) ?>
...
var columnB = {
    ...
    <?= grid_example('Custom Aggregation Functions', 'custom-agg-functions', 'generated', array("enterprise" => 1)) ?>
...
function createValueObject(gold, silver) {
    ...
    <?= grid_example('Multi-Column Aggregation', 'multi-column-aggregation', 'generated', array("enterprise" => 1)) ?>
...
colDef = {
    ...
    <?= grid_example('Custom Full Row Aggregation', 'custom-full-row-aggregation', 'generated', array("enterprise" => 1)) ?>
