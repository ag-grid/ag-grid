...
colDef = {
    ...
    <?= grid_example('Built-In Functions', 'built-in-functions', 'generated', ['enterprise' => true, 'exampleHeight' => 600]) ?>
...
var columnB = {
    ...
    <?= grid_example('Custom Aggregation Functions', 'custom-agg-functions', 'generated', ['enterprise' => true, 'exampleHeight' => 600]) ?>
...
function createValueObject(gold, silver) {
    ...
    <?= grid_example('Multi-Column Aggregation', 'multi-column-aggregation', 'generated', ['enterprise' => true, 'exampleHeight' => 600]) ?>
