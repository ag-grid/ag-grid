...
autoGroupColumnDef: {
    ...
    <?= grid_example('Org Hierarchy', 'org-hierarchy', 'generated', ['enterprise' => true, 'exampleHeight' => 375]) ?>
...
var rowData = [
    ...
    <?= grid_example('Filler Nodes', 'filler-nodes', 'generated', ['enterprise' => true, 'exampleHeight' => 300]) ?>
    ...
    <?= grid_example('File Browser', 'file-browser', 'generated', ['enterprise' => true, 'extras' => ['fontawesome']]) ?>
