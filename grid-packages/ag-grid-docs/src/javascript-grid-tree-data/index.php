...
autoGroupColumnDef: {
    ...
    <?= grid_example('Org Hierarchy', 'org-hierarchy', 'generated', ['enterprise' => true, 'exampleHeight' => 525]) ?>
...
var rowData = [
    ...
    <?= grid_example('Filler Nodes', 'filler-nodes', 'generated', ['enterprise' => true, 'exampleHeight' => 420]) ?>
    ...
    <?= grid_example('File Browser', 'file-browser', 'generated', ['enterprise' => true, 'exampleHeight' => 570, 'extras' => ['fontawesome']]) ?>
