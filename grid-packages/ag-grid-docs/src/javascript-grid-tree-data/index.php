...
autoGroupColumnDef: {
    ...
    <?= grid_example('Org Hierarchy', 'org-hierarchy', 'generated', ['enterprise' => true, 'exampleHeight' => 525, 'modules' => ['clientside', 'rowgrouping']]) ?>
...
var rowData = [
    ...
    <?= grid_example('Filler Nodes', 'filler-nodes', 'generated', ['enterprise' => true, 'exampleHeight' => 420, 'modules' => ['clientside', 'rowgrouping']]) ?>
    ...
    <?= grid_example('File Browser', 'file-browser', 'generated', ['enterprise' => true, 'exampleHeight' => 570, 'extras' => ['fontawesome'], 'modules' => ['clientside', 'rowgrouping']]) ?>
