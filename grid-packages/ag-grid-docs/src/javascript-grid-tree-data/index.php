...
autoGroupColumnDef: {
    ...
    <?= grid_example('Org Hierarchy', 'org-hierarchy', 'generated', array("enterprise" => 1, "exampleHeight" => 375, 'processVue' => true)) ?>
...
var rowData = [
    ...
    <?= grid_example('Filler Nodes', 'filler-nodes', 'generated', array("enterprise" => 1, "exampleHeight" => 300, 'processVue' => true)) ?>
    ...
    <?= grid_example('File Browser', 'file-browser', 'generated', array('enterprise' => true, 'extras' => array('fontawesome'), 'processVue' => true) ) ?>
