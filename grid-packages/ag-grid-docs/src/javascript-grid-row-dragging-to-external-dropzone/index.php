...
gridApi.removeRowDropZone(dropZoneParams);
    ...
    <p>
        It is possible to use a generic DropZone to Drag and Drop rows from one grid to another. However, 
        this approach will treat the target grid as a generic HTMLElement and adding the rows should be 
        handled by the <code>onDragStop</code> callback. If you wish the grid to manage the Drag and Drop
        across grid and also handle where the record should be dropped, take a look at
