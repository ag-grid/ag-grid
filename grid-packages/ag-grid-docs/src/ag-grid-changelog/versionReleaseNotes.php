<div class="note" style="display: none" fixVersionNote id="fix_version_23_2_0">
    ...
    <ul>
        ...
        <li>
            AG-3253: Allow keyboard navigation through all parts of the grid / columns / menu's / filters / tool panels
            (see <a href="/javascript-grid-keyboard-navigation/">Keyboard Navigation</a>)
        </li>

        <h2>Filter Enhancements</h2>
        ...
        <h2>Master Detail Enhancements</h2>
