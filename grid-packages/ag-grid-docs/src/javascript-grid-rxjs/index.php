...
<?= grid_example('RxJS - Row Updates', 'rxjs-updates', 'generated', ['enterprise' => true, 'extras' => ['lodash', 'rxjs', 'bluebirdjs'], 'removeTitles' => ['vanilla'], 'modules' => ['clientside', 'rowgrouping'], 'reactFunctional' => true]) ?>
...
<?= grid_example('RxJS - Full Updates', 'rxjs-full', 'generated', ['enterprise' => true, 'extras' => ['lodash', 'rxjs', 'bluebirdjs'], 'removeTitles' => ['vanilla'], 'modules' => ['clientside', 'rowgrouping'], 'reactFunctional' => true]) ?>
