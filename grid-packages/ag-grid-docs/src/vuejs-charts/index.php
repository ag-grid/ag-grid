...
Don't worry if your project has a different configuration. Ag-Charts and its Vue wrapper are distributed as NPM packages which work with any common Vue project setup. 
