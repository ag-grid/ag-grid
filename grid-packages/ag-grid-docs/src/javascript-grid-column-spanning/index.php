...
$pageDescription = "Core feature of ag-Grid supporting Angular, React, Javascript and more. One such feature is Column Spanning. Column Spanning allows cells to span columns, similar to cell span in Excel. Version 24.1.0 is available for download now, take it for a free two month trial.";
...
<p>
    ...
    before going a bit deeper into its usages. The following can be noted:
</p>

<ul class="content">
    <li>
        The Country column is configured to span 2 columns when 'Russia' and 4 columns
...
<ul class="content">
    ...
    <li>
        ...
        to set the column spans and the background colours.
    </li>
</ul>
...
<p>
    Column Spanning breaks out of the row / cell calculations that a lot of features in the grid are based on.
