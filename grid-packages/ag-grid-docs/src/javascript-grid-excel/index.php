...
<?php createDocumentationFromFile('../javascript-grid-properties/properties.json', 'miscellaneous', ['suppressExcelExport']) ?>

<h3>Grid API</h3>

<?php createDocumentationFromFile('../javascript-grid-api/api.json', 'export', ['exportDataAsExcel(params)', 'getDataAsExcel(params)']) ?>

<p>
    The <code>params</code> object can contain all the <a href="../javascript-grid-export/">common export options</a>, as
    well as these Excel-specific options:
</p>

<?php createDocumentationFromFile('excel.json', 'exportProperties') ?>
