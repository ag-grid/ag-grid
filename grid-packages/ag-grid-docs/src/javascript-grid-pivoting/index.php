...
gridOptions.columnDefs = [
    ...
    <?= grid_example('Pivot Mode Vs Pivot Active', 'pivot-mode', 'generated', array("enterprise" => 1)) ?>
...
console.log('found column with id ' + sausageKingdomColumn.getId());</snippet>
    ...
    <?= grid_example('Filtering With Pivot', 'filter', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Sorting With Pivot', 'sorting', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Pivot Column Group Totals', 'totals', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Pivot Row Totals', 'row-totals', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Saving & Restoring Column State', 'state', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Pivot API', 'api', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Secondary Columns', 'secondary-columns', 'generated', array("enterprise" => 1)) ?>
