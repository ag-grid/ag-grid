...
gridOptions.columnDefs = [
    ...
    <?= grid_example('Simple Example', 'simple', 'generated', ['enterprise' => true, 'exampleHeight' => 610, 'modules' => ['clientside', 'rowgrouping']]) ?>
    ...
    <?= grid_example('Pivot Mode Vs Pivot Active', 'pivot-mode', 'generated', ['enterprise' => true, 'exampleHeight' => 630, 'modules' => ['clientside', 'rowgrouping', 'columnpanel']]) ?>
...
console.log('found column with id ' + sausageKingdomColumn.getId());</snippet>
    ...
    <?= grid_example('Sorting With Pivot', 'sorting', 'generated', ['enterprise' => true, 'exampleHeight' => 630, 'modules' => ['clientside', 'rowgrouping', 'columnpanel']]) ?>
    ...
    <?= grid_example('Pivot Column Group Totals', 'totals', 'generated', ['enterprise' => true, 'exampleHeight' => 655, 'modules' => ['clientside', 'rowgrouping', 'columnpanel']]) ?>
    ...
    <?= grid_example('Pivot Row Totals', 'row-totals', 'generated', ['enterprise' => true, 'exampleHeight' => 655, 'modules' => ['clientside', 'rowgrouping', 'columnpanel', 'filterpanel']]) ?>
    ...
    <?= grid_example('Saving & Restoring Column State', 'state', 'generated', ['enterprise' => true, 'exampleHeight' => 630, 'modules' => ['clientside', 'rowgrouping', 'columnpanel', 'filterpanel']]) ?>
    ...
    <?= grid_example('Pivot API', 'api', 'generated', ['enterprise' => true, 'exampleHeight' => 620, 'modules' => ['clientside', 'rowgrouping', 'columnpanel', 'filterpanel', 'csv']]) ?>
    ...
    <?= grid_example('Secondary Columns', 'secondary-columns', 'generated', ['enterprise' => true, 'exampleHeight' => 650, 'modules' => ['clientside', 'rowgrouping', 'columnpanel', 'filterpanel']]) ?>
    ...
    <?= grid_example('Hide Open Parents', 'hide-open-parents', 'generated', ['enterprise' => true, 'exampleHeight' => 650, 'modules' => ['clientside', 'rowgrouping', 'columnpanel', 'filterpanel']]) ?>
