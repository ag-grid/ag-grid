...
?>
    ...
    <ul class="content">
        ...
        <li><code>exportDataAsExcel(params)</code>: download an Excel file to the user's computer.</li>
        <li><code>getDataAsCsv(params)</code>: return a CSV string.</li>
        <li><code>getDataAsExcel(params)</code>: return an Excel XML string. This forces <code>exportMode</code> to 'xml'.</li>
    </ul>

    <p>
        Each of these methods takes an optional params object:
    </p>
