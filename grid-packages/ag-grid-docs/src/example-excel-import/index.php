...
$pageKeywords = "ag-Grid import excel";
$pageGroup = "examples";
...
?>
    ...
    <?= grid_example('Import Excel into ag-Grid', 'excel-import', 'vanilla', array("showResult" => true, "exampleHeight" => 460, "extras" => array("xlsx-style"))) ?>
