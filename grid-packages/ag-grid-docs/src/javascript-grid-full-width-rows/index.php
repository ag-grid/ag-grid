...
<?= grid_example('Simple Full Width', 'simple-full-width', 'generated', array("processVue" => true)) ?>
...
<?= grid_example('Basic Full Width', 'basic-full-width', 'generated', array("processVue" => true)) ?>
