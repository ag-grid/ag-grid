...
&lt;/ag-grid-column&gt;</snippet>
    ...
    <?= grid_example('ag-Grid in Angular with Markup', 'angular-rich-grid-markup', 'angular', ['enterprise' => true, 'showImportsDropdown' => false, 'exampleHeight' => 525, 'showResult' => true, 'extras' => ['fontawesome', 'bootstrap']]); ?>
