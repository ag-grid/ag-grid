...
function createCustomAgeFilter() {
    ...
    CustomAgeFilter.prototype.init = function (params) {
        ...
        this.eGui
            .querySelector('[ref="bt18"]')
            .addEventListener('change', this.onSelection.bind(this, 18));
        this.eGui
...
function createServerSideDatasource(fakeServer, gridOptions) {
    ...
    ServerSideDatasource.prototype.getRows = function (params) {
        ...
        var that = this;
        this.fakeServer.getData(params.request, function successCallback(
            resultForGrid,
            lastRow,
            secondaryColDefs
        ) {
...
function createFakeServer(data) {
    ...
    FakeServer.prototype.pivot = function (
        pivotCols,
        rowGroupCols,
        valueCols,
        data
    ...
    FakeServer.prototype.buildGroupsFromData = function (
        rowData,
        rowGroupCols,
        groupKeys,
        valueCols
    ...
    FakeServer.prototype.filterOutOtherGroups = function (
        originalData,
        groupKeys,
        rowGroupCols
    ) {
