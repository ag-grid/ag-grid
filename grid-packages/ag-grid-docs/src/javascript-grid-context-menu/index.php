...
MenuItemDef {
    ...
    <?= grid_example('Context Menu Example', 'context-menu', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Small Grid Problem', 'popup-parent-problem', 'generated', array("enterprise" => 1)) ?>
    ...
    <?= grid_example('Small Grid Solution', 'popup-parent-solution', 'generated', array("enterprise" => 1)) ?>
