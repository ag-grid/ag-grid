...
<?= grid_example('Simple Dynamic Component', 'dynamic-components', 'generated', array('enterprise' => false, "processVue" => true, 'onlyShow' => 'vue', 'extras' => array('fontawesome', "bootstrap"))) ?>
