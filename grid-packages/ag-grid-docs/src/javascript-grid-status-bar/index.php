...
<?= grid_example('Status Bar Simple', 'status-bar-simple', 'generated', array("enterprise" => 1)) ?>
...
<?= grid_example('Status Bar', 'status-bar', 'generated', array("enterprise" => 1)) ?>
...
<?= grid_example('Status Bar Params', 'status-bar-params', 'generated', array("enterprise" => 1)) ?>
