...
<?= grid_example('Updating Row Data', 'updating-row-data', 'generated', array("enterprise" => 1, "extras" => array('lodash'))) ?>
...
<?= grid_example('Server-side Row Model & CRUD', 'crud', 'generated', array("enterprise" => 1)) ?>
