...
?>
    ...
    <?= grid_example('RxJS - With updated rows only supplied to the grid', 'rxjs-row', 'angular', ['exampleHeight' => 435, 'showResult' => true]); ?>
    ...
    <?= grid_example('RxJS - With full data set supplied to the grid', 'rxjs-bulk', 'angular', ['exampleHeight' => 435, 'showResult' => true]); ?>
