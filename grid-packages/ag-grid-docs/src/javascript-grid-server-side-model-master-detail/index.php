...
<?= grid_example('Infinite Scrolling with Master / Detail', 'infinite-scrolling', 'generated', ['enterprise' => true, 'exampleHeight' => 590, 'extras' => ['lodash'], 'modules' => ['serverside', 'clientside', 'masterdetail']]) ?>
...
<?= grid_example('Row Grouping with Master Detail', 'row-grouping', 'generated', ['enterprise' => true, 'exampleHeight' => 590, 'extras' => ['alasql'], 'modules' => ['serverside', 'clientside', 'masterdetail', 'rowgrouping']]) ?>
...
<?= grid_example('Dynamic Detail Row Height', 'dynamic-detail-row-height', 'generated', ['enterprise' => true, 'exampleHeight' => 590, 'extras' => ['alasql'], 'modules' => ['serverside', 'clientside', 'masterdetail']]) ?>
