...
<?= grid_example('Basic Grouping', 'basic-grouping', 'generated', ['exampleHeight' => 550]) ?>
...
<h2 id="colouring-groups">Colouring Groups</h2>

<p>
    The grid doesn't colour the groups for you. However you can use the column definition
...
<ul class="content">
    ...
    <li>
        If you move a non group column, e.g. Age, it will not be possible to place it in the
        middle of a group and hence impossible to break the group apart.
    </li>
    <li>
        It is possible to place a column between groups (e.g. you can place 'Age' between
        the 'Athlete Details' and 'Sports Results').
    </li>
</ul>

<?= grid_example('Marry Children', 'marry-children', 'generated', ['exampleHeight' => 560]) ?>
...
<ul class="content">
    ...
    <li>
        Demonstrates <code>colDef.openByDefault</code> property, where it sets this on E
        and F groups, resulting in these groups appearing as open by default.
    </li>
    <li>
...
<?= grid_example('Advanced Grouping', 'advanced-grouping', 'generated', ['extras' => ['fontawesome'], 'exampleHeight' => 680]) ?>
