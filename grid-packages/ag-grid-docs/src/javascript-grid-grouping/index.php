...
<?= grid_example('Auto Column Group', 'auto-column-group', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Multi Auto Column Group', 'multi-auto-column-group', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Configuring the Auto Group Column', 'configuring-auto-group-column', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Adding Values To Leaf Nodes', 'adding-values-to-leaf-nodes', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Adding Values To Leaf Nodes for Groups', 'adding-values-to-leaf-nodes-for-groups', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Row Group Index', 'row-group-index', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Keep Columns Visible', 'keep-columns-visible', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Full Width Group Rows', 'full-width-group-rows', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Full Width Groups Rendering', 'full-width-groups-rendering', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Default Group Order', 'default-group-order', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Unbalanced Groups', 'unbalanced-groups', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Grouping Complex Objects with Keys', 'grouping-complex-objects', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Group Footers', 'grouping-footers', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Keeping Group State', 'keeping-group-state', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Removing Single Children', 'remove-single-children', 'vanilla', ['enterprise' => true]) ?>
...
<?= grid_example('Custom Grouping Many Group Columns', 'custom-grouping-many-group-columns', 'generated', ['enterprise' => true]) ?>

<p>The following example shows how to display all the groups in a single column</p>

<?= grid_example('Custom Grouping Single Group Column', 'custom-grouping-single-group-column', 'generated', ['enterprise' => true]) ?>
...
<?= grid_example('Custom Grouping Hidden Parents', 'custom-grouping-hidden-parents', 'generated', ['enterprise' => true]) ?>
