...
<div class="card card-highlight mb-4">
    <div class="card-body">
        <h5 class="card-title"><a href="../ag-grid-changelog/?fixVersion=24.1.0">Version 24.1.0</a></h5>
        <h6 class="card-subtitle mb-2 text-muted">Oct 12</h6>
        <p class="card-text">
            Minor release with bug fixes.
        </p>
        <p class="text-right">
            <a class="learn-more" href="../ag-grid-changelog/?fixVersion=24.1.0">Change Log</a>
        </p>
    </div>
</div>
...
<div class="card card-highlight mb-4">
    <div class="card-body">
        ...
        <p class="font-weight-normal">Do you want more features? Then
            <a class="learn-more" href="/javascript-grid/licensing/">get started with AG Grid Enterprise</a>.
...
<div class="card card-highlight mb-4">
    <div class="card-body">
        <h5 class="card-title">Conferences 2020</h5>
    ...
    <form action="https://ag-grid.us11.list-manage.com/subscribe/post?u=9b44b788c97fa5b498fbbc9b5&amp;id=9353cf87ce"
        ...
        <div id="mc_embed_signup_scroll">
            ...
            <div class="mc-field-group input-group">
                <strong>Select your preference</strong>
                <ul>
                    <li><input type="checkbox" value="1" name="group[18365][1]" id="mce-group[18365]-18365-0"><label
                                for="mce-group[18365]-18365-0"> Angular</label></li>
                    <li><input type="checkbox" value="2" name="group[18365][2]" id="mce-group[18365]-18365-1"><label
                                for="mce-group[18365]-18365-1"> React</label></li>
                    <li><input type="checkbox" value="4" name="group[18365][4]" id="mce-group[18365]-18365-2"><label
                                for="mce-group[18365]-18365-2"> General</label></li>
                </ul>
            </div>
            ...
            <div class="clear"><input type="submit" style="background-color: #0084e7" value="Subscribe" name="subscribe"
