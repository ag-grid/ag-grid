...
<?= grid_example('Dynamic Rendering Component', 'dynamic-rendering-component', 'vanilla', array("enterprise" => 1, "exampleHeight" => 250)) ?>
...
<?= grid_example('Rendering Order', 'rendering-order', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
