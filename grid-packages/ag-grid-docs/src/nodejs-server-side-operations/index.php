...
<p>
    ...
    that uses a limited set of features and grid configurations.
</p>
...
<?= createSnippet('git clone https://github.com/ag-grid/ag-grid-server-side-nodejs-example.git', 'sh') ?>

<p>
    Navigate into the project directory:
</p>

<?= createSnippet('cd ag-grid-server-side-nodejs-example', 'sh') ?>
...
<p>
    ...
    the applied filters are kept, however since v21 of ag-Grid, <code>newRowsAction</code> defaults to <code>'keep'</code> for Server Side Row Model
...
<p>
    ...
    the <code>express</code> and <code>body-parser</code> npm packages.
</p>
