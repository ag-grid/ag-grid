...
$pageDescription = "Core feature of ag-Grid supporting Angular, React, Javascript and more. One such feature is Quick Filter, which filters all columns simultaneously with a simple text search, just like how you filter your Gmail. Version 24.1.0 is available for download now, take it for a free two month trial.";
