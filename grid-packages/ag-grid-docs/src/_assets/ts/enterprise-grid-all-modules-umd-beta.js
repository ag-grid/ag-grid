...
ModuleRegistry.register(GridChartsModule, false);
ModuleRegistry.register(ClipboardModule, false);
ModuleRegistry.register(ColumnsToolPanelModule, false);
ModuleRegistry.register(ExcelExportModule, false);
ModuleRegistry.register(FiltersToolPanelModule, false);
ModuleRegistry.register(MasterDetailModule, false);
ModuleRegistry.register(MenuModule, false);
ModuleRegistry.register(MultiFilterModule, false);
ModuleRegistry.register(RangeSelectionModule, false);
ModuleRegistry.register(RichSelectModule, false);
ModuleRegistry.register(RowGroupingModule, false);
ModuleRegistry.register(ServerSideRowModelModule, false);
ModuleRegistry.register(SetFilterModule, false);
ModuleRegistry.register(SideBarModule, false);
ModuleRegistry.register(SparklinesModule, false);
ModuleRegistry.register(StatusBarModule, false);
ModuleRegistry.register(ViewportRowModelModule, false);
