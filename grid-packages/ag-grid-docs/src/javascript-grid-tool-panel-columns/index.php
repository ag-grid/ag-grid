...
?>
    ...
    <?= grid_example('Tool Panel Simple', 'simple', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
...
interface IColumnToolPanel {
    ...
    <?= grid_example('Section Visibility', 'section-visibility', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
...
colDefs = {
    ...
    <?= grid_example('Tool Panel Styling', 'styling', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
    ...
    <?= grid_example('Read Only Example', 'read-only', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
...
<snippet>
    ...
    <?= grid_example('Expand / Collapse Column Groups', 'expand-collapse', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
...
columnsToolPanel.setColumnLayout(customToolPanelColumnDefs);
    ...
    <?= grid_example('Custom Column Layout', 'custom-layout', 'generated', array("enterprise" => 1, "processVue" => true)) ?>
