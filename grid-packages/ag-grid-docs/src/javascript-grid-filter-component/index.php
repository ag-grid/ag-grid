...
$pageKeywords = "JavaScript Grid Filtering";
...
<p>
    Filter components allow you to add your own filter types to ag-Grid. Use them when the provided
    filters do not meet your requirements.
</p>

<h2>Filter Component Interface (<code>IFilterComp</code>)</h2>
...
<h2 id="ifilter-params"><code>IFilterParams</code></h2>

<p>
    The method <code>init(params)</code> takes a <code>params</code> object with the items listed below. If the user
    provides params via the <code>colDef.filterParams</code> attribute, these will be additionally added to the
...
<h3 id="i-does-filter-pass-params"><code>IDoesFilterPassParams</code></h3>
...
<ol class="content">
    ...
    <li>
        ...
        don't provide a custom floating filter, ag-Grid will automatically provide a read-only version of a floating filter.
    </li>
</ol>

<p>
    If you don't provide either of these two options for your custom filter, the display area for the floating filter
    will be empty.
</p>

<h2>Example: Custom Filter</h2>
...
<p>
    ...
    This is the case for Date Filter as it pops up a Date Picker. If the library you use
...
<ul>
    <li>Add a mouse click listener to your floating element and set it to <code>preventDefault()</code>. This way, the click event
