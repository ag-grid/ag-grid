<h2 id="vueFiltering">VueJS Filtering</h2>
...
<p>The 'filter params' will be made available implicitly in a data value named <code>params</code>. This value will be
    available to you from the <code>created</code> VueJS lifecycle hook.</p>
...
<p>but you do not need to do this - it is made available to you behind the scenes, and contains the cell's value.</p>
...
<ul class="content">
    <li><code>init()</code> is not used. The cell's value is made available implicitly via a data field called <code>params</code>.
    </li>
...
<p>
    ...
    method. If your component is a VueJS component, then this will give you a reference to ag-Grid's
