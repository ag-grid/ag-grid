...
<div>
    ...
    <?= grid_example('Range Selection', 'range-selection', 'generated', ['enterprise' => true]) ?>
    ...
    <?= grid_example('Range Selection Suppress Multi', 'range-selection-suppress-multi', 'generated', ['enterprise' => true]) ?>
...
interface AddCellRangeParams {
    ...
    <?= grid_example('Advanced Range Selection', 'range-selection-advanced', 'generated', ['enterprise' => true]) ?>
