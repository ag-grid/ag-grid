...
<ul>
    ...
    <li>
        <a href="#application-created-charts">Application Created Charts</a>:
...
<p>
    ...
    is to import the <a href="#charts-module">charts module</a>
    and <a href="#enabling-charts">enable charts</a>.
</p>
...
<p>
    ...
    see the section on <a href="../javascript-grid-charts-integrated-container/">providing a chart container</a>.
</p>
...
<p>
    ...
    <a href="#user-created-charts">user-created charts</a>, these charts also
...
<ul>
    ...
    <li><a href="../javascript-grid-charts-integrated-container/">Provide a Chart Container</a>:
