<div class="container-fluid blackish text-light pt-2" id="dashboard-demo">
    ...
    <div class="row mt-3">
        <div class="col-12 text-right">
            <a class="btn btn-link" href="../documentation/javascript/integrated-charts/">Read more about integrated charting</a>
        </div>
    </div>
</div>

<script src="integrated-charting/main.js"></script>
