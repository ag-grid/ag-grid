...
$pageDescription = "Core feature of ag-Grid supporting Angular, React, Javascript and more. One such feature is Layout For Print. Use For Print to have the grid render without using any scrollbars. This is useful for printing the grid, where all rows should be printed, not just what's visible on the screen. Version 24.1.0 is available for download now, take it for a free two month trial.";
$pageKeywords = "ag-Grid Printing";
$pageGroup = "feature";
...
<snippet>
    ...
    <?= grid_example('For Print Complex', 'for-print-complex', 'generated', ['enterprise' => true, 'modules' => ['clientside', 'rowgrouping']]) ?>
