...
?>
    ...
    <?= grid_example('Multiple Row Selection', 'multiple-row-selection', 'generated', ['modules' => true]) ?>
...
api.forEachNodeAfterFilter(function(node) {
  ...
  node.setSelected(true);
    ...
    <p>
        ...
        <a href="../javascript-grid-keyboard-navigation/#custom-navigation">Custom Navigation</a>.
    </p>
