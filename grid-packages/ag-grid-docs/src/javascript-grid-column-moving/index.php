...
<ul class="content">
    ...
    <li>
        ...
        to place the medals columns at the start or at the end respectively.
    </li>
    <li>
...
<p>
    ...
    your target platform (browser and hardware) is too slow to manage the animations.
...
<p>
    The move column animation transitions the column's position only, so when you move a column,
...
<p>
    Below is a more real-world example of where locked columns would be used.
    ...
    actions e.g. 'Delete', 'Buy', 'Sell' etc.
</p>
...
<ul class="content">
    <li>
        ...
        and other columns cannot be moved around them.
    </li>
    <li>
        The first two columns have the user provided <code>locked-col</code> CSS class
        applied to them to change the background colour.
    </li>
    <li>
        ...
        <ul class="content">
            <li>
                Clicking <b>Pin Athlete</b> will pin the Athlete column, which will result in locked columns
                being pinned.
            </li>
            <li>
                Clicking <b>Un-Pin Athlete</b> will un-pin the Athlete column, which will result in locked columns
                being un-pinned (assuming no other columns are left pinned).
            </li>
        </ul>
    </li>
</ul>
...
<p>
    ...
    visible or hidden via the UI. When <code>lockVisible=true</code>, the column will not
    hide when it is dragged out of the grid, and columns dragged from the tool panel onto the
    grid will not become visible.
</p>

<p>
    There is a slight overlap with the property <code>suppressDragLeaveHidesColumns</code>.
    When <code>suppressDragLeaveHidesColumns=true</code> all columns remain visible
