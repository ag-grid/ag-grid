...
<?= grid_example('Cell Editing', 'cell-editing', 'generated', ['exampleHeight' =>  545, 'modules' => true, 'reactFunctional' => true]) ?>
...
<?= grid_example('Dynamic Editor Component', 'dynamic-editor-component', 'vanilla', ['enterprise' => true, 'exampleHeight' => 450, 'reactFunctional' => true]) ?>
...
<?= grid_example('Dynamic Parameters', 'dynamic-parameters', 'generated', ['enterprise' => true, 'exampleHeight' => 520, 'modules' => ['clientside', 'richselect', 'menu', 'columnpanel'], 'reactFunctional' => true]) ?>
...
<?= grid_example('Enter Key Navigation', 'enter-key-navigation', 'generated', ['exampleHeight' => 555, 'modules' => true, 'reactFunctional' => true]) ?>
...
<?= grid_example('Datepicker Cell Editing', 'datepicker-cell-editing', 'generated', ['enterprise' => true, 'extras' => ['jquery', 'jqueryui', 'bootstrap'], 'modules' => ['clientside', 'menu', 'columnpanel'], 'reactFunctional' => true]) ?>
...
<?= grid_example('Full Row Editing', 'full-row-editing', 'generated', ['enterprise' => true, 'exampleHeight' => 527, 'modules' => ['clientside', 'menu', 'columnpanel'], 'reactFunctional' => true]) ?>
...
<?= grid_example('Single Click Editing', 'single-click-editing', 'generated', ['exampleHeight' => 520, 'modules' => true, 'reactFunctional' => true]) ?>
...
<?= grid_example('No Click Editing', 'single-click-editing-renderer', 'generated', ['exampleHeight' => 520, 'modules' => true, 'reactFunctional' => true]) ?>
...
<?= grid_example('Stop Editing When Grid Loses Focus', 'stop-edit-when-grid-loses-focus', 'generated', ['exampleHeight' => 510, 'modules' => true, 'reactFunctional' => true]) ?>
