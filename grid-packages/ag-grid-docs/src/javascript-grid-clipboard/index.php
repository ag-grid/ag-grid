...
?>
    ...
    <?= grid_example('Clipboard example', 'simple', 'generated', array("enterprise" => true)) ?>
    ...
    <?= grid_example('Controlling Clipboard Copy', 'custom', 'generated', array("enterprise" => true)) ?>
...
export interface ProcessHeaderForExportParams {
    ...
    <?= grid_example('Example Process', 'process', 'generated', array("enterprise" => true)) ?>
...
export interface ProcessDataFromClipboardParams {
    ...
    <?= grid_example('Example Process All', 'process-all', 'generated', array("enterprise" => true)) ?>
    ...
    <?= grid_example('Complex Example', 'complex', 'generated', array("enterprise" => true)) ?>
