...
<?php createDocumentationFromFile('../javascript-grid-properties/properties.json', 'miscellaneous', ['suppressCsvExport']) ?>

<h3>Grid API</h3>

<?php createDocumentationFromFile('../javascript-grid-api/api.json', 'export', ['exportDataAsCsv(params)', 'getDataAsCsv(params)']) ?>
...
<?php createDocumentationFromFile('csv.json', 'exportProperties') ?>
