...
/* END OF GRID CSS DEV - DO NOT DELETE */
        ...
        "@ag-grid-enterprise/multi-filter" => "$prefix/@ag-grid-enterprise/multi-filter",
...
/* END OF GRID COMMUNITY MODULES PATHS DEV - DO NOT DELETE */
    ...
    $gridSystemJsEnterprisePaths = array(
        ...
        "@ag-grid-enterprise/multi-filter" => "$prefix/@ag-grid-enterprise/all-modules/dist/ag-grid-enterprise.cjs.js",
...
/* END OF GRID COMMUNITY MODULES PATHS PROD - DO NOT DELETE */
    ...
    $gridSystemJsEnterprisePaths = array(
        ...
        "@ag-grid-enterprise/multi-filter" => "https://unpkg.com/@ag-grid-enterprise/all-modules@" . AG_GRID_ENTERPRISE_VERSION . "/dist/ag-grid-enterprise.cjs.js",
