...
function getModuleImports(bindings: any, componentFilenames: string[], stateProperties: string[]): string[] {
    ...
    if (modules) {
        ...
        if (gridSettings.enterprise) {
            console.error(`The React Functional example ${bindings.exampleName} has "enterprise" : true but no modules have been provided "modules":[...]. Either remove the enterprise flag or provide the required modules.`)
        }
