...
$pageDescription = "ag-Grid is a feature-rich data grid supporting major JavaScript Frameworks. One such feature is RTL. Use Right to Left alignment to allow languages such as Arabic & Hebrew. Version 24.1.0 is available for download now, take it for a free two month trial.";
$pageKeywords = "ag-Grid RTL";
$pageGroup = "feature";
...
?>
    ...
    <?= grid_example('RTL Simple', 'rtl-simple', 'generated') ?>
