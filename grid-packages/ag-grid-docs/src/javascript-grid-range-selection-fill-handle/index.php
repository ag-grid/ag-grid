...
<div>
    ...
    <?= grid_example('Fill Handle', 'fill-handle', 'generated', ['enterprise' => true]) ?>
    ...
    <?= grid_example('Fill Handle - Range Reduction', 'fill-handle-reduction', 'generated', ['enterprise' => true]) ?>
    ...
    <?= grid_example('Custom Fill Operation', 'custom-fill-operation', 'generated', ['enterprise' => true]) ?>
