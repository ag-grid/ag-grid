...
$pageKeywords = "ag-Grid Cell Expressions";
$pageGroup = "feature";
...
colDef = {
    ...
    <?= grid_example('Column Definition Expressions', 'column-definition-expressions', 'generated', ['exampleHeight' => 560, 'modules' => true]) ?>
