...
<div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <a href="../javascript-grid-openfin/" class="column-links column-items">OpenFin</a>
        </div>
        <div class="col-sm-6">
            <a href="../javascript-grid-graphing/" class="column-links column-items">Graphing (D3, jQuery Sparklines)</a>
        </div>
    </div>
</div>
