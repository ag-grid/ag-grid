...
<?= grid_example('Refresh Rows', 'refresh-rows', 'mixed', ['enterprise' => true, 'exampleHeight' => 550, 'modules'=>['clientside', 'masterdetail', 'menu', 'columnpanel']]) ?>
...
<?= grid_example('Refresh Everything', 'refresh-everything', 'mixed', ['enterprise' => true, 'exampleHeight' => 550, 'modules'=>['clientside', 'masterdetail', 'menu', 'columnpanel']]) ?>
...
<?= grid_example('Refresh Nothing', 'refresh-nothing', 'mixed', ['enterprise' => true, 'exampleHeight' => 550, 'modules'=>['clientside', 'masterdetail', 'menu', 'columnpanel']]) ?>
