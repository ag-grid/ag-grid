...
export const baseTheme: Theme = {
  name: 'ag-theme-base',
  extends: null,
  addedVariables: allVariableNames.filter((v) => !/-alpine-|-balham-|-material-/.test(v)),
  colorBlends: [
    {
...
export const balhamTheme: Theme = {
  ...
  extends: baseTheme,
  addedVariables: ['--ag-balham-active-color'],
  colorBlends: [
    {
      destination: '--ag-secondary-foreground-color',
      source: '--ag-foreground-color',
...
export const materialTheme: Theme = {
  ...
  extends: baseTheme,
  addedVariables: ['--ag-material-primary-color', '--ag-material-accent-color'],
  colorBlends: [],
};
