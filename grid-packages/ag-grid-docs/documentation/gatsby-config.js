...
const plugins = [
  ...
  },
  {
    ...
    options: {
      filter: node =>
        node.sourceInstanceName === "doc-pages" &&
  ...
  "gatsby-plugin-react-helmet", // This is used for putting information into the header, e.g. meta tags
  {
    ...
    options: {
      ...
      resolvePages: ({ allSitePage }) => {
        ...
        const allPaths = allSitePage.nodes.map(node => {
          return node.path
        })
