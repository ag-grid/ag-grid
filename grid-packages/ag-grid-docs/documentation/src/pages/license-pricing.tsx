                ...
                <div className={styles['license-pricing__content']}>
                        ...
                        <div>
                            <div>
                                <div style={{ width: '75px' }}>
                                    <div style={{ backgroundColor: '#0057b7', height: '25px' }}></div>
                                    <div style={{ backgroundColor: '#ffd700', height: '25px' }}></div>
                                </div>
                            </div>
                            <div>
                                <h3>Sales Update</h3>
                                <p>
                                    In light of current events in Ukraine we are choosing to express our disappointment
                                    in the breakdown of diplomacy, and its effects on the people of Ukraine, the global
                                    economy and community by not licensing software to companies or individuals
                                    registered or residing in the Russian Federation.
                                </p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div>
                                ...
                                <p>
                                    AG Charts Community (a.k.a.{' '}
                                    <a href="/javascript-charts/overview/">Standalone Charts</a>) is a free to use
                                    product distributed under the{' '}
                                    <a href="/eula/AG-Grid-Community-License.html">MIT License</a>. It is free to use in
                                    your production environments.
                                </p>
                            </div>
                                ...
                                <div className={styles['license-pricing__content__packages__ag-enterprise__contents']}>
                                    <div>
                                        <p>
                                            ...
                                            <a href="/eula/AG-Grid-Enterprise-License-Latest.html">EULA</a> and
                                            supported by our technical staff. It has advanced functionality like Row
                                            Grouping, Range Selection, Master / Detail, Server Side Row Model and{' '}
                                            <a href="/javascript-grid/licensing/">more</a>. AG Grid Enterprise also
                                            comes with{' '}
                                            <a href="/javascript-grid/integrated-charts/">Integrated Charts</a>,
                                        ...
                                        <p>
                                            ...
                                            e-mail <a href="mailto:info@ag-grid.com">info@ag-grid.com</a> to get a
                                        ...
                                        <p>
                                            Expanded definitions and FAQ responses are available further down the page.
                                            You can e-mail us at any time on{' '}
                    ...
                    <section className={styles['license-pricing__licenses']}>
                        <div className={styles['license-pricing__licenses__license-container']}>
                            <div
                                className={styles['license-pricing__licenses__license']}
                                style={{ borderColor: '#009ede' }}
                            >
                                <div>
                                ...
                                <div>
                                    <a
                                        className="btn"
                                        style={{ color: '#009ede', borderColor: '#009ede' }}
                                        href="/ecommerce/#/ecommerce/?licenseType=single"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        BUY
                            ...
                            >
                                ...
                                <div>
                                    <a
                                        className="btn"
                                        style={{ color: '#009d70', borderColor: '#009d70' }}
                                        href="/ecommerce/#/ecommerce/?licenseType=multi"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        BUY
                        ...
                        <div>
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ maxWidth: 800, display: 'inline-block' }}>
                                    Bulk pricing discounts available. Use the BUY buttons above to see pricing for up to
                                    10 developers. For more than 10 developers or any questions with regards your
                                    purchase, please email <a href="mailto:info@ag-grid.com">info@ag-grid.com</a>.
                                </div>
                            </div>
                        </div>
                    </section>
                    <section className={styles['license-pricing__definitions']}>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        would need to be added to the license count, not just the ones working with AG
                                        Grid.
                                    </li>
                                    <li>
                                        Developers within the Single Application Development License count are unnamed,
                                        so long as the total licensed count isn’t exceeded.
                                    </li>
                                    <li>
                                        Single Application Development Licenses are bound to an application name and
                                        can’t be reused on other applications.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            ...
                            <div>
                                ...
                                <p>
                                    Licenses <b>unlimited number of applications</b>, developed for internal use, to
                                    embed AG Grid Enterprise in perpetuity.
                                </p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        Applications would need to be added to the license count, not just the ones
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p>
                                    Allows licensed developers to sub-license AG Grid for one application on one
                                    production environment in perpetuity. Includes a 1-year subscription to new
                                    versions, support and maintenance. Only available with a Developer License.
                                </p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        installation is considered one deployment and requires one Deployment License.
                                        This is true so long as the application instances within the cluster are
                                        replicas of each other and server to provide load balancing and fail over only.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        customers over different URLs, is considered one deployment, as each tenant is
                                        getting serviced by the same application instance.
                                    </li>
                                    <li>
                                        Different instances of the same application, where the instances are not part of
                                        a cluster for fail over or load balancing, are considered independent
                                    ...
                                    <li>
                                        ...
                                        Deployment License, regardless of how many virtual containers or servers the
                                        cloud application spawns for that one single instance of the application.
                                    </li>
                                </ul>

                                <p>
                                    If you have a deployment that doesn't fit within our licensing model, please start a
                                    conversation with us through <a href="mailto:info@ag-grid.com">info@ag-grid.com</a>{' '}
