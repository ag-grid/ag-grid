        ...
        <div id="doc-page-wrapper" className={styles['doc-page-wrapper']}>
            <div id="doc-content" className={classnames("doc-content", styles['doc-page'])}>
                ...
                <div className={styles.pageSections} style={{ marginTop: '25px' }}>
                    <ul>
                        <li>
                            <a target="_blank" href="https://github.com/kpmck/cypress-ag-grid">Cypress plugin</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://github.com/MichaelKim/ag-grid-svelte">Laravel Server Side Adapter</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://github.com/LSEG/ag-grid-playwright">Playwright Plugin</a>
                        </li>
                    </ul>
                </div>
            </div>
