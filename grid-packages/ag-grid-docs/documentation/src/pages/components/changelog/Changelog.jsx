    ...
    return (
        <>
            {!IS_SSR && (
                ...
                >
                    <div style={{ fontWeight: 400, fontSize: '2.5rem', lineHeight: 1.2, marginTop: '20px' }}>
                        AG Grid Changelog
                    </div>

                    <div className={styles['note']}>
                        The AG Grid Changelog lists the feature requests implemented and defects resolved across AG Grid
                        releases. If you can’t find the item you’re looking for, check the{' '}
