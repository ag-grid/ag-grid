...
const helmet = [];
if(isDevelopment()) {
    helmet.push(<link key="charting-dashboard-theme" rel="stylesheet" href={`${localPrefix}/@ag-grid-community/core/dist/styles/ag-theme-balham-dark.css`} crossOrigin="anonymous"/>);
