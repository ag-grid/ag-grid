            ...
            <div className={styles['page-content']} style={{ marginLeft: "5rem", marginRight: "5rem" }}>
                <div className={styles['about-page']}>
                    ...
                    <section>
                        ...
                        <article>
                            ...
                            <p>
                                ...
                                side
                                project to becoming the leading JavaScript datagrid on the market. We are a company
                                built by
                                developers for developers, and - true to our roots - we offer <strong>AG Grid
                                Community</strong>:
                                a free and open-source project that delivers world class grid performance. <strong>AG
                                Grid
                                Enterprise</strong> is our commercially-licensed offering which has enjoyed widespread
                                adoption
                            ...
                            <p>
                                ...
                                struggled
                                to find any datagrid component that could deliver the performance required in tandem
                                with a
                                complete feature list. This struggle ultimately led Niall to pulling out the keyboard
                                one
                                Christmas holiday period and starting <strong>AG Grid</strong> as a side project. This
                                was then
                            ...
                            <p>
                                ...
                                that
                                this thing had legs - and the idea of <strong>AG Grid Enterprise</strong> took seed in
                                Niall’s
                    ...
                    <section>
                        ...
                        <article>
                            <p>We believe that a datagrid should be agnostic to the framework that developers choose.
                                This
                                allows flexibility and future-proofs your development. This is also where the 'ag'
                                in <strong>AG Grid </strong>
                                comes from. </p>
                            <p>Our experience is in building Enterprise applications: we know that the datagrid is at
                                the core
                                of an Enterprise application, and needs to deliver performance and a rich feature
                                set. </p>
                            <p>We give away what others charge for. <strong>AG Grid Community</strong> provides all of
                                the
                                features of our competition. We only charge when we go above and beyond, with features
                                that
                    ...
                    <section>
                        ...
                        <article className="inline-container team">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div>
                                        <img src='../images/team/sachshell.png'
