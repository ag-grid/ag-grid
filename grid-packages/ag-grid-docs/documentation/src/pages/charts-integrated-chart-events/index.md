...
one of the [Provided Themes](../charts-integrated-customisation/#provided-themes) or 
a [Custom Theme](../charts-integrated-customisation/#custom-chart-themes) if used.
...
To learn about series events refer to the standalone charting library [documentation](../charts-integrated-chart-events/).

## Next Up

Continue to the next section to learn about: [Time Series](../charts-integrated-time-series/).
