        ...
        this.gui.innerHTML =
            `<div style="padding: 4px;">
                ...
                <div class="ag-input-wrapper">
                    <input class="ag-safe" style="margin: 4px 0 4px 0;" type="text" id="filterText" aria-label="Full name search" placeholder="Full name search..."/>
                </div>
                ...
                <div>
                    <img src="../images/ag-Grid2-200.png" alt="ag-grid" style="width: 150px; text-align: center; padding: 10px; margin: 10px; border: 1px solid lightgrey; background-color: white;"/>
                </div>
            </div>`;
