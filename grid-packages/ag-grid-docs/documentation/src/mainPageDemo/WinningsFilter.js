export class WinningsFilter {
    init(params) {
        ...
        this.eGui.innerHTML =
            ...
            '<div><label><input type="radio" class="ag-safe" name="filter"' + uniqueId + ' id="cbNoFilter" style="margin-right: 5px;">No filter</input></label></div>' +
            '<div style="margin: 5px 0;"><label><input type="radio" class="ag-safe" name="filter"' + uniqueId + ' id="cbPositive" style="margin-right: 5px;">Positive</input></label></div>' +
            '<div style="margin: 5px 0;"><label><input type="radio" class="ag-safe" name="filter"' + uniqueId + ' id="cbNegative" style="margin-right: 5px;">Negative</input></label></div>' +
            '<div style="margin: 5px 0;"><label><input type="radio" class="ag-safe" name="filter"' + uniqueId + ' id="cbGreater50" style="margin-right: 5px;">&gt; &dollar;50,000</label></div>' +
            '<div style="margin: 5px 0;"><label><input type="radio" class="ag-safe" name="filter"' + uniqueId + ' id="cbGreater90" style="margin-right: 5px;">&gt; &dollar;90,000</label></div>' +
            '</div>';
    ...
    getGui() {
        var isDark = document.querySelector('#myGrid').classList.value.includes('dark');
