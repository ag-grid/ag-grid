...
const types = {
    ...
    ExcelAlignment: '/excel-export/#excelalignment',
    ExcelBorder: '/excel-export/#excelborder',
    ExcelBorders: '/excel-export/#excelborders',
    ExcelCell: '/excel-export/#excelcell',
    ExcelData: '/excel-export/#exceldata',
    ExcelDataType: '/excel-export/#exceldatatype',
    ExcelExportParams: '/excel-export/#excelexportparams',
    ExcelFont: '/excel-export/#excelfont',
    ExcelInterior: '/excel-export/#excelinterior',
    ExcelNumberFormat: '/excel-export/#excelnumberformat',
    ExcelProtection: '/excel-export/#excelprotection',
    ExcelStyle: '/excel-export/#excelstyle',
    ExcelSheetConfig: '/excel-export/#excelsheetconfig',
    ExcelSheetPageSetup: '/excel-export/#excelsheetpagesetup',
    ExcelSheetMargin: '/excel-export/#excelsheetmargin',
