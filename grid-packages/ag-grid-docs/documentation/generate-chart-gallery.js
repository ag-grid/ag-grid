...
/*
    This script is used to generate and update assets for the chart gallery. You can edit the configuration in gallery.json
    and then run `node generate-chart-gallery.js to automatically update the menu, create thumbnails and create a dummy
    markdown page so that examples are picked up and generated by the example generator.

    Please ensure that the Gatsby website is built (not in develop mode) and being served on http://localhost:9000/ if
