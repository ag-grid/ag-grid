...
import { ColDef, ModuleRegistry, ValueGetterParams } from '@ag-grid-community/core';
...
const CompanyLogoRenderer = (params: CustomCellRendererProps) => (
  <span style={{ display: "flex", height: "100%", width: "100%", alignItems: "center" }}>
    {params.value && <img alt={`${params.value} Flag`} src={`https://www.ag-grid.com/example-assets/space-company-logos/${params.value.toLowerCase()}.png`} style={{display: "block", width: "25px", height: "auto", maxHeight: "50%", marginRight: "12px", filter: "brightness(1.1)"}} />}
  </span>
);
...
const MissionResultRenderer = (params: CustomCellRendererProps) => (
  <span style={{ display: "flex", justifyContent: "center", height: "100%", alignItems: "center"}}>
    {<img alt={`${params.value}`} src={`https://www.ag-grid.com/example-assets/icons/${params.value ? 'tick-in-circle' : 'cross-in-circle'}.png`} style={{width: "auto", height: "auto"}} />}
  </span>
);
...
const PriceRenderer = (params: CustomCellRendererProps) => {
  ...
  return(
    <span style={{display: "flex", height: "100%", width: "100%", alignItems: "center"}}>
      <img src="https://www.ag-grid.com/example-assets/pound.png" style={{display: "block", width: "15px", height: "auto", maxHeight: "50%"}}/>
    </span>
  )
