...
When using Row Grouping, the grid displays Group Cell Components in the group column to allow expanding and collapsing the group rows. This section describes how the group cell renderer can be configured.
