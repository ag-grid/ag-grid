...
import './styles.css';
import { CellEditingStartedEvent, CellEditingStoppedEvent, CellEditorSelectorResult, ColDef, ICellEditorParams, RowEditingStartedEvent, RowEditingStoppedEvent } from '@ag-grid-community/core';
...
const cellEditorSelector: (params: ICellEditorParams<IRow>) => CellEditorSelectorResult | undefined = (params: ICellEditorParams<IRow>) => {
