...
To provide your own IDs, implement the method `getRowKey(data)`, which takes the data and should return the ID for the data.

```js
gridOptions.getRowKey: function(item) {
