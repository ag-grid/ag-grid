...
constructor(private http: HttpClient) {}
    onGridReady(params: GridReadyEvent<IOlympicData>) {
        ...
        this.http.get<IOlympicData[]>('https://www.ag-grid.com/example-assets/small-olympic-winners.json').subscribe(data => params.api!.updateGridOption('rowData', data.filter((rec: any) => rec.country != null)));
    }
