import { Grid, FirstDataRenderedEvent, GridOptions, ICellRendererParams, IDetailCellRendererParams } from '@ag-grid-community/core'
...
const gridOptions: GridOptions = {
  ...
  detailCellRendererParams: (params: ICellRendererParams) => {
    ...
    var nameMatch =
      params.data.name === 'Mila Smith' || params.data.name === 'Harper Johnson'
