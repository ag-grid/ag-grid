...
| ## Grid Options
|
| The `gridOptions` object is a 'one stop shop' for the entire interface into the grid. The GridOptions interface supports a generic parameter for row data as detailed in [Using Typescript Generics](/typescript-generics).
|
