...
- **Backspace**: The default editor will start and clear the contents of the cell if <kbd>Backspace</kbd> is pressed on Windows. To mimic this behaviour on MacOS, please use the [enableCellEditingOnBackspace](/grid-options/#reference-editing-enableCellEditingOnBackspace) property.
