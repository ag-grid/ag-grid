...
ModuleRegistry.registerModules([ClientSideRowModelModule, ColumnsToolPanelModule, CsvExportModule, FiltersToolPanelModule, MenuModule, RowGroupingModule, SetFilterModule]);
