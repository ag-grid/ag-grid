...
If using Typescript, Row Nodes' support a generic data type via `RowNode<TData>`. If not set `TData` defaults to `any`. See [Using Typescript Generics](/typescript-generics) for more details.
