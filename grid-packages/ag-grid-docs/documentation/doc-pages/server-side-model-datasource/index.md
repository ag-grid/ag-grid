...
<snippet>
api.updateGridOption('serverSideDatasource', myDatasource);
</snippet>
...
- The datasource is registered with the grid using: `api.updateGridOption('serverSideDatasource', datasource)`.
