    ...
    ***************************************************************************** */
    ...
    var AgGridAngular = /** @class */ (function () {
        function AgGridAngular(elementDef, viewContainerRef, angularFrameworkOverrides, frameworkComponentWrapper, componentFactoryResolver) {
            ...
            this.displayedRowsChanged = new core.EventEmitter();
            this.leftPinnedWidthChanged = new core.EventEmitter();
            this.rightPinnedWidthChanged = new core.EventEmitter();
            this.rowContainerHeightChanged = new core.EventEmitter();
