  ...
  ***************************************************************************** */
  ...
  var AgGridAngular = /** @class */ (function () {
      function AgGridAngular(elementDef, viewContainerRef, angularFrameworkOverrides, frameworkComponentWrapper, componentFactoryResolver) {
          ...
          this.cutStart = new i0.EventEmitter();
          /** Cut operation has ended.     */
          this.cutEnd = new i0.EventEmitter();
          ...
          this.rangeDeleteStart = new i0.EventEmitter();
          /** Range delete operation (cell clear) has ended.     */
          this.rangeDeleteEnd = new i0.EventEmitter();
          ...
          this.storeRefreshed = new i0.EventEmitter();
          /** Cell is clicked.     */
          ...
          this.tooltipShow = new i0.EventEmitter();
          /** A tooltip was hidden     */
          this.tooltipHide = new i0.EventEmitter();
      ...
      AgGridAngular.prototype.ngAfterViewInit = function () {
          ...
          this.gridOptions = agGridCommunity.ComponentUtil.copyAttributesToGridOptions(this.gridOptions, this);
          this.gridParams = {
      ...
      AgGridAngular.prototype.ngOnChanges = function (changes) {
          if (this._initialised) {
              agGridCommunity.ComponentUtil.processOnChange(changes, this.api);
          }
      };
