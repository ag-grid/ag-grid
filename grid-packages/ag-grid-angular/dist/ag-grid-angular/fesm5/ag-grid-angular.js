...
import { VanillaFrameworkOverrides, BaseComponentWrapper, Promise, ComponentUtil, Grid, Utils, Events, GridOptionsWrapper } from 'ag-grid-community';
...
var AgGridAngular = /** @class */ (function () {
    ...
    AgGridAngular.prototype.checkForDeprecatedEvents = function () {
        var _this = this;
        Utils.iterateObject(Events, function (key, eventName) {
