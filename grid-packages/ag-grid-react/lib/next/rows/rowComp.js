...
var RowComp = function (params) {
    ...
    react_1.useEffect(function () {
        return jsComp_1.showJsComp(fullWidthCompDetails, context, eGui.current, function (compFactory) { return compFactory.createFullWidthCellRenderer(fullWidthCompDetails, rowCtrl.getFullWidthCellRendererType()); }, fullWidthCompRef);
    ...
    var rowStyles = react_1.useMemo(function () {
        ...
        ag_grid_community_1._.assign(rowStyles, userStyles);
        return res;
