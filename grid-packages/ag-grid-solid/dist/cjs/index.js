...
const HeaderRowContainerComp = props => {
  ...
  let eGui;
  const pinnedLeft = props.pinned === agGridCommunity.Constants.PINNED_LEFT;
  const pinnedRight = props.pinned === agGridCommunity.Constants.PINNED_RIGHT;
...
const GridHeaderComp = () => {
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(HeaderRowContainerComp, {
      get pinned() {
        return agGridCommunity.Constants.PINNED_LEFT;
      }
    ...
    web.insert(_el$, web.createComponent(HeaderRowContainerComp, {
      get pinned() {
        return agGridCommunity.Constants.PINNED_RIGHT;
      }
...
const AgGridSolid = props => {
  ...
  solidJs.createEffect(() => {
    ...
    if (changesExist) {
      agGridCommunity.ComponentUtil.processOnChange(changes, gridOptions, gridOptions.api, gridOptions.columnApi);
    }
  });
  solidJs.onMount(() => {
