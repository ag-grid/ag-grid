...
var _tmpl$$d = /*#__PURE__*/template(`<div class=ag-header-cell role=columnheader tabindex=-1><div class=ag-header-cell-resize role=presentation></div><div class=ag-header-cell-comp-wrapper role=presentation>`);
const HeaderCellComp = props => {
  ...
  return (() => {
    ...
    effect(_p$ => {
      ...
      _v$4 !== _p$.o && setAttribute(_el$, "aria-description", _p$.o = _v$4);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
var _tmpl$$c = /*#__PURE__*/template(`<div role=gridcell tabindex=-1><div role=presentation></div><div role=presentation><button type=button class="ag-button ag-floating-filter-button-button"tabindex=-1>`);
...
var _tmpl$$b = /*#__PURE__*/template(`<div role=columnheader tabindex=-1><div>`);
