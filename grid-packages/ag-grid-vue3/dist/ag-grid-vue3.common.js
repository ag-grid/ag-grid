...
var DATA_MODEL_ATTR_NAME = kebabNameToAttrEventName(kebabProperty('data-model-changed'));
...
var AgGridVue = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
    ...
    props: AgGridVue_assign({ gridOptions: {
            ...
            type: Array,
            default: function () { return []; },
        }, rowDataModel: undefined }, AgGridVue_props),
    data: function () {
        return {
            gridCreated: false,
            isDestroyed: false,
    ...
    watch: AgGridVue_assign({ rowDataModel: {
            handler: function (currentValue, previousValue) {
    ...
    mounted: function () {
        ...
        this.emitRowModel = this.debounce(function () {
            _this.$emit(DATA_MODEL_ATTR_NAME, Object.freeze(_this.getRowData()));
        }, 20);
