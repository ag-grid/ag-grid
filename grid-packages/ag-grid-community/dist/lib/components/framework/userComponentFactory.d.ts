...
export declare class UserComponentFactory extends BeanStub {
    ...
    newDateComponent(params: IDateParams): Promise<IDateComp> | null;
    newHeaderComponent(params: IHeaderParams): Promise<IHeaderComp> | null;
    newHeaderGroupComponent(params: IHeaderGroupParams): Promise<IHeaderGroupComp> | null;
    newFullWidthGroupRowInnerCellRenderer(params: ICellRendererParams): Promise<ICellRendererComp> | null;
    newFullWidthCellRenderer(params: ICellRendererParams, cellRendererType: string, cellRendererName: string): Promise<ICellRendererComp> | null;
    newCellRenderer(target: ColDef | IRichCellEditorParams, params: ICellRendererParams, isPinned?: boolean): Promise<ICellRendererComp> | null;
    newCellEditor(colDef: ColDef, params: ICellEditorParams): Promise<ICellEditorComp> | null;
    newInnerCellRenderer(target: GroupCellRendererParams, params: ICellRendererParams): Promise<ICellRendererComp> | null;
    newLoadingOverlayComponent(params: ILoadingOverlayParams): Promise<ILoadingOverlayComp> | null;
    newNoRowsOverlayComponent(params: INoRowsOverlayParams): Promise<INoRowsOverlayComp> | null;
    newTooltipComponent(params: ITooltipParams): Promise<ITooltipComp> | null;
    newFilterComponent(def: IFilterDef, params: IFilterParams, defaultFilter: string): Promise<IFilterComp> | null;
    newSetFilterCellRenderer(target: ISetFilterParams, params: ISetFilterCellRendererParams): Promise<ICellRendererComp> | null;
    newFloatingFilterComponent(def: IFilterDef, params: IFloatingFilterParams, defaultFloatingFilter: string | null): Promise<IFloatingFilterComp> | null;
    newToolPanelComponent(toolPanelDef: ToolPanelDef, params: IToolPanelParams): Promise<IToolPanelComp> | null;
    newStatusPanelComponent(def: StatusPanelDef, params: IStatusPanelParams): Promise<IStatusPanelComp> | null;
    /**
     ...
     */
    createAndInitUserComponent<A extends IComponent<TParams>, TParams>(definitionObject: DefinitionObject | null, paramsFromGrid: TParams, componentType: ComponentType, defaultComponentName?: string | null, optional?: boolean): Promise<A> | null;
