...
export const AllGridCommunityModules: Record<`${CommunityModuleName}Module`, number> = {
    ...
    AllCommunityModule: 475.88,
    CellApiModule: 0.28,
    CellStyleModule: 2.24,
    CheckboxEditorModule: 62.35,
    ...
    CustomEditorModule: 61.11,
    CustomFilterModule: 72,
    DateEditorModule: 67.4,
    ...
    LargeTextEditorModule: 62.99,
    LocaleModule: 0.43,
    NumberEditorModule: 66.58,
    ...
    TextEditorModule: 64.35,
    TextFilterModule: 120.09,
    TooltipModule: 23.68,
    UndoRedoEditModule: 67.08,
