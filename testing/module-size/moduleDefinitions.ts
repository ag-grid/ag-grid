...
export const AllGridCommunityModules: Record<`${CommunityModuleName}Module`, number> = {
    ...
    CustomEditorModule: 42.82,
    CustomFilterModule: 67.45,
    DateEditorModule: 47.34,
    ...
    LargeTextEditorModule: 44.01,
    LocaleModule: 0.43,
    NumberEditorModule: 47.72,
    ...
    RowStyleModule: 1.24,
    ScrollApiModule: 0.7,
    SelectEditorModule: 56.82,
    TextEditorModule: 45.47,
    TextFilterModule: 116.55,
    TooltipModule: 22.24,
    UndoRedoEditModule: 48.3,
