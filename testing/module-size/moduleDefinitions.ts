...
export const AllGridCommunityModules: Record<`${CommunityModuleName}Module`, number> = {
    ...
    CustomEditorModule: 44.73,
    CustomFilterModule: 67.45,
    DateEditorModule: 49.25,
    ...
    LargeTextEditorModule: 45.93,
    LocaleModule: 0.43,
    NumberEditorModule: 49.64,
    ...
    RowStyleModule: 1.24,
    ScrollApiModule: 0.7,
    SelectEditorModule: 58.74,
    TextEditorModule: 47.39,
    TextFilterModule: 116.55,
    TooltipModule: 22.24,
    UndoRedoEditModule: 50.22,
