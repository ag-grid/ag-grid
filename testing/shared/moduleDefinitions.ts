...
export const AllGridCommunityModules: Record<`${CommunityModuleName}Module`, number> = {
    ...
    CustomEditorModule: 56.92,
    CustomFilterModule: 70.29,
    DateEditorModule: 63.22,
    ...
    RowStyleModule: 1.24,
    ScrollApiModule: 0.7,
    SelectEditorModule: 71.67,
    TextEditorModule: 60.16,
    TextFilterModule: 120.09,
    TooltipModule: 23.68,
    UndoRedoEditModule: 62.41,
