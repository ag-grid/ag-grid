...
export function addSystemJs() {
    `<script>
            var appLocation = '/examples/getting-started/quick-start-example/reactFunctionalTs';
            var boilerplatePath = '/example-runner/grid-react-ts-boilerplate';
            var systemJsMap = {
                '@ag-grid-community/styles': 'https://cdn.jsdelivr.net/npm/@ag-grid-community/styles@34.0.2',
                'ag-grid-community': 'https://cdn.jsdelivr.net/npm/ag-grid-community@34.0.2',
                'ag-grid-enterprise': 'https://cdn.jsdelivr.net/npm/ag-grid-enterprise@34.0.2/',
                'ag-grid-react': 'https://cdn.jsdelivr.net/npm/ag-grid-react@34.0.2/',
            };
            var systemJsPaths = {
                '@ag-grid-community/locale':
                    'https://cdn.jsdelivr.net/npm/@ag-grid-community/locale@34.0.2/dist/package/main.cjs.js',
                'ag-charts-community': 'https://cdn.jsdelivr.net/npm/ag-charts-community@12.0.2/',
                'ag-charts-core': 'https://cdn.jsdelivr.net/npm/ag-charts-core@12.0.2/',
                'ag-charts-react': 'https://cdn.jsdelivr.net/npm/ag-charts-react@12.0.2/',
                'ag-charts-types': 'https://cdn.jsdelivr.net/npm/ag-charts-types@12.0.2/',
            };
        </script>
        <script src="https://cdn.jsdelivr.net/npm/systemjs@0.19.47/dist/system.js"></script>
        <script src="/example-runner/grid-react-ts-boilerplate/systemjs.config.js"></script>
        <script>
            System.import('/examples/getting-started/quick-start-example/reactFunctionalTs/index.tsx').catch(
                function (err) {
        ...
        <script>
            (function () {
                ...
                const exampleName = 'quick-start-example';
                const initSelector = '.ag-root-wrapper';
