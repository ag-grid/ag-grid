...
md += `${runs} run(s) per side. Aggregation: median hz per benchmark; `;
...
md += `---\n\n`;
md += `*Generated by bench-compare.mjs — ${runs} runs, median hz, ${new Date().toISOString().slice(0, 19).replace('T', ' ')}*\n`;
