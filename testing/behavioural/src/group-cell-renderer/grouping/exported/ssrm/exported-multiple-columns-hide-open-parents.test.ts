...
import { getTestGenerator, withValues } from '../../../util';
...
describe('ag-grid exported group values', () => {
    ...
    describe('with rowModelType=serverSide', () => {
        const gridOptions = rowModelGridOptions.ssrm;
        const testConcerns = withValues(
            withValues(getExportedTestConcerns(), 'groupDisplayType', ['multipleColumns']),
