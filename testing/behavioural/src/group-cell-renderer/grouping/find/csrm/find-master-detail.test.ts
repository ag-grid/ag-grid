import { FindModule, MasterDetailModule, RowGroupingModule } from 'ag-grid-enterprise';
...
describe('ag-grid find API', () => {
    const gridsManager = new TestGridsManager({ modules: [FindModule, MasterDetailModule, RowGroupingModule] });
