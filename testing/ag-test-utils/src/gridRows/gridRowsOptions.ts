...
export interface GridRowsOptions {
     ...
     * If an array, it must contain the id of the columns to include. Default is true. There is usually no
     * need to define this, and it is useful only if you have way too many columns.
     */
