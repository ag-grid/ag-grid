import { BaseComponentWrapper, ComponentType, FrameworkComponentWrapper, WrappableInterface } from '@ag-grid-community/core';
        ...
        class DynamicAgNg2Component extends BaseGuiComponent<any, AgFrameworkComponent<any>> implements WrappableInterface {
            init(params: any): void {
                ...
                if(compType.propertyName == 'cellRenderer'){
                    ...
                    super.init(params);
                    angularFrameworkOverrides.scheduleDetectChanges(this._componentRef.changeDetectorRef);
                }else{
