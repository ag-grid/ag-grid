...
import { BaseCellEditor, BaseDate, BaseDateParams, BaseFilter, BaseFilterParams, BaseFloatingFilter, BaseToolPanelParams, ICellEditorParams, ICellRendererParams, IDetailCellRendererParams, IFilter, IFloatingFilterParams, IGroupCellRendererParams, IHeaderGroupParams, IHeaderParams, ILoadingCellRendererParams, ILoadingOverlayParams, INoRowsOverlayParams, IStatusPanelParams, ITooltipParams } from "@ag-grid-community/core";
...
export declare function useGridCellEditor(methods: CustomCellEditorCallbacks): void;
/** Hook to allow custom date component callbacks to be provided to the grid */
export declare function useGridDate(methods: CustomDateCallbacks): void;
/** Hook to allow custom filter component callbacks to be provided to the grid */
export declare function useGridFilter(methods: CustomFilterCallbacks): void;
/** Hook to allow custom floating filter component callbacks to be provided to the grid */
export declare function useGridFloatingFilter(methods: CustomFloatingFilterCallbacks): void;
