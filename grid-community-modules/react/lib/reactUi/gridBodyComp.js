...
const GridBodyComp = () => {
    ...
    const cssClassManager = react_1.useMemo(() => new core_1.CssClassManager(() => eRoot.current), []);
    ...
    useEffectOnce_1.useLayoutEffectOnce(() => {
        ...
        const compProxy = {
            ...
            setRowCount: count => core_1._.setAriaRowCount(eRoot.current, count),
            setTopHeight,
            setBottomHeight,
            setStickyTopHeight,
            setStickyTopTop,
    ...
    const rootClasses = react_1.useMemo(() => utils_1.classesList('ag-root', 'ag-unselectable', layoutClass), [layoutClass]);
