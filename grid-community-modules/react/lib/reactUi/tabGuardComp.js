...
const TabGuardCompRef = (props, forwardRef) => {
    ...
    const createTabGuard = (side) => {
        const className = side === 'top' ? core_1.TabGuardClassNames.TAB_GUARD_TOP : core_1.TabGuardClassNames.TAB_GUARD_BOTTOM;
        return (react_1.default.createElement("div", { className: `${core_1.TabGuardClassNames.TAB_GUARD} ${className}`, role: "presentation", tabIndex: tabIndex, ref: side === 'top' ? topTabGuardRef : bottomTabGuardRef }));
    };
