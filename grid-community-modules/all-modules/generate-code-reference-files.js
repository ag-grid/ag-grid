...
const INTERFACE_GLOBS = [
    ...
    ...buildGlob('../../grid-enterprise-modules/set-filter/src'),
    ...buildGlob('../../grid-enterprise-modules/filter-tool-panel/src'),
    ...buildGlob('../../grid-enterprise-modules/multi-filter/src'),
