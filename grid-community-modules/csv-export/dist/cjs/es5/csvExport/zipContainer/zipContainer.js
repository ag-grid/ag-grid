...
var zipContainerHelper_1 = require("./zipContainerHelper");
var ZipContainer = /** @class */ (function () {
    ...
    ZipContainer.packageFiles = function (files) {
        ...
        var folderEnd = (0, zipContainerHelper_1.buildCentralDirectoryEnd)(files.length, folderHeadersLength, filesContentAndHeaderLength);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, zipContainerHelper_1.getDeflatedHeaderAndContent)(currentFile, lL)];
                    case 3:
                        output = _b.sent();
    ...
    ZipContainer.buildFileStream = function () {
        ...
        try {
            for (var totalFiles_2 = __values(totalFiles), totalFiles_2_1 = totalFiles_2.next(); !totalFiles_2_1.done; totalFiles_2_1 = totalFiles_2.next()) {
                ...
                var readyFile = (0, zipContainerHelper_1.getHeaderAndContent)(currentFile, lL);
