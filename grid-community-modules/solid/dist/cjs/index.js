...
const RowContainerComp = props => {
  ...
  const centerTemplate = name === core.RowContainerName.CENTER || name === core.RowContainerName.TOP_CENTER || name === core.RowContainerName.BOTTOM_CENTER || name === core.RowContainerName.STICKY_TOP_CENTER;
...
const TabGuardComp = props => {
  ...
  return [(() => {
    ...
    web.effect(_p$ => {
      var _v$ = `${core.TabGuardClassNames.TAB_GUARD} ${core.TabGuardClassNames.TAB_GUARD_TOP}`,
        _v$2 = tabIndex();
      _v$ !== _p$.e && web.className(_el$, _p$.e = _v$);
      _v$2 !== _p$.t && web.setAttribute(_el$, "tabindex", _p$.t = _v$2);
      return _p$;
    ...
    web.effect(_p$ => {
      var _v$3 = `${core.TabGuardClassNames.TAB_GUARD} ${core.TabGuardClassNames.TAB_GUARD_BOTTOM}`,
        _v$4 = tabIndex();
...
const AgGridSolid = props => {
  ...
  solidJs.createEffect(() => {
    ...
    if (changesExist) {
      core.ComponentUtil.processOnChange(changes, api);
    }
  });
  solidJs.onMount(() => {
    ...
    const gridOptions = core.ComponentUtil.combineAttributesAndGridOptions(props.gridOptions, props);
    const createUiCallback = context => {
      ...
      ctrlsService.whenReady(() => {
        ...
        if (refCallback) {
          const gridRef = {
            api: api,
            columnApi: new core.ColumnApi(api)
          };
          refCallback(gridRef);
        }
