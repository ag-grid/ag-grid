import { GridBodyCtrl, RowContainerName } from '@ag-grid-community/core';
...
const GridBodyComp = () => {
    ...
    return (<div ref={eRoot} class={getRootClasses()} role="treegrid" aria-colcount={getAriaColCount()} aria-rowcount={getAriaRowCount()}>
            <GridHeaderComp />
