...
export class RowContainerEventsFeature extends BeanStub {
    ...
    processKeyboardEvent(eventName, keyboardEvent) {
        const cellComp = getCtrlForEvent(this.gridOptionsService, keyboardEvent, CellCtrl.DOM_DATA_KEY_CELL_CTRL);
        const rowComp = getCtrlForEvent(this.gridOptionsService, keyboardEvent, RowCtrl.DOM_DATA_KEY_ROW_CTRL);
