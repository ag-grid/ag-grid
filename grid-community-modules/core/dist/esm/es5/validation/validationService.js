...
var ValidationService = /** @class */ (function (_super) {
    ...
    containerName, docsUrl) {
        ...
        var invalidProperties = fuzzyCheckStrings(Object.getOwnPropertyNames(object), __spreadArray(__spreadArray(__spreadArray([], __read(VUE_FRAMEWORK_PROPS), false), __read(exceptions), false), __read(validProperties), false), validProperties);
