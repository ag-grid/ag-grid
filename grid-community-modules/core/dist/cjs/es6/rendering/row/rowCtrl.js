...
class RowCtrl extends beanStub_1.BeanStub {
    constructor(rowNode, beans, animateIn, useAnimationFrameForCreate, printLayout) {
        ...
        this.rowId = (0, string_1.escapeString)(rowNode.id);
    ...
    executeSlideAndFadeAnimations(gui) {
        ...
        if (shouldSlide) {
            (0, function_1.executeNextVMTurn)(() => {
                this.onTopChanged();
            });
    ...
    setAnimateFlags(animateIn) {
        ...
        const oldRowTopExists = (0, generic_1.exists)(this.rowNode.oldRowTop);
    ...
    onRowClick(mouseEvent) {
        const stop = (0, event_1.isStopPropagationForAgGrid)(mouseEvent) || this.lastMouseDownOnDragger;
        if (stop) {
            return;
        }
    ...
    onRowSelected(gui) {
        ...
        this.forEachGui(gui, gui => {
            ...
            (0, aria_1.setAriaSelected)(gui.element, selected ? true : undefined);
            const ariaLabel = this.createAriaLabel();
            (0, aria_1.setAriaLabel)(gui.element, ariaLabel == null ? '' : ariaLabel);
        });
    }
    createAriaLabel() {
        const selected = this.rowNode.isSelected();
