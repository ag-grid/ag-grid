...
class CellComp extends component_1.Component {
    ...
    refreshWrapper(editing) {
        ...
        if (putWrapperIn) {
            this.eCellWrapper = (0, dom_1.loadTemplate)(/* html */ `<div class="ag-cell-wrapper" role="presentation"></div>`);
        ...
        if (putCellValueIn) {
            this.eCellValue = (0, dom_1.loadTemplate)(/* html */ `<span class="ag-cell-value" role="presentation"></span>`);
    ...
    insertValueWithoutCellRenderer(valueToDisplay) {
        ...
        const escapedValue = valueToDisplay != null ? (0, string_1.escapeString)(valueToDisplay) : null;
