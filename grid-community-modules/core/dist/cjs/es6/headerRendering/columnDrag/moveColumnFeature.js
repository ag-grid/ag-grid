...
class MoveColumnFeature {
    ...
    onDragging(draggingEvent = this.lastDraggingEvent, fromEnter = false, fakeEvent = false, finished = false) {
        ...
        const mouseX = columnMoveHelper_1.ColumnMoveHelper.normaliseX(draggingEvent.x, this.pinned, false, this.gridOptionsService, this.ctrlsService);
        ...
        const lastMovedInfo = columnMoveHelper_1.ColumnMoveHelper.attemptMoveColumns({
            allMovingColumns,
