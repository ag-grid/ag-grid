...
class HeaderComp extends component_1.Component {
    ...
    workOutTemplate() {
        let template = (0, array_1.firstExistingValue)(this.params.template, HeaderComp.TEMPLATE);
    ...
    setDisplayName(params) {
        if (this.currentDisplayName != params.displayName) {
            ...
            const displayNameSanitised = (0, string_1.escapeString)(this.currentDisplayName);
            if (this.eText) {
    ...
    workOutShowMenu() {
        ...
        const onIpadAndMenuHides = (0, browser_1.isIOSUserAgent)() && menuHides;
