...
class RowNode {
    ...
    setDataAndId(data, id) {
        const oldNode = (0, generic_1.exists)(this.id) ? this.createDaemonNode() : null;
        const oldData = this.data;
        this.data = data;
        this.updateDataOnDetailNode();
        this.setId(id);
    ...
    setAggData(newAggData) {
        ...
        const colIds = (0, object_1.getAllKeysInObjects)([this.aggData, newAggData]);
    ...
    */
    ...
    getFirstChildOfFirstChild(rowGroupColumn) {
        ...
        while (isCandidate && !foundFirstChildPath) {
            ...
            const firstChild = (0, generic_1.exists)(parentRowNode) && currentRowNode.firstChild;
            if (firstChild) {
