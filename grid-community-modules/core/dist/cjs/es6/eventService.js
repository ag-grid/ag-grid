...
__decorate([
    ...
    __param(1, (0, context_1.Qualifier)('gridOptionsService')),
    __param(2, (0, context_1.Qualifier)('frameworkOverrides')),
    __param(3, (0, context_1.Qualifier)('globalEventListener')),
    __param(4, (0, context_1.Qualifier)('globalSyncEventListener'))
