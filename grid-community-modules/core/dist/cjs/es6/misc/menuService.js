...
let MenuService = class MenuService extends beanStub_1.BeanStub {
    postConstruct() {
        var _a;
    ...
    isFloatingFilterButtonEnabled(column) {
        ...
        if (legacySuppressFilterButton != null) {
            (0, function_1.warnOnce)(`As of v31.1, 'colDef.floatingFilterComponentParams.suppressFilterButton' is deprecated. Use 'colDef.suppressFloatingFilterButton' instead.`);
        }
...
__decorate([
    (0, context_1.Optional)('enterpriseMenuFactory')
], MenuService.prototype, "enterpriseMenuFactory", void 0);
__decorate([
    (0, context_1.Autowired)('filterMenuFactory')
...
__decorate([
    (0, context_1.Optional)('columnChooserFactory')
