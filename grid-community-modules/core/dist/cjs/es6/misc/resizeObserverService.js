...
let ResizeObserverService = class ResizeObserverService extends beanStub_1.BeanStub {
    ...
    observeResize(element, callback) {
        ...
        const usePolyfill = () => {
            ...
            let widthLastTime = (0, dom_1.offsetWidth)(element);
            let heightLastTime = (0, dom_1.offsetHeight)(element);
            // when finished, this gets turned to false.
            let running = true;
            const periodicallyCheckWidthAndHeight = () => {
                if (running) {
                    const newWidth = (0, dom_1.offsetWidth)(element);
                    const newHeight = (0, dom_1.offsetHeight)(element);
