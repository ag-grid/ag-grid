...
const agAutocompleteRow_1 = require("./agAutocompleteRow");
const fuzzyMatch_1 = require("../utils/fuzzyMatch");
const popupComponent_1 = require("./popupComponent");
const context_1 = require("../context/context");
const generic_1 = require("../utils/generic");
class AgAutocompleteList extends popupComponent_1.PopupComponent {
    constructor(params) {
    ...
    onNavigationKeyDown(event, key) {
        ...
        const newIndex = key === keyCode_1.KeyCode.UP ? oldIndex - 1 : oldIndex + 1;
    ...
    runSearch() {
        ...
        if (this.params.useFuzzySearch) {
            matchingStrings = fuzzyMatch_1.fuzzySuggestions(this.searchString, searchStrings, true).values;
