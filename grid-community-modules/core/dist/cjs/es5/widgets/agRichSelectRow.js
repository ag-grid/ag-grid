...
var RichSelectRow = /** @class */ (function (_super) {
    ...
    RichSelectRow.prototype.highlightString = function (matchString) {
        ...
        if (this.params.cellRenderer || !generic_1.exists(parsedValue)) {
            return;
        }
        if (generic_1.exists(matchString)) {
            ...
            if (index >= 0) {
                ...
                var startPart = string_1.escapeString(parsedValue.slice(0, index), true);
                var highlightedPart = string_1.escapeString(parsedValue.slice(index, highlightEndIndex), true);
                var endPart = string_1.escapeString(parsedValue.slice(highlightEndIndex));
    ...
    RichSelectRow.prototype.updateHighlighted = function (highlighted) {
        ...
        if (highlighted) {
            ...
            aria_1.setAriaActiveDescendant(parentAriaEl, parentId);
    ...
    RichSelectRow.prototype.populateWithoutRenderer = function (value, valueFormatted) {
        ...
        var parsedValue = string_1.escapeString(generic_1.exists(valueFormatted) ? valueFormatted : value, true);
        this.parsedValue = generic_1.exists(parsedValue) ? parsedValue : null;
    ...
    RichSelectRow.prototype.renderValueWithoutRenderer = function (value) {
        ...
        span.innerHTML = generic_1.exists(value) ? value : '&nbsp;';
    };
