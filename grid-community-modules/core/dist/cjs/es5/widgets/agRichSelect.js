...
var AgRichSelect = /** @class */ (function (_super) {
        ...
        if (userCompDetailsPromise) {
            ...
            if ((0, generic_1.exists)(this.value)) {
                ...
                if ((0, generic_1.exists)(placeholder)) {
                    eDisplayField.innerHTML = "".concat((0, string_1.escapeString)(placeholder));
    ...
    AgRichSelect.prototype.getSuggestionsAndFilteredValues = function (searchValue, valueList) {
        ...
        if (searchType === 'fuzzy') {
            var fuzzySearchResult = (0, fuzzyMatch_1.fuzzySuggestions)(this.searchString, valueList, true);
