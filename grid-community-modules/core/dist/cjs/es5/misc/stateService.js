...
var StateService = /** @class */ (function (_super) {
    ...
    function StateService() {
        ...
        _this.dispatchStateUpdateEventDebounced = (0, function_1.debounce)(function () { return _this.dispatchQueuedStateUpdateEvents(); }, 0);
        return _this;
    }
    StateService.prototype.postConstruct = function () {
        ...
        var newColumnsLoadedDestroyFunc = this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_NEW_COLUMNS_LOADED, function (_a) {
        ...
        var rowCountReadyDestroyFunc = this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_COUNT_READY, function () {
        ...
        var firstDataRenderedDestroyFunc = this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_FIRST_DATA_RENDERED, function () {
    ...
    StateService.prototype.setupStateOnGridReady = function () {
        ...
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_TOOL_PANEL_VISIBLE_CHANGED, function () { return _this.updateCachedState('sideBar', _this.getSideBarState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_SIDE_BAR_UPDATED, function () { return _this.updateCachedState('sideBar', _this.getSideBarState()); });
    };
    StateService.prototype.setupStateOnColumnsInitialised = function () {
        ...
        // aggregation
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_VALUE_CHANGED, function () { return _this.updateColumnState(['aggregation']); });
        // columnOrder
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_MOVED, function () { return _this.updateColumnState(['columnOrder']); });
        // columnPinning
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_PINNED, function () { return _this.updateColumnState(['columnPinning']); });
        // columnSizing
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_RESIZED, function () { return _this.updateColumnState(['columnSizing']); });
        // columnVisibility
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_VISIBLE, function () { return _this.updateColumnState(['columnVisibility']); });
        // pivot
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_PIVOT_CHANGED, function () { return _this.updateColumnState(['pivot']); });
        // pivot
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_PIVOT_MODE_CHANGED, function () { return _this.updateColumnState(['pivot']); });
        // rowGroup
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_ROW_GROUP_CHANGED, function () { return _this.updateColumnState(['rowGroup']); });
        // sort
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_SORT_CHANGED, function () { return _this.updateColumnState(['sort']); });
        // any column
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_NEW_COLUMNS_LOADED, function () { return _this.updateColumnState([
            'aggregation', 'columnOrder', 'columnPinning', 'columnSizing', 'columnVisibility', 'pivot', 'pivot', 'rowGroup', 'sort'
        ]); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_COLUMN_GROUP_OPENED, function () { return _this.updateCachedState('columnGroup', _this.getColumnGroupState()); });
    };
    StateService.prototype.setupStateOnRowCountReady = function () {
        ...
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_FILTER_CHANGED, function () { return _this.updateCachedState('filter', _this.getFilterState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_GROUP_OPENED, function () { return _this.updateCachedState('rowGroupExpansion', _this.getRowGroupExpansionState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_EXPAND_COLLAPSE_ALL, function () { return _this.updateCachedState('rowGroupExpansion', _this.getRowGroupExpansionState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_SELECTION_CHANGED, function () { return _this.updateCachedState('rowSelection', _this.getRowSelectionState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_PAGINATION_CHANGED, function (event) {
    ...
    StateService.prototype.setupStateOnFirstDataRendered = function () {
        ...
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_CELL_FOCUSED, function () { return _this.updateCachedState('focusedCell', _this.getFocusedCellState()); });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_RANGE_SELECTION_CHANGED, function (event) {
            if (event.finished) {
                _this.updateCachedState('rangeSelection', _this.getRangeSelectionState());
            }
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_BODY_SCROLL_END, function () { return _this.updateCachedState('scroll', _this.getScrollState()); });
    };
    ...
    StateService.prototype.setColumnPivotState = function (applyOrder) {
        ...
        try {
            for (var columnStates_1 = __values(columnStates), columnStates_1_1 = columnStates_1.next(); !columnStates_1_1.done; columnStates_1_1 = columnStates_1.next()) {
    ...
    StateService.prototype.updateColumnState = function (features) {
        ...
        Object.entries(newColumnState).forEach(function (_a) {
            ...
            if (!(0, generic_1.jsonEquals)(value, _this.cachedState[key])) {
                hasChanged = true;
            }
        });
