...
var GroupCellRendererCtrl = /** @class */ (function (_super) {
    ...
    GroupCellRendererCtrl.prototype.addExpandAndContract = function () {
        var params = this.params;
        var eExpandedIcon = icon_1.createIconNoSpan('groupExpanded', this.gridOptionsService, null);
        var eContractedIcon = icon_1.createIconNoSpan('groupContracted', this.gridOptionsService, null);
        if (eExpandedIcon) {
