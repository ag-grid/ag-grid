...
var GroupCellRendererCtrl = /** @class */ (function (_super) {
    ...
    GroupCellRendererCtrl.prototype.addFooterValue = function () {
        ...
        if (footerValueGetter) {
            ...
            var paramsClone = (0, object_1.cloneObject)(this.params);
    ...
    GroupCellRendererCtrl.prototype.addExpandAndContract = function () {
        var _a;
        var params = this.params;
        var eExpandedIcon = (0, icon_1.createIconNoSpan)('groupExpanded', this.gridOptionsService, null);
        var eContractedIcon = (0, icon_1.createIconNoSpan)('groupContracted', this.gridOptionsService, null);
        if (eExpandedIcon) {
    ...
    GroupCellRendererCtrl.prototype.onCellDblClicked = function (mouseEvent) {
        ...
        var targetIsExpandIcon = (0, event_1.isElementInEventPath)(this.eExpanded, mouseEvent)
