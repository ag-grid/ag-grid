...
var dragAndDropService_1 = require("./dragAndDropService");
...
var VirtualListDragFeature = /** @class */ (function (_super) {
    ...
    VirtualListDragFeature.prototype.createDropTarget = function () {
        ...
        var dropTarget = {
            ...
            getIconName: function () { return _this.moveBlocked ? dragAndDropService_1.DragAndDropService.ICON_PINNED : dragAndDropService_1.DragAndDropService.ICON_MOVE; },
    ...
    VirtualListDragFeature.prototype.onDragging = function (e) {
        ...
        (0, dom_1.radioCssClass)(el, "ag-item-highlight-".concat(hoveredListItem.position));
    };
