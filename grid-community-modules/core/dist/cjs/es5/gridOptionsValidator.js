...
var GridOptionsValidator = /** @class */ (function () {
    ...
    GridOptionsValidator.prototype.init = function () {
        ...
        var validateRegistered = function (prop, module) { return _this.gridOptionsService.exists(prop) && moduleRegistry_1.ModuleRegistry.assertRegistered(module, prop, _this.gridOptionsService.getGridId()); };
