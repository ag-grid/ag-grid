...
var GridOptionsService = /** @class */ (function () {
    ...
    GridOptionsService.prototype.init = function () {
        this.gridOptionLookup = new Set(__spreadArray(__spreadArray([], __read(componentUtil_1.ComponentUtil.ALL_PROPERTIES)), __read(componentUtil_1.ComponentUtil.EVENT_CALLBACKS)));
    ...
    GridOptionsService.prototype.set = function (key, newValue, force, eventParams, changeSet) {
        ...
        if (this.gridOptionLookup.has(key)) {
            ...
            if (force || previousValue !== newValue) {
                this.gridOptions[key] = newValue;
                var event_1 = __assign({ type: key, currentValue: newValue, previousValue: previousValue, changeSet: changeSet }, eventParams);
