...
var DataTypeService = /** @class */ (function (_super) {
    ...
    DataTypeService.prototype.inferCellDataType = function (field) {
        ...
        if (rowData === null || rowData === void 0 ? void 0 : rowData.length) {
            value = object_1.getValueUsingField(rowData[0], field, fieldContainsDots);
        }
        else {
            ...
            if (rowNodes === null || rowNodes === void 0 ? void 0 : rowNodes.length) {
                value = object_1.getValueUsingField(rowNodes[0].data, field, fieldContainsDots);
            }
            else {
    ...
    DataTypeService.prototype.initWaitForRowData = function () {
        ...
        var destroyFunc = this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_DATA_UPDATED, function () {
    ...
    DataTypeService.prototype.setColDefPropertiesForBaseDataType = function (colDef, dataTypeDefinition, colId) {
        ...
        var usingSetFilter = moduleRegistry_1.ModuleRegistry.isRegistered(moduleNames_1.ModuleNames.SetFilterModule, this.context.getGridId());
