...
var DataTypeService = /** @class */ (function (_super) {
    ...
    DataTypeService.prototype.addColumnListeners = function (column) {
        ...
        this.columnStateUpdateListenerDestroyFuncs.push(function () { return column.removeEventListener(column_1.Column.EVENT_STATE_UPDATED, columnListener); });
    };
    ...
    DataTypeService.prototype.initWaitForRowData = function (colId) {
        ...
        var destroyFunc = this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_DATA_UPDATE_STARTED, function (event) {
    ...
    DataTypeService.prototype.setColDefPropertiesForBaseDataType = function (colDef, dataTypeDefinition, colId) {
        ...
        var usingSetFilter = moduleRegistry_1.ModuleRegistry.__isRegistered(moduleNames_1.ModuleNames.SetFilterModule, this.context.getGridId());
        ...
        switch (dataTypeDefinition.baseDataType) {
            ...
            case 'boolean': {
                ...
                colDef.suppressKeyboardEvent = function (params) { return !!params.colDef.editable && params.event.key === keyCode_1.KeyCode.SPACE; };
                if (usingSetFilter) {
                    mergeFilterParams({
