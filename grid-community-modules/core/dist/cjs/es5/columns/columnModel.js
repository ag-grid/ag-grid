...
var ColumnModel = /** @class */ (function (_super) {
    ...
    ColumnModel.prototype.init = function () {
        ...
        this.addManagedListener(this.eventService, events_1.Events.EVENT_FIRST_DATA_RENDERED, function () { return _this.onFirstDataRendered(); });
    };
    ...
    ColumnModel.prototype.getSecondaryPivotColumn = function (pivotKeys, valueColKey) {
        ...
        this.secondaryColumns.forEach(function (column) {
            ...
            var pivotKeyMatches = (0, array_1.areEqual)(thisPivotKeys, pivotKeys);
    ...
    ColumnModel.prototype.getViewportCenterColumnsForRow = function (rowNode) {
        ...
        var emptySpaceBeforeColumn = function (col) {
            ...
            return (0, generic_1.exists)(left) && left > _this.viewportLeft;
        };
    ...
    ColumnModel.prototype.setPivotColumns = function (colKeys, source) {
        if (source === void 0) { source = "api"; }
        this.setPrimaryColumnList(colKeys, this.pivotColumns, events_1.Events.EVENT_COLUMN_PIVOT_CHANGED, true, function (added, column) {
    ...
    ColumnModel.prototype.getDisplayedGroupAtDirection = function (columnGroup, direction) {
        ...
        var col = direction === 'After' ? (0, array_1.last)(colGroupLeafColumns) : colGroupLeafColumns[0];
    ...
    ColumnModel.prototype.orderColumnStateList = function (columnStateList) {
        ...
        var colIdToGridIndexMap = (0, map_1.convertToMap)(this.gridColumns.map(function (col, index) { return [col.getColId(), index]; }));
    ...
    ColumnModel.prototype.compareColumnStatesAndDispatchEvents = function (source) {
        ...
        return function () {
            ...
            var dispatchWhenListsDifferent = function (eventType, colsBefore, colsAfter, idMapper) {
                ...
                var unchanged = (0, array_1.areEqual)(beforeList, afterList);
                if (unchanged) {
                    return;
                }
            ...
            if (changedValues.length > 0) {
                _this.dispatchColumnChangedEvent(events_1.Events.EVENT_COLUMN_VALUE_CHANGED, changedValues, source);
            }
    ...
    ColumnModel.prototype.wrapHeaderNameWithAggFunc = function (column, headerName) {
        ...
        var pivotValueColumn = column.getColDef().pivotValueColumn;
        var pivotActiveOnThisColumn = (0, generic_1.exists)(pivotValueColumn);
        var aggFunc = null;
        var aggFuncFound;
    ...
    ColumnModel.prototype.extractColumns = function (oldPrimaryColumns, previousCols, setFlagFunc, getIndexFunc, getInitialIndexFunc, getValueFunc, getInitialValueFunc) {
        ...
        (this.primaryColumns || []).forEach(function (col) {
            ...
            var colDef = col.getColDef();
            var value = (0, generic_1.attrToBoolean)(getValueFunc(colDef));
            var initialValue = (0, generic_1.attrToBoolean)(getInitialValueFunc(colDef));
            var index = (0, generic_1.attrToNumber)(getIndexFunc(colDef));
            var initialIndex = (0, generic_1.attrToNumber)(getInitialIndexFunc(colDef));
            var include;
    ...
    ColumnModel.prototype.calculateColumnsForDisplay = function () {
        ...
        if (this.pivotMode && (0, generic_1.missing)(this.secondaryColumns)) {
            ...
            columnsForDisplay = this.gridColumns.filter(function (column) {
                var isAutoGroupCol = _this.groupAutoColumns && (0, array_1.includes)(_this.groupAutoColumns, column);
                var isValueCol = _this.valueColumns && (0, array_1.includes)(_this.valueColumns, column);
    ...
    ColumnModel.prototype.processSecondaryColumnDefinitions = function (colDefs) {
        ...
        var searchForColDefs = function (colDefs2) {
            colDefs2.forEach(function (abstractColDef) {
                var isGroup = (0, generic_1.exists)(abstractColDef.children);
                if (isGroup) {
    ...
    ColumnModel.prototype.updateGridColumns = function () {
        ...
        if (areAutoColsChanged && sortOrderToRecover) {
            var groupAutoColsMap_1 = (0, map_1.convertToMap)(this.groupAutoColumns.map(function (col) { return [col, true]; }));
    ...
    ColumnModel.prototype.orderGridColsLike = function (colsOrder) {
        ...
        var lastOrderMapped = (0, map_1.convertToMap)(colsOrder.map(function (col, index) { return [col, index]; }));
        ...
        var gridColsMap = (0, map_1.convertToMap)(this.gridColumns.map(function (col) { return [col, true]; }));
        var oldColsOrdered = colsOrder.filter(function (col) { return gridColsMap.has(col); });
        var oldColsMap = (0, map_1.convertToMap)(oldColsOrdered.map(function (col) { return [col, true]; }));
    ...
    ColumnModel.prototype.autoColsEqual = function (colsA, colsB) {
        return (0, array_1.areEqual)(colsA, colsB, function (a, b) { return a.getColId() === b.getColId(); });
    };
