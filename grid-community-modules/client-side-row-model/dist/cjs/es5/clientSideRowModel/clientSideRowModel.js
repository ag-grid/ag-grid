...
var ClientSideRowModel = /** @class */ (function (_super) {
    ...
    ClientSideRowModel.prototype.onFilterChanged = function (event) {
        ...
        var step = primaryOrQuickFilterChanged ? core_1.ClientSideRowModelSteps.FILTER : core_1.ClientSideRowModelSteps.FILTER_AGGREGATES;
    ...
    ClientSideRowModel.prototype.buildRefreshModelParams = function (step) {
        var paramsStep = core_1.ClientSideRowModelSteps.EVERYTHING;
        var stepsMapped = {
    ...
    ClientSideRowModel.prototype.expandOrCollapseAll = function (expand) {
        ...
        var recursiveExpandOrCollapse = function (rowNodes) {
            ...
            rowNodes.forEach(function (rowNode) {
                ...
                if (usingTreeData) {
                    var hasChildren = core_1._.exists(rowNode.childrenAfterGroup);
                    if (hasChildren) {
                        actionRow();
                    }
                    return;
