...
If your project does not use one of the JavaScript libraries that ag-Grid supports, or you are curious to understand how the grid works in its pure form, this guide is for you!
</p> 
