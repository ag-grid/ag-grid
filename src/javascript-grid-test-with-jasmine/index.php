...
<p class="lead">If your project does not use package manager and you don't want to refer ag-Grid from CDN, you can download the ag-Grid's source files and keep them in your project structure. <strong>Disclaimer:</strong> This makes upgrading more complex and prone to errors.</p>
