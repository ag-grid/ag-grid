...
<div style="padding: 20px;">
    ...
    <h3>Version X.Y.Z [12-DEC-2017]</h3>
    <p>For details of this release, check our dedicated <a href="../ag-grid-blog-X-Y-Z/">blog post for vX.Y.z</a>.</p>
    <h4>Enhancements</h4>
    <ul>
        <li>
...
params = {
    ...
    <li>Enhancement: Shift multi-select - a range of rows can be selected together by holding down shift (does not work
        with virtual pagination or viewport, only normal 'in memory row model').
    </li>
    ...
    <li>Enhancement: new method api.refreshInMemoryRowModel, does a complete refresh of the in memory row model. Useful
