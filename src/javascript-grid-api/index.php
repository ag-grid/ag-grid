...
<div>
    ...
    <table id="list-of-api-functions" class="table">
        ...
        <tr>
            <th>getRowNode(id)</th>
            <td>
                Returns the row node with the given ID. Works only with the InMemoryRowModel.
                The row node id is the one you provide with the callback <i>getRowNodeId(data)</i>,
