...
<!--        <script src="./dist/ag-grid.js?ignore=notused20"></script>-->
        <script src="./dist/ag-grid-enterprise.js?ignore=notused20"></script>
                        ...
                        <div style="padding: 5px 5px 6px 5px;">
                            ...
                            <div style="padding: 4px;">
                                ...
                                <select onchange="onThemeChanged(this.value)" style="width: 90px; color: #333;" class="hide-when-small">
                                    ...
                                    <option value="ag-bootstrap">Material</option>
                                </select>
