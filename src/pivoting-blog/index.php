...
<div class="container-fluid">
    ...
    <img src="cover-pivot.png"/>
    <div style="margin-top: 20px;" class="col-md-8">
    
    <h1>Understand your data: The power of pivot tables</h1>
    
    <h3><strong>Data is not to be stored but to be understood! Find out how to make the most of your data with ag-Grid Enterprise and it's pivot view.</strong></h3>
