...
<div class="row">
    ...
    <div class="col-md-8" style="padding-top: 40px;">
        <h1 style="margin-top: 0">Building a CRUD Application with ag-Grid</h1>
    </div>
    ...
    <div class="row" ng-app="documentation">
        <div class="col-md-9">
            ...
            <p>
                One of the most common scenarios in an Enterprise application is the creation, retrieval, updating and
                deletion (CRUD!) of records in some backend somewhere.
            </p>

            <p>Although there are many ways to implement the backend in a system like this, I describe a fairly simple setup here.
                The idea here is that I want to convey how simple this can be - and once you're happy with the overall idea it should
            be a trivial exercise to swap out the backend for the one your Enterprise uses, while being able to maintain & reuse most
            of the middle and front tiers of the application described.</p>

            <h2>Series Chapters</h2>

            <ul>
                <li>Part 1: Introduction & Initial Setup</li>
                <li>Part 2: Middle Tier</li>
            ...
            <ul>
                <li><code>Backend</code>: Java, Hibernate, H2 for the Database</li>
                <li><code>Middle Tier</code>: ??? </li>
