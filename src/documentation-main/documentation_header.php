    ...
    <div class="container" style="margin-top: 20px">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <?php } else { ?>
                    <a class="sidebarLink childItem" href="<?php print($rootFolder) ?>best-angular-2-data-grid/index.php"><img inline src="/images/angular2_small.png" width="20px"> AngularJS 2.0</a>
                <?php } ?>
