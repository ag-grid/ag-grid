...
<div class="news-box">
    ...
    <div style="position: relative;">
        <a href="../ag-grid-jobs-board/">
            <img src="../ag-grid-jobs-board/images/jobs_board_200.png" style="width: 100%;"/>
        </a>
    </div>
    <div>
        <br>
...
<div class="news-box">
    <div class="news-header">3rd October 2017</div>
    <div style="background-color: black; padding: 10px; position: relative;">
    ...
    <div>
        ...
        <div>
            <ul style="padding-left: 20px;">
                <li>
                    New <a href="../javascript-grid-features/">features overview page</a>.
                </li>
                <li>
                    Added support for React 16
                </li>
                <li>
                    New feature <a href="../javascript-grid-row-styles/">row class rules</a>
                </li>
            </ul>
        </div>
        <div>
