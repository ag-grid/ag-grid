...
export default {
    ...
    <ul class="content">
        ...
        <li><code>afterGuiAttached()</code> is not used. Instead implement the <code>mounted</code> VueJS lifecycle hook for any post Gui setup (ie to focus on an element).</li>
    </ul>
