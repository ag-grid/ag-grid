...
<table class="table">
    ...
    <tr>
        ...
        <td>A <a href="../javascript-grid-column-definitions/#defaultProperties">default column</a> definition.
            ...
            actual column definition get precedence.
        </td>
    </tr>
    <tr>
        ...
        <td>A <a href="../javascript-grid-column-definitions/#defaultProperties">default column group</a> definition.
            ...
            actual column group definition get precedence.
        </td>
    </tr>
    <tr>
        <th>headerHeight</th>
        <td>Height, in pixels, of the header row. The default is 25px. If grouping, each group row will be this
            height.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>If enableColResize=true suppressAutoSize and suppressAutoSize=false, then double clicking the resize
            bar in the header will not auto-size the column.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>If true, the <i>ag-column-moving</i> class is not added to the grid while columns are moving.
            In the default themes, this transpires to no animation for moving columns.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Set one of these to true to enable sorting. <i>enableSorting</i> will allow header clicks and show
            ...
            and show sort icons, but the sorting will be deferred to your datasource.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>If true, then middle clicks will result in 'click' events for cell and row. Otherwise the browser
            will use middle click to scroll the grid.
        </td>
    </tr>
    <tr>
        ...
        <td>If true, mouse wheel events will be passed to the browser - useful if your grid has no vertical scrolls
            and you want the mouse to scroll the browser page.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Set one of these to true to enable filtering. <i>enableFilter</i> will present filters
            ...
            but defer the filtering to your datasource.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <th>groupUseEntireRow<br/> groupDefaultExpanded<br/>
            ...
            groupSuppressAutoColumn <br/> groupSuppressBlankHeader, <br/>groupRemoveSingleChildren
        </th>
    ...
    <tr>
        ...
        <td>Set to true or false. When true, scrollbars are not used. Intention is to print the grid. Do not do this
            if you have many (more than 500??) rows as the browser will probably die.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <th>minColWidth</th>
        <td>The default min width for each col. Min widths specified in column definitions get preference, otherwise
            20px is the default.
        </td>
    </tr>
    <tr>
        <th>maxColWidth</th>
        <td>The default max width for each col. Max widths specified in column definitions get preference, otherwise no
            max is set.
        </td>
    </tr>
    <tr>
        ...
        <td>The class to give a particular row. Provide either a string (class name) or array of string (array
            of class names). If you want a different class per row, then use the callback getRowClass(params) instead.
        </td>
    </tr>
    <tr>
        <th>rowStyle</th>
        <td>The style for a particular row. Provide an array of CSS key / value pairs eg {color: 'red'}.
            If you a different style per row, then use the callback getRowStyle(params) instead.
        </td>
    </tr>
    <tr>
        <th>rowBuffer</th>
    ...
    <tr>
        <th>toolPanelSuppressRowGroups, toolPanelSuppressValues, toolPanelSuppressPivots, toolPanelSuppressPivotMode
        </th>
    ...
    <tr>
        ...
        <td>By default, scrolling lag is enabled for Safari and Internet Explorer (to solve scrolling performance
            ...
            whether to use scroll lag or not.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Does not apply 'ag-column-moving' class into grid when dragging columns. For the provided themes,
            this stops the animation while moving columns via dragging their headers.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Set to true to never show the horizontal scroll. This is useful if the grid is a slave grid,
            and will scroll with a master grid.
        </td>
    </tr>
    <tr>
        <th>slaveGrids</th>
        <td>A list of grids to treat as slaves. If a grid is a slave, it's columns and horizontal scrolling
            will try to mirror the columns of the master.
        </td>
    </tr>
    <tr>
        <th>rowModelType</th>
        <td>Sets the row model type - enabled Virtual Scrolling, Pagination and ViewPort functionality. Defaults to
            'normal'. Valid options are [pagination,virtual,viewport,normal]
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Set to true so that the grid doesn't virtualise the columns. So if you have 100 columns, but
            only 10 visible due to scrolling, all 100 will always be rendered.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>For normal paging, how many rows to show to a user at one time (ie page size).
            ...
            and virtual pagination, defines the block size the datasource is asked for data.
        </td>
    </tr>
    <tr>
        <th>groupRowInnerRenderer<br/> groupRowInnerRendererFramework<br/> groupRowRenderer <br/>groupRowRendererFramework
            <br/>groupRowRendererParams
        </th>
        <td>Sets grouping row cell renderer. See the section on <a
                    href="../javascript-grid-grouping/#groupingCallbacks">row grouping</a> for detailed explanation.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Se this to true so that neither single or double click starts editing. This is useful when you want to
            start the editing in another way, such as including a button in your cellRenderer.
        </td>
    </tr>
    <tr>
        <th>debug</th>
        <td>Set this to true to enable debug information from ag-grid and related components. Will result in
            additional logging being output, but very useful when investigating problems.
        </td>
    </tr>
    <tr>
        <th>icons</th>
        <td>ag-Grid comes with default icons that are created using SVG. You can provide your own icons for the grid to
            use.
            See <a href="../javascript-grid-icons/">Icons</a> for more information.
        </td>
    </tr>
    <tr>
        <th>animateRows</th>
    ...
    <tr>
        <th>pivotMode</th>
        <td>Set to true to enable pivot mode. See <a href="../javascript-grid-pivoting/">Pivoting</a> for more
            information.
        </td>
    </tr>
    <tr>
        ...
        <td>You can change the text in the paging panels and the default filters by providing a <i>localeText</i> or
            a <i>localeTextFunc</i> (see below). See <a href="../javascript-grid-internationalisation/">Internationalisation</a>
    ...
    <tr>
        ...
        <td>Allows specifying the group 'auto column' if you are not happy with the default. If grouping, this column
            def is included as the first column definition in the grid. If not grouping,
    ...
    <tr>
        <th>datasource</th>
        <td>A datasource is used when using row models a) pagination and b) virtual paging. This section explains the
...
<table class="table">
    ...
    <tr>
        ...
        <td>When to show the 'pivot panel' (where you drag rows to pivot) at the top. Default
            ...
            will never show if pivotMode is off.
        </td>
    </tr>
    <tr>
        <th>suppressContextMenu</th>
        <td>Set to true to not show context menu. Use if you don't want to use the default 'right click' context menu.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>By default the enterprise menu has three panels. Set these properties to true
            to suppress one or more of these panels.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>When true, the col id's are not used for values in the groups. To be used in conjunction
            with groupRowAggNodes() callback.
        </td>
    </tr>
    <tr>
        <th>suppressAggFuncInHeader</th>
        <td>When true, column headers won't include the aggFunc, eg 'sum(Bank Balance)' will just be 'Bank Balance'.
        </td>
    </tr>
    <tr>
        ...
        <td>If true, then row group, pivot and value aggregation will be read only from the gui. The grid will display
            what values are used for each, but will not allow the use to change the selection.
        </td>
    </tr>
    <tr>
        <th>suppressTouch</th>
    ...
    <tr>
        ...
        <td>To use the viewportRowModel you provide the grid with a viewportDatasource. See <a
                    href="../javascript-grid-viewport/">Viewport</a> for more information.
        </td>
    </tr>
    <tr>
        <th>aggFuncs</th>
