<?php
$pageTitle = "ag-Grid Blog: React Redux File Browser";
$pageDescription = "";
$pageKeyboards = "ag-Grid JavaScript React Redux Tree Data";

include('../includes/mediaHeader.php');
?>

<!-- <link rel="stylesheet" href="../documentation-main/documentation.css"> -->
<h1>Using Redux to manage state in a React Data Table</h1>
<p class="blog-author">Rob Clarke | 22nd January 2018</p>
<p class="lead">
    As applications grow in size and complexity, how state is managed becomes increasingly important. This post explores
    how a React component that uses the ag-Grid Data Table can take advantage of a Redux store to simplify state management.
</p>
...
<div class="col-md-8">
    ...
    <p style="margin-top: 20px">
        ...
        files will be dispatched to the Redux store for processing.
    </p>

    <note>
        This post assumes familiarity with React and ES6 Javascript features.
    </note>
...
<snippet language="js">
{
   ...
   payload: {
    ...
    <img style="margin-left: 2%" src="ag-grid-react-redux-file-browser/redux-data-flow.png" width="100%" />
...
export default connect(mapStateToProps, mapDispatchToProps)(FileBrowser);
    ...
    <p>
        <?= example('Redux File Browser', 'redux-file-browser', 'react', array("enterprise" => 1, "exampleHeight" => 525, "exampleWidth" => 525, "extras" => array( "fontawesome" ))) ?>
    </p>
...
<?php include '../blog-authors/rob.php'; ?>
