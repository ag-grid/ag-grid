...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="padding-top: 20px;">
            ...
            <hr/>
            <p>
                Thanks for choosing ag-Grid, we believe it's the best data grid in the world and we want your experience to reflect that. We've put this page together to answer some common questions for those that are getting started.
            </p>
            <p>
                The Customer Experience team are available to assist with your queries, please contact <a href="mailto:#">accounts@ag-grid.com</a> with any questions.
            </p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="padding-top: 20px;">
            ...
            <hr/>
            <p>
                We have created a Getting Started section for each framework. Just click on the relevant link below. This brings you through an example of setting up a simple grid in your framework to get you familiar with the basics.
            </p>
        </div>
    </div>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <hr/>
        <p>
            You should now have your license key, this should look like the example below. Please ensure that you use the license key in full and exactly as it was provided to you. The license key removes an error from the JavaScript console, we don't have any external connection to check license keys.
        </p>
        <p>
        <code>    
        ...
        <p>
            Further information on setting the license key is availble in our <a href="/javascript-grid-set-license/">documentation.</a>
        </p>
    </div>
</div>
...
<div class="container">
    <div class="row">
        ...
        <hr/>
        <p>
            ag-Grid Enterprise comes with many features, each of which are listed below with a link to the relevant documentation. You will find an explanantion of the feature as well as an example with sample code.
        </p>
...
<!-- <div class="container">
    <div class="row">
        ...
        <hr/>
        <p>
            This section lists useful resources for your development with ag-Grid. You can also join our mailing list to receive updates on releases and posts on our blog.

            TODO: Add exmaples, components, mailing list, twitter.
        </p>
        <div class="col-md-6">
            <ul>
                <li><a href="../javascript-grid-rtl/">RTL</a></li>
