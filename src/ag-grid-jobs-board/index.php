...
<div class="row">
    <div class="col-md-9">
        ...
        <p>
            ...
            team with a similar person who can contribute to the high quality of software
            that we provide. If you believe you will be a strong contributor to the ag-Grid
            project, we want to hear from you.
        </p>

        <p>
            We want to hire the right people. We will pay the right salary to get the right people in.
        </p>
        ...
        <p>
            ...
            <li>Experience using ag-Grid and / or other JavaScript grid frameworks.</li>
                ...
                <li>Ability to code complex system, beyond simple CRUD screens.</li>
            </ul>
        </p>
        ...
        <p>
            ...
            owning the support forum which is currently about 1hrs work per day. All developers
            help with answering questions, however one key person will own.
        </p>
        <p>
            <b>Desirable Skills</b>
            <ul>
