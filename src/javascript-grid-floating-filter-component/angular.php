...
<p>
    It is possible to provide a Angular floating filter for ag-Grid to use. All of the information above is
    relevant to Angular floatingFilter. This section explains how to apply this logic to your Angular component.
</p>
