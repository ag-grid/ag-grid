...
<head lang="en">
    ...
    <title>ag-Grid Free Features vs Enterprise Features</title>
...
<?php $navKey = "documentation"; include 'includes/navbar.php'; ?>

<?php $headerTitle = "Free Features and Enterprise Features"; include 'includes/headerRow.php'; ?>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="padding-top: 40px;">
            ...
            <p>
                The table below shows all of the features currently available in ag-Grid. The columns for ag-Grid Enterprise and ag-Grid Free indicate whether it is available in that version. Click on the feature name to view the Documentation related to it.
            </p>
            <br>
    </div>
