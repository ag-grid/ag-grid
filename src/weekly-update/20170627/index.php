...
$pageTitle = "ag-Grid Weekly Update 27th June 2017";
$pageDescription = "ag-Grid Weekly Update 27th June 2017";
...
<div class="weekly-news-section">
    ...
    <div style="overflow: hidden;">
        ...
        <div class="weekly-news-sub-title">
            Customer Experience Team, 27th June 2017
        </div>
    </div>
    ...
    <div class="weekly-news-image-right">
        <img src="./images/SwearJar.jpeg" style="width: 100%;"/>
        <br/>
    ...
    <div class="weekly-news-paragraph">
    Version 11 was released yesterday, make sure you sign up for release notes if you don't get our emails. Please see our Changelog for more information.
    </div>

    <div class="weekly-news-paragraph-title">Update on the Customer Experience Team</div>

    <div class="weekly-news-paragraph">
    Dimple and Bas have made their mark on the office, introducing a swear jar for all the team, and it’s rattling already! We’re not yet decided on where the proceeds should go; if you have any suggestions, please let us know in the comments below. The team are also actively contacting clients about renewing ag-Grid so watch out for an email from Dimple. 

    John is working on improving some of our website pages so you will notice changes over the coming week. We are putting a lot of effort into making our website more intuitive and making it easier to find the relevant content.

    There’ll be lots of ‘whoops!’ and ‘gosh-darnits!’ from here on out, I think…
    </div>
    ...
    <div class="weekly-news-paragraph">
        ...
        Robert is working on adding the ability to specify User Defined Columny Types which will simplify column definitions.
    </div>

    <div class="weekly-news-paragraph-title">ag-Grid and OpenFin</div>

    <div class="weekly-news-paragraph">
        Following on from his original example, Sean is working another ag-Grid and OpenFin examples that features a tear out functionality.
    </div>
    ...
    <div class="weekly-news-paragraph">
        Following completion of the OpenFin example, Sean will be turning his attention to our support to Web Components. If you're using this, keep an eye as it's getting an overhaul during the course of this week. Again, target is for our next release.
    </div>
