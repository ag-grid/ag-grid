...
var columnDefs = [
    {headerName: "Athlete", field: "athlete", enableRowGroup: true, suppressMenu: true, suppressFilter: true},
    {headerName: "Age", field: "age", enableRowGroup: true, filter: 'number',
        filterParams: {
            filterOptions: ['equals','lessThan','greaterThan'],
            newRowsAction: 'keep'}
        },
    {headerName: "Country", field: "country", enableRowGroup: true, rowGroupIndex: 0, filter: 'set', filterParams: {values: listOfCountries, newRowsAction: 'keep'}},
    {headerName: "Year", field: "year", enableRowGroup: true, rowGroupIndex: 1, filter: 'set', filterParams: {values: ['2000','2004','2008','2012'], newRowsAction: 'keep'}},
    {headerName: "Sport", field: "sport", enableRowGroup: true, suppressMenu: true, suppressFilter: true},
    {headerName: "Gold", field: "gold", aggFunc: 'sum', suppressMenu: true, suppressFilter: true},
    {headerName: "Silver", field: "silver", aggFunc: 'sum', suppressMenu: true, suppressFilter: true},
    {headerName: "Bronze", field: "bronze", aggFunc: 'sum', suppressMenu: true, suppressFilter: true}
];
