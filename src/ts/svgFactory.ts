...
export class SvgFactory {
    ...
    private static getFromCacheOrCreate(key: string, data: string): HTMLImageElement {
        ...
        return <HTMLImageElement> eCachedImg.cloneNode();
    }
    ...
    public createDropNotAllowedIcon() {
    ...
    public createCheckboxCheckedReadOnlyIcon() {
    ...
    public createCheckboxUncheckedReadOnlyIcon() {
    ...
    public createCheckboxIndeterminateReadOnlyIcon() {
...
/*function createPlusMinus(plus: boolean) {
    let eSvg = document.createElementNS(SVG_NS, "svg");
    let size = "14";
    eSvg.setAttribute("width", size);
    eSvg.setAttribute("height", size);

    let eRect = document.createElementNS(SVG_NS, "rect");
    ...
    let eLineAcross = document.createElementNS(SVG_NS, "line");
    ...
    if (plus) {
        let eLineDown = document.createElementNS(SVG_NS, "line");
...
function createCircle(fill: any) {
    ...
    let eCircle = document.createElementNS(SVG_NS, "circle");
