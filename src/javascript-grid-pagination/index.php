...
<div>
    ...
    <note>
        In v9.0 ag-Grid introduced client side pagination that can be applied to all existing row models.
        Before this, pagination was a less flexible design of 'Pagination Row Model' that did not work
        across all row models. The documentation
        for this old way is below and marked as deprecated. We will keep this old deprecated way in for
        the foreseeable future to help with your migration. However it is recommended to move to the new
        client side pagination. The method that is most like the old way is to apply client side pagination
        to infinite scrolling as demonstrated here XXXXXXXXXX.
    </note>

    <h2>Pagination and Infinite Scrolling</h2>
