...
<div class="row">
    <div class="col-md-9">
        ...
        <h3>Public speaking is exhausting</h3>
        ...
        <h3>T-minus five days and counting</h3>
        <p>
        ...
        <div style="float: right; padding-left: 20px; padding-bottom: 20px; padding-top: 5px;">
            ...
            <div style="padding: 0px; width: 400px; color: darkgrey; font-size: 12px;">
                John at our stand just after we put it up, the day before the conference. He’s not looking at the camera because he’s checking everything’s still going to plan.             </div>
        </div>
        <p>
        ...
        <h3>Playing with the big boys</h3>
        <p>
        ...
        <p>
            On one side of us were the Progress and Rangle.io stands. On the other was Angular Boot Camp. These were all well-known brands within the JavaScript community, so it felt pretty cool to be punching at the same weight.
        </p>
        <p>
        ...
        <h3>Startup successes and selfies</h3>
        <p>
        ...
        <p>
            Then, one minute before we went on stage I couldn’t resist it… I got her attention, <i>"June,”</i> I said <i>“I presume I can't say the word 'f#ck' during the talk?"</i>
        </p>
        <p>
            She released one ear from her headset, <i>"WHAT?"</i>
        </p>
        <p>
            So I repeated <i>"I presume I can't say the word 'f#ck'?"</i>
        </p>
        <p>
            <i>"Noooooo”</i> she said, pretty loud, with some disbelief.
        </p>
        <p>
            <i>"What about b#llocks then?"</i>
        </p>
        <p>
            <i>"Noooooo"</i> she repeated, as the disbelief turned to confusion and possibly panic.
        </p>
        <p>
            <i>"Then what about feck - surely I can say the work feck?"</i>
        </p>
        <p>
            <i>"You can't say any of those words"</i> she said, as worry started creeping onto her face.
        </p>
        <p>
            <i>"Then what's the worst word I can say?"</i> By this point Sean and John were doubled over trying to constrain their laughter. ”I'm only joking June - relax - I'm sorry," I said.
        </p>
        <p>
