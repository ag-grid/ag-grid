...
/home/ubuntu/.nvm/versions/node/v16.14.0/bin/node /home/ubuntu/jira_reports/jiraDataToMarkdown.mjs changelog /var/www/html/changelog/changelog.json /var/www/html/changelog.md >> changelog.log 2>&1
