...
/home/ubuntu/.nvm/versions/node/v16.14.0/bin/node /home/ubuntu/jira_reports/jiraDataToMarkdown.mjs changelog /var/www/html/studio/changelog/studio-changelog.json /var/www/html/studio/changelog.md "AG Studio" >> changelog.log 2>&1
