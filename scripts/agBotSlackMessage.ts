...
//     .parse();
//
// // Generated auth token in ValTown env var to secure this endpoint
// const AUTH_TOKEN = args.authToken;
//
...
// console.log('CHARTS_TEAM_CITY_CHANNEL', CHARTS_TEAM_CITY_CHANNEL);
// console.log('GRID_TEAM_CITY_CHANNEL', GRID_TEAM_CITY_CHANNEL);
// console.log('WEBSITE_STATUS_CHANNEL', WEBSITE_STATUS_CHANNEL);
// console.log('SLACK_BOT_OAUTH_TOKEN', SLACK_BOT_OAUTH_TOKEN);
// console.log('SLACK_DEBUG_CHANNEL', SLACK_DEBUG_CHANNEL);
// // type GH_MAPPING = {
// //     id: string;
// //     name: string;
// //     email: string[];
...
// //     })
// //
// //     return rawChanges.split('\n')
// //         .filter(change => change.length > 0)
// //         .map(change => change.split('||')).map((change) => ({
...
// // }
// //
// // function getChangesData(currentSha: string, lastSuccessfulSha: string, project: AgProject, gitChanges: GitChange[], userDisplayTypeSetting: UserDisplayType) {
// //
// //     const firstChangeSha = lastSuccessfulSha;
// //     const lastChangeSha = currentSha;
// //
// //     const baseGithubUrl = getGithubBaseUrl(project);
// //     const githubUrl = gitChanges.length > 1
...
// //     const changes = tooManyChanges
// //         ? gitChanges.slice(0, changesLimit)
// //         : gitChanges;
// //
...
// //     const userDisplayType = tooManyChanges && userDisplayTypeSetting === "slack" && uniqueUsers.length > 1
// //         ? "name"
// //         : userDisplayTypeSetting;
// //     const otherUsers = [
// //         ...new Set(allOtherUsers),
// //     ].map((username) => {
// //         return getUserDisplay(username, userDisplayType);
// //     }).join(", ");
// //
// //     let changeDetails = changes.map(({username, comment, version}: GitChange) => {
...
// //     if (tooManyChanges) {
// //         changeDetails += `\n• ...(${
// //             gitChanges.length - changesLimit
// //         } more changes from ${otherUsers})`;
// //     }
// //
// //     const changesText = gitChanges.length === 0 ? "_No changes_" : `Changes (<${githubUrl}|Github diff>):\n${changeDetails}`;
// //
// //     return {
// //         uniqueUsers,
// //         changesText,
...
// // }
// //
// // function buildFailureSlackMessageBlocks(changes: GitChange[], runContext: RunContext, userDisplayType: UserDisplayType) {
...
// //                 "type": "mrkdwn",
// //                 "text":
// //                     `:x: ${emoji} ${project} / <${webUrl} | ${workflow} #${runId}>${branchDetails} *failed* (<${reportUrl}|Test Results>)
...
// // }
// //
// // async function sendFailureSlackMessage(changes: GitChange[], runContext: RunContext, channel: string, userDisplayType: UserDisplayType) {
...
// // }
// //
// // async function sendSuccessSlackMessage(changes: GitChange[], runContext: RunContext, channel: string, userDisplayType: UserDisplayType) {
// //     const branchLink = getBranchLink(runContext);
// //     const branchDetails = branchLink ? ` (on ${branchLink})` : "";
// //
...
// // }
// //
// // async function notifyIndividualStagingDeploy(runContext: RunContext, changes: GitChange[], userDisplayType: UserDisplayType) {
...
// //
// //     const usersWithChanges = usersToCheck.map((mapping) => {
...
// //         const emoji = getEmoji(project);
// //         const text =
// //             `:rocket: ${emoji} Your recent changes were deployed to ${stagingUrl} (<${webUrl}|#${runId}>)\n${changesText}`;
// //
...
// // }
// //
// // async function notifyStagingDeploy(runContext: RunContext, changes: GitChange[], userDisplayType: UserDisplayType, channel: string) {
// //     const {currentSha, lastSuccessfulSha, runId, project, deployToStaging} = runContext;
// //
// //     let slackMessage;
// //
...
// //
// //         const text =
// //             `:rocket: ${emoji} ${project} changes were deployed to ${stagingUrl} (<${webUrl}|#${runId}>)\n${changesText}`;
// //
// //         const res = await sendSlackMessage({
// //             data: {
// //                 channel,
...
// //         if (project === "AgGrid") {
// //             await notifyBuildFailure(changes, runContext, TEAM_CITY_CHANNEL, "slack");
// //         } else if (project === "AgCharts") {
