...
version-modules.sh $1 $2 ag-grid ag-grid-enterprise ag-grid-dev ag-grid-angular ag-grid-react ag-grid-aurelia ag-grid-vue ag-grid-docs ag-grid-angular-cli-example ag-grid-aurelia-example ag-grid-react-example ag-grid-vue-example
