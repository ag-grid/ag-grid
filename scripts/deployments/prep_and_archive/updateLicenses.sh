...
# The Commercial End User Licence Agreement published at https://www.ag-grid.com/eula/commercial/ is the golden
# source for the enterprise licence. Render it into the package as LICENSE.html.
