...
sed "s#\@CHARTS_ROOT_DIR\@#$CHARTS_ROOT_DIR#g" ./scripts/deployments/release/switchReleaseRemote.sh | sed "s#\@WWW_ROOT_DIR\@#$WWW_ROOT_DIR#g" > /tmp/switchReleaseRemote.sh
