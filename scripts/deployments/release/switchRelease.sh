...
sed "s#\@PUBLIC_HTML_PATH\@#$PUBLIC_HTML_PATH#g" ./scripts/deployments/release/switchReleaseRemote.sh | sed "s#\@WORKING_DIR_ROOT\@#$WORKING_DIR_ROOT#g" > /tmp/switchReleaseRemote.sh
