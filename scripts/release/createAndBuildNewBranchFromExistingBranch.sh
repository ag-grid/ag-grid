...
if [ $PROJECTS_TO_VERSION == "all" ] || [ $PROJECTS_TO_VERSION == "grid" ]; then
  ...
  node scripts/release/versionModules.js 31.0.0 "~31.0.0" '["grid-packages", "grid-community-modules", "grid-enterprise-modules", "grid-examples"]' all "~v9.0.0-beta.20231127"
fi
