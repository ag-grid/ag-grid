...
var ToolPanelColumnGroupComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnGroupComp.prototype.init = function () {
        ...
        if (grid_core_1._.missing(this.displayName)) {
            this.displayName = '>>';
        }
        ...
        grid_core_1.CssClassApplier.addToolPanelClassesFromColDef(this.columnGroup.getColGroupDef(), this.getGui(), this.gridOptionsWrapper, null, this.columnGroup);
    };
    ToolPanelColumnGroupComp.prototype.addVisibilityListenersToAllChildren = function () {
        var _this = this;
        this.columnGroup.getLeafColumns().forEach(function (column) {
            _this.addDestroyableEventListener(column, grid_core_1.Column.EVENT_VISIBLE_CHANGED, _this.onColumnStateChanged.bind(_this));
            _this.addDestroyableEventListener(column, grid_core_1.Column.EVENT_VALUE_CHANGED, _this.onColumnStateChanged.bind(_this));
            _this.addDestroyableEventListener(column, grid_core_1.Column.EVENT_PIVOT_CHANGED, _this.onColumnStateChanged.bind(_this));
            _this.addDestroyableEventListener(column, grid_core_1.Column.EVENT_ROW_GROUP_CHANGED, _this.onColumnStateChanged.bind(_this));
        });
    };
    ...
    ToolPanelColumnGroupComp.prototype.setupExpandContract = function () {
        this.eGroupClosedIcon.appendChild(grid_core_1._.createIcon('columnSelectClosed', this.gridOptionsWrapper, null));
        this.eGroupOpenedIcon.appendChild(grid_core_1._.createIcon('columnSelectOpen', this.gridOptionsWrapper, null));
        ...
        var touchListener = new grid_core_1.TouchListener(this.eColumnGroupIcons, true);
        this.addDestroyableEventListener(touchListener, grid_core_1.TouchListener.EVENT_TAP, this.onExpandOrContractClicked.bind(this));
    ...
    ToolPanelColumnGroupComp.prototype.setOpenClosedIcons = function () {
        ...
        grid_core_1._.setDisplayed(this.eGroupClosedIcon, !folderOpen);
        grid_core_1._.setDisplayed(this.eGroupOpenedIcon, folderOpen);
    };
    ...
    __decorate([
        grid_core_1.RefSelector('eGroupOpenedIcon')
    ], ToolPanelColumnGroupComp.prototype, "eGroupOpenedIcon", void 0);
    __decorate([
        grid_core_1.RefSelector('eGroupClosedIcon')
    ], ToolPanelColumnGroupComp.prototype, "eGroupClosedIcon", void 0);
    __decorate([
        grid_core_1.RefSelector('eColumnGroupIcons')
