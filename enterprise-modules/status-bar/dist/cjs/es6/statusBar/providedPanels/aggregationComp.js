...
class AggregationComp extends core_1.Component {
    ...
    getAggregationValueComponent(aggFuncName) {
        ...
        const aggregationPanelConfig = core_1._.exists(this.gridOptions.statusBar) && this.gridOptions.statusBar ? this.gridOptions.statusBar.statusPanels.find(panel => panel.statusPanel === 'agAggregationComponent') : null;
