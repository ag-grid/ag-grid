 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function Ao(t,e,o){t.setAttribute(_o(e),o.toString())}function To(t,e){t.removeAttribute(_o(e))}function _o(t){return"aria-"+t}function Fo(t){return t.isSortAscending()?"ascending":t.isSortDescending()?"descending":"none"}function No(t){return parseInt(t.getAttribute("aria-posinset"),10)}function Lo(t){return t.getAttribute("aria-describedby")||""}function Io(t,e){Ao(t,"label",e)}function Go(t,e){Ao(t,"labelledby",e)}function Mo(t,e){Ao(t,"describedby",e)}function xo(t,e){Ao(t,"disabled",e)}function Vo(t,e){Ao(t,"expanded",e)}function Ho(t){To(t,"expanded")}function Wo(t,e){Ao(t,"setsize",e)}function ko(t,e){Ao(t,"posinset",e)}function Bo(t,e){Ao(t,"multiselectable",e)}function Uo(t,e){Ao(t,"rowcount",e)}function jo(t,e){Ao(t,"rowindex",e)}function zo(t,e){Ao(t,"colcount",e)}function Ko(t,e){Ao(t,"colindex",e)}function Yo(t,e){Ao(t,"colspan",e)}function qo(t,e){Ao(t,"sort",e)}function Xo(t){To(t,"sort")}function Qo(t,e){e?Ao(t,"selected",e):To(t,"selected")}function $o(t,e){Ao(t,"checked",void 0===e?"mixed":e)}var Zo=Object.freeze({__proto__:null,getAriaSortState:Fo,getAriaLevel:function(t){return parseInt(t.getAttribute("aria-level"),10)},getAriaPosInSet:No,getAriaDescribedBy:Lo,setAriaLabel:Io,setAriaLabelledBy:Go,setAriaDescribedBy:Mo,setAriaLevel:function(t,e){Ao(t,"level",e)},setAriaDisabled:xo,setAriaExpanded:Vo,removeAriaExpanded:Ho,setAriaSetSize:Wo,setAriaPosInSet:ko,setAriaMultiSelectable:Bo,setAriaRowCount:Uo,setAriaRowIndex:jo,setAriaColCount:zo,setAriaColIndex:Ko,setAriaColSpan:Yo,setAriaSort:qo,removeAriaSort:Xo,setAriaSelected:Qo,setAriaChecked:$o});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v25.1.0
 * @link http://www.ag-grid.com/
