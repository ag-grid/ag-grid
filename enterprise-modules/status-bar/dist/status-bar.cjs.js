/**
 * @ag-grid-enterprise/status-bar - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.1.0
...
var TotalAndFilteredRowsComp = /** @class */ (function (_super) {
    ...
    TotalAndFilteredRowsComp.prototype.onDataChanged = function () {
        var rowCount = core._.formatNumberCommas(this.getFilteredRowCountValue());
        var totalRowCount = core._.formatNumberCommas(this.getTotalRowCount());
...
var FilteredRowsComp = /** @class */ (function (_super) {
    ...
    FilteredRowsComp.prototype.onDataChanged = function () {
        ...
        this.setValue(core._.formatNumberCommas(filteredRowCountValue));
...
var TotalRowsComp = /** @class */ (function (_super) {
    ...
    TotalRowsComp.prototype.onDataChanged = function () {
        this.setValue(core._.formatNumberCommas(this.getRowCountValue()));
    };
...
var SelectedRowsComp = /** @class */ (function (_super) {
    ...
    SelectedRowsComp.prototype.postConstruct = function () {
        ...
        this.setValue(core._.formatNumberCommas(selectedRowCount));
...
var AggregationComp = /** @class */ (function (_super) {
    ...
    AggregationComp.prototype.setAggregationComponentValue = function (aggFuncName, value, visible) {
        ...
        if (core._.exists(statusBarValueComponent) && statusBarValueComponent) {
            statusBarValueComponent.setValue(core._.formatNumberTwoDecimalPlacesAndCommas(value));
    ...
    AggregationComp.prototype.getAggregationValueComponent = function (aggFuncName) {
        ...
        var aggregationPanelConfig = core._.exists(this.gridOptions.statusBar) && this.gridOptions.statusBar ? core._.find(this.gridOptions.statusBar.statusPanels, function (panel) { return panel.statusPanel === 'agAggregationComponent'; }) : null;
        if (core._.exists(aggregationPanelConfig) && aggregationPanelConfig) {
            ...
            if (!core._.exists(aggregationPanelConfig.statusPanelParams) ||
                (core._.exists(aggregationPanelConfig.statusPanelParams) &&
                    ...
                    core._.exists(core._.find(aggregationPanelConfig.statusPanelParams.aggFuncs, function (func) { return func === aggFuncName; })))) {
