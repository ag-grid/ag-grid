/**
          * @ag-grid-enterprise/status-bar - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v28.2.1
...
var AggregationComp = /** @class */ (function (_super) {
    ...
    AggregationComp.prototype.getAggregationValueComponent = function (aggFuncName) {
        ...
        var aggregationPanelConfig = core._.exists(this.gridOptions.statusBar) && this.gridOptions.statusBar ? this.gridOptions.statusBar.statusPanels.find(function (panel) { return panel.statusPanel === 'agAggregationComponent'; }) : null;
