...
import { Component, DragSourceType, Events, HDirection, VDirection, _ } from "@ag-community/grid-core";
...
var BaseDropZonePanel = /** @class */ (function (_super) {
    ...
    BaseDropZonePanel.prototype.getNewHorizontalInsertIndex = function (draggingEvent) {
        ...
        var goingLeft = draggingEvent.hDirection === HDirection.Left;
    ...
    BaseDropZonePanel.prototype.removeColumns = function (columnsToRemove) {
        ...
        columnsToRemove.forEach(function (column) { return _.removeFromArray(newColumnList, column); });
    ...
    BaseDropZonePanel.prototype.rearrangeColumns = function (columnsToAdd) {
        ...
        _.insertArrayIntoArray(newColumnList, columnsToAdd, this.insertIndex);
        var noChangeDetected = _.shallowCompare(newColumnList, this.getExistingColumns());
        if (noChangeDetected) {
            return false;
        }
        else {
    ...
    BaseDropZonePanel.prototype.getNonGhostColumns = function () {
        ...
        var nonGhostColumns;
        if (this.isPotentialDndColumns()) {
            nonGhostColumns = existingColumns.filter(function (column) { return !_.includes(_this.potentialDndColumns, column); });
        }
        else {
