...
export class AdvancedFilterComp extends Component {
    ...
    private setupBuilderButton(): void {
        this.eBuilderFilterButtonIcon.appendChild(_.createIconNoSpan('advancedFilterBuilder', this.beans.gos)!);
    ...
    private onValueConfirmed(isValid: boolean): void {
        ...
        this.beans.filterManager.onFilterChanged({ source: 'advancedFilter' });
    }
