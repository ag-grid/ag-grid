        ...
        closedFuncs.push((e) => {
            ...
            if (isKeyboardEvent && eventSource) {
                ...
                // the header that is closest to the previous header position
                    ...
                    const columnToFocus = allColumns[currentColumnIndex] || core_1._.last(allColumns);
                    if (columnToFocus) {
...
class EnterpriseMenu extends core_1.BeanStub {
    ...
    getDefaultMenuOptions() {
        ...
        const isInMemoryRowModel = this.rowModel.getType() === core_1.Constants.ROW_MODEL_TYPE_CLIENT_SIDE;
