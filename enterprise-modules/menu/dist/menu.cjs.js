/**
          * @ag-grid-enterprise/menu - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v28.2.1
        ...
        closedFuncs.push(function (e) {
            ...
            if (isKeyboardEvent && eventSource) {
                ...
                // the header that is closest to the previous header position
                    ...
                    var columnToFocus = allColumns[currentColumnIndex] || core._.last(allColumns);
                    if (columnToFocus) {
