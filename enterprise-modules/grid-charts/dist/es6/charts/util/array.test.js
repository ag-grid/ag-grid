...
describe("numericExtent", function () {
    ...
    test("coerces Dates to numbers", function () {
        var result = numericExtent([new Date(2019, 9, 13), new Date("03/03/1970"), new Date("05/05/1985")]);
    ...
    test("returns earliest and latest timestamp for mixed Dates and numbers", function () {
        var result = numericExtent([new Date(2019, 8, 13), new Date("03/03/1970"), 1568468277000, new Date("05/05/1985")]);
        expect(result[0]).toBe(5266800000);
