...
import { _, AgPanel, Autowired, Component, PostConstruct, Promise } from "@ag-grid-community/grid-core";
...
var ChartMenu = /** @class */ (function (_super) {
    ...
    ChartMenu.prototype.createMenu = function (defaultTab) {
        ...
        this.addDestroyableEventListener(this.menuPanel, Component.EVENT_DESTROYED, function () {
