...
import { _, Autowired, BeanStub, ModuleNames, ModuleRegistry, Optional } from "@ag-grid-community/grid-core";
...
var ChartDatasource = /** @class */ (function (_super) {
    ...
    ChartDatasource.prototype.extractRowsFromGridRowModel = function (params) {
        ...
        if (params.grouping) {
            ...
            extractedRowData = extractedRowData.filter(function (value, index) { return !_.includes(groupIndexesToRemove_1, index); });
        }
