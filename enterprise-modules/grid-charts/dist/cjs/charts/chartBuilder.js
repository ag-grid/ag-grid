...
var lineSeries_1 = require("./chart/series/lineSeries");
var scatterSeries_1 = require("./chart/series/scatterSeries");
var barSeries_1 = require("./chart/series/barSeries");
var areaSeries_1 = require("./chart/series/areaSeries");
var pieSeries_1 = require("./chart/series/pieSeries");
...
var ChartBuilder = /** @class */ (function () {
    ...
    ChartBuilder.createCartesianChart = function (parent, xAxis, yAxis, document) {
        return new cartesianChart_1.CartesianChart({
            parent: parent,
            xAxis: xAxis,
            yAxis: yAxis,
            document: document,
    ...
    ChartBuilder.createGroupedCategoryChart = function (parent, xAxis, yAxis, document) {
        return new groupedCategoryChart_1.GroupedCategoryChart({
            parent: parent,
            xAxis: xAxis,
            yAxis: yAxis,
            document: document,
    ...
    ChartBuilder.createPolarChart = function (parent) {
        return new polarChart_1.PolarChart({ parent: parent });
    };
