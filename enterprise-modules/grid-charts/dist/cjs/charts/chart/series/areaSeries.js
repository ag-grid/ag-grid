...
var array_2 = require("../../util/array");
...
var AreaSeries = /** @class */ (function (_super) {
    ...
    AreaSeries.prototype.processData = function () {
        ...
        //   [10, -15, 20]
        // ]
        var ySums = this.yData.map(function (values) { return array_1.sumPositiveValues(values); }); // used for normalization
        ...
        var domainX = isContinuousX ? (array_2.numericExtent(xData) || [0, 1]) : xData;
        if (isContinuousX) {
