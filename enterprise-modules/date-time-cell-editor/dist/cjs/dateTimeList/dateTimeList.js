...
exports.DateTimeList = void 0;
var core_1 = require("@ag-grid-community/core");
var dateTimeListModel_1 = require("./dateTimeListModel");
var DateTimeList = /** @class */ (function (_super) {
    __extends(DateTimeList, _super);
    function DateTimeList(options) {
        var _this = _super.call(this) || this;
        _this.currentPageNumber = 0;
        _this.model = new dateTimeListModel_1.DateTimeListModel();
        _this.columnLabels = [];
        _this.rowComps = [];
    ...
    DateTimeList.prototype.showPage = function (number) {
        ...
        this.columnLabels.forEach(function (columnLabel, i) { return core_1._.setDisplayed(columnLabel, i < page.columns.length); });
    };
    ...
    DateTimeList.prototype.getColumnLabel = function (index) {
        if (!this.columnLabels[index]) {
            var label = core_1._.loadTemplate("<div class=\"ag-date-time-list-page-column-label\"></div>");
    ...
    DateTimeList.prototype.handleFocusChange = function (hasFocus) {
        core_1._.addOrRemoveCssClass(this.getGui(), 'ag-has-focus', hasFocus);
    };
...
//# sourceMappingURL=dateTimeList.js.map