 ...
 * @param height
 */
export function createHdpiCanvas(width = 300, height = 150) {
...
export function applyHdpiOverrides(canvas) {
    const canvasDpr = canvas[DevicePixelRatioKey];
...
export function resizeCanvas(canvas, width, height) {
    const canvasDpr = canvas[DevicePixelRatioKey] || 1;
