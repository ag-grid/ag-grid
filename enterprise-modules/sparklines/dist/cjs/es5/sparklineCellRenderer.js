...
var agSparkline_1 = require("./sparkline/agSparkline");
    ...
    SparklineCellRenderer.prototype.init = function (params) {
        ...
        var updateSparkline = function () {
            ...
            if (firstTimeIn) {
                ...
                _this.sparkline = agSparkline_1.AgSparkline.create(options, _this.sparklineTooltipSingleton.getSparklineTooltip());
