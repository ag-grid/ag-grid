...
var extent = ag_charts_community_1._Util.extent, isNumber = ag_charts_community_1._Util.isNumber;
...
var BarColumnSparkline = /** @class */ (function (_super) {
    ...
    function BarColumnSparkline() {
        ...
        _this.rectSelection = ag_charts_community_1._Scene.Selection.select(_this.rectGroup).selectAll();
        _this.labelSelection = ag_charts_community_1._Scene.Selection.select(_this.labelGroup).selectAll();
    ...
    BarColumnSparkline.prototype.updateRectSelection = function (selectionData) {
        ...
        var enterRectSelection = updateRectSelection.enter.append(ag_charts_community_1._Scene.Rect);
    ...
    BarColumnSparkline.prototype.updateLabelSelection = function (selectionData) {
        ...
        var enterLabels = updateLabels.enter.append(ag_charts_community_1._Scene.Text).each(function (text) {
            (text.tag = BarColumnNodeTag.Label), (text.pointerEvents = ag_charts_community_1._Scene.PointerEvents.None);
        });
