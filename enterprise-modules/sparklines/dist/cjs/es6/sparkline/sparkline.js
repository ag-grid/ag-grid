...
class SparklineAxis extends observable_1.Observable {
    constructor() {
        super(...arguments);
        this.type = 'category';
...
class Sparkline extends observable_1.Observable {
    constructor() {
        super();
        ...
        this.padding = new padding_1.Padding(3);
        this.xKey = 'x';
        this.yKey = 'y';
        ...
        this.max = undefined;
        this.yScale = new linearScale_1.LinearScale();
        ...
        this.layoutId = 0;
        this.defaultDateFormatter = defaultLocale_1.locale.format('%m/%d/%y, %H:%M:%S');
