...
const barColumnSparkline_1 = require("./barColumnSparkline");
const hdpiCanvas_1 = require("../../canvas/hdpiCanvas");
class BarSparkline extends barColumnSparkline_1.BarColumnSparkline {
    updateYScaleRange() {
    ...
    generateNodeData() {
        ...
        for (let i = 0, n = yData.length; i < n; i++) {
            ...
            const height = xScale instanceof bandScale_1.BandScale
                ? xScale.bandwidth
                : this.bandWidth;
            ...
            if (labelPlacement === barColumnSparkline_1.BarColumnLabelPlacement.Center) {
                ...
                const textSize = hdpiCanvas_1.HdpiCanvas.getTextSize(labelText, labelFontFamily);
