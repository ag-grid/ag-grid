...
const { extent, isNumber } = ag_charts_community_1._Util;
...
class BarColumnSparkline extends sparkline_1.Sparkline {
    constructor() {
        ...
        this.rectSelection = ag_charts_community_1._Scene.Selection.select(this.rectGroup).selectAll();
        this.labelSelection = ag_charts_community_1._Scene.Selection.select(this.labelGroup).selectAll();
    ...
    updateRectSelection(selectionData) {
        ...
        const enterRectSelection = updateRectSelection.enter.append(ag_charts_community_1._Scene.Rect);
    ...
    updateLabelSelection(selectionData) {
        ...
        const enterLabels = updateLabels.enter.append(ag_charts_community_1._Scene.Text).each((text) => {
