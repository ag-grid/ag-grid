...
var ToolPanelColumnComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnComp.prototype.init = function () {
        ...
        this.setupTooltip();
        var classes = core_1.CssClassApplier.getToolPanelClassesFromColDef(this.column.getColDef(), this.gridOptionsWrapper, this.column, null);
    ...
    ToolPanelColumnComp.prototype.onColumnStateChanged = function () {
        ...
        core_1._.addOrRemoveCssClass(this.eDragHandle, 'ag-column-select-column-readonly', !canBeDragged);
        core_1._.addOrRemoveCssClass(this.getGui(), 'ag-column-select-column-readonly', !canBeDragged && !canBeToggled);
