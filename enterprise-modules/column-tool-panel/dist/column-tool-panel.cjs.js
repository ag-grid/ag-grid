/**
          * @ag-grid-enterprise/column-tool-panel - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v27.2.1
...
var ToolPanelContextMenu = /** @class */ (function (_super) {
    __extends$1(ToolPanelContextMenu, _super);
        ...
        var _loop_1 = function (val) {
            ...
            if (isInactive) {
                ret.push({
                    ...
                    icon: core._.createIconNoSpan(val.addIcon, this_1.gridOptionsWrapper, null),
            ...
            if (isActive) {
                ret.push({
                    ...
                    icon: core._.createIconNoSpan(val.removeIcon, this_1.gridOptionsWrapper, null),
...
var ToolPanelColumnGroupComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnGroupComp.prototype.init = function () {
        ...
        this.setupTooltip();
        var classes = core.CssClassApplier.getToolPanelClassesFromColDef(this.columnGroup.getColGroupDef(), this.gridOptionsWrapper, null, this.columnGroup);
...
var PrimaryColsListPanelItemDragFeature = /** @class */ (function (_super) {
    __extends$3(PrimaryColsListPanelItemDragFeature, _super);
...
var ToolPanelColumnComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnComp.prototype.init = function () {
        ...
        this.refreshAriaLabel();
        this.setupTooltip();
        var classes = core.CssClassApplier.getToolPanelClassesFromColDef(this.column.getColDef(), this.gridOptionsWrapper, this.column, null);
        classes.forEach(function (c) { return _this.addOrRemoveCssClass(c, true); });
    };
...
var PrimaryColsListPanel = /** @class */ (function (_super) {
    __extends$5(PrimaryColsListPanel, _super);
...
var PivotModePanel = /** @class */ (function (_super) {
    __extends$6(PivotModePanel, _super);
...
var PrimaryColsPanel = /** @class */ (function (_super) {
    __extends$7(PrimaryColsPanel, _super);
...
var ColumnToolPanel = /** @class */ (function (_super) {
    __extends$8(ColumnToolPanel, _super);
