/**
 * @ag-grid-enterprise/column-tool-panel - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.2.0
...
var PrimaryColsListPanelItemDragFeature = /** @class */ (function (_super) {
    ...
    PrimaryColsListPanelItemDragFeature.prototype.columnPanelItemDragStart = function (_a) {
        ...
        var hasNotMovable = core._.find(currentColumns, function (col) {
...
var ToolPanelColumnComp = /** @class */ (function (_super) {
    ...
    ToolPanelColumnComp.prototype.onColumnStateChanged = function () {
        ...
        core._.addOrRemoveCssClass(this.eDragHandle, 'ag-column-select-column-readonly', !canBeDragged);
        core._.addOrRemoveCssClass(this.getGui(), 'ag-column-select-column-readonly', !canBeDragged && !canBeToggled);
