...
var PrimaryColsListPanelItemDragFeature = class extends import_core6.BeanStub {
  ...
  getCurrentColumns(currentDragValue) {
    if ((0, import_core6.isProvidedColumnGroup)(currentDragValue)) {
...
var ColumnToolPanel = class extends import_core13.Component {
  ...
  isRowGroupingModuleLoaded() {
    return import_core13.ModuleRegistry.__assertRegistered(import_core13.ModuleNames.RowGroupingModule, "Row Grouping", this.gridId);
  }
