/**
 * @ag-grid-enterprise/clipboard - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v24.1.1
 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function z(t,e){U[e]||(t(),U[e]=!0)}function K(t){if(t.name)return t.name;var e=/function\s+([^\(]+)/.exec(t.toString());return e&&2===e.length?e[1].trim():null}function Y(t){return!!(t&&t.constructor&&t.call&&t.apply)}function q(t){X(t,400)}function Q(t){X(t,0)}function X(t,e){void 0===e&&(e=0),t.length>0&&window.setTimeout((function(){return t.forEach((function(t){return t()}))}),e)}function $(t,e,o){var n;return void 0===o&&(o=!1),function(){for(var i=[],r=0;r<arguments.length;r++)i[r]=arguments[r];var s=this,a=o&&!n;window.clearTimeout(n),n=window.setTimeout((function(){n=null,o||t.apply(s,i)}),e),a&&t.apply(s,i)}}function Z(t){t&&t()}var J=Object.freeze({__proto__:null,doOnce:z,getFunctionName:K,getFunctionParameters:function(t){var e=t.toString().replace(B,"");return e.slice(e.indexOf("(")+1,e.indexOf(")")).match(j)||[]},isFunction:Y,executeInAWhile:q,executeNextVMTurn:Q,executeAfter:X,debounce:$,compose:function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e];return function(e){return t.reduce((function(t,e){return e(t)}),e)}},callIfPresent:Z});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v24.1.1
 * @link http://www.ag-grid.com/
 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function To(t,e,o){t.setAttribute(Ao(e),o.toString())}function _o(t,e){t.removeAttribute(Ao(e))}function Ao(t){return"aria-"+t}function Fo(t){return t.isSortAscending()?"ascending":t.isSortDescending()?"descending":"none"}function No(t){return parseInt(t.getAttribute("aria-posinset"),10)}function Lo(t,e){To(t,"label",e)}function Io(t,e){To(t,"labelledby",e)}function Mo(t,e){To(t,"describedby",e)}function Go(t,e){To(t,"disabled",e)}function xo(t,e){To(t,"expanded",e)}function Vo(t){_o(t,"expanded")}function Wo(t,e){To(t,"setsize",e)}function Ho(t,e){To(t,"posinset",e)}function ko(t,e){To(t,"multiselectable",e)}function Bo(t,e){To(t,"rowcount",e)}function jo(t,e){To(t,"rowindex",e)}function Uo(t,e){To(t,"colcount",e)}function zo(t,e){To(t,"colindex",e)}function Ko(t,e){To(t,"colspan",e)}function Yo(t,e){To(t,"sort",e)}function qo(t){_o(t,"sort")}function Qo(t,e){e?To(t,"selected",e):_o(t,"selected")}function Xo(t,e){To(t,"checked",void 0===e?"mixed":e)}var $o=Object.freeze({__proto__:null,getAriaSortState:Fo,getAriaLevel:function(t){return parseInt(t.getAttribute("aria-level"),10)},getAriaPosInSet:No,setAriaLabel:Lo,setAriaLabelledBy:Io,setAriaDescribedBy:Mo,setAriaLevel:function(t,e){To(t,"level",e)},setAriaDisabled:Go,setAriaExpanded:xo,removeAriaExpanded:Vo,setAriaSetSize:Wo,setAriaPosInSet:Ho,setAriaMultiSelectable:ko,setAriaRowCount:Bo,setAriaRowIndex:jo,setAriaColCount:Uo,setAriaColIndex:zo,setAriaColSpan:Ko,setAriaSort:Yo,removeAriaSort:qo,setAriaSelected:Qo,setAriaChecked:Xo});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v24.1.1
 * @link http://www.ag-grid.com/
