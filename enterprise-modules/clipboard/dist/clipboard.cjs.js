...
var ClipboardService = /** @class */ (function (_super) {
    ...
    ClipboardService.prototype.processClipboardData = function (data) {
        ...
        var parsedData = core._.stringToArray(data, this.gridOptionsWrapper.getClipboardDeliminator());
    ...
    ClipboardService.prototype.pasteIntoActiveRange = function (clipboardData, cellsToFlash, updatedRowNodes, changedPath) {
        ...
        var rowCallback = function (currentRow, rowNode, columns, index) {
            ...
            columns.forEach(function (column, idx) {
                ...
                _this.valueService.setValue(rowNode, column, newValue, core.Constants.SOURCE_PASTE);
                if (changedPath) {
            ...
            var rowCallback = function (currentRow, rowNode, columns) {
                ...
                if (!firstRowValues.length) {
                    ...
                    columns.forEach(function (column, index) {
                        ...
                        _this.valueService.setValue(rowNode, column, firstRowValue, core.Constants.SOURCE_PASTE);
                        if (changedPath) {
                            changedPath.addParentNode(rowNode.parent, [column]);
                        }
                        var cellId = _this.cellPositionUtils.createIdFromValues(currentRow.rowIndex, column, currentRow.rowPinned);
    ...
    ClipboardService.prototype.updateCellValue = function (rowNode, column, value, cellsToFlash, type, changedPath) {
        ...
        this.valueService.setValue(rowNode, column, processedValue, core.Constants.SOURCE_PASTE);
    ...
    ClipboardService.prototype.copySelectedRangeToClipboard = function (includeHeaders) {
        ...
        var rowCallback = function (currentRow, rowNode, columns, _2, isLastRow) {
            ...
            columns.forEach(function (column, index) {
                ...
                var processedValue = _this.processCell(rowNode, column, value, core.Constants.EXPORT_TYPE_CLIPBOARD, processCellForClipboardFunc);
                if (index != 0) {
                    data += deliminator;
                }
                if (core._.exists(processedValue)) {
                    data += processedValue;
                }
                var cellId = _this.cellPositionUtils.createIdFromValues(currentRow.rowIndex, column, currentRow.rowPinned);
                cellsToFlash[cellId] = true;
    ...
    ClipboardService.prototype.copyFocusedCellToClipboard = function (includeHeaders) {
        ...
        var processedValue = this.processCell(rowNode, column, value, core.Constants.EXPORT_TYPE_CLIPBOARD, this.gridOptionsWrapper.getProcessCellForClipboardFunc());
        processedValue = core._.missing(processedValue) ? '' : processedValue.toString();
        var data;
        if (includeHeaders) {
