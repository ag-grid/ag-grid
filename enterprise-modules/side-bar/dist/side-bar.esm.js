/**
 * @ag-grid-enterprise/side-bar - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.1.0
 * @link http://www.ag-grid.com/
' * @license Commercial
 */

import { Autowired, PostConstruct, Component, _, RefSelector, KeyCode, PreDestroy, ManagedFocusFeature, ModuleRegistry, ModuleNames, Events, Bean, BeanStub, ProvidedColumnGroup } from '@ag-grid-community/core';
...
var SideBarComp = /** @class */ (function (_super) {
    __extends$4(SideBarComp, _super);
    ...
    SideBarComp.prototype.handleKeyDown = function (e) {
        ...
        var currentPos = _.findIndex(buttons, function (button) { return button.contains(currentButton); });
        var nextPos = null;
        switch (e.keyCode) {
            case KeyCode.LEFT:
            case KeyCode.UP:
...
var ToolPanelColDefService = /** @class */ (function (_super) {
    __extends$5(ToolPanelColDefService, _super);
    ...
    ToolPanelColDefService = __decorate$5([
