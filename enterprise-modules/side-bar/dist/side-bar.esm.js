/**
 * @ag-grid-enterprise/side-bar - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.0.1
 * @link http://www.ag-grid.com/
' * @license Commercial
 */

import { Autowired, PostConstruct, Component, KeyCode, _, PreDestroy, RefSelector, ModuleRegistry, ModuleNames, Events, Bean, BeanStub, OriginalColumnGroup } from '@ag-grid-community/core';
...
var SideBarButtonsComp = /** @class */ (function (_super) {
    __extends$1(SideBarButtonsComp, _super);
    ...
    SideBarButtonsComp.prototype.handleKeyDown = function (e) {
        ...
        var prevEl = this.focusService.findNextFocusableElement(this.getFocusableElement(), null, true);
        if (!prevEl) {
...
var SideBarButtonComp = /** @class */ (function (_super) {
    __extends$1(SideBarButtonComp, _super);
...
var SideBarComp = /** @class */ (function (_super) {
    __extends$3(SideBarComp, _super);
...
var ToolPanelColDefService = /** @class */ (function (_super) {
    __extends$4(ToolPanelColDefService, _super);
    ...
    ToolPanelColDefService = __decorate$4([
