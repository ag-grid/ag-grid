...
exports.ToolPanelColDefService = void 0;
const core_1 = require("@ag-grid-community/core");
let ToolPanelColDefService = class ToolPanelColDefService extends core_1.BeanStub {
    constructor() {
        super(...arguments);
    ...
    createColumnTree(colDefs) {
        ...
        const createDummyColGroup = (abstractColDef, depth) => {
            if (this.isColGroupDef(abstractColDef)) {
                ...
                const group = new core_1.ProvidedColumnGroup(groupDef, groupId, false, depth);
                const children = [];
    ...
    addChildrenToGroup(tree, groupId, colDef) {
        const subGroupIsSplit = (currentSubGroup, currentSubGroupToAdd) => {
            ...
            const childGroupAlreadyExists = core_1._.includes(existingChildIds, this.getId(currentSubGroupToAdd));
            const lastChild = core_1._.last(currentSubGroup.children);
        ...
        if (currentGroup.groupId === groupId) {
            ...
            const colDefAlreadyPresent = core_1._.includes(existingChildIds, this.getId(groupToAdd));
