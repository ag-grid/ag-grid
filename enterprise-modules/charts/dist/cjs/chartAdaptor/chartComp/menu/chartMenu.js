...
var ChartMenu = /** @class */ (function (_super) {
    ...
    ChartMenu.prototype.createMenuPanel = function (defaultTab) {
        ...
        var menuPanel = this.menuPanel = this.wireBean(new core_1.AgPanel({
            minWidth: width,
            width: width,
            height: '100%',
            closable: true,
        ...
        this.tabbedMenu = this.wireBean(new tabbedChartMenu_1.TabbedChartMenu({
            controller: this.chartController,
            type: this.chartController.getChartType(),
            panels: this.tabs
        }));
        this.addDestroyableEventListener(menuPanel, core_1.Component.EVENT_DESTROYED, function () { return _this.tabbedMenu.destroy(); });
    ...
    ChartMenu.prototype.refreshMenuClasses = function () {
        core_1._.addOrRemoveCssClass(this.eChartContainer, 'ag-chart-menu-visible', this.menuVisible);
        core_1._.addOrRemoveCssClass(this.eChartContainer, 'ag-chart-menu-hidden', !this.menuVisible);
    };
