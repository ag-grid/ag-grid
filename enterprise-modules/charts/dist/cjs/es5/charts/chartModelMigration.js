...
var seriesTypeMapper_1 = require("./chartComp/utils/seriesTypeMapper");
var axisTypeMapper_1 = require("./chartComp/utils/axisTypeMapper");
// the line below is automatically modified during releases - do not modify
// (see scripts/release/updateChartModel.js)
exports.CURRENT_VERSION = '28.2.0';
var DEBUG = false;
function upgradeChartModel(model) {
    ...
    model = migrateIfBefore(exports.CURRENT_VERSION, model, function (m) { return m; });
...
function migrateV24(model) {
    ...
    var axesTypes = axisTypeMapper_1.getLegacyAxisType(chartType);
    var axes = (_a = axesTypes) === null || _a === void 0 ? void 0 : _a.map(function (type, i) { return (__assign({ type: type }, (i === 0 ? xAxis : yAxis))); });
    return __assign({ chartType: chartType, chartThemeName: (_b = LEGACY_PALETTES[chartPalette], (_b !== null && _b !== void 0 ? _b : 'ag-default')), chartOptions: __assign(__assign({}, chartOptions), { axes: axes,
            xAxis: xAxis,
...
function migrateV26_2(model) {
    ...
    // `area` series).
    var seriesTypes = [seriesTypeMapper_1.getSeriesType(chartType)];
    var chartTypeMixin = {};
    if (!seriesTypes.includes('pie')) {
        ...
        var updatedAxes_1 = axes
            ...
            .reduce(merge, {});
        axisTypeMapper_1.ALL_AXIS_TYPES.filter(function (v) { return updatedAxes_1[v] == null; }).forEach(function (v) {
...
function heuristicVersionDetection(model) {
    ...
    var _j = __read(matchingHints[0], 1), _k = _j[0], heuristicVersion = _k === void 0 ? defaultVersion : _k;
    if (DEBUG)
