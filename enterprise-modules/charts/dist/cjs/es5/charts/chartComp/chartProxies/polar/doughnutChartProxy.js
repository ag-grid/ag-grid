...
var DoughnutChartProxy = /** @class */ (function (_super) {
    ...
    DoughnutChartProxy.prototype.updateSeries = function (updateParams) {
        ...
        if (this.crossFiltering) {
            ...
            if (isOpaqueSeries) {
                pieSeries.fills = updateParams.fills.map(function (fill) { return color_1.hexToRGBA(fill, '0.3'); });
                pieSeries.strokes = updateParams.strokes.map(function (stroke) { return color_1.hexToRGBA(stroke, '0.3'); });
