...
var ChartProxy = /** @class */ (function () {
    ...
    ChartProxy.prototype.transformData = function (data, categoryKey) {
        var usingGroupedCategory = this.chartProxyParams.grouping || this.chart.axes.filter(function (a) { return a instanceof ag_charts_community_1.CategoryAxis; }).length < 1;
