...
var ChartProxy = /** @class */ (function () {
    function ChartProxy(chartProxyParams) {
        ...
        if (this.chartProxyParams.chartOptionsToRestore) {
            ...
            this.chartTheme = ag_charts_community_1.getIntegratedChartTheme(__assign({ baseTheme: this.getSelectedTheme() }, themeOverrides));
            return;
        }
    ...
    ChartProxy.prototype.createChartTheme = function () {
        ...
        if (gridOptionsThemeOverrides || apiThemeOverrides) {
            ...
            return ag_charts_community_1.getIntegratedChartTheme(stockTheme ? __assign({ baseTheme: themeName }, themeOverrides_1) : getCustomTheme());
        }
    ...
    ChartProxy.prototype.getCommonChartOptions = function () {
        ...
        var getChartOption = function (propertyKey) {
            return core_1._.get(_this.chartOptions, _this.standaloneChartType + "." + propertyKey, undefined);
        };
        return {
