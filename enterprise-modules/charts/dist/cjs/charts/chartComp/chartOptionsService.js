...
var chartThemeOverridesMapper_1 = require("./chartThemeOverridesMapper");
var ChartOptionsService = /** @class */ (function (_super) {
    ...
    ChartOptionsService.prototype.setChartOption = function (expression, value) {
        ...
        var optionsType = chartThemeOverridesMapper_1.getChartThemeOverridesObjectName(this.getChartType());
    ...
    ChartOptionsService.prototype.getSeriesOption = function (expression) {
        return core_1._.get(this.getChart().series[0], expression, undefined);
    };
    ChartOptionsService.prototype.setSeriesOption = function (expression, value) {
        // update series options
        var optionsType = chartThemeOverridesMapper_1.getChartThemeOverridesObjectName(this.getChartType());
        core_1._.set(this.getChartOptions()[optionsType].series, expression, value);
        // update chart
        this.getChart().series.forEach(function (s) { return core_1._.set(s, expression, value); });
        this.raiseChartOptionsChangedEvent();
    };
