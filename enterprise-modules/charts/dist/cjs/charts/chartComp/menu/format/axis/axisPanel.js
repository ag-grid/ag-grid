...
var AxisPanel = /** @class */ (function (_super) {
    ...
    AxisPanel.prototype.addAdditionalLabelComps = function (labelPanelComp) {
        ...
        var createLabelUpdateFunc = function (axisPosition) { return function (newValue) {
            ...
            var axis = ag_charts_community_1.find(chart.axes, function (currentAxis) { return currentAxis.position === axisPosition; });
            if (axis) {
        ...
        createAngleComp(xRotationLabel, "xAxis.label.rotation", createLabelUpdateFunc(ag_charts_community_1.ChartAxisPosition.Bottom));
        createAngleComp(yRotationLabel, "yAxis.label.rotation", createLabelUpdateFunc(ag_charts_community_1.ChartAxisPosition.Left));
