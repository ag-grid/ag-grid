...
var PieSeriesPanel = /** @class */ (function (_super) {
    ...
    PieSeriesPanel.prototype.initOpacity = function () {
        ...
        this.seriesLineOpacitySlider
            ...
            .setStep(0.05)
            .setMaxValue(formatPanel_1.getMaxValue(currentLineOpacityValue, 1))
            .setTextFieldWidth(45)
        ...
        this.seriesFillOpacitySlider
            ...
            .setStep(0.05)
            .setMaxValue(formatPanel_1.getMaxValue(currentFillOpacityValue, 1))
            .setTextFieldWidth(45)
    ...
    PieSeriesPanel.prototype.initLabelPanel = function () {
        ...
        var calloutPanelComp = this.createBean(new calloutPanel_1.CalloutPanel(this.chartOptionsService));
...
//# sourceMappingURL=pieSeriesPanel.js.map