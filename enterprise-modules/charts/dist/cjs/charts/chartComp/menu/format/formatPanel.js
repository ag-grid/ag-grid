    ...
    FormatPanel.prototype.createPanels = function () {
        ...
        switch (chartType) {
            ...
            case core_1.ChartType.NormalizedBar:
                ...
                this.addComponent(new barSeriesPanel_1.BarSeriesPanel(this.chartOptionsService));
            ...
            case core_1.ChartType.Doughnut:
                this.addComponent(new pieSeriesPanel_1.PieSeriesPanel(this.chartOptionsService));
                break;
            case core_1.ChartType.Line:
                this.addComponent(new axisPanel_1.AxisPanel(this.chartController, this.chartOptionsService));
                this.addComponent(new lineSeriesPanel_1.LineSeriesPanel(this.chartOptionsService));
                this.addComponent(new navigatorPanel_1.NavigatorPanel(this.chartOptionsService));
                break;
            case core_1.ChartType.Scatter:
            case core_1.ChartType.Bubble:
                this.addComponent(new axisPanel_1.AxisPanel(this.chartController, this.chartOptionsService));
                this.addComponent(new scatterSeriesPanel_1.ScatterSeriesPanel(this.chartOptionsService));
                this.addComponent(new navigatorPanel_1.NavigatorPanel(this.chartOptionsService));
                break;
            ...
            case core_1.ChartType.NormalizedArea:
                this.addComponent(new axisPanel_1.AxisPanel(this.chartController, this.chartOptionsService));
                this.addComponent(new areaSeriesPanel_1.AreaSeriesPanel(this.chartOptionsService));
                this.addComponent(new navigatorPanel_1.NavigatorPanel(this.chartOptionsService));
                break;
            case core_1.ChartType.Histogram:
                this.addComponent(new axisPanel_1.AxisPanel(this.chartController, this.chartOptionsService));
                this.addComponent(new histogramSeriesPanel_1.HistogramSeriesPanel(this.chartOptionsService));
                this.addComponent(new navigatorPanel_1.NavigatorPanel(this.chartOptionsService));
                break;
            default:
