...
var BarChartProxy = /** @class */ (function (_super) {
    ...
    BarChartProxy.prototype.getSeries = function (normalised) {
        var groupedCharts = [core_1.ChartType.GroupedColumn, core_1.ChartType.GroupedBar];
    ...
    BarChartProxy.prototype.isNormalised = function () {
        var normalisedCharts = [core_1.ChartType.NormalizedColumn, core_1.ChartType.NormalizedBar];
