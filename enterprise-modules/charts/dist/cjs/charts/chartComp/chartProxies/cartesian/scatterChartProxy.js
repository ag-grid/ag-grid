...
var ScatterChartProxy = /** @class */ (function (_super) {
    ...
    ScatterChartProxy.prototype.update = function (params) {
        ...
        seriesDefinitions.forEach(function (seriesDefinition, index) {
            ...
            var series = existingSeries || ag_charts_community_1.AgChart.createComponent(__assign(__assign({}, seriesDefaults), { type: 'scatter', fillOpacity: seriesDefaults.fill.opacity, strokeOpacity: seriesDefaults.stroke.opacity, strokeWidth: seriesDefaults.stroke.width, marker: marker, tooltip: {
