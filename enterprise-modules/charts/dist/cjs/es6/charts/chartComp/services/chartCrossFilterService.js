...
let ChartCrossFilterService = ChartCrossFilterService_1 = class ChartCrossFilterService extends core_1.BeanStub {
    ...
    updateFilters(filterModel, event) {
        ...
        if (event.event.metaKey || event.event.ctrlKey) {
            ...
            const valueAlreadyExists = core_1._.includes(existingGridValues, selectedValue);
            let updatedValues;
    ...
    getCurrentGridValuesForCategory(dataKey) {
        let filteredValues = [];
        const gridContainsValue = core_1._.includes;
