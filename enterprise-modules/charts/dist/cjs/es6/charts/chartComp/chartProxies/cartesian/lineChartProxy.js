    ...
    update(params) {
        ...
        fields.forEach((f, index) => {
            ...
            if (lineSeries) {
                ...
                const seriesOptions = Object.assign(Object.assign({}, seriesOverrides), { type: 'line', title: f.displayName, data, xKey: params.category.id, xName: params.category.name, yKey: yKey, yName: f.displayName, fill, stroke: fill, marker: Object.assign(Object.assign({}, seriesOverrides.marker), { fill,
                        stroke }) });
