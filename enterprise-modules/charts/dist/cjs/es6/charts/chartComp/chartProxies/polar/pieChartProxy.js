...
class PieChartProxy extends chartProxy_1.ChartProxy {
    ...
    getSeries(params) {
        ...
        const series = this.getFields(params).map((f) => {
            ...
            const options = Object.assign(Object.assign({}, seriesDefaults), { type: this.standaloneChartType, angleKey: f.colId, angleName: f.displayName, calloutLabelKey: params.category.id, calloutLabelName: params.category.name });
            if (this.chartType === 'doughnut') {
                ...
                return Object.assign(Object.assign({}, options), { outerRadiusOffset,
                    innerRadiusOffset, title: Object.assign(Object.assign({}, seriesDefaults.title), { text: seriesDefaults.title.text || f.displayName, showInLegend: numFields > 1 }), calloutLine: Object.assign(Object.assign({}, seriesDefaults.calloutLine), { colors: this.chartTheme.palette.strokes }) });
            }
            return options;
        });
    ...
    extractCrossFilterSeries(series) {
        ...
        const filteredOutOptions = (seriesOptions, angleKey) => {
            var _a, _b, _c;
            return Object.assign(Object.assign({}, object_1.deepMerge({}, primaryOpts)), { radiusKey: angleKey + '-filtered-out', calloutLabel: seriesOverrides.calloutLabel, calloutLine: seriesOverrides.calloutLine && Object.assign(Object.assign({}, seriesOverrides.calloutLine), { colors: (_a = seriesOverrides.calloutLine.colors, (_a !== null && _a !== void 0 ? _a : palette.strokes)) }), fills: color_1.changeOpacity((_b = seriesOptions.fills, (_b !== null && _b !== void 0 ? _b : palette.fills)), 0.3), strokes: color_1.changeOpacity((_c = seriesOptions.strokes, (_c !== null && _c !== void 0 ? _c : palette.strokes)), 0.3), showInLegend: false });
        };
    ...
    getCrossFilterTooltipRenderer(title) {
        return (params) => {
            const label = params.datum[params.calloutLabelKey];
