...
var MiniWaterfall = class extends MiniChartWithAxes {
  ...
  updateColors(fills, strokes, themeTemplate, isCustomTheme) {
    ...
    const positive = isCustomTheme ? palettePositive : themeTemplate?.get(import_ag_charts_community30._Theme.PALETTE_UP_STROKE) ?? palettePositive;
    const negative = isCustomTheme ? paletteNegative : themeTemplate?.get(import_ag_charts_community30._Theme.PALETTE_DOWN_STROKE) ?? paletteNegative;
    this.bars.forEach((bar, i) => {
