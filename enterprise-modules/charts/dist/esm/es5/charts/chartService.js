...
var ChartService = /** @class */ (function (_super) {
    ...
    ChartService.prototype.createRangeChart = function (params) {
        ...
        return this.createChart(cellRange, params.chartType, params.chartThemeName, false, params.suppressChartRanges, params.chartContainer, params.aggFunc, params.chartThemeOverrides, params.unlinkChart, undefined, undefined);
    };
