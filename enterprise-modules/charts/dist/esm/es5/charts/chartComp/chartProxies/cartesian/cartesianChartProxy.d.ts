...
export declare abstract class CartesianChartProxy extends ChartProxy {
    ...
    protected extractLineAreaCrossFilterSeries(series: (AgLineSeriesOptions | AgAreaSeriesOptions)[], params: UpdateChartParams): (AgLineSeriesOptions | AgAreaSeriesOptions)[];
