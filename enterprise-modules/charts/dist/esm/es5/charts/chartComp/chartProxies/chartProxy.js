...
var ChartProxy = /** @class */ (function () {
    ...
    ChartProxy.prototype.getCommonChartOptions = function () {
        ...
        this.clearThemeOverrides = false;
        return __assign(__assign({}, existingOptions), { theme: __assign(__assign({}, createAgChartTheme(this.chartProxyParams, this)), formattingPanelOverrides), container: this.chartProxyParams.parentElement });
    };
