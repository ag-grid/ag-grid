    ...
    LineChartProxy.prototype.update = function (params) {
        ...
        fields.forEach(function (f, index) {
            ...
            if (lineSeries) {
                ...
                var seriesOptions = __assign(__assign({}, seriesOverrides), { type: 'line', title: f.displayName, data: data, xKey: params.category.id, xName: params.category.name, yKey: yKey, yName: f.displayName, fill: fill, stroke: fill, marker: __assign(__assign({}, seriesOverrides.marker), { fill: fill,
                        stroke: stroke }) });
