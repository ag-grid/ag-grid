...
export class HistogramChartProxy extends CartesianChartProxy {
    ...
    getSeries(params) {
        ...
        return [Object.assign(Object.assign({}, this.extractSeriesOverrides()), { type: this.standaloneChartType, xKey: firstField.colId, xName: firstField.displayName, areaPlot: false })];
    }
    getAxes() {
