...
export class PieChartProxy extends ChartProxy {
    ...
    extractCrossFilterSeries(series) {
        ...
        const filteredOutOptions = (seriesOptions, angleKey) => {
            var _a, _b, _c;
            return Object.assign(Object.assign({}, deepMerge({}, primaryOpts)), { radiusKey: angleKey + '-filtered-out', calloutLabel: seriesOverrides.calloutLabel, calloutLine: seriesOverrides.calloutLine && Object.assign(Object.assign({}, seriesOverrides.calloutLine), { colors: (_a = seriesOverrides.calloutLine.colors, (_a !== null && _a !== void 0 ? _a : palette.strokes)) }), fills: changeOpacity((_b = seriesOptions.fills, (_b !== null && _b !== void 0 ? _b : palette.fills)), 0.3), strokes: changeOpacity((_c = seriesOptions.strokes, (_c !== null && _c !== void 0 ? _c : palette.strokes)), 0.3), showInLegend: false });
        };
