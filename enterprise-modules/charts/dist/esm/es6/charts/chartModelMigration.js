...
function migrateV24(model) {
    ...
    const _c = model, { chartType, chartPalette } = _c, // Migrate.
    _d = _c.chartOptions, // Migrate.
    { xAxis, yAxis } = _d, chartOptions = __rest(_d, ["xAxis", "yAxis"]), chartModel = __rest(_c, ["chartType", "chartPalette", "chartOptions"]);
    const axesTypes = getLegacyAxisType(chartType);
    const axes = (_a = axesTypes) === null || _a === void 0 ? void 0 : _a.map((type, i) => (Object.assign({ type }, (i === 0 ? xAxis : yAxis))));
    return Object.assign({ chartType, chartThemeName: (_b = LEGACY_PALETTES[chartPalette], (_b !== null && _b !== void 0 ? _b : 'ag-default')), chartOptions: Object.assign(Object.assign({}, chartOptions), { axes,
            xAxis,
            yAxis }) }, chartModel);
}
