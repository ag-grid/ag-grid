...
let ChartService = class ChartService extends BeanStub {
    ...
    getChartModels() {
        ...
        const versionedModel = (c) => {
            return Object.assign(Object.assign({}, c), { version: CURRENT_VERSION });
        };
    ...
    restoreChart(model, chartContainer) {
        ...
        if (model.modelType === 'pivot') {
            ...
            const chartAllRangeParams = { rowStartIndex: null, rowEndIndex: null, columns };
    ...
    createChart(cellRange, chartType, chartThemeName, pivotChart = false, suppressChartRanges = false, container, aggFunc, chartThemeOverrides, unlinkChart = false, crossFiltering = false, chartOptionsToRestore, seriesChartTypes) {
