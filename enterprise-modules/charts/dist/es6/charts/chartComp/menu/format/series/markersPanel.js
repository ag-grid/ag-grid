...
import { _, Autowired, ChartType, Component, PostConstruct, RefSelector } from "@ag-grid-community/core";
...
var MarkersPanel = /** @class */ (function (_super) {
    ...
    MarkersPanel.prototype.initMarkers = function () {
        ...
        var shouldHideEnabledCheckbox = _.includes([ChartType.Scatter, ChartType.Bubble], chartType);
