...
var ChartProxy = /** @class */ (function () {
    ...
    ChartProxy.prototype.getInitialChartTheme = function () {
        var _this = this;
        ...
        if (gridOptionsThemeOverrides || apiThemeOverrides) {
            ...
            theme = this.isStockTheme(themeName) ? __assign({ baseTheme: themeName }, themeOverrides_1) : getCustomTheme();
        }
        else {
    ...
    ChartProxy.prototype.getChartOption = function (expression) {
        return _.get(this.iChartOptions, expression, undefined);
    };
    ...
    ChartProxy.prototype.getSeriesOption = function (expression) {
        return _.get(this.iChartOptions.seriesDefaults, expression, undefined);
    };
