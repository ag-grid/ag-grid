...
var AreaChartProxy = /** @class */ (function (_super) {
    ...
    AreaChartProxy.prototype.update = function (params) {
        ...
        if (this.chartType === ChartType.Area) {
            ...
            if (!areaSeries) {
                var seriesDefaults = __assign(__assign({}, this.chartOptions[this.standaloneChartType].series), { type: 'area', normalizedTo: this.chartType === ChartType.NormalizedArea ? 100 : undefined });
    ...
    AreaChartProxy.prototype.updateAreaChart = function (params) {
        ...
        params.fields.forEach(function (f, index) {
            ...
            if (areaSeries) {
                ...
                var seriesDefaults = __assign(__assign({}, seriesOverrides), { type: 'area', normalizedTo: _this.chartType === ChartType.NormalizedArea ? 100 : undefined });
