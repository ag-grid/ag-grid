import formatLocale, { formatRe, pad, requote } from "./locale";
...
var defaultLocale = formatLocale(defaultLocaleDefinition);
var russianLocale = formatLocale(russianLocaleDefinition);
test('pad', function () {
...
test('formatRe', function () {
    var regExp = formatRe(['$Jan]', '|Feb.', 'Mar']);
