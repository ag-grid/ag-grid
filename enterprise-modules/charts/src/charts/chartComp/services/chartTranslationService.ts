...
export class ChartTranslationService extends BeanStub {
    public static readonly DEFAULT_TRANSLATIONS = {
        ...
        zoomAxisDragging: 'Zoom by Dragging an Axis',
        zoomScrolling: 'Zoom by Scrolling',
        zoomScrollingStep: 'Zoom Scrolling Step',
        zoomSelecting: 'Zoom by Selecting',
        animationDurationMillis: 'Animation Duration (ms)',
        crosshairLabel: 'Crosshair Label',
        crosshairSnap: 'Crosshair Snap to Node',
        crosshairWidth: 'Crosshair Width',
        crosshairDash: 'Crosshair Dash',
        crosshairDashOffset: 'Crosshair Dash Offset',
        ...
        navigatorMiniChart: 'Navigator Mini-Chart',
        navigatorRangeStart: 'Navigator Initial Range Start',
        navigatorRangeEnd: 'Navigator Initial Range End',
