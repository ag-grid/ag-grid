...
export class HierarchicalChartProxy<TSeries extends 'sunburst' | 'treemap'>  extends ChartProxy<AgHierarchyChartOptions, TSeries> {
    constructor(chartProxyParams: ChartProxyParams) {
        super(chartProxyParams);
    }
    
    protected override getUpdateOptions(params: UpdateParams, commonChartOptions: AgHierarchyChartOptions): AgHierarchyChartOptions {
        const { fields } = params;
