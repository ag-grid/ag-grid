import { AgAbstractLabel, AgInputNumberField, AgLabelParams, DragListenerParams, Events, RefSelector, _ } from "@ag-grid-community/core";
...
export class AgAngleSelect extends AgAbstractLabel<AgAngleSelectParams> {
    ...
    postConstruct() {
        ...
        this.beans.dragService.addDragSource(this.dragListener);
        ...
        this.addManagedListener(this, Events.EVENT_FIELD_VALUE_CHANGED, () => {
            if (this.eAngleValue.getInputElement().contains(this.beans.gos.getActiveDomElement())) {
                return;
            }
            this.updateNumberInput();
        });
    ...
    protected destroy(): void {
        this.beans.dragService.removeDragSource(this.dragListener);
        super.destroy();
    }
}
