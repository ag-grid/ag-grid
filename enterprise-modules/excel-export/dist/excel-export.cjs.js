/**
 * @ag-grid-enterprise/excel-export - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.2.0
...
var ExcelXmlFactory = /** @class */ (function () {
    ...
    ExcelXmlFactory.workbook = function (docProperties, eWorkbook, styles, currentWorksheet) {
        ...
        return core._.assign({}, workbook.getTemplate(), { children: children });
    };
    ...
    ExcelXmlFactory.styleXmlElement = function (styleProperties) {
        ...
        return core._.assign({}, style.getTemplate(styleProperties), { children: children });
    };
...
var BaseExcelSerializingSession = /** @class */ (function (_super) {
    ...
    function BaseExcelSerializingSession(config) {
        ...
        _this.rows = [];
        _this.config = core._.assign({}, config);
        _this.stylesByIds = {};
    ...
    BaseExcelSerializingSession.prototype.onNewHeaderGroupingRow = function () {
        ...
        return {
            onColumn: function (header, index, span) {
                var styleIds = _this.config.styleLinker(csvExport.RowType.HEADER_GROUPING, 1, "grouping-" + header, undefined, undefined);
    ...
    BaseExcelSerializingSession.prototype.isFormula = function (value) {
        ...
        return this.config.autoConvertFormulas && core._.startsWith(value.toString(), '=');
    };
    ...
    BaseExcelSerializingSession.prototype.onNewHeaderColumn = function (rowIndex, currentCells) {
        ...
        return function (column, index) {
            ...
            var styleIds = _this.config.styleLinker(csvExport.RowType.HEADER, rowIndex, nameForCol, column, undefined);
    ...
    BaseExcelSerializingSession.prototype.onNewBodyColumn = function (rowIndex, currentCells) {
        ...
        return function (column, index, node) {
            ...
            var styleIds = _this.config.styleLinker(csvExport.RowType.BODY, rowIndex, valueForCell, column, node);
...
var ExcelXmlSerializingSession = /** @class */ (function (_super) {
    __extends$1(ExcelXmlSerializingSession, _super);
...
var contentTypesFactory = {
    getTemplate: function (sheetLen) {
        var worksheets = core._.fill(new Array(sheetLen), undefined).map(function (v, i) { return ({
            name: 'Override',
        ...
        var imageDocs = core._.fill(new Array(sheetsWithImages), undefined).map(function (v, i) { return ({
            name: 'Override',
        ...
        var children = __spreadArrays$1(imageTypes, [
            {
                name: 'Default',
                Extension: 'rels',
...
var registerFill = function (fill) {
    ...
    var pos = core._.findIndex(registeredFills, function (currentFill) {
...
var registerNumberFmt = function (format) {
    ...
    var pos = core._.findIndex(registeredNumberFmts, function (currentFormat) { return currentFormat.formatCode === format; });
    if (pos === -1) {
...
var registerBorders = function (borders) {
    ...
    var pos = core._.findIndex(registeredBorders, function (currentBorder) {
...
var registerFont = function (font) {
    ...
    var pos = core._.findIndex(registeredFonts, function (currentFont) {
...
var cellFactory = {
    getTemplate: function (config, idx, currentSheet) {
        ...
        return core._.assign({}, obj, { children: children });
    }
};
    ...
    if (mergeMap.length) {
        for (var i = mergeMap.length - 1; i >= 0; i--) {
            ...
            if (mergedCells.length) {
                cells.splice.apply(cells, __spreadArrays$2([mergeMap[i].pos + 1, 0], mergedCells));
            }
        }
    }
};
...
var worksheetFactory = {
    getTemplate: function (params) {
        ...
        var createWorksheetChildren = core._.compose(addColumns(columns), addSheetData(rows, currentSheet + 1), addMergeCells(mergedCells), addPageMargins(margins), addPageSetup(pageSetup), addHeaderFooter(headerFooterConfig), addDrawingRel(currentSheet));
...
var ExcelXlsxFactory = /** @class */ (function () {
    ...
    ExcelXlsxFactory.buildImageMap = function (image, rowIndex, col, columnsToExport, rowHeight) {
        ...
        if (!image.position || !image.position.row || !image.position.column) {
            ...
            image.position = core._.assign({}, image.position, {
                row: rowIndex,
        ...
        if (registeredImage) {
            var currentSheetImages = core._.find(registeredImage, function (currentImage) { return currentImage.sheetId === currentSheetIndex; });
    ...
    ExcelXlsxFactory.createWorkbookRels = function (sheetLen) {
        ...
        var rs = relationshipsFactory.getTemplate(__spreadArrays$3(worksheets, [
            {
                Id: "rId" + (sheetLen + 1),
...
var ExcelXlsxSerializingSession = /** @class */ (function (_super) {
    __extends$2(ExcelXlsxSerializingSession, _super);
...
var getMultipleSheetsAsExcel = function (params) {
    ...
    ExcelXlsxFactory.resetFactory();
    return csvExport.ZipContainer.getContent('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
};
...
var ExcelCreator = /** @class */ (function (_super) {
    __extends$3(ExcelCreator, _super);
    ...
    ExcelCreator.prototype.styleLinker = function (rowType, rowIndex, value, column, node) {
        if (rowType === csvExport.RowType.HEADER) {
            return ["header"];
        }
        if (rowType === csvExport.RowType.HEADER_GROUPING) {
