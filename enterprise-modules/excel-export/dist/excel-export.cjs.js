/**
 * @ag-grid-enterprise/excel-export - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v27.0.0
...
var contentTypesFactory = {
    getTemplate: function (sheetLen) {
        ...
        var children = __spread$1(imageTypes, [
            {
                name: 'Default',
                Extension: 'rels',
...
var getColorChildren = function (props) {
    var _a = __read$2(props, 4), type = _a[0], innerType = _a[1], val = _a[2], lastClr = _a[3];
    return {
        name: "a:" + type,
        children: [{
                name: "a:" + innerType,
...
var getGs = function (props) {
    var _a = __read$4(props, 6), pos = _a[0], schemeColor = _a[1], satMod = _a[2], lumMod = _a[3], tint = _a[4], shade = _a[5];
    var children = [];
...
var getGradFill = function (props) {
    var _a = __read$4(props, 5), rotWithShape = _a[0], gs1 = _a[1], gs2 = _a[2], gs3 = _a[3], lin = _a[4];
    var _b = __read$4(lin, 2), ang = _b[0], scaled = _b[1];
    return {
        name: 'a:gradFill',
        properties: {
            rawMap: {
...
var getLine = function (props) {
    var _a = __read$4(props, 4), w = _a[0], cap = _a[1], cmpd = _a[2], algn = _a[3];
    return {
        name: 'a:ln',
        properties: {
...
var getEffectStyle = function (shadow) {
    var children = [];
    if (shadow) {
        var _a = __read$4(shadow, 5), blurRad = _a[0], dist = _a[1], dir = _a[2], algn = _a[3], rotWithShape = _a[4];
        children.push({
            name: 'a:outerShdw',
            properties: {
    ...
    if (mergeMap.length) {
        for (var i = mergeMap.length - 1; i >= 0; i--) {
            ...
            if (mergedCells.length) {
                cells.splice.apply(cells, __spread$2([mergeMap[i].pos + 1, 0], mergedCells));
            }
        }
    }
};
...
var ExcelXlsxFactory = /** @class */ (function () {
    ...
    ExcelXlsxFactory.createWorkbookRels = function (sheetLen) {
        ...
        var rs = relationshipsFactory.getTemplate(__spread$3(worksheets, [
            {
                Id: "rId" + (sheetLen + 1),
