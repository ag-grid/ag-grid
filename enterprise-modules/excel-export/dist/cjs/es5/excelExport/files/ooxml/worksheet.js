...
var worksheetFactory = {
    getTemplate: function (params) {
        ...
        var createWorksheetChildren = core_1._.compose(addColumns(columns), addSheetData(rows, currentSheet + 1), addMergeCells(mergedCells), addPageMargins(margins), addPageSetup(pageSetup), addHeaderFooter(headerFooterConfig), addDrawingRel(currentSheet));
