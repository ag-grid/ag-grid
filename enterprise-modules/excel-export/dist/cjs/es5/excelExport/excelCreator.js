...
var ExcelCreator = /** @class */ (function (_super) {
    ...
    ExcelCreator.prototype.styleLinker = function (params) {
        ...
        if (isHeader || isGroupHeader) {
            ...
            if (col) {
                headerClasses = headerClasses.concat(core_1.CssClassApplier.getHeaderClassesFromColDef(col.getDefinition(), this.gridOptionsWrapper, column || null, columnGroup || null));
            }
