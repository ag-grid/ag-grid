...
var ExcelXlsxFactory = /** @class */ (function () {
    ...
    ExcelXlsxFactory.buildImageMap = function (image, rowIndex, col, columnsToExport, rowHeight) {
        ...
        if (!image.position || !image.position.row || !image.position.column) {
            ...
            image.position = core_1._.assign({}, image.position, {
                row: rowIndex,
        ...
        if (registeredImage) {
            var currentSheetImages = core_1._.find(registeredImage, function (currentImage) { return currentImage.sheetId === currentSheetIndex; });
