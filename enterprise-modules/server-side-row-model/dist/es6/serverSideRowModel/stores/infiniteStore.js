...
import { _, Autowired, BeanStub, Events, NumberSequence, PostConstruct, PreDestroy, ServerSideTransactionResultStatus, Qualifier } from "@ag-grid-community/core";
...
var InfiniteStore = /** @class */ (function (_super) {
    ...
    InfiniteStore.prototype.onBlockLoaded = function (block, params) {
        ...
        var finalRowCount = params.finalRowCount != null && params.finalRowCount >= 0 ? params.finalRowCount : undefined;
    ...
    InfiniteStore.prototype.purgeBlocksIfNeeded = function (blockToExclude) {
        ...
        blocksForPurging.forEach(function (block, index) {
            var purgeBecauseBlockEmpty = block.getState() === CacheBlock.STATE_WAITING_TO_LOAD && index >= emptyBlocksToKeep;
    ...
    InfiniteStore.prototype.purgeStore = function (suppressEvent) {
        var _this = this;
    ...
    InfiniteStore.prototype.createBlock = function (blockNumber, displayIndex, nextRowTop) {
        var block = this.createBean(new CacheBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
    ...
    InfiniteStore.prototype.refreshAfterFilter = function () {
    ...
    InfiniteStore.prototype.refreshAfterSort = function (params) {
        ...
        var grouping = level < this.ssrmParams.rowGroupCols.length;
        if (!grouping) {
            this.purgeStore(true);
            return;
        }
        var colIdThisGroup = this.ssrmParams.rowGroupCols[level].id;
        var sortingByThisGroup = params.changedColumnsInSort.indexOf(colIdThisGroup) > -1;
    ...
    ], InfiniteStore.prototype, "gridOptionsWrapper", void 0);
    __decorate([
        Autowired('rowNodeBlockLoader')
    ], InfiniteStore.prototype, "rowNodeBlockLoader", void 0);
    __decorate([
        Autowired('ssrmCacheUtils')
    ], InfiniteStore.prototype, "cacheUtils", void 0);
    __decorate([
        Autowired('columnController')
    ], InfiniteStore.prototype, "columnController", void 0);
    __decorate([
        PostConstruct
