...
export class InfiniteStore extends BeanStub {
    ...
    createBlock(blockNumber, displayIndex, nextRowTop) {
        const block = this.createBean(new InfiniteStoreBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
