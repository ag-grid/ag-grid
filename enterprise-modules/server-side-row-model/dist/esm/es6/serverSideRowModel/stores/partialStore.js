...
export class PartialStore extends BeanStub {
    ...
    createBlock(blockNumber, displayIndex, nextRowTop) {
        const block = this.createBean(new PartialStoreBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
