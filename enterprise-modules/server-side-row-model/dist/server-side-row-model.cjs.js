/**
          * @ag-grid-enterprise/server-side-row-model - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v29.1.0
...
var LazyBlockLoader = /** @class */ (function (_super) {
    __extends$9(LazyBlockLoader, _super);
    ...
    LazyBlockLoader.prototype.getBlocksToLoad = function () {
        ...
        this.cache.getNodeMapEntries().forEach(function (_a) {
            var _b = __read$3(_a, 2), stringIndex = _b[0]; _b[1];
    ...
    LazyBlockLoader.prototype.getNextBlockToLoad = function () {
        ...
        toLoad.sort(function (_a, _b) {
            var _c = __read$3(_a, 2), aStart = _c[0], aEnd = _c[1];
            var _d = __read$3(_b, 2), bStart = _d[0], bEnd = _d[1];
    ...
    LazyBlockLoader.prototype.queueLoadAction = function () {
        ...
        if (!this.nextBlockToLoad || (this.nextBlockToLoad[0] !== nextBlockToLoad[0] && this.nextBlockToLoad[1] !== nextBlockToLoad[1])) {
            ...
            window.clearTimeout(this.loaderTimeout);
            var _b = __read$3(this.nextBlockToLoad, 2), startRowString = _b[0], endRow_1 = _b[1];
...
var LazyCache = /** @class */ (function (_super) {
    ...
    LazyCache.prototype.getRowByDisplayIndex = function (displayIndex) {
        ...
        for (var i = 0; i < nodeMapEntries.length; i++) {
            var _b = __read$2(nodeMapEntries[i], 2), stringIndex = _b[0], node = _b[1];
    ...
    LazyCache.prototype.setDisplayIndexes = function (displayIndexSeq, nextRowTop) {
        ...
        nodeEntries.forEach(function (_a) {
            var _b = __read$2(_a, 2), stringIndex = _b[0], node = _b[1];
            var numericIndex = Number(stringIndex);
    ...
    LazyCache.prototype.getDisplayIndexFromStoreIndex = function (storeIndex) {
        ...
        for (var i = 0; i < allNodes.length; i++) {
            var _b = __read$2(allNodes[i], 2), stringNodeStoreIndex = _b[0], node = _b[1];
    ...
    LazyCache.prototype.createRowAtIndex = function (atStoreIndex, data, createNodeCallback) {
        ...
        if (data && usingRowIds) {
            ...
            var existingNodeDetails = allNodes.find(function (_a) {
                var _b = __read$2(_a, 2); _b[0]; var node = _b[1];
                return _this.doesNodeMatch(data, node);
            });
            if (existingNodeDetails) {
                var _a = __read$2(existingNodeDetails, 2), existingStringIndex = _a[0], existingNode = _a[1];
    ...
    LazyCache.prototype.getBlockStates = function () {
        ...
        this.getNodeMapEntries().forEach(function (_a) {
            var _b;
            var _c = __read$2(_a, 2), stringIndex = _c[0], node = _c[1];
        ...
        Object.entries(blockStates).forEach(function (_a) {
            var _b;
            var _c = __read$2(_a, 2), blockStart = _c[0], uniqueStates = _c[1];
            var sortedStates = __spread$1(uniqueStates).sort(function (a, b) { var _a, _b; return ((_a = statePriorityMap[a]) !== null && _a !== void 0 ? _a : 0) - ((_b = statePriorityMap[b]) !== null && _b !== void 0 ? _b : 0); });
    ...
    LazyCache.prototype.markBlockForVerify = function (rowIndex) {
        var _a = __read$2(this.rowLoader.getBlockBoundsForIndex(rowIndex), 2), start = _a[0], end = _a[1];
    ...
    LazyCache.prototype.purgeStubsOutsideOfViewport = function () {
        ...
        var _a = __read$2(this.rowLoader.getBlockBoundsForIndex(lastRow), 2); _a[0]; var lastRowBlockEnd = _a[1];
        this.getNodeMapEntries().forEach(function (_a) {
            var _b = __read$2(_a, 2), stringIndex = _b[0], node = _b[1];
            var numericIndex = Number(stringIndex);
    ...
    LazyCache.prototype.getBlocksDistanceFromRow = function (nodes, otherDisplayIndex) {
        ...
        nodes.forEach(function (_a) {
            var _b = __read$2(_a, 2), storeIndexString = _b[0], node = _b[1];
            var _c = __read$2(_this.rowLoader.getBlockBoundsForIndex(Number(storeIndexString)), 2), blockStart = _c[0], blockEnd = _c[1];
    ...
    LazyCache.prototype.purgeExcessRows = function () {
        ...
        var _a = __read$2(this.rowLoader.getBlockBoundsForIndex(lastRowInViewport), 2); _a[0]; var lastRowBlockEnd = _a[1];
    ...
    LazyCache.prototype.insertRowNodes = function (inserts, indexToAdd) {
        ...
        for (var i = allNodes.length - 1; i >= 0; i--) {
            var _a = __read$2(allNodes[i], 2), stringStoreIndex = _a[0], node = _a[1];
...
var ServerSideRowModel = /** @class */ (function (_super) {
    __extends$6(ServerSideRowModel, _super);
    ...
    ServerSideRowModel = __decorate$9([
        core.Bean('rowModel')
    ], ServerSideRowModel);
...
var TransactionManager = /** @class */ (function (_super) {
    ...
    TransactionManager = __decorate$5([
...
var ExpandListener = /** @class */ (function (_super) {
    __extends$2(ExpandListener, _super);
...
var SortListener = /** @class */ (function (_super) {
    __extends$1(SortListener, _super);
