...
var LazyBlockLoadingService = class extends import_core2.BeanStub {
  ...
  init() {
    this.addManagedListener(this.rowNodeBlockLoader, import_core2.RowNodeBlockLoader.BLOCK_LOADED_EVENT, () => this.queueLoadAction());
  }
  subscribe(cache) {
...
var ExpandListener = class extends import_core10.BeanStub {
  ...
  onRowGroupOpened(event) {
    ...
    } else if (this.gridOptionsService.get("purgeClosedRowNodes") && import_core10._.exists(rowNode.childStore)) {
