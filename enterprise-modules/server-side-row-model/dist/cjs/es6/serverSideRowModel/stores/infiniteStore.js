...
const infiniteStoreBlock_1 = require("../blocks/infiniteStoreBlock");
var FindResult;
(function (FindResult) {
...
class InfiniteStore extends core_1.BeanStub {
    ...
    purgeBlocksIfNeeded(blockToExclude) {
        ...
        blocksForPurging.forEach((block, index) => {
            const purgeBecauseBlockEmpty = block.getState() === infiniteStoreBlock_1.InfiniteStoreBlock.STATE_WAITING_TO_LOAD && index >= emptyBlocksToKeep;
    ...
    createBlock(blockNumber, displayIndex, nextRowTop) {
        const block = this.createBean(new infiniteStoreBlock_1.InfiniteStoreBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
