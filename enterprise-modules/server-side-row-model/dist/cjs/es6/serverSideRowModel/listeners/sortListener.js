...
let SortListener = class SortListener extends core_1.BeanStub {
    ...
    removeMultiColumnPrefixOnColumnIds(sortModel) {
        if (this.gridOptionsWrapper.isGroupMultiAutoColumn()) {
            const multiColumnPrefix = core_1.Constants.GROUP_AUTO_COLUMN_ID + "-";
    ...
    replaceAutoGroupColumnWithActualRowGroupColumns(sortModel) {
        ...
        const autoGroupSortModel = sortModel.find(sm => sm.colId == core_1.Constants.GROUP_AUTO_COLUMN_ID);
