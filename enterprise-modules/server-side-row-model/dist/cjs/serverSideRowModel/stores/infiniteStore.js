...
var cacheBlock_1 = require("../blocks/cacheBlock");
var FindResult;
(function (FindResult) {
...
var InfiniteStore = /** @class */ (function (_super) {
    ...
    InfiniteStore.prototype.purgeBlocksIfNeeded = function (blockToExclude) {
        ...
        blocksForPurging.forEach(function (block, index) {
            var purgeBecauseBlockEmpty = block.getState() === cacheBlock_1.CacheBlock.STATE_WAITING_TO_LOAD && index >= emptyBlocksToKeep;
    ...
    InfiniteStore.prototype.createBlock = function (blockNumber, displayIndex, nextRowTop) {
        var block = this.createBean(new cacheBlock_1.CacheBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
    ...
    InfiniteStore.prototype.refreshAfterSort = function (params) {
        ...
        this.getBlocksInOrder().forEach(function (block) {
            if (block.isGroupLevel()) {
                ...
                block.forEachNodeShallow(callback, new core_1.NumberSequence());
            }
        });
    };
