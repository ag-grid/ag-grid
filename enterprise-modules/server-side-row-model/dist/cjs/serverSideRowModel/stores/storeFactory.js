...
var clientSideStore_1 = require("./clientSideStore");
...
var StoreFactory = /** @class */ (function () {
    ...
    StoreFactory.prototype.createStore = function (ssrmParams, parentNode) {
        ...
        var CacheClass = storeParams.storeType === core_1.ServerSideStoreType.ClientSide ? clientSideStore_1.ClientSideStore : infiniteStore_1.InfiniteStore;
    ...
    StoreFactory.prototype.getMaxBlocksInCache = function (storeType, ssrmParams, userStoreParams) {
        if (storeType == core_1.ServerSideStoreType.ClientSide) {
            return undefined;
        }
    ...
    StoreFactory.prototype.getStoreType = function (storeParams) {
        ...
        switch (storeType) {
            case core_1.ServerSideStoreType.Infinite:
            case core_1.ServerSideStoreType.ClientSide:
                return storeType;
            case null:
            case undefined:
                return core_1.ServerSideStoreType.Infinite;
            default:
