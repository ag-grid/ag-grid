...
var ClientSideStore = /** @class */ (function (_super) {
    ...
    ClientSideStore.prototype.processServerResult = function (params) {
        ...
        if (params.info) {
            core_1._.assign(this.info, params.info);
        }
        this.destroyRowNodes();
    ...
    ClientSideStore.prototype.getChildStore = function (keys) {
        ...
        return this.cacheUtils.getChildStore(keys, this, function (key) {
            var rowNode = core_1._.find(_this.allRowNodes, function (currentRowNode) { return currentRowNode.key === key; });
            return rowNode;
        });
    };
    ...
    ClientSideStore.prototype.lookupRowNode = function (data) {
        ...
        if (core_1._.exists(rowNodeIdFunc)) {
            ...
            rowNode = core_1._.find(this.allRowNodes, function (currentRowNode) { return currentRowNode.data === data; });
            if (!rowNode) {
...
exports.ClientSideStore = ClientSideStore;
//# sourceMappingURL=clientSideStore.js.map