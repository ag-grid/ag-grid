...
var BlockUtils = /** @class */ (function (_super) {
    ...
    BlockUtils.prototype.clearDisplayIndex = function (rowNode) {
        rowNode.clearRowTop();
        rowNode.setRowIndex();
        var hasChildStore = rowNode.group && core_1._.exists(rowNode.childrenCache);
        if (hasChildStore) {
    ...
    BlockUtils.prototype.binarySearchForDisplayIndex = function (displayRowIndex, rowNodes) {
        ...
        while (true) {
            ...
            var childStore = currentRowNode.childrenCache;
    ...
    ], BlockUtils.prototype, "gridOptionsWrapper", void 0);
    __decorate([
