...
var ServerSideRowModel = /** @class */ (function (_super) {
    ...
    ServerSideRowModel.prototype.verifyProps = function () {
        if (this.gridOptionsWrapper.getDefaultGroupOrderComparator() != null) {
            ...
            core_1._.doOnce(function () { return console.warn(message_1); }, 'SSRM.DefaultGroupOrderComparator');
        }
        if (this.gridOptionsWrapper.isRowSelection() && this.gridOptionsWrapper.getRowNodeIdFunc() == null) {
            var message_2 = "AG Grid: getRowNodeId callback must be provided for Server Side Row Model selection to work correctly.";
