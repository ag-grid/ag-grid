...
var infiniteStoreBlock_1 = require("../blocks/infiniteStoreBlock");
var FindResult;
(function (FindResult) {
...
var InfiniteStore = /** @class */ (function (_super) {
    ...
    InfiniteStore.prototype.purgeBlocksIfNeeded = function (blockToExclude) {
        ...
        blocksForPurging.forEach(function (block, index) {
            var purgeBecauseBlockEmpty = block.getState() === infiniteStoreBlock_1.InfiniteStoreBlock.STATE_WAITING_TO_LOAD && index >= emptyBlocksToKeep;
    ...
    InfiniteStore.prototype.createBlock = function (blockNumber, displayIndex, nextRowTop) {
        var block = this.createBean(new infiniteStoreBlock_1.InfiniteStoreBlock(blockNumber, this.parentRowNode, this.ssrmParams, this.storeParams, this));
