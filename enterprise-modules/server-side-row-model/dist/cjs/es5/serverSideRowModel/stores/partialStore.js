...
var partialStoreBlock_1 = require("../blocks/partialStoreBlock");
var FindResult;
(function (FindResult) {
...
var PartialStore = /** @class */ (function (_super) {
    ...
    PartialStore.prototype.purgeBlocksIfNeeded = function (blockToExclude) {
        ...
        blocksForPurging.forEach(function (block, index) {
            var purgeBecauseBlockEmpty = block.getState() === partialStoreBlock_1.PartialStoreBlock.STATE_WAITING_TO_LOAD && index >= emptyBlocksToKeep;
    ...
    PartialStore.prototype.getBlocksInOrder = function () {
        ...
        var blocks = core_1._.getAllValuesInObject(this.blocks).sort(blockComparator);
        return blocks;
    };
