/**
 * @ag-grid-enterprise/server-side-row-model - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.0.0
 * @link http://www.ag-grid.com/
' * @license Commercial
 */

import { Events, _, RowNode, NumberSequence, Constants, Autowired, PreDestroy, Qualifier, PostConstruct, Bean, BeanStub, ServerSideTransactionResultStatus, RowNodeBlock, ServerSideStoreType, ModuleNames } from '@ag-grid-community/core';
...
var TransactionManager = /** @class */ (function (_super) {
    __extends$3(TransactionManager, _super);
    ...
    TransactionManager = __decorate$4([
...
var ExpandListener = /** @class */ (function (_super) {
    __extends$4(ExpandListener, _super);
...
var FilterListener = /** @class */ (function (_super) {
    __extends$6(FilterListener, _super);
...
var PartialStoreBlock = /** @class */ (function (_super) {
    __extends$7(PartialStoreBlock, _super);
...
var PartialStore = /** @class */ (function (_super) {
    __extends$8(PartialStore, _super);
