/**
          * @ag-grid-enterprise/range-selection - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v28.2.0
    ...
    FillHandle.prototype.processValues = function (event, values, initialValues, col, rowNode, idx) {
        ...
        if (event.altKey || !allNumbers) {
            if (allNumbers && initialValues.length === 1) {
                ...
                return { value: parseFloat(core._.last(processedValues)) + 1 * multiplier, fromUserFunction: false };
            }
            return { value: processedValues[idx % processedValues.length], fromUserFunction: false };
        }
        return { value: core._.last(core._.findLineByLeastSquares(processedValues.map(Number))), fromUserFunction: false };
    };
