...
var RangeService = /** @class */ (function (_super) {
    ...
    RangeService.prototype.init = function () {
        var _this = this;
        this.addManagedListener(this.eventService, core.Events.EVENT_NEW_COLUMNS_LOADED, function () { return _this.removeAllCellRanges(); });
        ...
        this.addManagedListener(this.eventService, core.Events.EVENT_COLUMN_VISIBLE, this.onColumnVisibleChange.bind(this));
    ...
    RangeService.prototype.setRangeToCell = function (cell, appendRange) {
        ...
        if (cellRange) {
            ...
            if (core._.last(this.cellRanges) !== cellRange) {
                core._.removeFromArray(this.cellRanges, cellRange);
...
var AutoScrollService = /** @class */ (function () {
    ...
    AutoScrollService.prototype.check = function (mouseEvent, skipVerticalScroll) {
        ...
        skipVerticalScroll = skipVerticalScroll || this.gridOptionsWrapper.getDomLayout() !== core.Constants.DOM_LAYOUT_NORMAL;
...
var AbstractSelectionHandle = /** @class */ (function (_super) {
    ...
    AbstractSelectionHandle.prototype.init = function () {
        ...
        this.dragService.addDragSource({
            ...
            onDragStop: function (e) {
                ...
                core._.removeCssClass(document.body, _this.getDraggingCssClass());
    ...
    AbstractSelectionHandle.prototype.onDragStart = function (e) {
        ...
        core._.addCssClass(document.body, this.getDraggingCssClass());
    };
    ...
    FillHandle.prototype.processValues = function (event, values, initialValues, col, rowNode, idx) {
        ...
        if (event.altKey || !allNumbers) {
            if (allNumbers && initialValues.length === 1) {
                ...
                return parseFloat(core._.last(values)) + 1 * multiplier;
            }
            return values[idx % values.length];
        }
        return core._.last(core._.findLineByLeastSquares(values.map(Number)));
    };
