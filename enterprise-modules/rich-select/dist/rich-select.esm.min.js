/**
 * @ag-grid-enterprise/rich-select - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v25.1.0
 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function To(t,e,o){t.setAttribute(_o(e),o.toString())}function Ao(t,e){t.removeAttribute(_o(e))}function _o(t){return"aria-"+t}function Fo(t){return t.isSortAscending()?"ascending":t.isSortDescending()?"descending":"none"}function No(t){return parseInt(t.getAttribute("aria-posinset"),10)}function Lo(t){return t.getAttribute("aria-describedby")||""}function Io(t,e){To(t,"label",e)}function Go(t,e){To(t,"labelledby",e)}function Mo(t,e){To(t,"describedby",e)}function xo(t,e){To(t,"disabled",e)}function Vo(t,e){To(t,"expanded",e)}function Ho(t){Ao(t,"expanded")}function Wo(t,e){To(t,"setsize",e)}function ko(t,e){To(t,"posinset",e)}function Bo(t,e){To(t,"multiselectable",e)}function Uo(t,e){To(t,"rowcount",e)}function jo(t,e){To(t,"rowindex",e)}function zo(t,e){To(t,"colcount",e)}function Ko(t,e){To(t,"colindex",e)}function Yo(t,e){To(t,"colspan",e)}function qo(t,e){To(t,"sort",e)}function Xo(t){Ao(t,"sort")}function Qo(t,e){e?To(t,"selected",e):Ao(t,"selected")}function $o(t,e){To(t,"checked",void 0===e?"mixed":e)}var Zo=Object.freeze({__proto__:null,getAriaSortState:Fo,getAriaLevel:function(t){return parseInt(t.getAttribute("aria-level"),10)},getAriaPosInSet:No,getAriaDescribedBy:Lo,setAriaLabel:Io,setAriaLabelledBy:Go,setAriaDescribedBy:Mo,setAriaLevel:function(t,e){To(t,"level",e)},setAriaDisabled:xo,setAriaExpanded:Vo,removeAriaExpanded:Ho,setAriaSetSize:Wo,setAriaPosInSet:ko,setAriaMultiSelectable:Bo,setAriaRowCount:Uo,setAriaRowIndex:jo,setAriaColCount:zo,setAriaColIndex:Ko,setAriaColSpan:Yo,setAriaSort:qo,removeAriaSort:Xo,setAriaSelected:Qo,setAriaChecked:$o});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v25.1.0
 * @link http://www.ag-grid.com/
