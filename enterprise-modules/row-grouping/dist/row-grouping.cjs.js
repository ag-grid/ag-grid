/**
          * @ag-grid-enterprise/row-grouping - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v29.1.0
        ...
        if (column && !column.isVisible()) {
            ...
            if (compDetails) {
                if (!this.columnVisibleChangedListener) {
                    this.columnVisibleChangedListener = this.addManagedListener(column, core.Column.EVENT_VISIBLE_CHANGED, this.onColumnVisibleChanged.bind(this));
                }
