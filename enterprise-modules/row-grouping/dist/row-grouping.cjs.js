/**
          * @ag-grid-enterprise/row-grouping - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v28.0.0
...
var DropZoneColumnComp = /** @class */ (function (_super) {
    ...
    DropZoneColumnComp.prototype.setupAria = function () {
        ...
        var aggSeperator = translate('ariaDropZoneColumnComponentAggFuncSeperator', ' of ');
        var sortDirection = {
...
var BaseDropZonePanel = /** @class */ (function (_super) {
    ...
    BaseDropZonePanel.prototype.onDragLeave = function (draggingEvent) {
        ...
        if (this.isPotentialDndColumns()) {
            var hideColumnOnExit = this.isRowGroupPanel() && !this.gridOptionsWrapper.isSuppressMakeColumnVisibleAfterUnGroup() && !draggingEvent.fromNudge;
            if (hideColumnOnExit) {
                var dragItem_1 = draggingEvent.dragSource.getDragItem();
                var hiddenCols = this.potentialDndColumns.filter(function (col) { var _a, _b; return _b = (_a = dragItem_1.visibleState) === null || _a === void 0 ? void 0 : _a[col.getId()], (_b !== null && _b !== void 0 ? _b : false); });
                var visibleCols = this.potentialDndColumns.filter(function (col) { var _a, _b; return !(_b = (_a = dragItem_1.visibleState) === null || _a === void 0 ? void 0 : _a[col.getId()], (_b !== null && _b !== void 0 ? _b : false)); });
