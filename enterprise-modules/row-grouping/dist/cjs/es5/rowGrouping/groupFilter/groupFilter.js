...
var GroupFilter = /** @class */ (function (_super) {
    ...
    GroupFilter.prototype.init = function (params) {
        ...
        return this.updateGroups().then(function () {
            _this.addManagedListener(_this.eventService, core_1.Events.EVENT_COLUMN_ROW_GROUP_CHANGED, function () { return _this.onColumnRowGroupChanged(); });
        });
    };
    ...
    GroupFilter.prototype.getUnderlyingFilters = function (sourceColumns) {
        ...
        return core_1.AgPromise.all(filterPromises).then(function () {
