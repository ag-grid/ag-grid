...
let PivotColDefService = PivotColDefService_1 = class PivotColDefService extends core_1.BeanStub {
    ...
    recursivelyAddGroup(parentChildren, pivotColumnDefs, index, uniqueValues, pivotKeys, levelsDeep, primaryPivotColumns) {
        core_1._.iterateObject(uniqueValues, (key, value) => {
    ...
    createRowGroupTotal(parentChildren, pivotColumnDefs, pivotKeys, valueColumn, colIds, insertAfter) {
    ...
    createColDef(valueColumn, headerName, pivotKeys) {
        const colDef = {};
