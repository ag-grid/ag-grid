...
__decorateClass([
  (0, import_core3.Autowired)("gridOptionsService")
...
var RowGroupDropZonePanel = class extends BaseDropZonePanel {
  ...
  passBeansUp() {
    ...
    super.init({
      icon: import_core8._.createIconNoSpan("rowGroupPanel", this.gridOptionsService, null),
      emptyMessage,
      title
    });
...
var PivotDropZonePanel = class extends BaseDropZonePanel {
  ...
  passBeansUp() {
    ...
    super.init({
      icon: import_core9._.createIconNoSpan("pivotPanel", this.gridOptionsService, null),
      emptyMessage,
      title
    });
...
var ValuesDropZonePanel = class extends BaseDropZonePanel {
  ...
  passBeansUp() {
    ...
    super.init({
      icon: import_core16._.createIconNoSpan("valuePanel", this.gridOptionsService, null),
      emptyMessage,
      title
    });
