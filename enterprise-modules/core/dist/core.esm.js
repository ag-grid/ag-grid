...
import { _, Autowired, PreConstruct, Bean, BeanStub, PostConstruct, RefSelector, Component, ModuleNames } from '@ag-grid-community/core';
...
var LicenseManager = /** @class */ (function (_super) {
    ...
    LicenseManager.RELEASE_INFORMATION = 'MTYzMjgzMjEzNDg4Mw==';
    __decorate([
        Autowired('md5')
...
export { EnterpriseCoreModule, LicenseManager };
