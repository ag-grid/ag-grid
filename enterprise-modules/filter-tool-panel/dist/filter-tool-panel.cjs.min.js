 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function Do(t,e,o){t.setAttribute(_o(e),o.toString())}function Ao(t,e){t.removeAttribute(_o(e))}function _o(t){return"aria-"+t}function Fo(t){return t.isSortAscending()?"ascending":t.isSortDescending()?"descending":"none"}function No(t){return parseInt(t.getAttribute("aria-posinset"),10)}function Lo(t){return t.getAttribute("aria-describedby")||""}function Io(t,e){Do(t,"label",e)}function Go(t,e){Do(t,"labelledby",e)}function Mo(t,e){Do(t,"describedby",e)}function xo(t,e){Do(t,"disabled",e)}function Vo(t,e){Do(t,"expanded",e)}function Ho(t){Ao(t,"expanded")}function Wo(t,e){Do(t,"setsize",e)}function ko(t,e){Do(t,"posinset",e)}function Bo(t,e){Do(t,"multiselectable",e)}function jo(t,e){Do(t,"rowcount",e)}function Uo(t,e){Do(t,"rowindex",e)}function zo(t,e){Do(t,"colcount",e)}function Ko(t,e){Do(t,"colindex",e)}function Yo(t,e){Do(t,"colspan",e)}function qo(t,e){Do(t,"sort",e)}function Xo(t){Ao(t,"sort")}function Qo(t,e){e?Do(t,"selected",e):Ao(t,"selected")}function $o(t,e){Do(t,"checked",void 0===e?"mixed":e)}var Zo=Object.freeze({__proto__:null,getAriaSortState:Fo,getAriaLevel:function(t){return parseInt(t.getAttribute("aria-level"),10)},getAriaPosInSet:No,getAriaDescribedBy:Lo,setAriaLabel:Io,setAriaLabelledBy:Go,setAriaDescribedBy:Mo,setAriaLevel:function(t,e){Do(t,"level",e)},setAriaDisabled:xo,setAriaExpanded:Vo,removeAriaExpanded:Ho,setAriaSetSize:Wo,setAriaPosInSet:ko,setAriaMultiSelectable:Bo,setAriaRowCount:jo,setAriaRowIndex:Uo,setAriaColCount:zo,setAriaColIndex:Ko,setAriaColSpan:Yo,setAriaSort:qo,removeAriaSort:Xo,setAriaSelected:Qo,setAriaChecked:$o});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v25.1.0
 * @link http://www.ag-grid.com/
