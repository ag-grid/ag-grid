/**
          * @ag-grid-enterprise/filter-tool-panel - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v28.2.0
...
var ToolPanelFilterComp = /** @class */ (function (_super) {
    ...
    ToolPanelFilterComp.prototype.postConstruct = function () {
        this.eExpandChecked = core._.createIconNoSpan('columnSelectOpen', this.gridOptionsWrapper);
        this.eExpandUnchecked = core._.createIconNoSpan('columnSelectClosed', this.gridOptionsWrapper);
    ...
    ToolPanelFilterComp.prototype.addInIcon = function (iconName, eParent, column) {
        ...
        var eIcon = core._.createIconNoSpan(iconName, this.gridOptionsWrapper, column);
...
var FiltersToolPanel = /** @class */ (function (_super) {
    ...
    FiltersToolPanel.prototype.init = function (params) {
        ...
        this.params = __assign(__assign(__assign({}, defaultParams), this.params), { context: this.gridOptionsWrapper.getContext() });
