import type { AgComponentSelector, BeanCollection, ColumnModel, InternalColumn } from '@ag-grid-community/core';
import {
    AgInputTextField,
    Component,
    Events,
...
export class AgFiltersToolPanelHeader extends Component {
    ...
    private showOrHideOptions(): void {
        ...
        const isFilterGroupPresent = (col: InternalColumn) => col.getOriginalParent() && col.isFilterAllowed();
