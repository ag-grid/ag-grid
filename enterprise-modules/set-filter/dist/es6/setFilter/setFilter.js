...
import { Autowired, Constants, Events, ProvidedFilter, RefSelector, VirtualList, Promise, KeyCode, _ } from '@ag-grid-community/core';
...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.setModelAndRefresh = function (values) {
        var _this = this;
        return this.valueModel ? this.valueModel.setModel(values).then(function () { return _this.refresh(); }) : Promise.resolve();
    };
