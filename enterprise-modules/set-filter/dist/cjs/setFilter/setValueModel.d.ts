import { ISetFilterParams, Promise, ValueFormatterService, IEventEmitter } from '@ag-grid-community/core';
...
export declare class SetValueModel implements IEventEmitter {
     ...
     * otherwise the current selection will be preserved.
     */
    overrideValues(valuesToUse: (string | null)[], keepSelection?: boolean): Promise<void>;
    ...
    setModel(model: (string | null)[] | null): Promise<void>;
