...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.doesFilterPass = function (params) {
        ...
        if (Array.isArray(value)) {
            return core_1._.some(value, function (v) { return _this.appliedModelValues[_this.caseFormat(core_1._.makeNull(v))] === true; });
        }
    ...
    SetFilter.prototype.onMiniFilterKeyPress = function (e) {
        var _a = this.setFilterParams || {}, excelMode = _a.excelMode, readOnly = _a.readOnly;
        if (core_1._.isKeyPressed(e, core_1.KeyCode.ENTER) && !excelMode && !readOnly) {
