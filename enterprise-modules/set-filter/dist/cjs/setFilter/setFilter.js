...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.handleKeySpace = function (e) {
        ...
        if (core_1._.exists(currentItem)) {
    ...
    SetFilter.prototype.setParams = function (params) {
        ...
        this.valueModel = new setValueModel_1.SetValueModel(params.rowModel, params.colDef, params.column, params.valueGetter, params.doesRowPassOtherFilter, params.suppressSorting, function (loading) { return _this.setLoading(loading); }, this.valueFormatterService, function (key) { return _this.translate(key); });
    ...
    SetFilter.prototype.syncAfterDataChange = function (refreshValues, keepSelection) {
        ...
        var promise = core_1.Promise.resolve(null);
        if (refreshValues) {
    ...
    SetFilter.prototype.createSetListItem = function (value) {
        var _this = this;
        var listItem = this.createBean(new setFilterListItem_1.SetFilterListItem(value, this.setFilterParams, function (key) { return _this.translate(key); }));
    ...
    SetFilter.prototype.updateUiAfterMiniFilterChange = function () {
        ...
        if (!this.setFilterParams.suppressSelectAll) {
            core_1._.setDisplayed(this.eSelectAllContainer, !hideResults);
        }
    };
    ...
    SetFilter.prototype.onMiniFilterKeyPress = function (e) {
        if (core_1._.isKeyPressed(e, core_1.Constants.KEY_ENTER) && !this.setFilterParams.excelMode) {
    ...
    __decorate([
        core_1.RefSelector('eSelectAllLabel')
