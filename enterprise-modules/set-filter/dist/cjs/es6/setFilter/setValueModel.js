...
class SetValueModel {
    constructor(filterParams, setIsLoading, valueFormatterService, translate, caseFormat) {
        ...
        if (rowModel.getType() === core_1.Constants.ROW_MODEL_TYPE_CLIENT_SIDE) {
            this.clientSideValuesExtractor = new clientSideValueExtractor_1.ClientSideValuesExtractor(rowModel, this.filterParams, this.caseFormat);
        }
        if (values == null) {
            ...
            switch (this.valuesType) {
                ...
                case SetFilterModelValuesType.PROVIDED_LIST: {
                    const values = this.valuesType === SetFilterModelValuesType.TAKEN_FROM_GRID_VALUES ?
                        ...
                        core_1._.values(this.uniqueValues(core_1._.toStrings(this.providedValues) || []));
                ...
                case SetFilterModelValuesType.PROVIDED_CALLBACK: {
                    ...
                    const params = {
                        success: values => {
                            const processedValues = core_1._.values(this.uniqueValues(core_1._.toStrings(values) || []));
    ...
    updateDisplayedValues() {
        ...
        this.availableValues.forEach(value => {
            if (value == null) {
                ...
                const valueFormatterValue = this.valueFormatterService.formatValue(this.column, null, null, textFormatterValue, this.filterParams.valueFormatter, false);
    ...
    uniqueValues(values) {
        ...
        (values || []).forEach(rawValue => {
            const value = core_1._.makeNull(rawValue);
