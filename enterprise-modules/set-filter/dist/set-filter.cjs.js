...
var SetValueModel = /** @class */ (function () {
            ...
            switch (_this.valuesType) {
                ...
                case SetFilterModelValuesType.PROVIDED_LIST: {
                    var values = _this.valuesType === SetFilterModelValuesType.TAKEN_FROM_GRID_VALUES ?
                        ...
                        core._.values(_this.uniqueValues(core._.toStrings(_this.providedValues) || []));
                ...
                case SetFilterModelValuesType.PROVIDED_CALLBACK: {
                    ...
                    var params_1 = {
                        success: function (values) {
                            var processedValues = core._.values(_this.uniqueValues(core._.toStrings(values) || []));
    ...
    SetValueModel.prototype.uniqueValues = function (values) {
        ...
        var uniqueValues = {};
        core._.forEach(values || [], function (value) {
...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.doesFilterPass = function (params) {
        ...
        if (Array.isArray(value)) {
            return core._.some(value, function (v) { return _this.appliedModelValues[_this.caseFormat(core._.makeNull(v))] === true; });
        }
    ...
    SetFilter.prototype.onMiniFilterKeyPress = function (e) {
        var _a = this.setFilterParams || {}, excelMode = _a.excelMode, readOnly = _a.readOnly;
        if (core._.isKeyPressed(e, core.KeyCode.ENTER) && !excelMode && !readOnly) {
