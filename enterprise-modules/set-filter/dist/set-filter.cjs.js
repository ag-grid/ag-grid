/**
 * @ag-grid-enterprise/set-filter - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.1.0
    ...
    ClientSideValuesExtractor.prototype.extractUniqueValues = function (predicate) {
        ...
        this.rowModel.forEachLeafNode(function (node) {
            ...
            if (value != null && Array.isArray(value)) {
                core._.forEach(value, function (x) {
                    var formatted = core._.toStringOrNull(core._.makeNull(x));
                    values.add(formatted);
                });
            }
            else {
                values.add(core._.toStringOrNull(value));
            }
        });
...
var SetValueModel = /** @class */ (function () {
    function SetValueModel(filterParams, setIsLoading, valueFormatterService, translate) {
        ...
        var column = filterParams.column, colDef = filterParams.colDef, textFormatter = filterParams.textFormatter, doesRowPassOtherFilter = filterParams.doesRowPassOtherFilter, suppressSorting = filterParams.suppressSorting, comparator = filterParams.comparator, rowModel = filterParams.rowModel, values = filterParams.values;
        this.column = column;
        this.colDef = colDef;
        ...
        if (rowModel.getType() === core.Constants.ROW_MODEL_TYPE_CLIENT_SIDE) {
            this.clientSideValuesExtractor = new ClientSideValuesExtractor(rowModel, this.filterParams);
        }
        if (values == null) {
            ...
            switch (_this.valuesType) {
                ...
                case SetFilterModelValuesType.PROVIDED_LIST: {
                    var values = _this.valuesType === SetFilterModelValuesType.TAKEN_FROM_GRID_VALUES ?
                        _this.getValuesFromRows(false) : core._.toStrings(_this.providedValues);
                ...
                case SetFilterModelValuesType.PROVIDED_CALLBACK: {
                    ...
                    var params_1 = {
                        success: function (values) {
                            var processedValues = core._.toStrings(values);
    ...
    SetValueModel.prototype.sortValues = function (values) {
        ...
        return core._.filter(values, function (v) { return v != null; }).sort(this.comparator).concat(null);
    };
    ...
    SetValueModel.prototype.selectAllMatchingMiniFilter = function (clearExistingSelection) {
        ...
        if (this.miniFilterText == null) {
            ...
            core._.forEach(this.displayedValues, function (value) { return _this.selectedValues.add(value); });
        }
    };
    SetValueModel.prototype.deselectAllMatchingMiniFilter = function () {
        ...
        if (this.miniFilterText == null) {
            ...
            core._.forEach(this.displayedValues, function (value) { return _this.selectedValues.delete(value); });
        }
    };
    ...
    SetValueModel.prototype.isEverythingVisibleSelected = function () {
        var _this = this;
        return core._.filter(this.displayedValues, function (it) { return _this.isValueSelected(it); }).length === this.displayedValues.length;
    };
    SetValueModel.prototype.isNothingVisibleSelected = function () {
        var _this = this;
        return core._.filter(this.displayedValues, function (it) { return _this.isValueSelected(it); }).length === 0;
    };
    ...
    SetValueModel.prototype.setModel = function (model) {
        ...
        return this.allValuesPromise.then(function (values) {
            if (model == null) {
                ...
                var allValues_1 = core._.convertToSet(values || []);
                core._.forEach(model, function (value) {
...
var SetFilter = /** @class */ (function (_super) {
    ...
    SetFilter.prototype.setModelIntoUi = function (model) {
        ...
        if (model instanceof Array) {
            ...
            core._.doOnce(function () { return console.warn(message_1); }, 'setFilter.modelAsArray');
        }
    ...
    SetFilter.prototype.setParams = function (params) {
        ...
        if (params.rowModel.getType() === core.Constants.ROW_MODEL_TYPE_CLIENT_SIDE &&
            !params.values &&
    ...
    SetFilter.prototype.checkSetFilterDeprecatedParams = function (params) {
        if (params.syncValuesLikeExcel) {
            ...
            core._.doOnce(function () { return console.warn(message_2); }, 'syncValuesLikeExcel deprecated');
        }
        if (params.selectAllOnMiniFilter) {
            ...
            core._.doOnce(function () { return console.warn(message_3); }, 'selectAllOnMiniFilter deprecated');
        }
        if (params.suppressSyncValuesAfterDataChange) {
            ...
            core._.doOnce(function () { return console.warn(message_4); }, 'suppressSyncValuesAfterDataChange deprecated');
        }
        if (params.suppressRemoveEntries) {
            var message_5 = 'AG Grid: since version 23.1, the Set Filter param suppressRemoveEntries has' +
                ' been deprecated and will be removed in a future major release.';
            core._.doOnce(function () { return console.warn(message_5); }, 'suppressRemoveEntries deprecated');
        }
    };
    SetFilter.prototype.addEventListenersForDataChanges = function () {
        var _this = this;
        this.addManagedListener(this.eventService, core.Events.EVENT_ROW_DATA_UPDATED, function () { return _this.syncAfterDataChange(); });
    ...
    SetFilter.prototype.syncAfterDataChange = function (refreshValues, keepSelection) {
        ...
        var promise = core.AgPromise.resolve();
        if (refreshValues) {
    ...
    SetFilter.prototype.setLoading = function (loading) {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.setLoading');
    ...
    SetFilter.prototype.initVirtualList = function () {
        ...
        var virtualList = this.virtualList = this.createBean(new core.VirtualList('filter'));
    ...
    SetFilter.prototype.initMiniFilter = function () {
        ...
        core._.setDisplayed(eMiniFilter.getGui(), !this.setFilterParams.suppressMiniFilter);
    ...
    SetFilter.prototype.applyModel = function () {
        ...
        if (appliedModel) {
            this.appliedModelValues = core._.reduce(appliedModel.values, function (values, value) {
    ...
    SetFilter.prototype.doesFilterPass = function (params) {
        ...
        if (Array.isArray(value)) {
            return core._.some(value, function (v) { return _this.appliedModelValues[core._.makeNull(v)] === true; });
        }
    ...
    SetFilter.prototype.onMiniFilterKeyPress = function (e) {
        if (core._.isKeyPressed(e, core.KeyCode.ENTER) && (!this.setFilterParams || !this.setFilterParams.excelMode)) {
    ...
    SetFilter.prototype.selectEverything = function () {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.selectEverything');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
        this.valueModel.selectAllMatchingMiniFilter();
    ...
    SetFilter.prototype.selectNothing = function () {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.selectNothing');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
        this.valueModel.deselectAllMatchingMiniFilter();
    ...
    SetFilter.prototype.unselectValue = function (value) {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.unselectValue');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
        this.valueModel.deselectValue(value);
    ...
    SetFilter.prototype.selectValue = function (value) {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.selectValue');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
        this.valueModel.selectValue(value);
    ...
    SetFilter.prototype.isValueSelected = function (value) {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.isValueSelected');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
    ...
    SetFilter.prototype.isEverythingSelected = function () {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.isEverythingSelected');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
    ...
    SetFilter.prototype.isNothingSelected = function () {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.isNothingSelected');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
    ...
    SetFilter.prototype.getUniqueValueCount = function () {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.getUniqueValueCount');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
    ...
    SetFilter.prototype.getUniqueValue = function (index) {
        ...
        core._.doOnce(function () { return console.warn(message); }, 'setFilter.getUniqueValue');
        if (!this.valueModel) {
            throw new Error('Value model has not been created.');
        }
...
var SetFloatingFilterComp = /** @class */ (function (_super) {
    ...
    SetFloatingFilterComp.prototype.updateFloatingFilterText = function () {
        ...
        this.params.parentFilterInstance(function (setFilter) {
            ...
            var availableValues = core._.filter(values, function (v) { return valueModel.isValueAvailable(v); });
            var localeTextFunc = _this.gridOptionsWrapper.getLocaleTextFunc();
            // format all the values, if a formatter is provided
            var formattedValues = core._.map(availableValues, function (value) {
