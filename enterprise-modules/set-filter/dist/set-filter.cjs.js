/**
          * @ag-grid-enterprise/set-filter - Advanced Data Grid / Data Table supporting Javascript / Typescript / React / Angular / Vue * @version v29.0.0
...
var TreeSetDisplayValueModel = /** @class */ (function () {
    ...
    TreeSetDisplayValueModel.prototype.generateItemTree = function (getValue, allKeys, availableKeys) {
        ...
        var _loop_1 = function (key) {
            ...
            dataPath.forEach(function (treeKey, depth) {
                ...
                if (!item) {
                    item = { treeKey: treeKey, depth: depth, filterPasses: true, expanded: false, available: available };
    ...
    TreeSetDisplayValueModel.prototype.updateFilter = function (matchesFilter, nullMatchesFilter) {
        ...
        var passesFilter = function (item) {
            ...
            return matchesFilter(_this.formatter(_this.treeListFormatter ? _this.treeListFormatter(item.treeKey, item.depth) : item.treeKey));
        };
    ...
    SetFilter.prototype.createSetListItem = function (item, isTree, focusWrapper) {
        ...
        if (this.isSetFilterModelTreeItem(item)) {
            ...
            if (item.key === SetFilterDisplayValue.SELECT_ALL) {
                ...
                // group
                value = (_c = (_b = (_a = this.setFilterParams).treeListFormatter) === null || _b === void 0 ? void 0 : _b.call(_a, item.treeKey, item.depth)) !== null && _c !== void 0 ? _c : item.treeKey;
                isGroup = true;
                ...
                // leaf
                value = (_f = (_e = (_d = this.setFilterParams).treeListFormatter) === null || _e === void 0 ? void 0 : _e.call(_d, item.treeKey, item.depth)) !== null && _f !== void 0 ? _f : item.treeKey;
