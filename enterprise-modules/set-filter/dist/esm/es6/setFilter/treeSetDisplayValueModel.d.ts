...
export declare class TreeSetDisplayValueModel<V> implements ISetDisplayValueModel<V> {
    ...
    constructor(formatter: TextFormatter, treeListPathGetter?: ((value: V | null) => string[] | null) | undefined, treeListFormatter?: ((pathKey: string | null, level: number) => string) | undefined, treeDataOrGrouping?: boolean | undefined);
