import { IDoesFilterPassParams, SetFilterParams, ProvidedFilter, IAfterGuiAttachedParams, AgPromise, ISetFilter, SetFilterModel, SetFilterModelValue } from '@ag-grid-community/core';
