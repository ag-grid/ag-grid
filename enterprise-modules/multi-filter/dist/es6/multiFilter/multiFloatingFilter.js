...
import { Component, _, Autowired, HeaderFilterCellCtrl, AgPromise, } from '@ag-grid-community/core';
...
var MultiFloatingFilterComp = /** @class */ (function (_super) {
    ...
    MultiFloatingFilterComp.prototype.createFloatingFilter = function (filterDef, params) {
        var defaultComponentName = HeaderFilterCellCtrl.getDefaultFloatingFilterType(filterDef) || 'agTextColumnFloatingFilter';
