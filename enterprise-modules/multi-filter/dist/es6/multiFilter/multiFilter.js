...
var MultiFilter = /** @class */ (function (_super) {
    ...
    MultiFilter.prototype.createFilter = function (filterDef, index) {
        ...
        var filterInstance;
        var filterParams = __assign(__assign({}, this.filterManager.createFilterParams(this.column, this.column.getColDef())), { filterModifiedCallback: filterModifiedCallback, filterChangedCallback: function (additionalEventAttributes) { return _this.filterChanged(index, additionalEventAttributes); }, doesRowPassOtherFilter: function (node) {
