/**
 * @ag-grid-enterprise/multi-filter - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.1.0
 * @link http://www.ag-grid.com/
' * @license Commercial
 */

import { _, AgPromise, AgGroupComponent, Autowired, PostConstruct, TabGuardComp, HeaderFilterCellComp, Component, ModuleNames } from '@ag-grid-community/core';
...
var MultiFloatingFilterComp = /** @class */ (function (_super) {
    __extends$1(MultiFloatingFilterComp, _super);
    ...
    MultiFloatingFilterComp.prototype.createFloatingFilter = function (filterDef, params) {
        var defaultComponentName = HeaderFilterCellComp.getDefaultFloatingFilterType(filterDef) || 'agTextColumnFloatingFilter';
