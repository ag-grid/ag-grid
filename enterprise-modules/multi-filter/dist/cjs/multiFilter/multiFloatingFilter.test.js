...
var multiFloatingFilter_1 = require("./multiFloatingFilter");
...
function createFloatingFilter(filterParams) {
    ...
    var multiFloatingFilter = new multiFloatingFilter_1.MultiFloatingFilterComp();
    multiFloatingFilter.userComponentFactory = userComponentFactory;
    multiFloatingFilter.init(params);
    return multiFloatingFilter;
}
beforeEach(function () {
    userComponentFactory = mock_1.mock('newFloatingFilterComponent', 'createUserComponentFromConcreteClass');
    parentFilter = mock_1.mock('getLastActiveFilterIndex');
});
describe('init', function () {
    beforeEach(function () {
        floatingFilter1 = mock_1.mock('getGui');
        floatingFilter2 = mock_1.mock('getGui');
    });
...
describe('onParentModelChanged', function () {
    beforeEach(function () {
        floatingFilter1 = mock_1.mock('getGui', 'onParentModelChanged');
        floatingFilter1.getGui.mockReturnValue(document.createElement('div'));
        floatingFilter2 = mock_1.mock('getGui', 'onParentModelChanged');
...
//# sourceMappingURL=multiFloatingFilter.test.js.map