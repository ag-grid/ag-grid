...
beforeEach(function () {
    eGui = mock_1.mock('appendChild', 'insertAdjacentElement');
    filterManager = mock_1.mock('createFilterParams');
    userComponentFactory = mock_1.mock('newFilterComponent');
    focusController = mock_1.mock('findFocusableElements');
    context = mock_1.mock('createBean', 'destroyBean');
    colDef = mock_1.mock();
    column = mock_1.mock('getColDef');
    column.getColDef.mockReturnValue(colDef);
    rowModel = mock_1.mock('getType');
});
describe('init', function () {
    beforeEach(function () {
        filter1 = mock_1.mock('getGui');
        filter2 = mock_1.mock('getGui');
...
describe('isFilterActive', function () {
    beforeEach(function () {
        filter1 = mock_1.mock('getGui', 'isFilterActive');
...
describe('doesFilterPass', function () {
    beforeEach(function () {
        filter1 = mock_1.mock('getGui', 'isFilterActive', 'doesFilterPass');
        filter2 = mock_1.mock('getGui', 'isFilterActive', 'doesFilterPass');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
    });
...
describe('getModel', function () {
    beforeEach(function () {
        filter1 = mock_1.mock('getGui', 'isFilterActive', 'getModel');
        filter2 = mock_1.mock('getGui', 'isFilterActive', 'getModel');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
    });
    it('returns null if neither filter is active', function () {
...
describe('setModel', function () {
    beforeEach(function () {
        filter1 = mock_1.mock('getGui', 'isFilterActive', 'setModel');
        filter2 = mock_1.mock('getGui', 'isFilterActive', 'setModel');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
    });
...
describe('afterGuiAttached', function () {
    ...
    it('passes through to filter if it has afterGuiAttached function', function () {
        filter1 = mock_1.mock('getGui', 'afterGuiAttached');
        filter1.getGui.mockReturnValue(filter1Gui);
        filter2 = mock_1.mock('getGui', 'afterGuiAttached');
        filter2.getGui.mockReturnValue(filter2Gui);
        var multiFilter = createFilter();
...
describe('onAnyFilterChanged', function () {
    ...
    it('passes through to filter if it has onAnyFilterChanged function', function () {
        filter1 = mock_1.mock('getGui', 'onAnyFilterChanged');
        filter2 = mock_1.mock('getGui', 'onAnyFilterChanged');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
        var multiFilter = createFilter();
...
describe('onNewRowsLoaded', function () {
    ...
    it('passes through to filter if it has onNewRowsLoaded function', function () {
        filter1 = mock_1.mock('getGui', 'onNewRowsLoaded');
        filter2 = mock_1.mock('getGui', 'onNewRowsLoaded');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
        var multiFilter = createFilter();
...
describe('onFilterChanged', function () {
    ...
    it('triggers onAnyFilterChanged on other filters if exists', function () {
        filter1 = mock_1.mock('getGui', 'isFilterActive', 'setModel', 'onAnyFilterChanged');
        filter2 = mock_1.mock('getGui', 'isFilterActive', 'setModel', 'onAnyFilterChanged');
        filter1.getGui.mockReturnValue(document.createElement('div'));
        filter2.getGui.mockReturnValue(document.createElement('div'));
        createFilter();
