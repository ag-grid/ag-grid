/**
 * @ag-grid-enterprise/multi-filter - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v26.2.0
...
var MultiFilter = /** @class */ (function (_super) {
    ...
    MultiFilter.prototype.init = function (params) {
        ...
        var filterPromises = [];
        core._.forEach(this.filterDefs, function (filterDef, index) {
    ...
    MultiFilter.prototype.refreshGui = function (container) {
        ...
        core._.forEach(this.filters, function (filter, index) {
            if (index > 0) {
    ...
    MultiFilter.prototype.destroyChildren = function () {
        core._.forEach(this.guiDestroyFuncs, function (func) { return func(); });
        this.guiDestroyFuncs.length = 0;
    };
    MultiFilter.prototype.insertFilterMenu = function (filter, name) {
        var _this = this;
        var menuItem = this.createBean(new menu.MenuItemComponent({
            name: name,
            subMenu: filter,
        ...
        this.addManagedListener(menuItem, menu.MenuItemComponent.EVENT_MENU_ITEM_ACTIVATED, function (event) {
    ...
    MultiFilter.prototype.isFilterActive = function () {
        return core._.some(this.filters, function (filter) { return filter.isFilterActive(); });
    };
    ...
    MultiFilter.prototype.getModelFromUi = function () {
        var model = {
            ...
            filterModels: core._.map(this.filters, function (filter) {
    ...
    MultiFilter.prototype.setModel = function (model) {
        ...
        var promises = [];
        if (model == null) {
            promises = core._.map(this.filters, function (filter, index) {
    ...
    MultiFilter.prototype.destroy = function () {
        var _this = this;
        core._.forEach(this.filters, function (filter) {
...
var MultiFloatingFilterComp = /** @class */ (function (_super) {
    ...
    MultiFloatingFilterComp.prototype.init = function (params) {
        ...
        core._.forEach(MultiFilter.getFilterDefs(filterParams), function (filterDef, index) {
        ...
        return core.AgPromise.all(floatingFilterPromises).then(function (floatingFilters) {
            core._.forEach(floatingFilters, function (floatingFilter, index) {
    ...
    MultiFloatingFilterComp.prototype.onParentModelChanged = function (model, event) {
        ...
        this.params.parentFilterInstance(function (parent) {
            if (model == null) {
                core._.forEach(_this.floatingFilters, function (filter, i) {
    ...
    MultiFloatingFilterComp.prototype.createFloatingFilter = function (filterDef, params) {
        var defaultComponentName = core.HeaderFilterCellCtrl.getDefaultFloatingFilterType(filterDef) || 'agTextColumnFloatingFilter';
