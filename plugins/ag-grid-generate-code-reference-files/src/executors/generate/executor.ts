...
import { getColumnGroup, getGridOptions, getInterfaces, getProvidedColumnGroup } from './generate-code-reference-files';
...
async function generateFile(options: ExecutorOptions) {
    ...
    const generateMetaFiles = async () => {
        ...
        await writeJSONFile(distFolder + '/providedColumnGroup.AUTO.json', getProvidedColumnGroup(columnFile));
