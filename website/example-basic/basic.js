...
fileBrowserModule.controller('basicController', function($scope) {
    ...
    var columnDefs = [
        ...
        {displayName: "Technology", width: 125, group: 'IT Skills', suppressSorting: true, cellRenderer: skillsCellRenderer},
        {displayName: "Proficiency", field: "proficiency", group: 'IT Skills', filter: 'number', width: 100, cellRenderer: percentCellRenderer},
    ...
    function skillsCellRenderer(params) {
        ...
        var skills = [];
        ['android','css','html5','mac','windows'].forEach(function (skill) {
