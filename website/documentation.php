...
<div>
    ...
    <div style="width: 800px;">
        <p>
            ...
            any examples of the grid you can share, please send them on. If using the grid
            in the public domain, please pass on your url.
        </p>
        <h4>
            Help Grow the Community
        </h4>
        <p>
            If you are using or thinking of using Angular Grid, then please show your support. You can do this
            in any of the following ways:
            <h4>1. Star or Watch this Project on Github
            ...
            <h4>2. Say you use this project in
            ...
            <h4>4. As a question on the
                <a href="/forum" style="color: black; border: 1px solid darkgrey; background-color: lightgrey; padding: 2px;">
                    <span style="color: darkred">A</span>ngular <span style="color: darkred">G</span>rid Forum
                </a>
            </h4>

            <h4>5. Link to this page from yours, or ask me to do a link swap!</h4>
