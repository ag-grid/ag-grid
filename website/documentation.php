...
<div style="border: 1px solid darkgrey; background-color: #eee; padding: 10px; margin: 30px 5px 5px 5px;">
    ...
    <p>
        ...
        to everyone who has started to use Angular Grid.
    </p>
    <p>
        Last week saw <b>over 12,000 visits</b> to the Angular Grid website. Github stars are now in the hundreds.
        <a href="http://dailyjs.com/2015/03/31/angular-grid-react-native/?utm_content=buffer98f7e&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer">DailyJS</a> covered the launch.
        Angular Grid is alive!
    </p>
