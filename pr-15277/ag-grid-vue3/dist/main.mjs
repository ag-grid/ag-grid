...
import { defineComponent, createVNode, render, isRef, isReactive, isProxy, toRaw, mergeModels, useTemplateRef, shallowRef, toRefs, watch, useModel, getCurrentInstance, onMounted, markRaw, onUnmounted, createElementBlock, openBlock, mergeDefaults } from "vue";
...
const _VueComponentFactory = class _VueComponentFactory {
  static getComponentDefinition(component, parent, gridId) {
  ...
  static createAndMountComponent(component, params, parent, provides, gridId) {
    const componentDefinition = _VueComponentFactory.getComponentDefinition(component, parent, gridId);
    if (!componentDefinition) {
      return;
    }
