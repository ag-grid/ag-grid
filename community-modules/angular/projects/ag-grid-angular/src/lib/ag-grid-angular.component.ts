...
export class AgGridAngular implements AfterViewInit {
    ...
    static ngAcceptInputType_suppressCellSelection: boolean | '';
    ...
    static ngAcceptInputType_angularCompileRows: boolean | '';
    static ngAcceptInputType_angularCompileFilters: boolean | '';
    static ngAcceptInputType_groupSuppressAutoColumn: boolean | '';
    static ngAcceptInputType_groupSelectsChildren: boolean | '';
    static ngAcceptInputType_groupIncludeFooter: boolean | '';
    static ngAcceptInputType_groupIncludeTotalFooter: boolean | '';
    static ngAcceptInputType_groupUseEntireRow: boolean | '';
    ...
    static ngAcceptInputType_rememberGroupStateWhenNewData: boolean | '';
    ...
    static ngAcceptInputType_enableMultiRowDragging: boolean | '';
    static ngAcceptInputType_enableGroupEdit: boolean | '';
    static ngAcceptInputType_embedFullWidthRows: boolean | '';
    static ngAcceptInputType_deprecatedEmbedFullWidthRows: boolean | '';
    ...
    static ngAcceptInputType_groupMultiAutoColumn: boolean | '';
    static ngAcceptInputType_pagination: boolean | '';
    static ngAcceptInputType_stopEditingWhenGridLosesFocus: boolean | '';
    ...
    static ngAcceptInputType_deltaRowDataMode: boolean | '';
    ...
    static ngAcceptInputType_suppressEnterpriseResetOnNewColumns: boolean | '';
    static ngAcceptInputType_enableOldSetFilterModel: boolean | '';
    ...
    static ngAcceptInputType_serverSideSortingAlwaysResets: boolean | '';
    static ngAcceptInputType_suppressSetColumnStateEvents: boolean | '';
    static ngAcceptInputType_suppressColumnStateEvents: boolean | '';
    static ngAcceptInputType_enableCharts: boolean | '';
    static ngAcceptInputType_deltaColumnMode: boolean | '';
    ...
    static ngAcceptInputType_allowProcessChartOptions: boolean | '';
    // @END@
}
