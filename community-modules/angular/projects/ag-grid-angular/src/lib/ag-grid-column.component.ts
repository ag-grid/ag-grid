...
export class AgGridColumn {
    ...
    @Input() public defaultAggFunc: any;
    ...
    @Input() public defaultPivotIndex: any;
    ...
    @Input() public defaultHide: any;
    @Input() public rowGroup: any;
    @Input() public defaultRowGroup: any;
    @Input() public pivot: any;
    @Input() public defaultPivot: any;
