...
import { VanillaFrameworkOverrides, BaseComponentWrapper, AgPromise, ComponentUtil, createGrid, ColumnApi } from '@ag-grid-community/core';
...
class AgGridAngular {
    constructor(elementDef, viewContainerRef, angularFrameworkOverrides, frameworkComponentWrapper) {
        ...
        /** Enables the legacy format of the Integrated Charts Menu and Tool Panels.
             ...
             * @initial
             */
        this.legacyChartsMenu = undefined;
