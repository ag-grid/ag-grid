...
import { VanillaFrameworkOverrides, BaseComponentWrapper, Promise, ComponentUtil, Grid, Utils, Events, GridOptionsWrapper } from '@ag-grid-community/core';
...
let AgGridAngular = class AgGridAngular {
    ...
    checkForDeprecatedEvents() {
        Utils.iterateObject(Events, (key, eventName) => {
