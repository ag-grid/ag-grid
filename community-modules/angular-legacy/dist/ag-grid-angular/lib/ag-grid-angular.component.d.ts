...
export declare class AgGridAngular<TData = any> implements AfterViewInit {
    ...
    columnDefs: (ColDef<TData> | ColGroupDef<TData>)[] | null | undefined;
    ...
    rowModelType: 'clientSide' | 'infinite' | 'viewport' | 'serverSide' | undefined;
