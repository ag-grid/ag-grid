...
var GridOptionsWrapper = /** @class */ (function () {
    ...
    GridOptionsWrapper.prototype.checkColumnDefProperties = function () {
        ...
        this.gridOptions.columnDefs.forEach(function (colDef) {
            ...
            var validProperties = __spreadArrays(colDefUtil_1.ColDefUtil.ALL_PROPERTIES, colDefUtil_1.ColDefUtil.FRAMEWORK_PROPERTIES);
    ...
    GridOptionsWrapper.prototype.checkGridOptionsProperties = function () {
        ...
        var validProperties = __spreadArrays(propertyKeys_1.PropertyKeys.ALL_PROPERTIES, propertyKeys_1.PropertyKeys.FRAMEWORK_PROPERTIES, utils_1._.values(eventKeys_1.Events).map(function (event) { return componentUtil_1.ComponentUtil.getCallbackForEvent(event); }));
    ...
    GridOptionsWrapper.prototype.checkProperties = function (userProperties, validPropertiesAndExceptions, validProperties, containerName, docsUrl) {
        ...
        utils_1._.iterateObject(invalidProperties, function (key, value) {
    ...
    GridOptionsWrapper.prototype.getDomLayout = function () {
        ...
        if (validLayouts.indexOf(domLayout) === -1) {
            utils_1._.doOnce(function () { return console.warn("ag-Grid: " + domLayout + " is not valid for DOM Layout, valid values are " + constants_1.Constants.DOM_LAYOUT_NORMAL + ", " + constants_1.Constants.DOM_LAYOUT_AUTO_HEIGHT + " and " + constants_1.Constants.DOM_LAYOUT_PRINT); }, 'warn about dom layout values');
