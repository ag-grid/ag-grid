...
var Grid = /** @class */ (function () {
        ...
        function addModule(module) {
            function addIndividualModule(module) {
                if (!mapNames[module.moduleName]) {
                    ...
                    moduleRegistry_1.ModuleRegistry.register(module); // Niall / Sean - my addition
                }
            }
    ...
    Grid.prototype.createBeansList = function (registeredModules) {
        ...
        var beans = [
            ...
            changeDetectionService_1.ChangeDetectionService, animationFrameService_1.AnimationFrameService, tooltipManager_1.TooltipManager, detailRowCompCache_1.DetailRowCompCache
        ];
