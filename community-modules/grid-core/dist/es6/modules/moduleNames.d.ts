...
export declare enum ModuleNames {
    CommunityCoreModule = "@ag-community/grid-core",
    CommunityAllModules = "@ag-community/grid-all",
    ...
    CsvExportModule = "@ag-community/grid-csv-export",
    RowNodeCache = "@ag-community/grid-row-node-cache",
    EnterpriseCoreModule = "@ag-enterprise/grid-core",
    EnterpriseAllModules = "@ag-enterprise/grid-all",
    ...
    ServerSideRowModelModule = "@ag-enterprise/grid-server-side-row-model",
