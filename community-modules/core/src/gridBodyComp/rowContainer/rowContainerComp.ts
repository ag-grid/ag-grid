...
import { Autowired, ComponentMeta, PostConstruct, PreDestroy } from '../../context/context';
import {
...
export function useRowContainerComp(comps: ComponentMeta[]) {
    ...
    comps.push({ componentName: 'AgRowContainer', componentClass: RowContainerComp });
}
