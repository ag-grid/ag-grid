...
export class HeaderComp extends Component implements IHeaderComp {
    ...
    #currentSuppressMenuHide: boolean;
    #currentSort: boolean | undefined;
    ...
    #workOutTemplate(): string | null | undefined {
    ...
    #configureFilter(enabled: boolean, element: HTMLElement, filterChangedCallback: () => void): boolean {
        if (!enabled) {
