...
export interface GridComp extends TabGuardComp {}

export function getGridComp(eDiv: HTMLElement) : GridComp {
    class GridCompClass extends TabGuardComp {
