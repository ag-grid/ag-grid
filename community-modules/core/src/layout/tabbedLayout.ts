...
export class TabbedLayout extends TabGuardComp {
    ...
    #eTabHeader: HTMLElement;
    #eCloseButton?: HTMLElement;

    #params: TabbedLayoutParams;
    #afterAttachedParams: IAfterGuiAttachedParams;
    #items: TabbedItemWrapper[] = [];
    #activeItem: TabbedItemWrapper;
    #lastScrollListener: (() => null) | null | undefined;
    readonly #tabbedItemScrollMap = new Map<string, number>();
    ...
    #setupCloseButton(addCssClasses: (el: HTMLElement, suffix: string) => void): void {
    ...
    protected onTabKeyDown(e: KeyboardEvent) {
        ...
        const { focusService, eHeader, eBody } = this;
        const { suppressTrapFocus, enableCloseButton } = this.#params;
    ...
    #focusBody(fromBottom?: boolean): void {
