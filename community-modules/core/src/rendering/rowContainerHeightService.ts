...
export class RowContainerHeightService extends BeanStub {
    ...
    #modelHeight: number | null; // how many pixels the model needs
    #uiContainerHeight: number | null; // how many pixels we actually have
    #pixelsToShave: number; // the number of pixels we need to shave
    ...
    #setUiContainerHeight(height: number | null): void {
    ...
    #setDivStretchOffset(newOffset: number): void {
