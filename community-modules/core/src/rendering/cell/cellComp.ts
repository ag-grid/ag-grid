...
export class CellComp extends Component implements TooltipParentComp {
    ...
    #checkboxSelectionComp: CheckboxSelectionComponent | undefined;
    #dndSourceComp: DndSourceComp | undefined;
    #rowDraggingComp: RowDragComp | undefined;

    #hideEditorPopup: Function | null | undefined;
    #cellEditorPopupWrapper: PopupEditorWrapper | undefined;
    #cellEditor: ICellEditorComp | null | undefined;
    #cellEditorGui: HTMLElement | null;

    #cellRenderer: ICellRendererComp | null | undefined;
    #cellRendererGui: HTMLElement | null;
    ...
    #refreshWrapper(editing: boolean): boolean {
    ...
    #createCellEditorInstance(compDetails: UserCompDetails, popup?: boolean, position?: 'over' | 'under'): void {
    ...
    #insertValueWithoutCellRenderer(valueToDisplay: any): void {
    ...
    #refreshCellRenderer(compClassAndParams: UserCompDetails): boolean {
    ...
    #createCellRendererInstance(compDetails: UserCompDetails): void {
    ...
    #addPopupCellEditor(params: ICellEditorParams, position?: 'over' | 'under'): void {
