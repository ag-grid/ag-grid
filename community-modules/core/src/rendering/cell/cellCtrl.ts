...
export class CellCtrl extends BeanStub {
    ...
    #focusEventToRestore: CellFocusedEvent | undefined;
    ...
    #cellRangeFeature: CellRangeFeature | null = null;
    #cellPositionFeature: CellPositionFeature | null = null;
    #cellCustomStyleFeature: CellCustomStyleFeature | null = null;
    #tooltipFeature: TooltipFeature | null = null;
    #cellMouseListenerFeature: CellMouseListenerFeature | null = null;
    #cellKeyboardListenerFeature: CellKeyboardListenerFeature | null = null;
    ...
    #colIdSanitised: string;
    #tabIndex: number | undefined;
    #isAutoHeight: boolean;

    #suppressRefreshCell = false;

    // this comp used only for custom row drag handle (ie when user calls params.registerRowDragger)
    #customRowDragComp: RowDragComp;

    #onCellCompAttachedFuncs: (() => void)[] = [];
    ...
    #enableTooltipFeature(value?: string, shouldDisplayTooltip?: () => boolean): void {
    ...
    #setupAutoHeight(eCellWrapper?: HTMLElement): void {
    ...
    #showValue(forceNewCellRendererInstance = false): void {
    ...
    #isIncludeControl(value: boolean | Function | undefined): boolean {
    ...
    #takeValueFromCellEditor(cancel: boolean): { newValue?: any, newValueExists: boolean } {
     ...
     */
    #saveNewValue(oldValue: any, newValue: any): boolean {
    ...
    #dispatchEditingStoppedEvent(oldValue: any, newValue: any, valueChanged: boolean): void {
    ...
    #createCellEditorParams(key: string | null, cellStartedEdit: boolean): ICellEditorParams {
    ...
    #navigateAfterEdit(shiftKey: boolean): void {
    ...
    #callValueFormatter(value: any): string | null {
    ...
    #refreshFirstAndLastStyles(): void {
        ...
        CssClassApplier.refreshFirstAndLastStyles(cellComp, column, this.#beans.columnModel);
    }
