...
export class CheckboxSelectionComponent extends Component {
    ...
    #shouldHandleIndeterminateState(isSelected: boolean | undefined, groupSelectsFiltered: boolean): boolean {
    ...
    #getIsVisible(): boolean | CheckboxSelectionCallback<any> | undefined {
        if (this.#overrides) {
