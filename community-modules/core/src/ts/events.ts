...
export interface AgGridEvent<TData = any, TContext = any> extends AgEvent, AgGridCommon<TData, TContext> { }
...
export interface CellFocusClearedEvent<TData = any, TContext = any> extends CellFocusClearedParams, AgGridEvent<TData, TContext> { }

// this does not extent CellEvent as the focus service doesn't keep a reference to
// the rowNode.
export interface CellFocusedEvent<TData = any, TContext = any> extends CellFocusedParams, AgGridEvent<TData, TContext> { }

export interface FullWidthRowFocusedEvent<TData = any, TContext = any> extends CellFocusedEvent<TData, TContext> {
    fromBelow: boolean;
}
...
/** ROW EVENTS */
/**------------*/
interface BaseRowEvent<TData, TContext = any> extends AgGridEvent<TData, TContext> {
    /** The row node. */
    node: IRowNode<TData>;
...
/** CELL EVENTS */
/**------------*/
export interface CellEvent<TData = any, TValue = any, TContext = any> extends RowEvent<TData, TContext> {
    column: Column;
...
interface CellWithDataEvent<TData = any, TValue = any, TContext = any> extends RowWithDataEvent<TData, TContext> {
    column: Column;
    colDef: ColDef<TData, TContext>;
...
export interface CellKeyDownEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellKeyPressEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellClickedEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellMouseDownEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellDoubleClickedEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellMouseOverEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellMouseOutEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellContextMenuEvent<TData = any, TValue = any, TContext = any> extends CellEvent<TData, TValue, TContext> { }

export interface CellEditingStartedEvent<TData = any, TValue = any, TContext = any> extends CellWithDataEvent<TData, TValue, TContext> { }

export interface CellEditingStoppedEvent<TData = any, TValue = any, TContext = any> extends CellWithDataEvent<TData, TValue, TContext> {
...
export interface CellValueChangedEvent<TData = any, TValue = any, TContext = any> extends CellWithDataEvent<TData, TValue, TContext> {
    oldValue: any;
    newValue: any;
    source: string | undefined;
}

export interface CellEditRequestEvent<TData = any, TValue = any, TContext = any> extends CellWithDataEvent<TData, TValue, TContext> {
    oldValue: any;
    newValue: any;
    source: string | undefined;
}
