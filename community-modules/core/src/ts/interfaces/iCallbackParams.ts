...
export interface GetServerSideGroupLevelParamsParams<TContext = any> extends AgGridCommon<any, TContext> {
...
export interface GetServerSideStoreParamsParams<TContext = any> extends GetServerSideGroupLevelParamsParams<TContext> { }

export interface IsServerSideGroupOpenByDefaultParams<TContext = any> extends AgGridCommon<any, TContext> {
    data: any;
    rowNode: IRowNode;
}

export interface IsApplyServerSideTransactionParams<TContext = any> extends AgGridCommon<any, TContext> {
