...
export interface IFilter {
    ...
    /**
     * Used to execute the provided callback when the filter is ready. Useful when the filter needs to perform
     * asynchronous logic, e.g. to load values, before it can be interacted with.
    */
