...
export interface IComponent<T> {
     ...
     * rendered on the screen. If a parent popup is closed and reopened (e.g. for filters), this
     * method is called each time the component is shown. This is useful for any logic that
     * requires attachment before executing, such as putting focus on a particular DOM element.
     */
