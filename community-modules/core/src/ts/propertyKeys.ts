...
export class PropertyKeys {
    ...
    public static BOOLEAN_PROPERTIES: KeysOfType<boolean>[] = [
        ...
        'suppressScrollWhenPopupsAreOpen', 'purgeClosedRowNodes', 'cacheQuickFilter', 'ensureDomOrder', 'accentedSort', 'suppressChangeDetection', 'valueCache',
        'valueCacheNeverExpires', 'aggregateOnlyChangedColumns', 'suppressAnimationFrame', 'suppressExcelExport', 'suppressCsvExport', 'treeData', 'masterDetail',
        ...
        'columnHoverHighlight', 'reactUi', 'suppressReactUi', 'readOnlyEdit', 'readOnlyGrid', 'suppressRowVirtualisation', 'enableCellEditingOnBackspace', 'resetRowDataOnUpdate',
