...
export class PropertyKeys {
    ...
    public static BOOLEAN_PROPERTIES: KeysOfType<boolean>[] = [
        ...
        'removePivotHeaderRowWhenSingleValueColumn', 'suppressCopySingleCellRanges', 'groupRowsSticky', 'suppressServerSideInfiniteScroll',
        'rowGroupPanelSuppressSort', 'allowShowChangeAfterFilter'
    ];
