...
export function useFilterManager(){
    @Bean('filterManager')
    class FilterManager extends BeanStub implements IFilterManager {
        ...
        public init(): void {
            ...
            if(this.quickFilterService){
                this.addManagedListener(this.quickFilterService, 'quickFilterChanged', () => this.onFilterChanged({ source: 'quickFilter' }));
            }
        ...
        public isQuickFilterPresent(): boolean {
            return this.quickFilterService?.isQuickFilterPresent() ?? false;
        }
    ...
    ModuleRegistry.registerFeature(FilterManager);
}
...
type IFilterManager = FilterManager;
