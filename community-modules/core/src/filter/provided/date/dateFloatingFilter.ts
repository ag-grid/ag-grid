...
import { getDebounceMs } from '../providedFilter';
...
export interface DateFloatingFilter extends SimpleFloatingFilter {}

export function useDateFloatingFilter() {
    ...
    UserComponentRegistry.registerDefaultComponent('agDateColumnFloatingFilter', DateFloatingFilter);
}