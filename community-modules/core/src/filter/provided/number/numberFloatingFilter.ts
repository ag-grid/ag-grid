...
class FloatingFilterNumberInputService extends BeanStub implements FloatingFilterInputService {
    #eFloatingFilterTextInput: AgInputTextField;
    #eFloatingFilterNumberInput: AgInputNumberField;
    #valueChangedListener: (e: KeyboardEvent) => void = () => {};
    ...
    #getActiveInputElement(): AgInputTextField | AgInputNumberField {
    ...
    #setupListeners(element: HTMLElement, listener: (e: KeyboardEvent) => void): void {
