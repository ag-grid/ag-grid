...
export function useNumberFloatingFilter() {
    ...
    class NumberFloatingFilter extends TextInputFloatingFilter<NumberFilterModel> {
    ...
    UserComponentRegistry.registerDefaultComponent('agNumberColumnFloatingFilter', NumberFloatingFilter);
}
