...
export class ColumnGroup implements IHeaderColumn {
    ...
    #children: IHeaderColumn[] | null;
    // depends on the open/closed state of the group, only displaying columns are stored here
    #displayedChildren: IHeaderColumn[] | null = [];

    readonly #groupId: string;
    readonly #partId: number;
    readonly #providedColumnGroup: ProvidedColumnGroup;
    readonly #pinned: ColumnPinnedType;

    // private moving = false
    #left: number | null;
    #oldLeft: number | null;
    #localEventService: EventService = new EventService();
