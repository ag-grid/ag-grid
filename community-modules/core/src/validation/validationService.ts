...
interface IValidationService extends ValidationService {}
export function useValidations() {
    @Bean('validationService')
    class ValidationService extends BeanStub implements IValidationService {
        ...
        private checkForWarning<T extends {}>(
            key: keyof T,
    ...
    ModuleRegistry.registerFeature(ValidationService);
}
