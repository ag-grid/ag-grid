...
export class AgMenuItemComponent extends BeanStub {
    ...
    #childComponent?: IComponent<any>;
    #contextParams: WithoutGridCommon<IMenuActionParams>;
    #menuItemComp: IMenuItemComp;
    #isActive = false;
    #hideSubMenu: (() => void) | null;
    #subMenuIsOpen = false;
    #subMenuIsOpening = false;
    #activateTimeoutId: number;
    #deactivateTimeoutId: number;
    #parentComponent?: Component;
    #tooltip?: string;
    #tooltipFeature?: TooltipFeature;
    #suppressRootStyles: boolean = true;
    #suppressAria: boolean = true;
    #suppressFocus: boolean = true;
    #cssClassPrefix: string;
    #eSubMenuGui?: HTMLElement;
    ...
    #addListeners(eGui: HTMLElement, params?: IMenuConfigParams): void {
    ...
    #onItemSelected(event: MouseEvent | KeyboardEvent): void {
    ...
    #closeMenu(event?: MouseEvent | KeyboardEvent): void {
    ...
    #refreshTooltip(tooltip?: string, shouldDisplayTooltip?: () => boolean): void {
