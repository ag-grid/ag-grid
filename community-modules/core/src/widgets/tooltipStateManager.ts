...
export class TooltipStateManager extends BeanStub {
    ...
    readonly #SHOW_QUICK_TOOLTIP_DIFF = 1000;
    readonly #FADE_OUT_TOOLTIP_TIMEOUT = 1000;
    readonly #INTERACTIVE_HIDE_DELAY = 100;
    ...
    #showTooltipTimeoutId: number | undefined;
    #hideTooltipTimeoutId: number | undefined;
    #interactiveTooltipTimeoutId: number | undefined;

    #interactionEnabled = false;
    #isInteractingWithTooltip = false;

    #state = TooltipStates.NOTHING;

    #lastMouseEvent: MouseEvent | null;

    #tooltipComp: ITooltipComp | undefined;
    #tooltipPopupDestroyFunc: (() => void) | undefined;
    // when showing the tooltip, we need to make sure it's the most recent instance we request, as due to
    // async we could request two tooltips before the first instance returns, in which case we should
    // disregard the second instance.
    #tooltipInstanceCount = 0;
    #tooltipMouseTrack: boolean = false;
    #tooltipTrigger: TooltipTrigger;

    #tooltipMouseEnterListener: (() => null) | null;
    #tooltipMouseLeaveListener: (() => null) | null;
    #tooltipFocusInListener: (() => null) | null;
    #tooltipFocusOutListener: (() => null) | null;

    #onBodyScrollEventCallback: (() => null) | undefined;
    #onColumnMovedEventCallback: (() => null) | undefined;
    ...
    #getGridOptionsTooltipDelay(delayOption: 'tooltipShowDelay' | 'tooltipHideDelay'): number {
    ...
    #getTooltipDelay(type: 'show' | 'hide'): number {
        if (type === 'show') {
    ...
    #onTooltipFocusOut(e: FocusEvent): void {
