...
export class ColumnSizeService extends BeanStub {
    ...
    public setColumnWidths(
        ...
        columnWidths.forEach(columnWidth => {
            const col = this.columnModel.getPrimaryOrGridColumn(columnWidth.key);
            ...
            if (shiftKey) {
                const otherCol = this.columnModel.getDisplayedColAfter(col);
                if (!otherCol) { return; }
    ...
    public resizeColumnSets(params: {
        ...
        if (atLeastOneColChanged) {
            ...
            this.columnModel.setLeftValues(source);
            this.columnModel.updateBodyWidths();
    ...
    public refreshFlexedColumns(params: { resizingCols?: Column[], skipSetLeft?: boolean, viewportWidth?: number, source?: ColumnEventType, fireResizedEvent?: boolean, updateBodyWidths?: boolean; } = {}): Column[] {
        ...
        let displayedCenterCols = this.columnModel.getDisplayedCenterColumns();
