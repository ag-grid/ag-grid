...
export class DragAndDropService extends BeanStub {
    ...
    @PostConstruct
    private init(): void {
        this.ePinnedIcon = createIcon('columnMovePin', this.beans.gos, null);
        this.eHideIcon = createIcon('columnMoveHide', this.beans.gos, null);
        this.eMoveIcon = createIcon('columnMoveMove', this.beans.gos, null);
        this.eLeftIcon = createIcon('columnMoveLeft', this.beans.gos, null);
        this.eRightIcon = createIcon('columnMoveRight', this.beans.gos, null);
        this.eGroupIcon = createIcon('columnMoveGroup', this.beans.gos, null);
        this.eAggregateIcon = createIcon('columnMoveValue', this.beans.gos, null);
        this.ePivotIcon = createIcon('columnMovePivot', this.beans.gos, null);
        this.eDropNotAllowedIcon = createIcon('dropNotAllowed', this.beans.gos, null);
    }
    ...
    private findCurrentDropTarget(mouseEvent: MouseEvent, validDropTargets: DropTarget[]): DropTarget | null {
        ...
        const rootNode = this.beans.gos.getRootNode();
    ...
    private createGhost(): void {
        ...
        try {
            ...
            if (!rootNode) {
                rootNode = this.beans.gos.getRootNode();
            }
    ...
    public setGhostIcon(iconName: string | null, shake = false): void {
        ...
        if (eIcon === this.eHideIcon && this.beans.gos.get('suppressDragLeaveHidesColumns')) {
            return;
        }
        if (eIcon) {
