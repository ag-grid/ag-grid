...
export class VirtualListDragFeature<C extends Component, R extends Component, V, E extends AgEvent> extends BeanStub {
    ...
    #currentDragValue: V | null = null;
    #lastHoveredListItem: VirtualListDragItem<R> | null = null;
    ...
    #listItemDragStart(event: E): void {
    ...
    #getListDragItem(e: DraggingEvent): VirtualListDragItem<R> {
        const virtualListGui = this.virtualList.getGui();
