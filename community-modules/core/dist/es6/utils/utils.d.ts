...
export declare const _: {
    ...
    areEqual<T_24>(a?: T_24[], b?: T_24[], comparator?: (a: T_24, b: T_24) => boolean): boolean;
    ...
    toStrings<T_33>(array: T_33[]): string[];
    ...
    map<T_39, V_2>(list: T_39[], process: (value: T_39, index: number) => V_2): V_2[];
    filter<T_40>(list: T_40[], predicate: (value: T_40, index: number) => boolean): T_40[];
    reduce<T_41, V_3>(list: T_41[], step: (acc: V_3, value: T_41, index: number) => V_3, initial: V_3): V_3;
