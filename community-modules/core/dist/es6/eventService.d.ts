...
export declare class EventService implements IEventEmitter {
    ...
    private scheduled;
    private firedEvents;
    setBeans(loggerFactory: LoggerFactory, gridOptionsWrapper: GridOptionsWrapper, globalEventListener: Function | null, frameworkOverrides: IFrameworkOverrides): void;
