...
export declare class GridOptionsWrapper {
    ...
    getRowStyle(): import("./entities/gridOptions").RowStyle;
    getRowClass(): string | string[];
    getRowStyleFunc(): (params: import("./entities/gridOptions").RowClassParams) => import("./entities/gridOptions").RowStyle;
    getRowClassFunc(): (params: import("./entities/gridOptions").RowClassParams) => string | string[];
    rowClassRules(): import("./entities/gridOptions").RowClassRules;
    ...
    getDefaultGroupOrderComparator(): (nodeA: RowNode, nodeB: RowNode) => number;
    ...
    getSendToClipboardFunc(): (params: import("./entities/gridOptions").SendToClipboardParams) => void;
