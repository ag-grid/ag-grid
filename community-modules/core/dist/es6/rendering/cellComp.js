...
var CellComp = /** @class */ (function (_super) {
    ...
    CellComp.prototype.createCellRendererParams = function () {
        ...
        return {
            ...
            registerRowDragger: function (element, dragStartPixels) { return _this.addRowDragging(element, dragStartPixels); },
    ...
    CellComp.prototype.addRowDragging = function (customElement, dragStartPixels) {
        ...
        if (!this.rowDraggingComp) {
            this.rowDraggingComp = new RowDragComp(this.rowNode, this.column, function () { return _this.value; }, this.beans, customElement, dragStartPixels);
