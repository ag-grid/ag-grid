...
let RowRenderer = class RowRenderer extends BeanStub {
    ...
    refreshFloatingRows(rowComps, rowNodes) {
        ...
        rowNodes.forEach(rowNode => {
            const rowCon = new RowCtrl(this.$scope, rowNode, this.beans, false, false, this.printLayout);
    ...
    redrawFullWidthEmbeddedRows() {
        ...
        const rowsToRemove = [];
        iterateObject(this.rowCtrlsByRowIndex, (id, rowComp) => {
    ...
    refreshFullWidthRows(rowNodesToRefresh) {
        ...
        iterateObject(this.rowCtrlsByRowIndex, (id, rowCtrl) => {
            if (!rowCtrl.isFullWidth()) {
                return;
            }
    ...
    createRowCon(rowNode, animate, afterScroll) {
        ...
        const res = new RowCtrl(this.$scope, rowNode, this.beans, animate, useAnimationFrameForCreate, this.printLayout);
        return res;
    }
    getRenderedNodes() {
