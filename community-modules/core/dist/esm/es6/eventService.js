...
let EventService = class EventService {
    ...
    dispatchEvent(event) {
        ...
        if (this.gridOptionsService) {
            ...
            agEvent = Object.assign(Object.assign({}, event), { api: this.gridOptionsService.get('api'), columnApi: this.gridOptionsService.get('columnApi'), context: this.gridOptionsService.get('context') });
        }
