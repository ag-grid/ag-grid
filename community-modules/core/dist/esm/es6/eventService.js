...
let EventService = class EventService {
    ...
    setBeans(loggerFactory, gridOptionsWrapper, frameworkOverrides, globalEventListener = null) {
    ...
    dispatchEvent(event) {
        ...
        if (this.gridOptionsWrapper) {
            ...
            agEvent = Object.assign(Object.assign({}, event), { api: this.gridOptionsWrapper.getApi(), columnApi: this.gridOptionsWrapper.getColumnApi(), context: this.gridOptionsWrapper.getContext() });
        }
