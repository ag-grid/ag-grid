...
let ColumnModel = class ColumnModel extends BeanStub {
    ...
    orderColumnStateList(columnStateList) {
        ...
        const gridColumnIdMap = convertToMap(this.gridColumns.map((col, index) => [col.getColId(), index]));
    ...
    compareColumnStatesAndRaiseEvents(source) {
        ...
        return () => {
            ...
            raiseWhenListsDifferent(Events.EVENT_COLUMN_ROW_GROUP_CHANGED, startState.rowGroupColumns, this.rowGroupColumns, columnIdMapper);
            raiseWhenListsDifferent(Events.EVENT_COLUMN_PIVOT_CHANGED, startState.pivotColumns, this.pivotColumns, columnIdMapper);
    ...
    orderGridColsLikeLastPrimary() {
        ...
        const lastPrimaryOrderMapped = convertToMap(this.lastPrimaryOrder.map((col, index) => [col, index]));
