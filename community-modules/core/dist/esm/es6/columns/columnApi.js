...
let ColumnApi = class ColumnApi {
    ...
    getAllColumns() { return this.columnModel.getAllPrimaryColumns(); }
    /**
    ...
    getSecondaryPivotColumn(pivotKeys, valueColKey) { return this.columnModel.getSecondaryPivotColumn(pivotKeys, valueColKey); }
    ...
    setSecondaryColumns(colDefs) { this.columnModel.setSecondaryColumns(colDefs, 'api'); }
    /** Returns the grid's secondary columns. */
    getSecondaryColumns() { return this.columnModel.getSecondaryColumns(); }
    /** Returns the grid's primary columns. */
    getPrimaryColumns() { return this.columnModel.getAllPrimaryColumns(); }
