...
let ColumnFactory = class ColumnFactory extends BeanStub {
    ...
    recursivelyCreateColumns(defs, level, primaryColumns, existingColsCopy, columnKeyCreator, existingGroups) {
        ...
        defs.forEach((def) => {
            let newGroupOrColumn;
            if (this.isColumnGroup(def)) {
                newGroupOrColumn = this.createColumnGroup(primaryColumns, def, level, existingColsCopy, columnKeyCreator, existingGroups);
            }
            else {
                newGroupOrColumn = this.createColumn(primaryColumns, def, existingColsCopy, columnKeyCreator);
            }
    ...
    findExistingColumn(newColDef, existingColsCopy) {
        const res = (existingColsCopy || []).find(existingCol => {
    ...
    findExistingGroup(newGroupDef, existingGroups) {
        const res = existingGroups.find(existingGroup => {
