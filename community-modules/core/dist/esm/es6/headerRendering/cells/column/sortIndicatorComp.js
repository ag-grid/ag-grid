...
export class SortIndicatorComp extends Component {
    ...
    updateSortOrder() {
        ...
        const indexThisCol = (_a = this.sortController.getDisplaySortIndexForColumn(this.column), (_a !== null && _a !== void 0 ? _a : -1));
        const moreThanOneColSorting = allColumnsWithSorting.some(col => { var _a; return _a = this.sortController.getDisplaySortIndexForColumn(col), (_a !== null && _a !== void 0 ? _a : -1 >= 1); });
