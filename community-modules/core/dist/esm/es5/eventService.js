...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.dispatchEvent = function (event) {
        ...
        if (this.gridOptionsService) {
            ...
            agEvent = __assign(__assign({}, event), { api: this.gridOptionsService.get('api'), columnApi: this.gridOptionsService.get('columnApi'), context: this.gridOptionsService.get('context') });
        }
