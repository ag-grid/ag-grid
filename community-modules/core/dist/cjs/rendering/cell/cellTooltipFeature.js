...
var CellTooltipFeature = /** @class */ (function (_super) {
    ...
    CellTooltipFeature.prototype.updateTooltipText = function () {
        ...
        this.tooltipSanatised = string_1.escapeString(this.tooltip);
    };
    CellTooltipFeature.prototype.createTooltipFeatureIfNeeded = function () {
        ...
        this.genericTooltipFeature = this.createManagedBean(new tooltipFeature_1.TooltipFeature(parent), this.beans.context);
    };
...
exports.CellTooltipFeature = CellTooltipFeature;

//# sourceMappingURL=cellTooltipFeature.js.map
