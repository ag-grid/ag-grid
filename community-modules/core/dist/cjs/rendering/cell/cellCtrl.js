...
var cellTooltipFeature_1 = require("./cellTooltipFeature");
...
var CellCtrl = /** @class */ (function (_super) {
    ...
    CellCtrl.prototype.addFeatures = function () {
        ...
        this.cellTooltipFeature = new cellTooltipFeature_1.CellTooltipFeature(this, this.beans);
    ...
    CellCtrl.prototype.createRowDragComp = function (customElement, dragStartPixels) {
        ...
        var rowDragComp = new rowDragComp_1.RowDragComp(function () { return _this.value; }, this.rowNode, this.column, customElement, dragStartPixels);
