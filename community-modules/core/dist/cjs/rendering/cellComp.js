...
var CellComp = /** @class */ (function (_super) {
    ...
    CellComp.prototype.populateTemplate = function () {
        if (this.usingWrapper) {
            ...
            aria_1.setAriaDescribedBy(this.getGui(), (describedByIds + " " + this.eCellValue.id).trim());
        }
        else {
    ...
    CellComp.prototype.addRowDragging = function (customElement, dragStartPixels) {
        ...
        if (!this.rowDraggingComp) {
            this.rowDraggingComp = new rowDragComp_1.RowDragComp(function () { return _this.value; }, this.rowNode, this.column, customElement, dragStartPixels);
