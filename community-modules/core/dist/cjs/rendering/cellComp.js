...
var CellComp = /** @class */ (function (_super) {
    ...
    CellComp.prototype.createTooltipFeatureIfNeeded = function () {
        ...
        this.createManagedBean(new tooltipFeature_1.TooltipFeature(this), this.beans.context);
    ...
    CellComp.prototype.createCellEditor = function (params) {
        ...
        return cellEditorPromise.then(function (cellEditor) {
            ...
            var popupEditorWrapper = new popupEditorWrapper_1.PopupEditorWrapper(cellEditorComp);
    ...
    CellComp.prototype.onMouseDown = function (mouseEvent) {
        ...
        if (!shiftKey || (rangeController && !rangeController.getCellRanges().length)) {
            ...
            var forceBrowserFocus = (browser_1.isBrowserIE() || browser_1.isBrowserEdge()) && !this.editingCell && !dom_1.isFocusableFormField(target);
    ...
    CellComp.prototype.populateTemplate = function () {
        if (this.usingWrapper) {
            ...
            aria_1.setAriaDescribedBy(this.getGui(), describedByIds + " " + this.eCellValue.id);
        }
        else {
    ...
    CellComp.prototype.addRowDragging = function (customElement, dragStartPixels) {
        ...
        if (!this.rowDraggingComp) {
            this.rowDraggingComp = new rowDragComp_1.RowDragComp(this.rowNode, this.column, function () { return _this.value; }, this.beans, customElement, dragStartPixels);
    ...
    CellComp.prototype.addDndSource = function () {
        var dndSourceComp = new dndSourceComp_1.DndSourceComp(this.rowNode, this.column, this.beans, this.getGui());
