...
var RowRenderer = /** @class */ (function (_super) {
    ...
    RowRenderer.prototype.refreshFloatingRows = function (rowComps, rowNodes) {
        ...
        rowNodes.forEach(function (rowNode) {
            var rowCon = new rowCtrl_1.RowCtrl(_this.$scope, rowNode, _this.beans, false, false, _this.printLayout);
    ...
    RowRenderer.prototype.getCellToRestoreFocusToAfterRefresh = function (params) {
        ...
        var cellDomData = this.gridOptionsWrapper.getDomData(activeElement, cellCtrl_1.CellCtrl.DOM_DATA_KEY_CELL_CTRL);
        var rowDomData = this.gridOptionsWrapper.getDomData(activeElement, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
    ...
    RowRenderer.prototype.redrawFullWidthEmbeddedRows = function () {
        ...
        var rowsToRemove = [];
        object_1.iterateObject(this.rowCtrlsByRowIndex, function (id, rowComp) {
    ...
    RowRenderer.prototype.refreshFullWidthRows = function (rowNodesToRefresh) {
        ...
        object_1.iterateObject(this.rowCtrlsByRowIndex, function (id, rowCtrl) {
            if (!rowCtrl.isFullWidth()) {
                return;
            }
    ...
    RowRenderer.prototype.createRowCon = function (rowNode, animate, afterScroll) {
        ...
        var res = new rowCtrl_1.RowCtrl(this.$scope, rowNode, this.beans, animate, useAnimationFrameForCreate, this.printLayout);
        return res;
    };
