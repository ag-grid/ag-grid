...
var rowController_1 = require("./row/rowController");
...
var RowRenderer = /** @class */ (function (_super) {
    ...
    RowRenderer.prototype.updateAllRowCons = function () {
        this.allRowCons = __spreadArrays(object_1.getAllValuesInObject(this.rowConsByRowIndex), object_1.getAllValuesInObject(this.zombieRowCons));
    };
    ...
    RowRenderer.prototype.getAllCellsForColumn = function (column) {
        ...
        object_1.iterateObject(this.rowConsByRowIndex, callback);
        object_1.iterateObject(this.bottomRowCons, callback);
        object_1.iterateObject(this.topRowCons, callback);
        return eCells;
    };
    ...
    RowRenderer.prototype.refreshFloatingRows = function (rowComps, rowNodes) {
        ...
        rowNodes.forEach(function (rowNode) {
            var rowCon = new rowController_1.RowController(_this.$scope, rowNode, _this.beans, false, false, _this.printLayout);
    ...
    RowRenderer.prototype.getRenderedIndexesForRowNodes = function (rowNodes) {
        ...
        object_1.iterateObject(this.rowConsByRowIndex, function (index, renderedRow) {
    ...
    RowRenderer.prototype.forEachCellCompFiltered = function (rowNodes, columns, callback) {
        ...
        object_1.iterateObject(this.rowConsByRowIndex, function (index, rowComp) {
            processRow(rowComp);
        });
        if (this.topRowCons) {
    ...
    RowRenderer.prototype.calculateIndexesToDraw = function (rowsToRecycle) {
        ...
        object_1.iterateObject(this.rowConsByRowIndex, checkRowToDraw);
    ...
    RowRenderer.prototype.redrawFullWidthEmbeddedRows = function () {
        ...
        var rowsToRemove = [];
        object_1.iterateObject(this.rowConsByRowIndex, function (id, rowComp) {
            if (rowComp.isFullWidth()) {
    ...
    RowRenderer.prototype.destroyRowCons = function (rowConsMap, animate) {
        ...
        object_1.iterateObject(rowConsMap, function (nodeId, rowCon) {
    ...
    RowRenderer.prototype.createRowCon = function (rowNode, animate, afterScroll) {
        ...
        var res = new rowController_1.RowController(this.$scope, rowNode, this.beans, animate, useAnimationFrameForCreate, this.printLayout);
        return res;
    };
    ...
    RowRenderer.prototype.tabToNextCellCommon = function (previousCellOrRow, backwards) {
        ...
        if (!editing && previousCellOrRow instanceof cellComp_1.CellComp) {
    ...
    RowRenderer.prototype.moveToNextCellNotEditing = function (previousRenderedCell, backwards) {
        var displayedColumns = this.columnController.getAllDisplayedColumns();
        var gridCell;
        if (previousRenderedCell instanceof rowController_1.RowController) {
    ...
    __decorate([
        context_1.Optional("controllersService")
