...
var RowComp = /** @class */ (function (_super) {
    ...
    RowComp.prototype.addListeners = function () {
        ...
        this.addDestroyableEventListener(this.rowNode, rowNode_1.RowNode.EVENT_HIGHLIGHT_CHANGED, this.onRowNodeHighlightChanged.bind(this));
        ...
        this.addDestroyableEventListener(eventService, events_1.Events.EVENT_COLUMN_MOVED, this.onColumnMoved.bind(this));
    ...
    RowComp.prototype.onRowNodeHighlightChanged = function () {
        ...
        this.eAllRowContainers.forEach(function (row) {
            utils_1._.removeCssClass(row, 'ag-row-highlight-above');
            utils_1._.removeCssClass(row, 'ag-row-highlight-below');
            if (highlighted) {
                utils_1._.addCssClass(row, 'ag-row-highlight-' + highlighted);
            }
        });
    };
    ...
    RowComp.prototype.insertCellsIntoContainer = function (eRow, cols) {
        ...
        if (this.elementOrderChanged && this.beans.gridOptionsWrapper.isEnsureDomOrder()) {
            ...
            utils_1._.setDomChildOrder(eRow, correctChildOrder);
        }
    };
    ...
    RowComp.prototype.onRowMouseDown = function (mouseEvent) {
        this.lastMouseDownOnDragger = utils_1._.isElementChildOfClass(mouseEvent.target, 'ag-row-drag', 3);
    };
    RowComp.prototype.onRowClick = function (mouseEvent) {
        var stop = utils_1._.isStopPropagationForAgGrid(mouseEvent) || this.lastMouseDownOnDragger;
        if (stop) {
            return;
        }
