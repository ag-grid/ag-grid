...
var RowCtrl = /** @class */ (function (_super) {
    ...
    RowCtrl.prototype.setComp = function (rowComp, element, pinned) {
        ...
        if (pinned === constants_1.Constants.PINNED_LEFT) {
            this.leftGui = gui;
        }
    ...
    RowCtrl.prototype.getFullWidthCellRendererType = function () {
        return exports.FullWidthKeys.get(this.rowType);
    };
    RowCtrl.prototype.getFullWidthCellRendererName = function () {
        return exports.FullWidthRenderers.get(this.rowType);
    };
    ...
    RowCtrl.prototype.updateColumnListsImpl = function () {
        ...
        this.allRowGuis.forEach(function (item) {
            var cellControls = item.pinned === constants_1.Constants.PINNED_LEFT ? _this.leftCellCtrls :
                item.pinned === constants_1.Constants.PINNED_RIGHT ? _this.rightCellCtrls : _this.centerCellCtrls;
    ...
    RowCtrl.prototype.onKeyboardNavigate = function (keyboardEvent) {
        var currentFullWidthComp = generic_1.find(this.allRowGuis, function (c) { return c.element.contains(keyboardEvent.target); });
