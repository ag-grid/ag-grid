...
exports.FullWidthRenderers = map_1.convertToMap([
...
exports.FullWidthKeys = map_1.convertToMap([
...
var RowController = /** @class */ (function (_super) {
    ...
    function RowController(parentScope, rowNode, beans, animateIn, useAnimationFrameForCreate, printLayout) {
        ...
        _this.addListeners();
        if (_this.slideRowIn) {
            function_1.executeNextVMTurn(_this.onTopChanged.bind(_this));
        }
        if (_this.fadeRowIn) {
            function_1.executeNextVMTurn(function () {
                _this.allRowComps.forEach(function (rowComp) { return dom_1.removeCssClass(rowComp.getGui(), 'ag-opacity-zero'); });
            });
        }
        return _this;
    }
    ...
    RowController.prototype.getColsForRowComp = function (pinned) {
        switch (pinned) {
            case constants_1.Constants.PINNED_RIGHT: return this.rightCols;
            case constants_1.Constants.PINNED_LEFT: return this.leftCols;
    ...
    RowController.prototype.refreshFullWidth = function () {
        ...
        var leftSuccess = tryRefresh(this.leftRowComp, constants_1.Constants.PINNED_LEFT);
        var rightSuccess = tryRefresh(this.rightRowComp, constants_1.Constants.PINNED_RIGHT);
    ...
    RowController.prototype.onRowNodeHighlightChanged = function () {
        ...
        this.allRowComps.forEach(function (rowComp) {
            ...
            dom_1.removeCssClass(eGui, 'ag-row-highlight-above');
            dom_1.removeCssClass(eGui, 'ag-row-highlight-below');
            if (highlighted) {
                dom_1.addCssClass(eGui, 'ag-row-highlight-' + highlighted);
            }
        });
    };
    ...
    RowController.prototype.postProcessRowDragging = function () {
        ...
        this.allRowComps.forEach(function (rowComp) { return dom_1.addOrRemoveCssClass(rowComp.getGui(), 'ag-row-dragging', dragging); });
    };
    ...
    RowController.prototype.onKeyboardNavigate = function (keyboardEvent) {
        var currentFullWidthComp = generic_1.find(this.allRowComps, function (rowComp) { return rowComp.getGui().contains(keyboardEvent.target); });
    ...
    RowController.prototype.onFullWidthRowFocused = function (event) {
        ...
        dom_1.addOrRemoveCssClass(element, 'ag-full-width-focus', isFocused);
        if (isFocused) {
    ...
    RowController.prototype.addFullWidthRowDragging = function (rowDraggerElement, dragStartPixels, value) {
        ...
        var rowDragComp = new rowDragComp_1.RowDragComp(function () { return value; }, this.rowNode, undefined, rowDraggerElement, dragStartPixels);
    ...
    RowController.prototype.onUiLevelChanged = function () {
        ...
        if (this.rowLevel != newLevel) {
            ...
            this.allRowComps.forEach(function (rowComp) {
                var eGui = rowComp.getGui();
                dom_1.addCssClass(eGui, classToAdd_1);
                dom_1.removeCssClass(eGui, classToRemove_1);
            });
        }
    ...
    RowController.prototype.onModelUpdated = function () {
        ...
        if (this.firstRowOnPage !== newFirst) {
            ...
            this.allRowComps.forEach(function (rowComp) { return dom_1.addOrRemoveCssClass(rowComp.getGui(), 'ag-row-first', newFirst); });
        }
        if (this.lastRowOnPage !== newLast) {
            this.lastRowOnPage = newLast;
            this.allRowComps.forEach(function (rowComp) { return dom_1.addOrRemoveCssClass(rowComp.getGui(), 'ag-row-last', newLast); });
        }
    };
    ...
    RowController.prototype.setEditingRow = function (value) {
        ...
        this.allRowComps.forEach(function (rowComp) { return dom_1.addOrRemoveCssClass(rowComp.getGui(), 'ag-row-editing', value); });
        var event = value ?
    ...
    RowController.prototype.postProcessClassesFromGridOptions = function () {
        ...
        cssClasses.forEach(function (classStr) {
            _this.allRowComps.forEach(function (rowComp) { return dom_1.addCssClass(rowComp.getGui(), classStr); });
        });
    };
    RowController.prototype.postProcessRowClassRules = function () {
        ...
        this.beans.rowCssClassCalculator.processRowClassRules(this.rowNode, this.scope, function (className) {
            _this.allRowComps.forEach(function (rowComp) { return dom_1.addCssClass(rowComp.getGui(), className); });
        }, function (className) {
            _this.allRowComps.forEach(function (rowComp) { return dom_1.removeCssClass(rowComp.getGui(), className); });
        });
    };
    RowController.prototype.postProcessStylesFromGridOptions = function () {
        var rowStyles = this.processStylesFromGridOptions();
        this.allRowComps.forEach(function (rowComp) { return dom_1.addStylesToElement(rowComp.getGui(), rowStyles); });
    };
    ...
    RowController.prototype.onRowSelected = function () {
        ...
        this.allRowComps.forEach(function (rowComp) {
            var eGui = rowComp.getGui();
            aria_1.setAriaSelected(eGui, selected);
            dom_1.addOrRemoveCssClass(eGui, 'ag-row-selected', selected);
    ...
    RowController.prototype.setupRemoveAnimation = function () {
        ...
        if (rowStillVisibleJustNotInViewport) {
            ...
            this.allRowComps.forEach(function (rowComp) {
                dom_1.addCssClass(rowComp.getGui(), 'ag-opacity-zero');
            });
        }
    };
    ...
    RowController.prototype.onCellFocusChanged = function () {
        ...
        if (rowFocused !== this.rowFocused) {
            this.allRowComps.forEach(function (rowComp) {
                var eRow = rowComp.getGui();
                dom_1.addOrRemoveCssClass(eRow, 'ag-row-focus', rowFocused);
                dom_1.addOrRemoveCssClass(eRow, 'ag-row-no-focus', !rowFocused);
            });
    ...
    RowController.prototype.getRenderedCellForColumn = function (column) {
        ...
        var cellComp = generic_1.find(cellComps, function (c) { return !!c; });
        if (cellComp) {
            return cellComp;
        }
        var spannedCellComps = this.allRowComps.map(function (rc) { return rc.getCellCompSpanned(column); });
        cellComp = generic_1.find(spannedCellComps, function (c) { return !!c; });
