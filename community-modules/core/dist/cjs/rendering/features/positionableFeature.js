...
var PositionableFeature = /** @class */ (function (_super) {
    ...
    function PositionableFeature(element, config) {
        ...
        _this.config = object_1.assign({}, { popup: false }, config);
        return _this;
    }
    ...
    PositionableFeature.prototype.onResizeStart = function (e, side) {
        ...
        dom_1.addCssClass(this.element, 'ag-resizing');
        dom_1.addCssClass(this.resizerMap[side].element, 'ag-active');
    ...
    PositionableFeature.prototype.getSiblings = function () {
        ...
        return Array.prototype.slice.call(parent.children).filter(function (el) { return !dom_1.containsClass(el, 'ag-hidden'); });
    };
    ...
    PositionableFeature.prototype.onResizeEnd = function (e, side) {
        ...
        dom_1.removeCssClass(this.element, 'ag-resizing');
        dom_1.removeCssClass(this.resizerMap[side].element, 'ag-active');
    ...
    PositionableFeature.prototype.onMoveStart = function (e) {
        ...
        this.isMoving = true;
        dom_1.addCssClass(this.element, 'ag-moving');
        this.updateDragStartPosition(e.clientX, e.clientY);
    };
    ...
    PositionableFeature.prototype.onMoveEnd = function () {
        this.isMoving = false;
        this.boundaryEl = null;
        dom_1.removeCssClass(this.element, 'ag-moving');
    };
