...
var GridOptionsWrapper = /** @class */ (function () {
    ...
    GridOptionsWrapper.prototype.checkGridOptionsProperties = function () {
        ...
        var validProperties = __spreadArrays(propertyKeys_1.PropertyKeys.ALL_PROPERTIES, propertyKeys_1.PropertyKeys.FRAMEWORK_PROPERTIES, generic_1.values(eventKeys_1.Events).map(function (event) { return componentUtil_1.ComponentUtil.getCallbackForEvent(event); }));
    ...
    GridOptionsWrapper.prototype.isGroupMultiAutoColumn = function () {
        if (this.gridOptions.groupDisplayType) {
            return this.matchesGroupDisplayType(gridOptions_1.RowGroupingDisplayType.MULTIPLE_COLUMNS, this.gridOptions.groupDisplayType);
        }
    ...
    GridOptionsWrapper.prototype.isGroupUseEntireRow = function (pivotMode) {
        ...
        return this.gridOptions.groupDisplayType ?
            this.matchesGroupDisplayType(gridOptions_1.RowGroupingDisplayType.GROUP_ROWS, this.gridOptions.groupDisplayType) : false;
    };
    GridOptionsWrapper.prototype.isGroupSuppressAutoColumn = function () {
        var isCustomRowGroups = this.gridOptions.groupDisplayType ?
            this.matchesGroupDisplayType(gridOptions_1.RowGroupingDisplayType.CUSTOM, this.gridOptions.groupDisplayType) : false;
        if (isCustomRowGroups) {
            return true;
        }
        return this.gridOptions.treeDataDisplayType ?
            this.matchesTreeDataDisplayType(gridOptions_1.TreeDataDisplayType.CUSTOM, this.gridOptions.treeDataDisplayType) : false;
    };
    ...
    GridOptionsWrapper.prototype.getTooltipShowDelay = function () {
        ...
        if (generic_1.exists(tooltipShowDelay)) {
    ...
    GridOptionsWrapper.prototype.checkForDeprecated = function () {
        ...
        if (options.groupMultiAutoColumn) {
            ...
            options.groupDisplayType = gridOptions_1.RowGroupingDisplayType.MULTIPLE_COLUMNS;
        }
        if (options.groupUseEntireRow) {
            console.warn("AG Grid: since v26.0, the grid property `groupUseEntireRow` has been replaced by `groupDisplayType = 'groupRows'`");
            options.groupDisplayType = gridOptions_1.RowGroupingDisplayType.GROUP_ROWS;
        }
        if (options.groupSuppressAutoColumn) {
            ...
            options.groupDisplayType = gridOptions_1.RowGroupingDisplayType.CUSTOM;
        }
    ...
    GridOptionsWrapper.prototype.matchesGroupDisplayType = function (toMatch, supplied) {
        var groupDisplayTypeValues = object_1.getAllValuesInObject(gridOptions_1.RowGroupingDisplayType);
    ...
    GridOptionsWrapper.prototype.matchesTreeDataDisplayType = function (toMatch, supplied) {
        var treeDataDisplayTypeValues = object_1.getAllValuesInObject(gridOptions_1.TreeDataDisplayType);
