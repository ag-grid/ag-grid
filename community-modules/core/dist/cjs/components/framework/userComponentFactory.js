...
var UserComponentFactory = /** @class */ (function (_super) {
    ...
    UserComponentFactory.prototype.newDateComponent = function (params) {
        return this.lookupAndCreateComponent(this.gridOptions, params, componentTypes_1.DateComponent, 'agDateInput');
    };
    UserComponentFactory.prototype.newHeaderComponent = function (params) {
        return this.lookupAndCreateComponent(params.column.getColDef(), params, componentTypes_1.HeaderComponent, 'agColumnHeader');
    };
    UserComponentFactory.prototype.newHeaderGroupComponent = function (params) {
        return this.lookupAndCreateComponent(params.columnGroup.getColGroupDef(), params, componentTypes_1.HeaderGroupComponent, 'agColumnGroupHeader');
    };
    ...
    UserComponentFactory.prototype.newCellRenderer = function (def, params) {
        return this.lookupAndCreateComponent(def, params, componentTypes_1.CellRendererComponent, null, true);
    };
    UserComponentFactory.prototype.getInnerRendererDetails = function (def, params) {
        return this.getCompDetails(def, componentTypes_1.InnerRendererComponent.propertyName, null, params);
    };
    ...
    UserComponentFactory.prototype.newFullWidthGroupRowInnerCellRenderer = function (params) {
        return this.lookupAndCreateComponent(this.gridOptions.groupRowRendererParams, params, componentTypes_1.InnerRendererComponent, null, true);
    };
    // delete this one
    UserComponentFactory.prototype.newInnerCellRenderer = function (def, params) {
        return this.lookupAndCreateComponent(def, params, componentTypes_1.InnerRendererComponent, null);
    };
    UserComponentFactory.prototype.getCellRendererDetails = function (def, params) {
        return this.getCompDetails(def, componentTypes_1.CellRendererComponent.propertyName, null, params);
    };
    UserComponentFactory.prototype.createCellRenderer = function (userCompDetails) {
        return this.createAndInitComponent(userCompDetails, componentTypes_1.CellRendererComponent);
    };
    // CELL EDITOR
    UserComponentFactory.prototype.newCellEditor = function (colDef, params) {
        return this.lookupAndCreateComponent(colDef, params, componentTypes_1.CellEditorComponent, 'agCellEditor');
    };
    UserComponentFactory.prototype.getCellEditorDetails = function (def, params) {
        return this.getCompDetails(def, componentTypes_1.CellEditorComponent.propertyName, 'agCellEditor', params, true);
    };
    UserComponentFactory.prototype.createCellEditor = function (compClassAndParams) {
        return this.createAndInitComponent(compClassAndParams, componentTypes_1.CellEditorComponent);
    };
    UserComponentFactory.prototype.newLoadingOverlayComponent = function (params) {
        return this.lookupAndCreateComponent(this.gridOptions, params, componentTypes_1.LoadingOverlayComponent, 'agLoadingOverlay');
    };
    UserComponentFactory.prototype.newNoRowsOverlayComponent = function (params) {
        return this.lookupAndCreateComponent(this.gridOptions, params, componentTypes_1.NoRowsOverlayComponent, 'agNoRowsOverlay');
    };
    UserComponentFactory.prototype.newTooltipComponent = function (params) {
        return this.lookupAndCreateComponent(params.colDef, params, componentTypes_1.TooltipComponent, 'agTooltipComponent');
    };
    UserComponentFactory.prototype.newFilterComponent = function (def, params, defaultFilter) {
        return this.lookupAndCreateComponent(def, params, componentTypes_1.FilterComponent, defaultFilter, false);
    };
    ...
    UserComponentFactory.prototype.newFloatingFilterComponent = function (def, params, defaultFloatingFilter) {
        return this.lookupAndCreateComponent(def, params, componentTypes_1.FloatingFilterComponent, defaultFloatingFilter, true);
    };
    UserComponentFactory.prototype.newToolPanelComponent = function (toolPanelDef, params) {
        return this.lookupAndCreateComponent(toolPanelDef, params, componentTypes_1.ToolPanelComponent);
    };
    UserComponentFactory.prototype.newStatusPanelComponent = function (def, params) {
        return this.lookupAndCreateComponent(def, params, componentTypes_1.StatusPanelComponent);
    };
