...
var Utils = /** @class */ (function () {
    ...
    Utils.radioCssClass = function (element, elementClass, otherElementClass) {
        ...
        while (sibling) {
            if (elementClass) {
                exports._.addOrRemoveCssClass(sibling, elementClass, sibling === element);
            }
            if (otherElementClass) {
                exports._.addOrRemoveCssClass(sibling, otherElementClass, sibling !== element);
            }
    ...
    Utils.deepFreeze = function (object) {
        ...
        exports._.values(object).filter(function (v) { return v != null; }).forEach(function (v) {
