...
export declare function areEqual<T>(a: T[], b: T[], comparator?: (a: T, b: T) => boolean): boolean;
/** @deprecated */
...
export declare function toStrings<T>(array: T[]): (string | null)[];
 ...
 */
export declare function map<T, V>(list: T[], process: (value: T, index: number) => V): V[];
/**
 ...
 */
export declare function filter<T>(list: T[], predicate: (value: T, index: number) => boolean): T[];
/**
 ...
 */
export declare function reduce<T, V>(list: T[], step: (acc: V, value: T, index: number) => V, initial: V): V;
/** @deprecated */
