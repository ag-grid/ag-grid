...
export declare const _: {
    ...
    map<T_41, V_3>(list: T_41[], process: (value: T_41, index: number) => V_3): V_3[] | null;
    filter<T_42>(list: T_42[], predicate: (value: T_42, index: number) => boolean): T_42[] | null;
    reduce<T_43, V_4>(list: T_43[], step: (acc: V_4, value: T_43, index: number) => V_4, initial: V_4): V_4 | null;
