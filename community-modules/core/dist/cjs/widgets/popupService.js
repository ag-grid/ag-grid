...
var PopupService = /** @class */ (function (_super) {
    ...
    PopupService.prototype.postConstruct = function () {
        ...
        this.ctrlsService.whenReady(function (p) {
            ...
            _this.addManagedListener(_this.gridCtrl, events_1.Events.EVENT_KEYBOARD_FOCUS, function () {
                array_1.forEach(_this.popupList, function (popup) { return dom_1.addCssClass(popup.element, focusService_1.FocusService.AG_KEYBOARD_FOCUS); });
            });
            _this.addManagedListener(_this.gridCtrl, events_1.Events.EVENT_MOUSE_FOCUS, function () {
                array_1.forEach(_this.popupList, function (popup) { return dom_1.removeCssClass(popup.element, focusService_1.FocusService.AG_KEYBOARD_FOCUS); });
            });
        });
    };
    ...
    PopupService.prototype.addPopup = function (params) {
        ...
        if (this.focusService.isKeyboardMode()) {
            dom_1.addCssClass(eChild, focusService_1.FocusService.AG_KEYBOARD_FOCUS);
        }
    ...
    PopupService.prototype.hasAnchoredPopup = function () {
        return array_1.some(this.popupList, function (popup) { return popup.isAnchored; });
    };
