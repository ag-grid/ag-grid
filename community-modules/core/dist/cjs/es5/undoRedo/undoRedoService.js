...
var UndoRedoService = /** @class */ (function (_super) {
    ...
    UndoRedoService.prototype.init = function () {
        ...
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_MODEL_UPDATED, function (e) {
    ...
    UndoRedoService.prototype.undo = function () {
        ...
        if (undoAction instanceof undoRedoStack_1.RangeUndoRedoAction) {
    ...
    UndoRedoService.prototype.redo = function () {
        ...
        if (redoAction instanceof undoRedoStack_1.RangeUndoRedoAction) {
    ...
    UndoRedoService.prototype.processAction = function (action, valueExtractor) {
        ...
        action.cellValueChanges.forEach(function (cellValueChange) {
            ...
            var value = (typeof (extractedValue === null || extractedValue === void 0 ? void 0 : extractedValue.toString) === 'function') ? extractedValue.toString() : extractedValue;
    ...
    UndoRedoService.prototype.addRowEditingListeners = function () {
        var _this = this;
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_EDITING_STARTED, function (e) {
            _this.activeRowEdit = { rowIndex: e.rowIndex, rowPinned: e.rowPinned };
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_ROW_EDITING_STOPPED, function () {
    ...
    UndoRedoService.prototype.addCellEditingListeners = function () {
        var _this = this;
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_CELL_EDITING_STARTED, function (e) {
            _this.activeCellEdit = { column: e.column, rowIndex: e.rowIndex, rowPinned: e.rowPinned };
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_CELL_EDITING_STOPPED, function (e) {
            _this.activeCellEdit = null;
    ...
    UndoRedoService.prototype.addPasteListeners = function () {
        var _this = this;
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_PASTE_START, function () {
            _this.isPasting = true;
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_PASTE_END, function () {
            var action = new undoRedoStack_1.UndoRedoAction(_this.cellValueChanges);
            _this.pushActionsToUndoStack(action);
            _this.isPasting = false;
        });
    ...
    UndoRedoService.prototype.addFillListeners = function () {
        var _this = this;
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_FILL_START, function () {
            _this.isRangeInAction = true;
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_FILL_END, function (event) {
            var action = new undoRedoStack_1.RangeUndoRedoAction(_this.cellValueChanges, event.initialRange, event.finalRange);
            _this.pushActionsToUndoStack(action);
            _this.isRangeInAction = false;
        });
    };
    UndoRedoService.prototype.addCellKeyListeners = function () {
        var _this = this;
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_KEY_SHORTCUT_CHANGED_CELL_START, function () {
            _this.isRangeInAction = true;
        });
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_KEY_SHORTCUT_CHANGED_CELL_END, function () {
            ...
            if (_this.rangeService && _this.gridOptionsService.isEnableRangeSelection()) {
                action = new undoRedoStack_1.RangeUndoRedoAction(_this.cellValueChanges, undefined, undefined, __spread(_this.rangeService.getCellRanges()));
            }
            else {
