...
var RowCtrl = /** @class */ (function (_super) {
    ...
    RowCtrl.prototype.initialiseRowComps = function () {
        ...
        if (this.fadeRowIn) {
            function_1.executeNextVMTurn(function () {
    ...
    RowCtrl.prototype.addRowDraggerToRow = function (gui) {
        ...
        var rowDragComp = new rowDragComp_1.RowDragComp(function () { return '1 row'; }, this.rowNode, undefined, gui.element, undefined, true);
    ...
    RowCtrl.prototype.refreshFullWidth = function () {
        ...
        var leftSuccess = tryRefresh(this.leftGui, constants_1.Constants.PINNED_LEFT);
        var rightSuccess = tryRefresh(this.rightGui, constants_1.Constants.PINNED_RIGHT);
    ...
    RowCtrl.prototype.onRowNodeHighlightChanged = function () {
        ...
        this.allRowGuis.forEach(function (gui) {
            var aboveOn = highlighted === rowNode_1.RowHighlightPosition.Above;
            var belowOn = highlighted === rowNode_1.RowHighlightPosition.Below;
    ...
    RowCtrl.prototype.startRowEditing = function (key, charPress, sourceRenderedCell) {
    ...
    RowCtrl.prototype.getPinnedForContainer = function (rowContainerType) {
        var pinned = rowContainerType === rowContainerCtrl_1.RowContainerType.LEFT ? constants_1.Constants.PINNED_LEFT :
            rowContainerType === rowContainerCtrl_1.RowContainerType.RIGHT ? constants_1.Constants.PINNED_RIGHT : null;
        return pinned;
    };
