...
var RowContainerEventsFeature = /** @class */ (function (_super) {
    ...
    RowContainerEventsFeature.prototype.getRowForEvent = function (event) {
        ...
        while (sourceElement) {
            var rowCon = this.gridOptionsWrapper.getDomData(sourceElement, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
            if (rowCon) {
                return rowCon;
            }
    ...
    RowContainerEventsFeature.prototype.processKeyboardEvent = function (eventName, keyboardEvent) {
        ...
        var rowComp = event_1.getCtrlForEvent(this.gridOptionsWrapper, keyboardEvent, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
