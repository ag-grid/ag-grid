...
var RowContainerEventsFeature = /** @class */ (function (_super) {
    ...
    RowContainerEventsFeature.prototype.processKeyboardEvent = function (eventName, keyboardEvent) {
        var cellComp = event_1.getCtrlForEvent(this.gridOptionsService, keyboardEvent, cellCtrl_1.CellCtrl.DOM_DATA_KEY_CELL_CTRL);
        var rowComp = event_1.getCtrlForEvent(this.gridOptionsService, keyboardEvent, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
