...
var Column = /** @class */ (function () {
    ...
    Column.prototype.validate = function () {
        ...
        generic_1.exists(colDefAny['menuTabs']) && moduleRegistry_1.ModuleRegistry.assertRegistered(moduleNames_1.ModuleNames.MenuModule, 'menuTabs');
        generic_1.exists(colDefAny['columnsMenuParams']) && moduleRegistry_1.ModuleRegistry.assertRegistered(moduleNames_1.ModuleNames.MenuModule, 'columnsMenuParams');
        generic_1.exists(colDefAny['columnsMenuParams']) && moduleRegistry_1.ModuleRegistry.assertRegistered(moduleNames_1.ModuleNames.ColumnToolPanelModule, 'columnsMenuParams');
