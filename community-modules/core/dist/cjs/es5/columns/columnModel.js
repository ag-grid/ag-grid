...
var ColumnModel = /** @class */ (function (_super) {
    ...
    ColumnModel.prototype.init = function () {
        ...
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_GROUP_DISPLAY_TYPE, function () { return _this.onAutoGroupColumnDefChanged(); });
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_AUTO_GROUP_COLUMN_DEF, function () { return _this.onAutoGroupColumnDefChanged(); });
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_DEFAULT_COL_DEF, function () { return _this.onDefaultColDefChanged(); });
    };
    ...
    ColumnModel.prototype.applyColumnState = function (params, source) {
        ...
        var applyStates = function (states, existingColumns, getById) {
            ...
            states.forEach(function (state) {
                ...
                var isAutoGroupColumn = colId.startsWith(constants_1.Constants.GROUP_AUTO_COLUMN_ID);
    ...
    ColumnModel.prototype.applyOrderAfterApplyState = function (params) {
        ...
        this.gridColumns.forEach(function (col) {
            ...
            var isAutoGroupCol = colId.startsWith(constants_1.Constants.GROUP_AUTO_COLUMN_ID);
            if (isAutoGroupCol) {
