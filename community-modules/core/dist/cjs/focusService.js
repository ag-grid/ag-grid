...
var FocusService = /** @class */ (function (_super) {
    ...
    FocusService.prototype.getFocusCellToUseAfterRefresh = function () {
        ...
        if (this.isDomDataMissingInHierarchy(document.activeElement, cellCtrl_1.CellCtrl.DOM_DATA_KEY_CELL_CTRL)) {
            return null;
        }
    ...
    FocusService.prototype.getFocusHeaderToUseAfterRefresh = function () {
        ...
        // we check that the browser is actually focusing on the grid, if it is not, then
        // we have nothing to worry about
        if (this.isDomDataMissingInHierarchy(document.activeElement, abstractHeaderCellCtrl_1.AbstractHeaderCellCtrl.DOM_DATA_KEY_HEADER_CTRL)) {
            return null;
        }
