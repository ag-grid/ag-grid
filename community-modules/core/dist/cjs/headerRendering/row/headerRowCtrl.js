...
var HeaderRowCtrl = /** @class */ (function (_super) {
    ...
    HeaderRowCtrl.prototype.getHtmlElementForColumnHeader = function (column) {
        if (this.type != headerRowComp_1.HeaderRowType.COLUMN) {
            return;
        }
        var cellCtrl = generic_1.find(this.headerCellCtrls, function (cellCtrl) { return cellCtrl.getColumnGroupChild() == column; });
        if (!cellCtrl) {
            return;
        }
    ...
    HeaderRowCtrl.prototype.focusHeader = function (column, event) {
        ...
        var ctrl = generic_1.find(allCtrls, function (ctrl) { return ctrl.getColumnGroupChild() == column; });
        if (!ctrl) {
            return false;
        }
        ctrl.focus(event);
