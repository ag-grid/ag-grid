...
var HeaderFilterCellComp = /** @class */ (function (_super) {
    ...
    HeaderFilterCellComp.prototype.postConstruct = function () {
        ...
        var compProxy = {
            ...
            addOrRemoveBodyCssClass: function (cssClassName, on) { return dom_1.addOrRemoveCssClass(_this.eFloatingFilterBody, cssClassName, on); },
            addOrRemoveButtonWrapperCssClass: function (cssClassName, on) { return dom_1.addOrRemoveCssClass(_this.eButtonWrapper, cssClassName, on); },
