...
var HeaderGroupComp = /** @class */ (function (_super) {
    ...
    HeaderGroupComp.prototype.setupExpandIcons = function () {
        ...
        this.addManagedListener(originalColumnGroup, providedColumnGroup_1.ProvidedColumnGroup.EVENT_EXPANDED_CHANGED, this.updateIconVisibility.bind(this));
        this.addManagedListener(originalColumnGroup, providedColumnGroup_1.ProvidedColumnGroup.EVENT_EXPANDABLE_CHANGED, this.updateIconVisibility.bind(this));
    };
