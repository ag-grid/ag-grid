...
var HeaderGroupCellCtrl = /** @class */ (function (_super) {
    ...
    HeaderGroupCellCtrl.prototype.setComp = function (comp, eGui, eResize) {
        ...
        this.createManagedBean(new groupResizeFeature_1.GroupResizeFeature(comp, eResize, pinned, this.columnGroup));
    ...
    HeaderGroupCellCtrl.prototype.addClasses = function () {
        var _this = this;
        var colGroupDef = this.columnGroup.getColGroupDef();
        var classes = cssClassApplier_1.CssClassApplier.getHeaderClassesFromColDef(colGroupDef, this.gridOptionsWrapper, null, this.columnGroup);
