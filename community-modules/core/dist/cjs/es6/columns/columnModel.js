...
let ColumnModel = class ColumnModel extends beanStub_1.BeanStub {
    ...
    init() {
        ...
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_GROUP_DISPLAY_TYPE, () => this.onAutoGroupColumnDefChanged());
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_AUTO_GROUP_COLUMN_DEF, () => this.onAutoGroupColumnDefChanged());
        this.addManagedListener(this.gridOptionsWrapper, gridOptionsWrapper_1.GridOptionsWrapper.PROP_DEFAULT_COL_DEF, () => this.onDefaultColDefChanged());
    }
    ...
    fireColumnResizedEvent(columns, finished, source, flexColumns = null) {
    ...
    fireColumnEvent(type, columns, source) {
        const event = {
            type: type,
            columns: columns,
    ...
    moveColumns(columnsToMoveKeys, toIndex, source = "api") {
    ...
    getPrimaryAndAutoGroupCols() {
        return [].concat(...[
            this.primaryColumns || [],
            this.groupAutoColumns || [],
        ]);
    }
    getPrimaryAndSecondaryColumns() {
        return [].concat(...[
            this.primaryColumns || [],
            this.secondaryColumns || [],
        ]);
    ...
    applyColumnState(params, source = "api") {
        ...
        const applyStates = (states, existingColumns, getById) => {
            ...
            states.forEach((state) => {
                ...
                const isAutoGroupColumn = colId.startsWith(constants_1.Constants.GROUP_AUTO_COLUMN_ID);
    ...
    applyOrderAfterApplyState(params) {
        ...
        this.gridColumns.forEach(col => {
            ...
            const isAutoGroupCol = colId.startsWith(constants_1.Constants.GROUP_AUTO_COLUMN_ID);
            if (isAutoGroupCol) {
    ...
    compareColumnStatesAndRaiseEvents(source) {
        const startState = {
        ...
        return () => {
            if (this.gridOptionsWrapper.isSuppressColumnStateEvents()) {
                return;
            }
            const colsForState = this.getPrimaryAndSecondaryAndAutoColumns();
            // raises generic ColumnEvents where all columns are returned rather than what has changed
            const raiseWhenListsDifferent = (eventType, colsBefore, colsAfter, idMapper) => {
            ...
            raiseWhenListsDifferent(events_1.Events.EVENT_COLUMN_ROW_GROUP_CHANGED, startState.rowGroupColumns, this.rowGroupColumns, columnIdMapper);
            raiseWhenListsDifferent(events_1.Events.EVENT_COLUMN_PIVOT_CHANGED, startState.pivotColumns, this.pivotColumns, columnIdMapper);
            ...
            if (changedValues.length > 0) {
                ...
                this.fireColumnEvent(events_1.Events.EVENT_COLUMN_VALUE_CHANGED, this.valueColumns, source);
            }
    ...
    raiseColumnPinnedEvent(changedColumns, source) {
    ...
    raiseColumnVisibleEvent(changedColumns, source) {
        if (!changedColumns.length) {
            return;
        }
        // if just one column, we use this, otherwise we don't include the col
    ...
    raiseColumnMovedEvent(colStateBefore, source) {
    ...
    setAutoHeightActive() {
        ...
        if (this.autoHeightActive) {
            ...
            const supportedRowModel = rowModelType === constants_1.Constants.ROW_MODEL_TYPE_CLIENT_SIDE || rowModelType === constants_1.Constants.ROW_MODEL_TYPE_SERVER_SIDE;
    ...
    sizeColumnsToFit(gridWidth, source = "sizeColumnsToFit", silent, params) {
        ...
        const limitsMap = {};
        if (params) {
            (_b = (_a = params) === null || _a === void 0 ? void 0 : _a.columnLimits) === null || _b === void 0 ? void 0 : _b.forEach((_a) => {
        ...
        while (!finishedResizing) {
            ...
            if (availablePixels <= 0) {
                ...
                colsToSpread.forEach((column) => {
                    var _a, _b, _c, _d;
                    const widthOverride = (_c = (_b = (_a = limitsMap) === null || _a === void 0 ? void 0 : _a[column.getId()]) === null || _b === void 0 ? void 0 : _b.minWidth, (_c !== null && _c !== void 0 ? _c : (_d = params) === null || _d === void 0 ? void 0 : _d.defaultMinWidth));
                ...
                for (let i = colsToSpread.length - 1; i >= 0; i--) {
                    ...
                    const widthOverride = (_c = limitsMap) === null || _c === void 0 ? void 0 : _c[column.getId()];
                    const minOverride = (_e = (_d = widthOverride) === null || _d === void 0 ? void 0 : _d.minWidth, (_e !== null && _e !== void 0 ? _e : (_f = params) === null || _f === void 0 ? void 0 : _f.defaultMinWidth));
                    const maxOverride = (_h = (_g = widthOverride) === null || _g === void 0 ? void 0 : _g.maxWidth, (_h !== null && _h !== void 0 ? _h : (_j = params) === null || _j === void 0 ? void 0 : _j.defaultMaxWidth));
                    const colMinWidth = (_k = column.getMinWidth(), (_k !== null && _k !== void 0 ? _k : 0));
                    const colMaxWidth = (_l = column.getMaxWidth(), (_l !== null && _l !== void 0 ? _l : Number.MAX_VALUE));
