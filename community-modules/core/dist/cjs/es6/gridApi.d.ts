...
import { GetGroupRowAggParams, GetServerSideStoreParamsParams, InitialGroupOrderComparatorParams, IsServerSideGroupOpenByDefaultParams, NavigateToNextCellParams, NavigateToNextHeaderParams, PaginationNumberFormatterParams, PostProcessPopupParams, PostSortRowsParams, ProcessRowParams, RowHeightParams, TabToNextCellParams, TabToNextHeaderParams } from "./entities/iCallbackParams";
...
export declare class GridApi {
    ...
    */
     ...
     */
    getFilterInstance(key: string | Column, callback?: (filter: IFilter | null) => void): IFilter | null | undefined;
    ...
    */
    ...
    setFocusedCell(rowIndex: number, colKey: string | Column, rowPinned?: string): void;
    ...
    setIsFullWidthRow(isFullWidthRowFunc: (rowNode: RowNode) => boolean): void;
