...
class AgDialog extends agPanel_1.AgPanel {
    ...
    setMaximizable(maximizable) {
        ...
        eGui.appendChild(this.maximizeIcon = icon_1.createIconNoSpan('maximize', this.gridOptionsService));
        this.maximizeIcon.classList.add('ag-panel-title-bar-button-icon');
        eGui.appendChild(this.minimizeIcon = icon_1.createIconNoSpan('minimize', this.gridOptionsService));
        this.minimizeIcon.classList.add('ag-panel-title-bar-button-icon');
        dom_1.setDisplayed(this.minimizeIcon, false);
