...
let GridApi = class GridApi {
    ...
    refreshClientSideRowModel(step) {
        ...
        let paramsStep = iClientSideRowModel_1.ClientSideRowModelSteps.EVERYTHING;
        const stepsMapped = {
            everything: iClientSideRowModel_1.ClientSideRowModelSteps.EVERYTHING,
    ...
    */
    ...
    doLayout() {
        ...
        function_1.doOnce(() => console.warn(message), 'doLayoutDeprecated');
    }
    ...
    updateRowData(rowDataTransaction) {
        ...
        function_1.doOnce(() => console.warn(message), 'updateRowData deprecated');
    ...
    batchUpdateRowData(rowDataTransaction, callback) {
        ...
        function_1.doOnce(() => console.warn(message), 'batchUpdateRowData deprecated');
    ...
    refreshServerSideStore(params) {
        ...
        function_1.doOnce(() => console.warn(message), 'refreshServerSideStore-renamed');
    ...
    getServerSideStoreState() {
        ...
        function_1.doOnce(() => console.warn(message), 'getServerSideStoreState-renamed');
