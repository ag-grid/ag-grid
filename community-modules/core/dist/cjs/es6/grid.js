...
class GridCoreCreator {
    ...
    createBeansList(rowModelType, registeredModules) {
        ...
        const beans = [
            rowModelClass, beans_1.Beans, rowPositionUtils_1.RowPositionUtils, cellPositionUtils_1.CellPositionUtils, headerPosition_1.HeaderPositionUtils,
    ...
    getRowModelClass(rowModelType, registeredModules) {
        ...
        if (missingModules[rowModelType]) {
            moduleRegistry_1.ModuleRegistry.assertRegistered(missingModules[rowModelType], `rowModelType = '${rowModelType}'`);
        }
        else {
