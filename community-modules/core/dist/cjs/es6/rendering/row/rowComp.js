...
class RowComp extends component_1.Component {
    constructor(ctrl, beans, containerType) {
        ...
        const compProxy = {
            ...
            setAriaExpanded: on => aria_1.setAriaExpanded(eGui, on),
            setUserStyles: styles => dom_1.addStylesToElement(eGui, styles),
            setAriaSelected: value => aria_1.setAriaSelected(eGui, value),
            setAriaLabel: value => {
    ...
    newCellComp(cellCtrl) {
        const cellComp = new cellComp_1.CellComp(this.rowCtrl.getScope(), this.beans, cellCtrl, this.rowCtrl.isPrintLayout(), this.getGui(), this.rowCtrl.isEditing());
