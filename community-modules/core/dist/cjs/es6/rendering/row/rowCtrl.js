...
const angularRowUtils_1 = require("./angularRowUtils");
...
class RowCtrl extends beanStub_1.BeanStub {
    constructor(parentScope, rowNode, beans, animateIn, useAnimationFrameForCreate, printLayout) {
        super();
        this.allRowGuis = [];
        this.active = true;
    ...
    setupAngular1Scope() {
        const scopeResult = angularRowUtils_1.AngularRowUtils.createChildScopeOrNull(this.rowNode, this.parentScope, this.beans.gridOptionsWrapper);
        if (scopeResult) {
    ...
    startRowEditing(key = null, charPress = null, sourceRenderedCell = null) {
    ...
    postProcessRowClassRules() {
        this.beans.rowCssClassCalculator.processRowClassRules(this.rowNode, this.scope, (className) => {
    ...
    getPinnedForContainer(rowContainerType) {
        const pinned = rowContainerType === rowContainerCtrl_1.RowContainerType.LEFT ? constants_1.Constants.PINNED_LEFT :
