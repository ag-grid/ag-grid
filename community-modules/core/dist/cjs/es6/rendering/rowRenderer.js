...
let RowRenderer = class RowRenderer extends beanStub_1.BeanStub {
    ...
    registerCellEventListeners() {
        ...
        this.addManagedListener(this.eventService, events_1.Events.EVENT_CELL_FOCUS_CLEARED, () => {
    ...
    getCellToRestoreFocusToAfterRefresh(params) {
        ...
        const cellDomData = this.gridOptionsService.getDomData(activeElement, cellCtrl_1.CellCtrl.DOM_DATA_KEY_CELL_CTRL);
        const rowDomData = this.gridOptionsService.getDomData(activeElement, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
