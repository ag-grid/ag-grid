...
let RowRenderer = class RowRenderer extends beanStub_1.BeanStub {
    ...
    refreshFloatingRows(rowComps, rowNodes) {
        ...
        rowNodes.forEach(rowNode => {
            const rowCon = new rowCtrl_1.RowCtrl(this.$scope, rowNode, this.beans, false, false, this.printLayout);
    ...
    calculateIndexesToDraw(rowsToRecycle) {
        ...
        const indexesToDraw = number_1.createArrayOfNumbers(this.firstRenderedRow, this.lastRenderedRow);
    ...
    redrawFullWidthEmbeddedRows() {
        ...
        const rowsToRemove = [];
        object_1.iterateObject(this.rowCtrlsByRowIndex, (id, rowComp) => {
    ...
    refreshFullWidthRows(rowNodesToRefresh) {
        ...
        object_1.iterateObject(this.rowCtrlsByRowIndex, (id, rowCtrl) => {
            if (!rowCtrl.isFullWidth()) {
                return;
            }
    ...
    createOrUpdateRowCtrl(rowIndex, rowsToRecycle, animate, afterScroll) {
        let rowNode;
        let rowCon = this.rowCtrlsByRowIndex[rowIndex];
    ...
    createRowCon(rowNode, animate, afterScroll) {
        ...
        const res = new rowCtrl_1.RowCtrl(this.$scope, rowNode, this.beans, animate, useAnimationFrameForCreate, this.printLayout);
        return res;
    }
    getRenderedNodes() {
...
__decorate([
    context_1.Optional("ctrlsService")
