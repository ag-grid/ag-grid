...
const popupEditorWrapper_1 = require("./../cellEditors/popupEditorWrapper");
const aria_1 = require("../../utils/aria");
const string_1 = require("../../utils/string");
const generic_1 = require("../../utils/generic");
const dom_1 = require("../../utils/dom");
class CellComp extends component_1.Component {
    constructor(scope, beans, cellCtrl, printLayout, eRow, editingRow) {
        super();
        this.scope = null;
        ...
        const compProxy = {
            ...
            setAriaSelected: selected => aria_1.setAriaSelected(eGui, selected),
            setAriaExpanded: selected => aria_1.setAriaExpanded(eGui, selected),
            getFocusableElement: () => this.getFocusableElement(),
            setAriaColIndex: index => aria_1.setAriaColIndex(this.getGui(), index),
    ...
    insertValueUsingAngular1Template() {
        ...
        if (template != null) {
            ...
            // as in cache.
            templateToInsert = this.beans.templateService.getTemplate(templateUrl, () => this.cellCtrl.refreshCell({ forceRefresh: true }));
        }
        else {
    ...
    updateAngular1ScopeAndCompile() {
        if (this.beans.gridOptionsWrapper.isAngularCompileRows() && this.scope) {
            this.scope.data = Object.assign({}, this.rowNode.data);
            if (this.angularCompiledElement) {
                this.angularCompiledElement.remove();
            }
            const eParent = this.getParentOfValue();
