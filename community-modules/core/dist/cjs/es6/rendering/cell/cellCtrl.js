...
const cellRangeFeature_1 = require("./cellRangeFeature");
const generic_1 = require("../../utils/generic");
const beanStub_1 = require("../../context/beanStub");
const cellPositionFeature_1 = require("./cellPositionFeature");
const string_1 = require("../../utils/string");
const cellCustomStyleFeature_1 = require("./cellCustomStyleFeature");
const tooltipFeature_1 = require("../../widgets/tooltipFeature");
const cellMouseListenerFeature_1 = require("./cellMouseListenerFeature");
const cellKeyboardListenerFeature_1 = require("./cellKeyboardListenerFeature");
const keyCode_1 = require("../../constants/keyCode");
const checkboxSelectionComponent_1 = require("../checkboxSelectionComponent");
const dndSourceComp_1 = require("../dndSourceComp");
...
class CellCtrl extends beanStub_1.BeanStub {
    ...
    addFeatures() {
        ...
        this.cellKeyboardListenerFeature = new cellKeyboardListenerFeature_1.CellKeyboardListenerFeature(this, this.beans, this.column, this.rowNode, this.scope, this.rowCtrl);
    ...
    setComp(comp, scope, eGui, eCellWrapper, printLayout, startEditing) {
        this.cellComp = comp;
        ...
        const colIdSanitised = string_1.escapeString(this.column.getId());
    ...
    setupAutoHeight() {
        ...
        const measureHeight = (timesCalled) => {
            ...
            const { paddingTop, paddingBottom } = dom_1.getElementSize(eParentCell);
    ...
    setupAriaExpanded() {
        ...
        this.addManagedListener(this.rowNode, rowNode_1.RowNode.EVENT_EXPANDED_CHANGED, listener);
        listener();
    }
    ...
    startEditing(key = null, charPress = null, cellStartedEdit = false) {
        ...
        const event = this.createEvent(null, events_1.Events.EVENT_CELL_EDITING_STARTED);
    ...
    dispatchEditingStoppedEvent(oldValue, newValue) {
        const editingStoppedEvent = Object.assign(Object.assign({}, this.createEvent(null, events_1.Events.EVENT_CELL_EDITING_STOPPED)), { oldValue,
            newValue });
    ...
    startRowOrCellEdit(key, charPress) {
        if (this.beans.gridOptionsWrapper.isFullRowEdit()) {
    ...
    dispatchCellContextMenuEvent(event) {
        const colDef = this.column.getColDef();
        const cellContextMenuEvent = this.createEvent(event, events_1.Events.EVENT_CELL_CONTEXT_MENU);
    ...
    createRowDragComp(customElement, dragStartPixels, suppressVisibilityChange) {
        ...
        if (rowDragManaged) {
            ...
            if (!clientSideRowModelActive) {
                function_1.doOnce(() => console.warn('AG Grid: managed row dragging is only allowed in the Client Side Row Model'), 'CellComp.addRowDragging');
                return;
            }
            if (pagination) {
                function_1.doOnce(() => console.warn('AG Grid: managed row dragging is not possible when doing pagination'), 'CellComp.addRowDragging');
                return;
            }
        }
        // otherwise (normal case) we are creating a RowDraggingComp for the first time
        const rowDragComp = new rowDragComp_1.RowDragComp(() => this.value, this.rowNode, this.column, customElement, dragStartPixels, suppressVisibilityChange);
