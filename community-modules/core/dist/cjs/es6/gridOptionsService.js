...
let GridOptionsService = class GridOptionsService {
    ...
    */
    mergeGridCommonParams(callback) {
        if (callback) {
            const wrapped = (callbackParams) => {
                const mergedParams = Object.assign(Object.assign({}, callbackParams), { api: this.gridOptions.api, columnApi: this.gridOptions.columnApi, context: this.gridOptions.context });
    ...
    isDomLayout(domLayout) {
        var _a;
        const gridLayout = (_a = this.get('domLayout')) !== null && _a !== void 0 ? _a : 'normal';
