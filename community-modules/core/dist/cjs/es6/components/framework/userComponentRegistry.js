...
let UserComponentRegistry = class UserComponentRegistry extends beanStub_1.BeanStub {
    ...
    retrieve(name) {
        ...
        if (moduleForComponent) {
            ...
            function_1.doOnce(() => console.warn(`AG Grid: Looking for component [${name}] but it wasn't found. Have you registered the component? See https://ag-grid.com/javascript-data-grid/components/`), "MissingComp" + name);
        }
        return null;
    }
};
