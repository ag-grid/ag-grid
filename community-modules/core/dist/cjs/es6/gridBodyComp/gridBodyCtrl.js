...
class GridBodyCtrl extends beanStub_1.BeanStub {
    ...
    addAngularApplyCheck() {
        ...
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_DISPLAYED_COLUMNS_CHANGED, () => this.requestAngularApply());
        this.addManagedListener(this.eventService, eventKeys_1.Events.EVENT_VIRTUAL_COLUMNS_CHANGED, () => this.requestAngularApply());
    }
}
__decorate([
