...
function templateFactory() {
    ...
    const template2 = name === rowContainerCtrl_1.RowContainerName.TOP_CENTER || name === rowContainerCtrl_1.RowContainerName.BOTTOM_CENTER;
    if (template1) {
        res = /* html */
...
class RowContainerComp extends component_1.Component {
    ...
    newRowComp(rowCtrl) {
        const pinned = rowContainerCtrl_1.RowContainerCtrl.getPinned(this.name);
        const res = new rowComp_1.RowComp(rowCtrl, this.beans, this.type);
        return res;
    }
}
__decorate([
