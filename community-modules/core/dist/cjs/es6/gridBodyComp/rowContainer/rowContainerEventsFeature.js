...
class RowContainerEventsFeature extends beanStub_1.BeanStub {
    ...
    getRowForEvent(event) {
        ...
        while (sourceElement) {
            const rowCon = this.gridOptionsWrapper.getDomData(sourceElement, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
            if (rowCon) {
                return rowCon;
            }
    ...
    processKeyboardEvent(eventName, keyboardEvent) {
        const cellComp = event_1.getCtrlForEvent(this.gridOptionsWrapper, keyboardEvent, cellCtrl_1.CellCtrl.DOM_DATA_KEY_CELL_CTRL);
        const rowComp = event_1.getCtrlForEvent(this.gridOptionsWrapper, keyboardEvent, rowCtrl_1.RowCtrl.DOM_DATA_KEY_ROW_CTRL);
    ...
    processCellKeyboardEvent(cellCtrl, eventName, keyboardEvent) {
        ...
        const gridProcessingAllowed = !keyboard_1.isUserSuppressingKeyboardEvent(this.gridOptionsWrapper, keyboardEvent, rowNode, column, editing);
    ...
    processFullWidthRowKeyboardEvent(rowComp, eventName, keyboardEvent) {
        ...
        const gridProcessingAllowed = !keyboard_1.isUserSuppressingKeyboardEvent(this.gridOptionsWrapper, keyboardEvent, rowNode, column, false);
        if (gridProcessingAllowed) {
    ...
    onCtrlAndA(event) {
        ...
        const { PINNED_BOTTOM, PINNED_TOP } = constants_1.Constants;
