...
var SimpleFilter = /** @class */ (function (_super) {
    ...
    SimpleFilter.prototype.doesFilterPass = function (params) {
        ...
        var combineFunction = operator && operator === 'OR' ? array_1.some : array_1.every;
    ...
    SimpleFilter.prototype.getDefaultJoinOperator = function (defaultJoinOperator) {
        return array_1.includes(['AND', 'OR'], defaultJoinOperator) ? defaultJoinOperator : 'AND';
    };
    SimpleFilter.prototype.putOptionsIntoDropdown = function () {
        ...
        array_1.forEach(filterOptions, function (option) {
            ...
            array_1.forEach(eTypes, function (eType) { return eType.addOption(listOption); });
        });
        // Make drop-downs read-only if there is only one option.
        array_1.forEach(eTypes, function (eType) { return eType.setDisabled(filterOptions.length <= 1); });
    };
    ...
    SimpleFilter.prototype.updateUiVisibility = function () {
        ...
        array_1.forEach(elementConditionGroups, function (group, position) {
            var visible = _this.isConditionVisible(position);
            var disabled = _this.isConditionDisabled(position);
            array_1.forEach(group, function (element) {
                if (element instanceof agAbstractInputField_1.AgAbstractInputField || element instanceof agSelect_1.AgSelect) {
                    ...
                    dom_1.setDisplayed(element, visible);
                }
            });
        });
        array_1.forEach(elementBodies, function (element, index) {
    ...
    SimpleFilter.prototype.isConditionUiComplete = function (position) {
        ...
        if (utils_1._.some(this.getValues(position), function (v) { return v == null; })) {
            return false;
        }
        return true;
    };
    ...
    SimpleFilter.prototype.evaluateCustomFilter = function (customFilterOption, values, cellValue) {
        ...
        if (predicate != null && !utils_1._.some(values, function (v) { return v == null; })) {
    ...
    __decorate([
        componentAnnotations_1.RefSelector('eCondition1Body')
