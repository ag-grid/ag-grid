...
var ProvidedFilter = /** @class */ (function (_super) {
    ...
    ProvidedFilter.prototype.setParams = function (params) {
        ...
        utils_1._.setDisplayed(this.eClearButton, clearActive);
        ...
        utils_1._.setDisplayed(this.eResetButton, resetActive);
    ...
    __decorate([
        componentAnnotations_1.RefSelector('eResetButton')
