...
var OptionsFactory = /** @class */ (function () {
    ...
    OptionsFactory.prototype.checkForDeprecatedParams = function () {
        if (utils_1._.some(this.filterOptions, function (opt) { return typeof opt != 'string' && opt.test != null; })) {
            console.warn("AG Grid: [IFilterOptionDef] since v26.2.0, test() has been replaced with predicate().");
        }
        if (utils_1._.some(this.filterOptions, function (opt) { return typeof opt != 'string' && opt.hideFilterInput != null; })) {
    ...
    OptionsFactory.prototype.mapCustomOptions = function () {
        ...
        this.filterOptions.forEach(function (filterOption) {
            ...
            var propertyCheck = function (keys) {
                if (!array_1.some(keys, function (key) { return filterOption[key] != null; })) {
                    console.warn("AG Grid: ignoring FilterOptionDef as it doesn't contain one of '" + keys + "'");
                    return false;
                }
                return true;
            };
            if (!array_1.every(requiredProperties, propertyCheck)) {
                _this.filterOptions = utils_1._.filter(_this.filterOptions, function (v) { return v === filterOption; }) || [];
                return;
            }
