...
export declare class GridOptionsWrapper {
    ...
    getRowStyleFunc(): ((params: import("./entities/gridOptions").RowClassParams) => import("./entities/gridOptions").RowStyle | undefined) | undefined;
    ...
    getTabToNextHeaderFunc(): ((params: TabToNextHeaderParams) => (HeaderPosition | null)) | undefined;
    getNavigateToNextCellFunc(): ((params: NavigateToNextCellParams) => (CellPosition | null)) | undefined;
    getTabToNextCellFunc(): ((params: TabToNextCellParams) => (CellPosition | null)) | undefined;
    ...
    getProcessGroupHeaderForClipboardFunc(): ((params: ProcessGroupHeaderForExportParams) => any) | undefined;
