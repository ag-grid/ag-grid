...
export declare enum RowGroupingDisplayType {
    SINGLE_COLUMN = "singleColumn",
    MULTIPLE_COLUMNS = "multipleColumns",
    GROUP_ROWS = "groupRows",
    CUSTOM = "custom"
}
export declare enum TreeDataDisplayType {
    AUTO = "auto",
    CUSTOM = "custom"
}
