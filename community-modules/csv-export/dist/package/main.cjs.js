...
var Downloader = class {
  static download(fileName, content) {
    ...
    if (!win) {
      (0, import_core2._warnOnce)("There is no `window` associated with the current `document`");
      return;
    }
...
var CsvSerializingSession = class extends BaseGridSerializingSession {
  ...
  putInQuotes(value) {
    ...
    if (typeof value === "string") {
      ...
      (0, import_core3._warnOnce)("unknown value type during csv conversion");
      stringValue = "";
    }
...
var CsvCreator = class extends BaseCreator {
  ...
  export(userParams) {
    if (this.isExportSuppressed()) {
      (0, import_core4._warnOnce)(`Export cancelled. Export is not allowed as per your configuration.`);
      return;
    }
...
var GridSerializer = class extends import_core5.BeanStub {
  constructor() {
    super(...arguments);
  ...
  serialize(gridSerializingSession, params = {}) {
    ...
    const serializeChain = (0, import_core5._compose)(
  ...
  exportColumnGroups(params, columnsToExport) {
    return (gridSerializingSession) => {
      if (!params.skipColumnGroupHeaders) {
        const idCreator = new import_core5.GroupInstanceIdCreator();
  ...
  getColumnsToExport(allColumns = false, skipRowGroups = false, columnKeys) {
    ...
    if (skipRowGroups && !isTreeData) {
      columnsToExport = columnsToExport.filter((column) => column.getColId() !== import_core5.GROUP_AUTO_COLUMN_ID);
    }
  ...
  recursivelyAddHeaderGroups(displayedGroups, gridSerializingSession, processGroupHeaderCallback) {
    ...
    if (displayedGroups.length > 0 && (0, import_core5.isColumnGroup)(displayedGroups[0])) {
  ...
  doAddHeaderHeader(gridSerializingSession, displayedGroups, processGroupHeaderCallback) {
    ...
    displayedGroups.forEach((columnGroupChild) => {
      ...
      const collapsibleGroupRanges = columnGroup.getLeafColumns().reduce((collapsibleGroups, currentColumn, currentIdx, arr) => {
        let lastGroup = (0, import_core5._last)(collapsibleGroups);
...
var CsvExportCoreModule = {
  version: VERSION,
  moduleName: `${import_core6.ModuleNames.CsvExportModule}-core`,
  beans: [CsvCreator, GridSerializer]
};
var CsvExportApiModule = {
  version: VERSION,
  moduleName: `${import_core6.ModuleNames.CsvExportModule}-api`,
  apiFunctions: {
    getDataAsCsv,
    exportDataAsCsv
  },
...
var CsvExportModule = {
  version: VERSION,
  moduleName: import_core6.ModuleNames.CsvExportModule,
...
var getHeaders = (currentFile, isCompressed, offset, rawSize, rawContent, deflatedSize) => {
  ...
  const utfPath = (0, import_core7._utf8_encode)(path);
