...
var InfiniteBlock = class extends import_core.RowNodeBlock {
  ...
  loadFromDatasource() {
    ...
    if ((0, import_core._missing)(this.params.datasource.getRows)) {
      (0, import_core._warnOnce)(`datasource is missing getRows method`);
      return;
    }
    window.setTimeout(() => {
...
var InfiniteCache = class extends import_core2.BeanStub {
  constructor(params) {
    super();
  ...
  pageLoaded(block, lastRow) {
    ...
    if (this.gos.get("debug")) {
      (0, import_core2._log)(`InfiniteCache - onPageLoaded: page = ${block.getId()}, lastRow = ${lastRow}`);
    }
  ...
  setRowCount(rowCount, lastRowIndexKnown) {
    ...
    if ((0, import_core2._exists)(lastRowIndexKnown)) {
  ...
  getBlocksInOrder() {
    ...
    const blocks = (0, import_core2._getAllValuesInObject)(this.blocks).sort(blockComparator);
    return blocks;
  }
  destroyBlock(block) {
...
var InfiniteRowModel = class extends import_core3.BeanStub {
  ...
  isSortModelDifferent() {
    return !(0, import_core3._jsonEquals)(this.cacheParams.sortModel, this.sortController.getSortModel());
  }
  getType() {
    return "infinite";
  }
...
var InfiniteRowModelCoreModule = {
  version: VERSION,
  moduleName: `${import_core4.ModuleNames.InfiniteRowModelModule}-core`,
  rowModel: "infinite",
  beans: [InfiniteRowModel],
  dependantModules: [import_core4._RowNodeBlockModule]
};
var InfiniteRowModelApiModule = {
  version: VERSION,
  moduleName: `${import_core4.ModuleNames.InfiniteRowModelModule}-api`,
  beans: [import_core4.RowModelHelperService],
  apiFunctions: {
  ...
  dependantModules: [InfiniteRowModelCoreModule, import_core4._SsrmInfiniteSharedApiModule]
};
