...
import { Bean as Bean2, ComponentUtil as ComponentUtil2, Events, createGrid } from "@ag-grid-community/core";
...
AgGridVue.ALWAYS_SYNC_GLOBAL_EVENTS = /* @__PURE__ */ new Set([Events.EVENT_GRID_PRE_DESTROYED]);
__decorateClass([
  Prop(Boolean)
