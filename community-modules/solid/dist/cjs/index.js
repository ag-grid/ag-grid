...
const TabGuardComp = props => {
  ...
  return [(() => {
    ...
    web.effect(_p$ => {
      const _v$ = `${core.TabGuardClassNames.TAB_GUARD} ${core.TabGuardClassNames.TAB_GUARD_TOP}`,
        _v$2 = tabIndex();
      _v$ !== _p$._v$ && web.className(_el$, _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && web.setAttribute(_el$, "tabindex", _p$._v$2 = _v$2);
      return _p$;
    ...
    web.effect(_p$ => {
      const _v$3 = `${core.TabGuardClassNames.TAB_GUARD} ${core.TabGuardClassNames.TAB_GUARD_BOTTOM}`,
        _v$4 = tabIndex();
      _v$3 !== _p$._v$3 && web.className(_el$2, _p$._v$3 = _v$3);
