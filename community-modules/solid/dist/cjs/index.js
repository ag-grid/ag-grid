...
class SolidCompWrapperFactory extends core.BaseComponentWrapper {
...
const DetailCellRenderer = props => {
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      const _c$ = web.memo(() => !!getDetailGridOptions(), true);
...
const UserComp = p => {
  ...
  return [web.memo((() => {
    const _c$ = web.memo(() => !!showSolidComp(), true);
    ...
    const _c$2 = web.memo(() => !!showJsComp(), true);
...
const GroupCellRenderer = props => {
  ...
  solidJs.onMount(() => {
    const compProxy = {
      setInnerRenderer: (details, valueToDisplay) => {
        ...
        const escapedValue = core._.escapeString(valueToDisplay, true);
    ...
    const ctrl = context.createBean(new core.GroupCellRendererCtrl());
  ...
  return (() => {
    ...
    web.insert(_el$5, (() => {
      const _c$ = web.memo(() => !!isShowUserComp(), true);
    ...
    web.insert(_el$5, (() => {
      const _c$2 = web.memo(() => !!isShowValue(), true);
...
class SolidFrameworkOverrides extends core.VanillaFrameworkOverrides {
  constructor() {
    super();
...
const HeaderCellComp = props => {
  ...
  const cssClassManager = new core.CssClassManager(() => eGui);
  solidJs.onMount(() => {
    const compProxy = {
  ...
  return (() => {
    ...
    web.insert(_el$3, (() => {
      const _c$ = web.memo(() => !!getUserCompDetails(), true);
...
const HeaderFilterCellComp = props => {
  ...
  let userCompPromise;
  solidJs.onMount(() => {
    userCompPromise = new core.AgPromise(resolve => {
...
const HeaderRowComp = props => {
  ...
  const typeColumn = ctrl.getType() === core.HeaderRowType.COLUMN;
  const typeGroup = ctrl.getType() === core.HeaderRowType.COLUMN_GROUP;
  const typeFilter = ctrl.getType() === core.HeaderRowType.FLOATING_FILTER;
  ...
  const setCellCtrlsMaintainOrder = next => {
    ...
    const prevMap = core._.mapById(prev, c => c.getInstanceId());

    const nextMap = core._.mapById(next, c => c.getInstanceId());
  ...
  const createCellJsx = cellCtrl => {
    switch (ctrl.getType()) {
      case core.HeaderRowType.COLUMN_GROUP:
        return web.createComponent(HeaderGroupCellComp, {
          ctrl: cellCtrl
        });

      case core.HeaderRowType.FLOATING_FILTER:
...
const _tmpl$$9 = /*#__PURE__*/web.template(`<div role="presentation"></div>`, 2),
      _tmpl$2$3 = /*#__PURE__*/web.template(`<div role="presentation"><div class="ag-header-container" role="rowgroup"></div></div>`, 4);
...
const HeaderRowContainerComp = props => {
  ...
  let eGui;
  const pinnedLeft = props.pinned === core.Constants.PINNED_LEFT;
  const pinnedRight = props.pinned === core.Constants.PINNED_RIGHT;
  ...
  solidJs.onMount(() => {
    ...
    const ctrl = context.createBean(new core.HeaderRowContainerCtrl(props.pinned));
  ...
  return [pinnedLeft && (() => {
    ...
    web.effect(_p$ => {
      ...
      _v$3 !== _p$._v$3 && web.className(_el$2, _p$._v$3 = _v$3);
      _p$._v$4 = web.style(_el$2, _v$4, _p$._v$4);
      return _p$;
    }, {
      _v$3: undefined,
      _v$4: undefined
    ...
    web.effect(_p$ => {
      ...
      _p$._v$6 = web.style(_el$4, _v$6, _p$._v$6);
      return _p$;
    }, {
      _v$5: undefined,
      _v$6: undefined
...
const GridHeaderComp = () => {
  ...
  solidJs.onMount(() => {
    ...
    const ctrl = context.createBean(new core.GridHeaderCtrl());
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(HeaderRowContainerComp, {
      get pinned() {
        return core.Constants.PINNED_LEFT;
      }
    ...
    web.insert(_el$, web.createComponent(HeaderRowContainerComp, {
      get pinned() {
        return core.Constants.PINNED_RIGHT;
      }
...
const PopupEditorComp = props => {
  ...
  const wrapper = context.createBean(new core.PopupEditorWrapper(compDetails.params));
...
const ShowRenderDetails = props => {
  ...
  const isNoCompDetails = solidJs.createMemo(() => props.showDetails.compDetails == null); // if we didn't do this, objects would cause error. we depend on objects for things
  ...
  const bodyJsxFunc = () => [web.memo((() => {
    const _c$4 = web.memo(() => !!isNoCompDetails(), true);

    return () => _c$4() && web.memo(valueForNoCellRenderer);
  })()), web.memo((() => {
    const _c$5 = web.memo(() => !!getCompDetails(), true);
  ...
  return [web.memo((() => {
    const _c$6 = web.memo(() => !!props.showTools, true);
    ...
    const _c$7 = web.memo(() => !!props.showCellWrapper, true);
...
const _tmpl$$6 = /*#__PURE__*/web.template(`<div> </div>`, 2),
      _tmpl$2$2 = /*#__PURE__*/web.template(`<div class="ag-cell-wrapper" role="presentation"></div>`, 2);
...
const checkCellEditorDeprecations = (popup, cellEditor, cellCtrl) => {
  ...
  if (!popup && cellEditor.isPopup && cellEditor.isPopup()) {
    ...
    core._.doOnce(() => console.warn(msg), 'jsEditorComp-isPopup-' + cellCtrl.getColumn().getColId());
  ...
  if (popup && cellEditor.getPopupPosition && cellEditor.getPopupPosition() != null) {
    ...
    core._.doOnce(() => console.warn(msg), 'jsEditorComp-getPopupPosition-' + cellCtrl.getColumn().getColId());
  }
};
...
const CellComp = props => {
  ...
  const ariaDescribedBy = solidJs.createMemo(() => showCellWrapper() ? `cell-${cellInstanceId}` : undefined);
  solidJs.onMount(() => {
    if (!cellCtrl) {
      return;
    }
  ...
  const bodyJsxFunc = () => [web.createComponent(solidJs.For, {
    ...
    children: () => web.memo((() => {
      const _c$2 = web.memo(() => !!renderDetails(), true);
    ...
    const _c$ = web.memo(() => !!editDetails(), true);
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      const _c$3 = web.memo(() => !!showCellWrapper(), true);
...
const RowComp = params => {
  ...
  const [getDomOrder, setDomOrder] = solidJs.createSignal(false); // these styles have initial values, so element is placed into the DOM with them,
  // rather than an transition getting applied.

  const [getTop, setTop] = solidJs.createSignal(rowCtrl.getInitialRowTop());
  const [getTransform, setTransform] = solidJs.createSignal(rowCtrl.getInitialTransform());
  let eGui;
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      const _c$ = web.memo(() => !!isShowFullWidth(), true);

      return () => _c$() && showFullWidthJsx();
    })(), null);

    web.insert(_el$, (() => {
      const _c$2 = web.memo(() => !!isShowCells(), true);
...
const _tmpl$$4 = /*#__PURE__*/web.template(`<div></div>`, 2),
      _tmpl$2$1 = /*#__PURE__*/web.template(`<div role="presentation"><div role="presentation"></div></div>`, 4),
...
const RowContainerComp = props => {
  ...
  const containerType = solidJs.createMemo(() => core.getRowContainerTypeForName(name));
  let eWrapper;
  let eViewport;
  let eContainer;
  const cssClasses = solidJs.createMemo(() => core.RowContainerCtrl.getRowContainerCssClasses(name));
  ...
  const containerClasses = solidJs.createMemo(() => classesList(cssClasses().container)); // no need to useMemo for boolean types

  const template1 = name === core.RowContainerName.CENTER;
  const template2 = name === core.RowContainerName.TOP_CENTER || name === core.RowContainerName.BOTTOM_CENTER || name === core.RowContainerName.STICKY_TOP_CENTER;
  ...
  solidJs.onMount(() => {
    ...
    const ctrl = context.createBean(new core.RowContainerCtrl(name));
...
const _tmpl$$3 = /*#__PURE__*/web.template(`<div role="grid"><div role="presentation"></div><div role="presentation"></div><div role="presentation"></div><div role="presentation"></div></div>`, 10);
...
const GridBodyComp = () => {
  ...
  const [getCellSelectableCss, setCellSelectableCss] = solidJs.createSignal(null); // we initialise layoutClass to 'ag-layout-normal', because if we don't, the comp will initially
  ...
  solidJs.onMount(() => {
    ...
    const ctrl = context.createBean(new core.GridBodyCtrl());
    solidJs.onCleanup(() => context.destroyBean(ctrl)); // fixme - should not be in a timeout,
  ...
  return (() => {
    ...
    web.insert(_el$2, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.TOP_LEFT;
      }
    ...
    web.insert(_el$2, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.TOP_CENTER;
      }
    ...
    web.insert(_el$2, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.TOP_RIGHT;
      }
    ...
    web.insert(_el$2, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.TOP_FULL_WIDTH;
      }

    }), null);

    const _ref$3 = eBodyViewport;
    typeof _ref$3 === "function" ? web.use(_ref$3, _el$3) : eBodyViewport = _el$3;

    web.insert(_el$3, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.LEFT;
      }
    ...
    web.insert(_el$3, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.CENTER;
      }
    ...
    web.insert(_el$3, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.RIGHT;
      }
    ...
    web.insert(_el$3, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.FULL_WIDTH;
      }

    }), null);

    const _ref$4 = eStickyTop;
    typeof _ref$4 === "function" ? web.use(_ref$4, _el$4) : eStickyTop = _el$4;

    web.insert(_el$4, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.STICKY_TOP_LEFT;
      }
    ...
    web.insert(_el$4, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.STICKY_TOP_CENTER;
      }
    ...
    web.insert(_el$4, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.STICKY_TOP_RIGHT;
      }
    ...
    web.insert(_el$4, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.STICKY_TOP_FULL_WIDTH;
      }

    }), null);

    const _ref$5 = eBottom;
    typeof _ref$5 === "function" ? web.use(_ref$5, _el$5) : eBottom = _el$5;

    web.insert(_el$5, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.BOTTOM_LEFT;
      }
    ...
    web.insert(_el$5, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.BOTTOM_CENTER;
      }
    ...
    web.insert(_el$5, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.BOTTOM_RIGHT;
      }
    ...
    web.insert(_el$5, web.createComponent(RowContainerComp, {
      get name() {
        return core.RowContainerName.BOTTOM_FULL_WIDTH;
      }
    ...
    web.effect(_p$ => {
      ...
      _v$7 !== _p$._v$7 && web.className(_el$4, _p$._v$7 = _v$7);
      _p$._v$8 = web.style(_el$4, _v$8, _p$._v$8);
      _v$9 !== _p$._v$9 && web.className(_el$5, _p$._v$9 = _v$9);
      _p$._v$10 = web.style(_el$5, _v$10, _p$._v$10);
      return _p$;
    }, {
      _v$: undefined,
      _v$2: undefined,
...
const _tmpl$$2 = /*#__PURE__*/web.template(`<div class="ag-tab-guard ag-tab-guard-top" role="presentation"></div>`, 2),
      _tmpl$2 = /*#__PURE__*/web.template(`<div class="ag-tab-guard ag-tab-guard-bottom" role="presentation"></div>`, 2);
...
const TabGuardComp = props => {
  ...
  solidJs.onMount(() => {
    ...
    ctrl = context.createBean(new core.TabGuardCtrl({
      comp: compProxy,
      eTopGuard: eTopGuard,
  ...
  return [(() => {
    ...
    web.effect(() => web.setAttribute(_el$, "tabindex", tabIndex()));
    ...
    web.effect(() => web.setAttribute(_el$2, "tabindex", tabIndex()));
...
const GridComp = props => {
  ...
  solidJs.onMount(() => {
    gridCtrl = context.createBean(new core.GridCtrl());
    destroyFuncs.push(() => context.destroyBean(gridCtrl));
    const compProxy = {
      destroyGridUi: () => {},
      // do nothing, as framework users destroy grid by removing the comp
      setRtlClass: setRtlClass,
      addOrRemoveKeyboardFocusClass: addOrRemove => setKeyboardFocusClass(addOrRemove ? core.FocusService.AG_KEYBOARD_FOCUS : ''),
      forceFocusOutOfContainer: () => {
  ...
  return (() => {
    ...
    web.insert(_el$2, (() => {
      const _c$ = web.memo(() => !!initialised(), true);
...
const AgGridSolid = props => {
  ...
  solidJs.createEffect(() => {
    ...
    if (changesExist) {
      core.ComponentUtil.processOnChange(changes, gridOptions, gridOptions.api, gridOptions.columnApi);
    }
  });
  solidJs.onMount(() => {
    ...
    core.ComponentUtil.copyAttributesToGridOptions(gridOptions, props);
    ...
    const createUiCallback = context => {
      ...
      const ctrlsService = context.getBean(core.CtrlsService.NAME);
    ...
    const gridCoreCreator = new core.GridCoreCreator();
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      const _c$ = web.memo(() => !!context(), true);
