...
const _tmpl$$6 = /*#__PURE__*/web.template(`<div> </div>`, 2),
  _tmpl$2$2 = /*#__PURE__*/web.template(`<div class="ag-cell-wrapper" role="presentation" aria-hidden="true"></div>`, 2);
...
const AgGridSolid = props => {
  ...
  solidJs.createEffect(() => {
    ...
    if (changesExist) {
      core.ComponentUtil.processOnChange(changes, gridOptions.api);
    }
  });
  solidJs.onMount(() => {
