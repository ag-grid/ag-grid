...
var ReactComponent = class {
  constructor(reactComponent, portalManager, componentType, suppressFallbackMethods) {
    ...
    this.instanceCreated = this.isStatelessComponent() ? import_core3.AgPromise.resolve(false) : new import_core3.AgPromise((resolve) => {
  ...
  addParentContainerStyleAndClasses() {
    ...
    if (this.componentInstance.getReactContainerStyle && this.componentInstance.getReactContainerStyle()) {
      import_core3._.warnOnce('Since v31.1 "getReactContainerStyle" is deprecated. Apply styling directly to ".ag-react-container" if needed.');
      Object.assign(this.eParentElement.style, this.componentInstance.getReactContainerStyle());
    }
    if (this.componentInstance.getReactContainerClasses && this.componentInstance.getReactContainerClasses()) {
      import_core3._.warnOnce('Since v31.1 "getReactContainerClasses" is deprecated. Apply styling directly to ".ag-react-container" if needed.');
  ...
  init(params) {
    ...
    return new import_core3.AgPromise((resolve) => this.createReactComponent(resolve));
  }
...
var GroupCellRenderer = (0, import_react7.forwardRef)((props, ref) => {
  ...
  const setRef2 = (0, import_react7.useCallback)((ref2) => {
    ...
    ctrlRef.current = context.createBean(new import_core5.GroupCellRendererCtrl());
  ...
  const escapedValue = import_core5._.escapeString(value, true);
...
var HeaderCellComp = (props) => {
  ...
  if (isAlive && !cssClassManager.current) {
    cssClassManager.current = new import_core11.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react13.useCallback)((e) => {
    ...
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? import_core11._.setAriaSort(eGui.current, sort) : import_core11._.removeAriaSort(eGui.current);
        }
      },
...
function getInstance(wrapperComponent, callback) {
  var _a, _b;
  const promise = (_b = (_a = wrapperComponent == null ? void 0 : wrapperComponent.getInstance) == null ? void 0 : _a.call(wrapperComponent)) != null ? _b : import_core13.AgPromise.resolve(void 0);
  promise.then((comp) => callback(comp));
}
function warnReactiveCustomComponents() {
  import_core13._.warnOnce("Using custom components without `reactiveCustomComponents = true` is deprecated.");
}
var HeaderFilterCellComp = (props) => {
  ...
  const setRef2 = (0, import_react15.useCallback)((e) => {
    ...
    userCompPromise.current = new import_core12.AgPromise((resolve) => {
...
var HeaderRowComp = (props) => {
  ...
  const createCellJsx = (0, import_react12.useCallback)((cellCtrl) => {
    switch (ctrl.getType()) {
      case import_core10.HeaderRowType.COLUMN_GROUP:
      ...
      case import_core10.HeaderRowType.FLOATING_FILTER:
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react10.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_core8.GridHeaderCtrl());
...
var PopupEditorComp = (props) => {
  ...
  useEffectOnce(() => {
    ...
    const wrapper = context.createBean(new import_core17.PopupEditorWrapper(compDetails.params));
...
var checkCellEditorDeprecations = (popup, cellEditor, cellCtrl) => {
  ...
  if (!popup && cellEditor.isPopup && cellEditor.isPopup()) {
    ...
    import_core16._.doOnce(() => console.warn(msg), "jsEditorComp-isPopup-" + cellCtrl.getColumn().getColId());
  }
  if (popup && cellEditor.getPopupPosition && cellEditor.getPopupPosition() != null) {
    ...
    import_core16._.doOnce(() => console.warn(msg), "jsEditorComp-getPopupPosition-" + cellCtrl.getColumn().getColId());
  }
};
    ...
    const addComp = (comp) => {
      ...
      if (comp) {
        ...
        cellWrapperDestroyFuncs.current.push(() => {
          context.destroyBean(comp);
          import_core16._.removeFromParent(eGui2);
        });
      }
      return comp;
    };
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerType = (0, import_react17.useMemo)(() => (0, import_core14.getRowContainerTypeForName)(name), [name]);
  ...
  const cssClasses = (0, import_react17.useMemo)(() => import_core14.RowContainerCtrl.getRowContainerCssClasses(name), [name]);
  ...
  const centerTemplate = name === import_core14.RowContainerName.CENTER || name === import_core14.RowContainerName.TOP_CENTER || name === import_core14.RowContainerName.BOTTOM_CENTER || name === import_core14.RowContainerName.STICKY_TOP_CENTER || name === import_core14.RowContainerName.STICKY_BOTTOM_CENTER;
...
var GridBodyComp = () => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_core7.CssClassManager(() => eRoot.current);
  }
  ...
  const setRef2 = (0, import_react9.useCallback)((e) => {
    ...
    const compProxy = {
      ...
      setColumnCount: (count) => {
        if (eRoot.current) {
          import_core7._.setAriaColCount(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          import_core7._.setAriaRowCount(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
    ...
    const ctrl = context.createBean(new import_core7.GridBodyCtrl());
  ...
  return /* @__PURE__ */ import_react9.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, /* @__PURE__ */ import_react9.default.createElement(gridHeaderComp_default, null), createSection({ section: eTop, className: topClasses, style: topStyle, children: [
    import_core7.RowContainerName.TOP_LEFT,
    import_core7.RowContainerName.TOP_CENTER,
    import_core7.RowContainerName.TOP_RIGHT,
    import_core7.RowContainerName.TOP_FULL_WIDTH
    ...
    children: [
      import_core7.RowContainerName.LEFT,
      import_core7.RowContainerName.CENTER,
      import_core7.RowContainerName.RIGHT,
      import_core7.RowContainerName.FULL_WIDTH
    ]
  })), createSection({ section: eStickyTop, className: stickyTopClasses, style: stickyTopStyle, children: [
    import_core7.RowContainerName.STICKY_TOP_LEFT,
    import_core7.RowContainerName.STICKY_TOP_CENTER,
    import_core7.RowContainerName.STICKY_TOP_RIGHT,
    import_core7.RowContainerName.STICKY_TOP_FULL_WIDTH
  ] }), createSection({ section: eStickyBottom, className: stickyBottomClasses, style: stickyBottomStyle, children: [
    import_core7.RowContainerName.STICKY_BOTTOM_LEFT,
    import_core7.RowContainerName.STICKY_BOTTOM_CENTER,
    import_core7.RowContainerName.STICKY_BOTTOM_RIGHT,
    import_core7.RowContainerName.STICKY_BOTTOM_FULL_WIDTH
  ] }), createSection({ section: eBottom, className: bottomClasses, style: bottomStyle, children: [
    import_core7.RowContainerName.BOTTOM_LEFT,
    import_core7.RowContainerName.BOTTOM_CENTER,
    import_core7.RowContainerName.BOTTOM_RIGHT,
    import_core7.RowContainerName.BOTTOM_FULL_WIDTH
  ] }));
};
...
var TabGuardCompRef = (props, forwardRef4) => {
  ...
  const setupCtrl = (0, import_react23.useCallback)(() => {
    ...
    if (topTabGuardRef.current && bottomTabGuardRef.current) {
      ...
      tabGuardCtrlRef.current = context.createBean(new import_core19.TabGuardCtrl({
        comp: compProxy,
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react8.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_core6.GridCtrl());
...
var AgGridReactUi = (props) => {
  ...
  const setRef2 = (0, import_react2.useCallback)((e) => {
    ...
    const mergedGridOps = import_core.ComponentUtil.combineAttributesAndGridOptions(props.gridOptions, props);
    const gridParams = {
    ...
    const createUiCallback = (context2) => {
      ...
      const ctrlsService = context2.getBean(import_core.CtrlsService.NAME);
      ctrlsService.whenReady(() => {
        ...
        if (api) {
          if (props.setGridApi) {
            props.setGridApi(api, new import_core.ColumnApi(api));
          }
        }
      });
    };
  ...
  (0, import_react2.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        import_core.ComponentUtil.processOnChange(changes, apiRef.current);
      }
    });
  }, [props]);
...
var DetailCellRenderer = (0, import_react2.forwardRef)((props, ref) => {
  ...
  if (props.template) {
    import_core._.warnOnce("detailCellRendererParams.template is not supported by AG Grid React. To change the template, provide a Custom Detail Cell Renderer. See https://ag-grid.com/react-data-grid/master-detail-custom-detail/");
  }
  const setRef2 = (0, import_react2.useCallback)((e) => {
    eGuiRef.current = e;
    if (!eGuiRef.current) {
