...
var ReactComponent = class {
  constructor(reactComponent, portalManager, componentType, suppressFallbackMethods) {
    ...
    this.instanceCreated = this.isStatelessComponent() ? import_core.AgPromise.resolve(false) : new import_core.AgPromise((resolve) => {
  ...
  addParentContainerStyleAndClasses() {
    ...
    if (this.componentInstance.getReactContainerStyle && this.componentInstance.getReactContainerStyle()) {
      import_core._.warnOnce('Since v31.1 "getReactContainerStyle" is deprecated. Apply styling directly to ".ag-react-container" if needed.');
      Object.assign(this.eParentElement.style, this.componentInstance.getReactContainerStyle());
    }
    if (this.componentInstance.getReactContainerClasses && this.componentInstance.getReactContainerClasses()) {
      import_core._.warnOnce('Since v31.1 "getReactContainerClasses" is deprecated. Apply styling directly to ".ag-react-container" if needed.');
  ...
  init(params) {
    ...
    return new import_core.AgPromise((resolve) => this.createReactComponent(resolve));
  }
...
var CustomComponentWrapper = class extends ReactComponent {
  constructor() {
    super(...arguments);
    this.awaitUpdateCallback = new import_core2.AgPromise((resolve) => {
  ...
  refreshProps() {
    ...
    return new import_core2.AgPromise((resolve) => this.awaitUpdateCallback.then(() => {
...
function updateFloatingFilterParent(params, model) {
  params.parentFilterInstance((instance) => {
    (instance.setModel(model) || import_core3.AgPromise.resolve()).then(() => {
...
var GroupCellRenderer = (0, import_react5.forwardRef)((props, ref) => {
  ...
  const setRef2 = (0, import_react5.useCallback)((ref2) => {
    ...
    ctrlRef.current = context.createBean(new import_core4.GroupCellRendererCtrl());
  ...
  const escapedValue = import_core4._.escapeString(value, true);
...
var HeaderCellComp = (props) => {
  ...
  if (isAlive && !cssClassManager.current) {
    cssClassManager.current = new import_core5.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react6.useCallback)((e) => {
    ...
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? import_core5._.setAriaSort(eGui.current, sort) : import_core5._.removeAriaSort(eGui.current);
        }
      },
...
function getInstance(wrapperComponent, callback) {
  var _a, _b;
  const promise = (_b = (_a = wrapperComponent == null ? void 0 : wrapperComponent.getInstance) == null ? void 0 : _a.call(wrapperComponent)) != null ? _b : import_core6.AgPromise.resolve(void 0);
  promise.then((comp) => callback(comp));
}
function warnReactiveCustomComponents() {
  import_core6._.warnOnce("Using custom components without `reactiveCustomComponents = true` is deprecated.");
}
...
var HeaderRowContainerComp = (props) => {
  ...
  const setRef2 = (0, import_react10.useCallback)((e) => {
    ...
    headerRowCtrlRef.current = context.createBean(new import_core9.HeaderRowContainerCtrl(props.pinned));
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react11.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_core10.GridHeaderCtrl());
...
var PopupEditorComp = (props) => {
  ...
  useEffectOnce(() => {
    ...
    const wrapper = context.createBean(new import_core11.PopupEditorWrapper(compDetails.params));
...
var checkCellEditorDeprecations = (popup, cellEditor, cellCtrl) => {
  ...
  if (!popup && cellEditor.isPopup && cellEditor.isPopup()) {
    ...
    import_core13._.doOnce(() => console.warn(msg), "jsEditorComp-isPopup-" + cellCtrl.getColumn().getColId());
  }
  if (popup && cellEditor.getPopupPosition && cellEditor.getPopupPosition() != null) {
    ...
    import_core13._.doOnce(() => console.warn(msg), "jsEditorComp-getPopupPosition-" + cellCtrl.getColumn().getColId());
  }
};
    ...
    const addComp = (comp) => {
      ...
      if (comp) {
        ...
        cellWrapperDestroyFuncs.current.push(() => {
          context.destroyBean(comp);
          import_core13._.removeFromParent(eGui2);
        });
      }
      return comp;
    };
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerType = (0, import_react18.useMemo)(() => (0, import_core15.getRowContainerTypeForName)(name), [name]);
  ...
  const cssClasses = (0, import_react18.useMemo)(() => import_core15.RowContainerCtrl.getRowContainerCssClasses(name), [name]);
  ...
  const centerTemplate = name === import_core15.RowContainerName.CENTER || name === import_core15.RowContainerName.TOP_CENTER || name === import_core15.RowContainerName.BOTTOM_CENTER || name === import_core15.RowContainerName.STICKY_TOP_CENTER || name === import_core15.RowContainerName.STICKY_BOTTOM_CENTER;
...
var GridBodyComp = () => {
  ...
  const setRef2 = (0, import_react19.useCallback)((e) => {
    ...
    const compProxy = {
      ...
      setColumnCount: (count) => {
        if (eRoot.current) {
          import_core16._.setAriaColCount(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          import_core16._.setAriaRowCount(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
  ...
  return /* @__PURE__ */ import_react19.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, /* @__PURE__ */ import_react19.default.createElement(gridHeaderComp_default, null), createSection({ section: eTop, className: topClasses, style: topStyle, children: [
    import_core16.RowContainerName.TOP_LEFT,
    import_core16.RowContainerName.TOP_CENTER,
    import_core16.RowContainerName.TOP_RIGHT,
    import_core16.RowContainerName.TOP_FULL_WIDTH
    ...
    children: [
      import_core16.RowContainerName.LEFT,
      import_core16.RowContainerName.CENTER,
      import_core16.RowContainerName.RIGHT,
      import_core16.RowContainerName.FULL_WIDTH
    ]
  })), createSection({ section: eStickyTop, className: stickyTopClasses, style: stickyTopStyle, children: [
    import_core16.RowContainerName.STICKY_TOP_LEFT,
    import_core16.RowContainerName.STICKY_TOP_CENTER,
    import_core16.RowContainerName.STICKY_TOP_RIGHT,
    import_core16.RowContainerName.STICKY_TOP_FULL_WIDTH
  ] }), createSection({ section: eStickyBottom, className: stickyBottomClasses, style: stickyBottomStyle, children: [
    import_core16.RowContainerName.STICKY_BOTTOM_LEFT,
    import_core16.RowContainerName.STICKY_BOTTOM_CENTER,
    import_core16.RowContainerName.STICKY_BOTTOM_RIGHT,
    import_core16.RowContainerName.STICKY_BOTTOM_FULL_WIDTH
  ] }), createSection({ section: eBottom, className: bottomClasses, style: bottomStyle, children: [
    import_core16.RowContainerName.BOTTOM_LEFT,
    import_core16.RowContainerName.BOTTOM_CENTER,
    import_core16.RowContainerName.BOTTOM_RIGHT,
    import_core16.RowContainerName.BOTTOM_FULL_WIDTH
  ] }));
};
...
var TabGuardCompRef = (props, forwardRef4) => {
  ...
  const setupCtrl = (0, import_react20.useCallback)(() => {
    ...
    if (topTabGuardRef.current && bottomTabGuardRef.current) {
      ...
      tabGuardCtrlRef.current = context.createBean(new import_core17.TabGuardCtrl({
        comp: compProxy,
...
var AgGridReactUi = (props) => {
  ...
  const setRef2 = (0, import_react22.useCallback)((e) => {
    ...
    const mergedGridOps = import_core19.ComponentUtil.combineAttributesAndGridOptions(props.gridOptions, props);
    const gridParams = {
    ...
    const createUiCallback = (context2) => {
      ...
      const ctrlsService = context2.getBean(import_core19.CtrlsService.NAME);
      ctrlsService.whenReady(() => {
        ...
        if (api) {
          if (props.setGridApi) {
            props.setGridApi(api, new import_core19.ColumnApi(api));
          }
        }
      });
    };
    ...
    const gridCoreCreator = new import_core19.GridCoreCreator();
  ...
  (0, import_react22.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        import_core19.ComponentUtil.processOnChange(changes, apiRef.current);
      }
    });
  }, [props]);
...
var ReactFrameworkComponentWrapper = class extends import_core19.BaseComponentWrapper {
...
var DetailCellRenderer = (0, import_react22.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react22.useMemo)(() => import_core19.ModuleRegistry.__getGridRegisteredModules(props.api.getGridId()), [props]);
  ...
  if (props.template) {
    import_core19._.warnOnce("detailCellRendererParams.template is not supported by AG Grid React. To change the template, provide a Custom Detail Cell Renderer. See https://ag-grid.com/react-data-grid/master-detail-custom-detail/");
  }
  const setRef2 = (0, import_react22.useCallback)((e) => {
    eGuiRef.current = e;
    if (!eGuiRef.current) {
...
var ReactFrameworkOverrides = class extends import_core19.VanillaFrameworkOverrides {
  constructor() {
    super("react");
...
// community-modules/react/src/shared/interfaces.ts
