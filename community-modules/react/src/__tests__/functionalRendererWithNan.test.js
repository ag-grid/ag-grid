...
it('functional renderer with NaN renders expected cell values', () => {
    ...
    expect(component.render().find('div .ag-cell-value').first().html()).toEqual(`<div class="ag-react-container">NaN</div>`);
    expect(component.render().find('div .ag-cell-value').last().html()).toEqual(`<div class="ag-react-container">10</div>`);
});
