...
const RowContainerComp = (params) => {
    ...
    const template2 = name === core_1.RowContainerName.TOP_CENTER || name === core_1.RowContainerName.BOTTOM_CENTER;
    ...
    const buildContainer = () => (react_1.default.createElement("div", { className: containerClasses, ref: eContainer, role: "rowgroup", style: containerStyle }, rowCtrlsOrdered.map(rowCtrl => react_1.default.createElement(rowComp_1.default, { rowCtrl: rowCtrl, containerType: containerType, key: rowCtrl.getInstanceId() }))));
