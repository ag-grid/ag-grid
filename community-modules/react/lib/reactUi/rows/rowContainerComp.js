...
const RowContainerComp = (params) => {
    ...
    const buildContainer = () => (react_1.default.createElement("div", { className: containerClasses, ref: eContainer, role: "rowgroup", style: containerStyle }, rowCtrls.map(rowCtrl => react_1.default.createElement(rowComp_1.default, { rowCtrl: rowCtrl, containerType: containerType, key: rowCtrl.getInstanceId() }))));
