...
var checkCellEditorDeprecations = function (popup, cellEditor, cellCtrl) {
    ...
    if (!popup && cellEditor.isPopup && cellEditor.isPopup()) {
        ...
        core_1._.doOnce(function () { return console.warn(msg_1); }, 'jsEditorComp-isPopup-' + cellCtrl.getColumn().getColId());
    }
    ...
    if (popup && cellEditor.getPopupPosition && cellEditor.getPopupPosition() != null) {
        ...
        core_1._.doOnce(function () { return console.warn(msg_2); }, 'jsEditorComp-getPopupPosition-' + cellCtrl.getColumn().getColId());
    }
};
...
var CellComp = function (props) {
    ...
    react_1.useEffect(function () {
        ...
        var cellEditor = jsComp_1.createJsComp(context, function (factory) { return factory.createInstanceFromCompDetails(compDetails); });
        if (!cellEditor) {
            return;
        }
