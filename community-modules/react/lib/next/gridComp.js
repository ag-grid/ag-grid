// @ag-grid-community/react v26.0.1
"use strict";
...
var GridComp = function (_a) {
    ...
    react_1.useEffect(function () {
        ...
        var compProxy = {
            ...
            addOrRemoveKeyboardFocusClass: function (addOrRemove) { return setKeyboardFocusClass(addOrRemove ? core_1.FocusService.AG_KEYBOARD_FOCUS : ''); },
