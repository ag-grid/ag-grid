  ...
  import_core.ComponentUtil.ALL_PROPERTIES.filter((propertyName) => propertyName != "gridOptions").forEach((propertyName) => {
    ...
    watch2[propertyName] = {
      handler(currentValue, previousValue) {
        ...
        if (propertyName === "rowData" && currentValue != import_core.ComponentUtil.VUE_OMITTED_PROPERTY) {
          currValue = convertToRaw(currentValue);
        }
        this.batchChanges[propertyName] = currValue === import_core.ComponentUtil.VUE_OMITTED_PROPERTY ? void 0 : currValue;
        if (this.batchTimeout == null) {
          this.batchTimeout = setTimeout(() => {
            this.batchTimeout = null;
            (0, import_core._processOnChange)(this.batchChanges, this.api);
