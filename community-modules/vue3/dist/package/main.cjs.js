...
// community-modules/vue3/src/main.ts
var main_exports = {};
...
// community-modules/vue3/src/AgGridVue.ts
var import_core5 = require("@ag-grid-community/core");

// community-modules/vue3/node_modules/@vue/shared/dist/shared.esm-bundler.js
// @__NO_SIDE_EFFECTS__
...
// community-modules/vue3/src/Utils.ts
...
var getAgGridProperties = () => {
  const props2 = {};
  const eventNameAsProps = import_core.ComponentUtil.PUBLIC_EVENTS.map(
  ...
  const watch2 = {
    modelValue: {
      handler(currentValue, previousValue) {
        ...
        (0, import_core._processOnChange)({ rowData: currentValue }, this.api);
      },
      deep: true
    }
  };
  let timeout = null;
  let changes = {};
  import_core.ComponentUtil.ALL_PROPERTIES.filter((propertyName) => propertyName != "gridOptions").forEach((propertyName) => {
    props2[propertyName] = {
      default: import_core.ComponentUtil.VUE_OMITTED_PROPERTY
    };
    watch2[propertyName] = {
      handler(currentValue, previousValue) {
        changes[propertyName] = currentValue === import_core.ComponentUtil.VUE_OMITTED_PROPERTY ? void 0 : currentValue;
        if (timeout == null) {
          timeout = setTimeout(() => {
            (0, import_core._processOnChange)(changes, this.api);
            timeout = null;
            changes = {};
          }, 0);
        }
...
// community-modules/vue3/src/VueFrameworkComponentWrapper.ts
var import_core3 = require("@ag-grid-community/core");

// community-modules/vue3/src/VueComponentFactory.ts
var import_core2 = require("@ag-grid-community/core");
var import_vue = require("vue");
function logMissingComp(component) {
  (0, import_core2._errorOnce)(`Could not find component with name of ${component}. Is it in Vue.components?`);
}
var VueComponentFactory = class _VueComponentFactory {
  static getComponentDefinition(component, parent) {
    ...
    if (typeof component === "string") {
      ...
      componentDefinition = { extends: (0, import_vue.defineComponent)({ ...component }) };
    }
  ...
  static mount(component, props2, parent, provides) {
    let vNode = (0, import_vue.createVNode)(component, props2);
...
// community-modules/vue3/src/VueFrameworkComponentWrapper.ts
var VueFrameworkComponentWrapper = class _VueFrameworkComponentWrapper extends import_core3.BaseComponentWrapper {
  ...
  createMethodProxy(wrapper, methodName, mandatory) {
    return function() {
      ...
      if (mandatory) {
        (0, import_core3._warnOnce)("Framework component is missing the method " + methodName + "()");
      }
      return null;
    };
  }
...
// community-modules/vue3/src/VueFrameworkOverrides.ts
var import_core4 = require("@ag-grid-community/core");
var VueFrameworkOverrides = class extends import_core4.VanillaFrameworkOverrides {
  constructor(parent) {
    super("vue");
    this.parent = parent;
  }
...
var AgGridVue = (0, import_vue2.defineComponent)({
  render() {
  ...
  methods: {
    globalEventListenerFactory(restrictToSyncOnly) {
      return (eventType) => {
        ...
        const alwaysSync = import_core5.ALWAYS_SYNC_GLOBAL_EVENTS.has(eventType);
    ...
    processChanges(propertyName, currentValue, previousValue) {
      if (this.gridCreated) {
        ...
        (0, import_core5._processOnChange)(options, this.api);
      }
    },
    checkForBindingConflicts() {
      ...
      if ((thisAsAny.rowData && thisAsAny.rowData !== "AG-VUE-OMITTED-PROPERTY" || this.gridOptions.rowData) && thisAsAny.modelValue) {
        (0, import_core5._warnOnce)("Using both rowData and v-model. rowData will be ignored.");
      }
    },
    getRowData() {
      const rowData = [];
    ...
    getProvides() {
      let instance = (0, import_vue2.getCurrentInstance)();
      let provides = {};
      while (instance) {
  ...
  mounted() {
    ...
    const gridOptions = markRaw((0, import_core5._combineAttributesAndGridOptions)(toRaw(this.gridOptions), this));
    this.checkForBindingConflicts();
    const rowData = this.getRowDataBasedOnBindings();
    if (rowData !== import_core5.ComponentUtil.VUE_OMITTED_PROPERTY) {
    ...
    this.api = (0, import_core5.createGrid)(this.$el, gridOptions, gridParams);
