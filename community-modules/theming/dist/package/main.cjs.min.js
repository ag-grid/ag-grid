...
`}return a},quartzIconSvg=(e,a)=>{const r=iconNameToSvgFragment[e];if(!r)throw new Error(`Missing icon data for ${e}`);return`<svg xmlns="http://www.w3.org/2000/svg" class="ag-icon ag-icon-${e}" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="black" stroke-width="${a}" viewBox="0 0 24 24"><style>* { vector-effect: non-scaling-stroke; }</style>`+r+"</svg>"},iconSetQuartzLight=definePart({partId:"iconSet",variantId:"quartzLight",css:[()=>getQuartzIconsCss({strokeWidth:1})]}),iconSetQuartzRegular=definePart({partId:"iconSet",variantId:"quartzRegular",css:[getQuartzIconsCss]}),iconSetQuartzBold=definePart({partId:"iconSet",variantId:"quartzBold",css:[()=>getQuartzIconsCss({strokeWidth:2})]}),allIconSets=[iconSetQuartzLight,iconSetQuartzRegular,iconSetQuartzBold,iconSetMaterial,iconSetAlpine],_css4={text:":where(input[class^=ag-][type=number]:not(.ag-number-field-input-stepper)){-moz-appearance:textfield}:where(input[class^=ag-][type=number]:not(.ag-number-field-input-stepper))::-webkit-inner-spin-button,:where(input[class^=ag-][type=number]:not(.ag-number-field-input-stepper))::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]){background-color:var(--ag-input-background-color);border:var(--ag-input-border);border-radius:var(--ag-input-border-radius);color:var(--ag-input-text-color);min-height:var(--ag-input-height)}.ag-ltr :where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]){padding-left:var(--ag-input-padding-start)}.ag-rtl :where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]){padding-right:var(--ag-input-padding-start)}:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]):where(:disabled){background-color:var(--ag-input-disabled-background-color);border:var(--ag-input-disabled-border);color:var(--ag-input-disabled-text-color)}:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]):where(:focus){background-color:var(--ag-input-focus-background-color);border:var(--ag-input-focus-border);box-shadow:var(--ag-input-focus-shadow);color:var(--ag-input-focus-text-color)}:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]):where(:invalid){background-color:var(--ag-input-invalid-background-color);border:var(--ag-input-invalid-border);color:var(--ag-input-invalid-text-color)}:where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]):where(.invalid){background-color:var(--ag-input-invalid-background-color);border:var(--ag-input-invalid-border);color:var(--ag-input-invalid-text-color)}"},inputStyleBaseCSS=()=>_css4.text,_css5={text:":where(input[class^=ag-]:not([type]),input[class^=ag-][type=text],input[class^=ag-][type=number],input[class^=ag-][type=tel],input[class^=ag-][type=date],input[class^=ag-][type=datetime-local],textarea[class^=ag-]){border-left:none;border-right:none;border-top:none}"},inputStyleUnderlinedCSS=()=>_css5.text,inputStyleBase=definePart({partId:"inputStyle",variantId:"base",additionalParams:{inputBackgroundColor:"transparent",inputBorder:!1,inputBorderRadius:"0",inputTextColor:ref("textColor"),inputPaddingStart:"0",inputHeight:calc("max(iconSize, fontSize) + gridSize * 2"),inputFocusBackgroundColor:ref("inputBackgroundColor"),inputFocusBorder:ref("inputBorder"),inputFocusShadow:"none",inputFocusTextColor:ref("inputTextColor"),inputDisabledBackgroundColor:ref("inputBackgroundColor"),inputDisabledBorder:ref("inputBorder"),inputDisabledTextColor:ref("inputTextColor"),inputInvalidBackgroundColor:ref("inputBackgroundColor"),inputInvalidBorder:ref("inputBorder"),inputInvalidTextColor:ref("inputTextColor")},css:[inputStyleBaseCSS]}),inputStyleBordered=extendPart(inputStyleBase,{variantId:"bordered",overrideParams:{inputBackgroundColor:ref("backgroundColor"),inputBorder:!0,inputBorderRadius:ref("borderRadius"),inputPaddingStart:ref("gridSize"),inputFocusBorder:refBorder("accentColor"),inputFocusShadow:ref("focusShadow"),inputDisabledBackgroundColor:opaqueForeground(.06),inputDisabledTextColor:transparentRef("textColor",.5),inputInvalidBorder:refBorder("invalidColor")}}),inputStyleUnderlined=extendPart(inputStyleBase,{variantId:"underlined",overrideParams:{inputBorder:"solid 2px "+transparentForeground(.3),inputPaddingStart:ref("gridSize"),inputFocusBorder:"solid 2px var(--ag-accent-color)",inputDisabledTextColor:transparentRef("textColor",.5),inputDisabledBorder:"solid 1px var(--ag-border-color)",inputInvalidBorder:"solid 2px "+ref("invalidColor")},css:[inputStyleUnderlinedCSS]}),allInputStyles=[inputStyleBase,inputStyleBordered,inputStyleUnderlined],_css6={text:'.ag-tabs-header{background-color:var(--ag-tab-bar-background-color);border-bottom:var(--ag-tab-bar-border);gap:var(--ag-tab-spacing);padding:var(--ag-tab-bar-top-padding) var(--ag-tab-bar-horizontal-padding) 0}.ag-tabs-header-wrapper{display:flex}.ag-tabs-header-wrapper .ag-tabs-header{flex:1}.ag-tabs-close-button-wrapper{border:0;padding:var(--ag-grid-size)}.ag-ltr .ag-tabs-close-button-wrapper{border-right:1px solid var(--ag-border-color)}.ag-rtl .ag-tabs-close-button-wrapper{border-left:1px solid var(--ag-border-color)}.ag-tabs-close-button{background-color:unset;border:0;cursor:pointer;padding:0}.ag-tab{align-items:center;background-color:var(--ag-tab-background-color);border-left:var(--ag-tab-selected-border-width) solid transparent;border-right:var(--ag-tab-selected-border-width) solid transparent;color:var(--ag-tab-text-color);display:flex;flex:1;justify-content:center;padding:var(--ag-tab-top-padding) var(--ag-tab-horizontal-padding) var(--ag-tab-bottom-padding);position:relative}.ag-tab:hover{background-color:var(--ag-tab-hover-background-color);color:var(--ag-tab-hover-text-color)}.ag-tab.ag-tab-selected{background-color:var(--ag-tab-selected-background-color);color:var(--ag-tab-selected-text-color)}.ag-ltr .ag-tab.ag-tab-selected:not(:first-of-type){border-left-color:var(--ag-tab-selected-border-color)}.ag-ltr .ag-tab.ag-tab-selected:not(:last-of-type),.ag-rtl .ag-tab.ag-tab-selected:not(:first-of-type){border-right-color:var(--ag-tab-selected-border-color)}.ag-rtl .ag-tab.ag-tab-selected:not(:last-of-type){border-left-color:var(--ag-tab-selected-border-color)}.ag-tab:after{background-color:var(--ag-tab-selected-underline-color);bottom:0;content:"";display:block;height:var(--ag-tab-selected-underline-width);left:0;opacity:0;position:absolute;right:0;transition:opacity var(--ag-tab-selected-underline-transition-duration)}.ag-tab.ag-tab-selected:after{opacity:1}.ag-tab:focus-visible{box-shadow:inset var(--ag-focus-shadow)}'},tabStyleBaseCSS=()=>_css6.text,_css7={text:".ag-tab{border-left:var(--ag-tab-selected-border-width) solid transparent;border-right:var(--ag-tab-selected-border-width) solid transparent;border-top:var(--ag-tab-selected-border-width) solid transparent;flex:0}.ag-tab.ag-tab-selected{border-left-color:var(--ag-tab-selected-border-color);border-right-color:var(--ag-tab-selected-border-color);border-top-color:var(--ag-tab-selected-border-color);margin-bottom:-1px;padding-bottom:calc(var(--ag-tab-bottom-padding) + 1px)}"},tabStyleRolodexCSS=()=>_css7.text,tabParamDocs={},tabStyleBase=definePart({partId:"tabStyle",variantId:"base",additionalParams:{tabBarBackgroundColor:"transparent",tabBarHorizontalPadding:"0",tabBarTopPadding:"0",tabBackgroundColor:"transparent",tabTextColor:ref("textColor"),tabHorizontalPadding:calc("gridSize"),tabTopPadding:calc("gridSize"),tabBottomPadding:calc("gridSize"),tabSpacing:"0",tabHoverBackgroundColor:ref("tabBackgroundColor"),tabHoverTextColor:ref("tabTextColor"),tabSelectedBackgroundColor:ref("tabBackgroundColor"),tabSelectedTextColor:ref("tabTextColor"),tabSelectedBorderWidth:"1px",tabSelectedBorderColor:"transparent",tabSelectedUnderlineColor:"transparent",tabSelectedUnderlineWidth:"0",tabSelectedUnderlineTransitionDuration:"0",tabBarBorder:!1},css:[tabStyleBaseCSS]}),tabStyleQuartz=extendPart(tabStyleBase,{variantId:"quartz",overrideParams:{tabBarBorder:!0,tabBarBackgroundColor:transparentForeground(.05),tabTextColor:transparentRef("textColor",.7),tabSelectedTextColor:ref("textColor"),tabHoverTextColor:ref("textColor"),tabSelectedBorderColor:ref("borderColor"),tabSelectedBackgroundColor:ref("backgroundColor")}}),tabStyleMaterial=extendPart(tabStyleBase,{variantId:"material",overrideParams:{tabBarBackgroundColor:ref("chromeBackgroundColor"),tabSelectedUnderlineColor:ref("primaryColor"),tabSelectedUnderlineWidth:"2px",tabSelectedUnderlineTransitionDuration:"0"},additionalParams:{primaryColor:"#3f51b5"}}),tabStyleAlpine=extendPart(tabStyleBase,{variantId:"alpine",overrideParams:{tabBarBorder:!0,tabBarBackgroundColor:ref("chromeBackgroundColor"),tabHoverTextColor:ref("accentColor"),tabSelectedTextColor:ref("accentColor"),tabSelectedUnderlineColor:ref("accentColor"),tabSelectedUnderlineWidth:"2px",tabSelectedUnderlineTransitionDuration:"0.3s"}}),tabStyleRolodex=extendPart(tabStyleBase,{variantId:"rolodex",overrideParams:{tabBarBackgroundColor:ref("chromeBackgroundColor"),tabBarHorizontalPadding:ref("gridSize"),tabBarTopPadding:ref("gridSize"),tabBarBorder:!0,tabHorizontalPadding:calc("gridSize * 2"),tabTopPadding:calc("gridSize"),tabBottomPadding:calc("gridSize"),tabSpacing:calc("gridSize"),tabSelectedBorderColor:ref("borderColor"),tabSelectedBackgroundColor:ref("backgroundColor")},css:[tabStyleRolodexCSS]}),allTabStyles=[tabStyleBase,tabStyleQuartz,tabStyleAlpine,tabStyleMaterial,tabStyleRolodex],designQuartz=definePart({partId:"design",variantId:"quartz",overrideParams:{},dependencies:()=>[colorSchemeLightNeutral,iconSetQuartzRegular,tabStyleQuartz,inputStyleBordered]}),designBalham=definePart({partId:"design",variantId:"balham",overrideParams:{borderRadius:"2px",wrapperBorderRadius:"2px",headerColumnResizeHandleDisplay:"none",headerColumnBorder:!0,headerColumnBorderHeight:"50%",oddRowBackgroundColor:transparentRef("chromeBackgroundColor",.5),headerTextColor:transparentRef("foregroundColor",.5),fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif',fontSize:"12px"},css:[`
  ...
  `],dependencies:()=>[colorSchemeLightCold,iconSetAlpine,tabStyleRolodex,inputStyleBordered]}),designMaterial=definePart({partId:"design",variantId:"material",overrideParams:{borderRadius:"0",wrapperBorderRadius:"0",wrapperBorder:!1,sidePanelBorder:!1,sideButtonSelectedBorder:!1,headerColumnResizeHandleDisplay:"none",headerBackgroundColor:ref("backgroundColor"),rangeSelectionBackgroundColor:transparentRef("primaryColor",.2),rangeSelectionBorderColor:ref("primaryColor"),fontFamily:'Roboto, -apple-system, BlinkMacSystemFont, "Segoe UI", Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif',inputFocusBorder:"solid 2px var(--ag-primary-color)"},additionalParams:{primaryColor:"#3f51b5"},css:[`
  ...
  `],dependencies:()=>[iconSetMaterial,tabStyleMaterial,inputStyleUnderlined]}),allDesigns=[designQuartz,designBalham,designMaterial],docs={backgroundColor:"Background colour of the grid. Many UI elements are semi-transparent, so their colour blends with the background colour.",foregroundColor:"Default colour for neutral UI elements. Most text, borders and backgrounds are defined as semi-transparent versions of this colour, resulting in a blend between the background and foreground colours.",textColor:"Default colour for all text",accentColor:"The 'brand colour' for the grid, used wherever a non-neutral colour is required. Selections, focus outlines and checkboxes use the accent colour by default.",invalidColor:"The colour for inputs and UI controls in an invalid state.",colorScheme:"The colour scheme to apply to browser scrollbars within the grid",borderColor:"Default colour for borders.",wrapperBorder:"Borders around the outside of the grid",headerRowBorder:"Borders between and below header rows.",rowBorder:"Horizontal borders between rows.",footerRowBorder:"Horizontal borders above footer components like the pagination and status bars",columnBorder:"Vertical borders between columns.",headerColumnBorder:"Vertical borders between column headers.",headerColumnBorderHeight:"Height of the vertical border between column headers. Percentage values are relative to the header height.",pinnedColumnBorder:"Vertical borders between columns that are pinned to the left or right and the rest of the grid",pinnedRowBorder:"Horizontal borders between the grid and rows that are pinned to the top or bottom and the rest of the grid",sidePanelBorder:"Borders between the grid and side panels including the column and filter tool bars, and chart settings",sideButtonSelectedBorder:"Border around the selected sidebar button on the side panel",sideButtonSelectedBackgroundColor:"Background colour of the selected sidebar button on the side panel",sideBarBackgroundColor:"Background colour for non-data areas of the grid. Headers, tool panels and menus use this colour by default.",fontFamily:"Font family used for all text.",chromeBackgroundColor:"Background colour for non-data areas of the grid. Headers, tool panels and menus use this colour by default.",headerBackgroundColor:"Background colour for header and header-like.",headerFontWeight:"Font weight of text in the header",headerFontFamily:"Font family of text in the header",headerFontSize:"Size of text in the header",headerVerticalPaddingScale:"Multiply the header vertical padding by a number, e.g. 1.5 to increase by 50%",headerTextColor:"Colour of text in the header",headerCellHoverBackgroundColor:"Background colour when hovering over header cells.",headerCellHoverBackgroundTransitionDuration:"Duration of header cell hover transition, if headerCellHoverBackgroundColor is set.",cellTextColor:"Colour of text in grid cells.",subtleTextColor:"Colour of text and UI elements that should stand out less than the default.",rangeSelectionBorderStyle:"Border style around range selections.",rangeSelectionBorderColor:"The colour used for borders around range selections. The selection background defaults to a semi-transparent version of this colour.",rangeSelectionBackgroundColor:"Background colour of selected cell ranges. Choosing a semi-transparent colour ensure that multiple overlapping ranges look correct.",rangeSelectionChartBackgroundColor:"Background colour for cells that provide data to the current range chart",rangeSelectionChartCategoryBackgroundColor:"Background colour for cells that provide categories to the current range chart",rangeSelectionHighlightColor:"Background colour to briefly apply to a cell range when the user copies from or pastes into it.",rowHoverColor:"Background colour when hovering over rows in the grid and in dropdown menus. Set to `transparent` to disable the hover effect. Note: if you want a hover effect on one but not the other, use CSS selectors instead of this property.",columnHoverColor:"Background colour when hovering over columns in the grid. This is not visible unless enabled in the grid options.",selectedRowBackgroundColor:"Background colour of selected rows in the grid and in dropdown menus.",modalOverlayBackgroundColor:"Background colour of the overlay shown over the grid e.g. a data loading indicator.",oddRowBackgroundColor:"Background colour applied to every other row",borderRadius:"Default corner radius for many UI elements such as menus, dialogs and form widgets.",wrapperBorderRadius:"Corner radius of the outermost container around the grid.",cellWidgetSpacing:"Horizontal spacing between widgets inside cells (e.g. row group expand buttons and row selection checkboxes).",rowGroupIndentSize:"The size of indentation applied to each level of row grouping - deep rows are indented by a multiple of this value.",valueChangeDeltaUpColor:"Colour to temporarily apply to cell data when its value increases in an agAnimateShowChangeCellRenderer cell",valueChangeDeltaDownColor:"Colour to temporarily apply to cell data when its value decreases in an agAnimateShowChangeCellRenderer cell",valueChangeValueHighlightBackgroundColor:"Background colour to apply when a cell value changes and enableCellChangeFlash is enabled",gridSize:"Amount of spacing around and inside UI elements. All padding and margins in the grid are defined as a multiple of this value.",cellHorizontalPadding:"Padding at the start and end of grid cells and header cells.",cellHorizontalPaddingScale:"Multiply the cell horizontal padding by a number, e.g. 1.5 to increase by 50%",fontSize:"Default font size for text in the grid",rowHeight:"Height of grid rows",rowVerticalPaddingScale:"Multiply the row vertical padding by a number, e.g. 1.5 to increase by 50%. If rowHeight is set, the amount of padding is fixed and so this will have no effect.",headerHeight:"Height of header rows",popupShadow:"Default shadow for elements that float above the grid e.g. dialogs and menus",dropdownShadow:"Default shadow for dropdown menus",dragGhostBackgroundColor:"Background colour of the ghost element when dragging columns",dragGhostBorder:"Border colour of the ghost element when dragging columns",dragGhostShadow:"Shadow for the ghost element when dragging columns",focusShadow:"Shadow around UI controls that have focus e.g. text inputs and buttons. The value must a valid CSS box-shadow.",sideBarPanelWidth:"Default width of the sidebar that contains the columns and filters tool panels",headerColumnResizeHandleDisplay:"Whether to display an indicator of the drag handle on resizable header columns. If hidden, the handle will still be active but invisible.",headerColumnResizeHandleHeight:"Height of the drag handle on resizable header columns. Percentage values are relative to the header height.",headerColumnResizeHandleWidth:"Width of the drag handle on resizable header columns.",headerColumnResizeHandleColor:"Colour of the drag handle on resizable header columns",widgetContainerHorizontalPadding:"The horizontal padding of containers that contain stacked widgets, such as menus and tool panels",widgetContainerVerticalPadding:"The vertical padding of containers that contain stacked widgets, such as menus and tool panels",widgetHorizontalSpacing:"The spacing between widgets in containers arrange widgets horizontally",widgetVerticalSpacing:"The spacing between widgets in containers arrange widgets vertically",listItemHeight:"Height of items in scrolling lists e.g. dropdown select inputs and column menu set filters.",toggleButtonWidth:"Width of the whole toggle button component",toggleButtonHeight:"Height of the whole toggle button component",toggleButtonBorderWidth:"Width of the toggle button outer border",toggleButtonOnBorderColor:"Colour of the toggle button outer border in its 'on' state",toggleButtonOnBackgroundColor:"Colour of the toggle button background in its 'on' state",toggleButtonOffBorderColor:"Colour of the toggle button's outer border in its 'off' state",toggleButtonOffBackgroundColor:"Colour of the toggle button background in its 'off' state",toggleButtonSwitchBorderColor:"Border colour of the toggle button switch (the bit that slides from left to right)",toggleButtonSwitchBackgroundColor:"Background colour of the toggle button switch (the bit that slides from left to right)",checkboxBorderWidth:"Border width for checkboxes",checkboxBorderRadius:"Border radius for checkboxes",checkboxUncheckedBackgroundColor:"Background colour of an unchecked checkbox",checkboxUncheckedBorderColor:"Border colour of an unchecked checkbox",checkboxCheckedBackgroundColor:"Background colour of a checked checkbox",checkboxCheckedBorderColor:"Border colour of a checked checkbox",checkboxCheckedShapeImage:"An image defining the shape of the check mark on checked checkboxes.",checkboxCheckedShapeColor:"The colour of the check mark on checked checkboxes.",checkboxIndeterminateBackgroundColor:"Background colour of an indeterminate checkbox",checkboxIndeterminateBorderColor:"Border colour of an indeterminate checkbox",checkboxIndeterminateShapeImage:"An image defining the shape of the dash mark on indeterminate checkboxes",checkboxIndeterminateShapeColor:"The colour of the dash mark on indeterminate checkboxes",radioCheckedShapeImage:"An image defining the shape of the mark on checked radio buttons",menuBorder:"Border around menus e.g. column menu and right-click context menu",menuBackgroundColor:"Background colour for menus e.g. column menu and right-click context menu",menuTextColor:"Text colour for menus e.g. column menu and right-click context menu",menuShadow:"Shadow for menus e.g. column menu and right-click context menu",menuSeparatorColor:"Colour of the dividing line between sections of menus e.g. column menu and right-click context menu",setFilterIndentSize:"Amount of indentation for each level of child items in the Set Filter list when filtering tree data.",chartMenuPanelWidth:"Width of the chart editing panel for integrated charts",chartMenuLabelColor:"Colour of form field labels within the chart editing panel for integrated charts",iconButtonHoverColor:"Hover colour for clickable icons",dialogShadow:"Shadow for popup dialogs such as the integrated charts and the advanced filter builder.",dialogBorder:"Border colour popup dialogs such as the integrated charts and the advanced filter builder.",panelBackgroundColor:"Background colour for panels and dialogs such as the integrated charts and the advanced filter builder.",panelTitleBarBackgroundColor:"Background colour for the title bar of panels and dialogs such as the integrated charts and the advanced filter builder.",panelTitleBarBorder:"Border below the title bar of panels and dialogs such as the integrated charts and the advanced filter builder.",columnSelectIndentSize:"Amount of indentation for each level of children when selecting grouped columns in the column select widget.",toolPanelSeparatorBorder:"The dividing line between sections of menus e.g. column menu and right-click context menu",tooltipBackgroundColor:"Background colour for tooltips",tooltipTextColor:"Text colour for tooltips",tooltipBorder:"Border for tooltips",columnDropCellBackgroundColor:"Background colour for the representation of columns within the column drop component",columnDropCellBorder:"Border for the representation of columns within the column drop component",advancedFilterBuilderButtonBarBorder:"Colour of the dividing line above the buttons in the advanced filter builder",advancedFilterBuilderIndentSize:"Amount that each level of the nesting in the advanced filter builder is indented by",advancedFilterBuilderJoinPillColor:"Colour of the join operator pills in the Advanced Filter Builder",advancedFilterBuilderColumnPillColor:"Colour of the column pills in the Advanced Filter Builder",advancedFilterBuilderOptionPillColor:"Colour of the filter option pills in the Advanced Filter Builder",advancedFilterBuilderValuePillColor:"Colour of the value pills in the Advanced Filter Builder",filterToolPanelGroupIndent:"How much to indent child columns in the filters tool panel relative to their parent",iconButtonHoverBackgroundColor:"Background colour of clickable icons when hovered",iconSize:"The size of square icons and icon-buttons",primaryColor:"Application primary colour as defined to the Material Design specification. Only used by Material theme parts.",tabBarBackgroundColor:"Background colour of the container for tabs",tabBarBorder:"Border below the container for tabs",tabBarTopPadding:"Padding at the top of the container for tabs",tabBarHorizontalPadding:"Padding at the left and right of the container for tabs",tabBackgroundColor:"Background colour of tabs",tabTextColor:"Colour of text within tabs",tabSpacing:"Spacing between tabs",tabHorizontalPadding:"Padding inside the top and bottom sides of the container for tabs",tabTopPadding:"Padding at the top of the container for tabs",tabBottomPadding:"Padding at the bottom of the container for tabs",tabHoverBackgroundColor:"Background colour of tabs when hovered over",tabHoverTextColor:"Colour of text within tabs when hovered over",tabSelectedTextColor:"Colour of text within the selected tabs",tabSelectedBackgroundColor:"Background colour of selected tabs",tabSelectedBorderWidth:"Width of the border around selected tabs",tabSelectedBorderColor:"Colour of the border around selected tabs",tabSelectedUnderlineColor:"Colour of line drawn under selected tabs",tabSelectedUnderlineWidth:"Width of line drawn under selected tabs",tabSelectedUnderlineTransitionDuration:"Duration of the fade in/out transition for the line drawn under selected tabs",inputBackgroundColor:"Background colour for text inputs",inputBorder:"Border around text inputs. By default the border is drawn all around the input, when using Material Design inputs the border is drawn underneath",inputBorderRadius:"Corner radius of the border around text inputs",inputTextColor:"Colour of text within text inputs",inputPaddingStart:"Padding at the start of text in text inputs",inputHeight:"Minimum height of text inputs",inputFocusBackgroundColor:"Background colour for focussed text inputs",inputFocusBorder:"Border around focussed text inputs. By default the border is drawn all around the input, when using Material Design inputs the border is drawn underneath",inputFocusShadow:"Shadow around focussed text inputs",inputFocusTextColor:"Colour of text within focussed text inputs",inputDisabledBackgroundColor:"Background colour for disabled text inputs",inputDisabledBorder:"Border around disabled text inputs. By default the border is drawn all around the input, when using Material Design inputs the border is drawn underneath",inputDisabledTextColor:"Colour of text within disabled text inputs",inputInvalidBackgroundColor:"Background colour for text inputs in an invalid state",inputInvalidBorder:"Border around text inputs in an invalid state. By default the border is drawn all around the input, when using Material Design inputs the border is drawn underneath",inputInvalidTextColor:"Colour of text within text inputs in an invalid state",rowLoadingSkeletonEffectColor:"Colour of the skeleton loading effect used when loading row data with the Server-side Row Model"},getParamDocs=e=>docs[e],getParamDocsKeys=()=>Object.keys(docs);
