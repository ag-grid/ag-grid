...
var ClientSideNodeManager = /** @class */ (function () {
    ...
    ClientSideNodeManager.prototype.lookupRowNode = function (data) {
        ...
        var rowNode;
        if (core._.exists(rowNodeIdFunc)) {
            ...
            rowNode = core._.find(this.rootNode.allLeafChildren, function (node) { return node.data === data; });
            if (!rowNode) {
...
var ClientSideRowModel = /** @class */ (function (_super) {
    ...
    ClientSideRowModel.prototype.init = function () {
        ...
        this.addManagedListener(this.gridOptionsWrapper, core.GridOptionsWrapper.PROP_GROUP_REMOVE_SINGLE_CHILDREN, refreshMapListener);
        this.addManagedListener(this.gridOptionsWrapper, core.GridOptionsWrapper.PROP_GROUP_REMOVE_LOWEST_SINGLE_CHILDREN, refreshMapListener);
        this.rootNode = new core.RowNode();
    ...
    ClientSideRowModel.prototype.setRowTopAndRowIndex = function () {
        ...
        for (var i = 0; i < this.rowsToDisplay.length; i++) {
            ...
            var allowEstimate = this.gridOptionsWrapper.getDomLayout() === core.Constants.DOM_LAYOUT_NORMAL;
            var rowNode = this.rowsToDisplay[i];
            if (core._.missing(rowNode.rowHeight)) {
    ...
    ClientSideRowModel.prototype.onFilterChanged = function (event) {
        ...
        var animate = this.gridOptionsWrapper.isAnimateRows();
        this.refreshModel({ step: core.ClientSideRowModelSteps.FILTER, keepRenderedRows: true, animate: animate });
    };
    ...
    ClientSideRowModel.prototype.getType = function () {
        return core.Constants.ROW_MODEL_TYPE_CLIENT_SIDE;
    };
    ...
    ClientSideRowModel.prototype.isSuppressModelUpdateAfterUpdateTransaction = function (params) {
        ...
        var transWithAddsOrDeletes = core._.filter(params.rowNodeTransactions, function (tx) {
    ...
    ClientSideRowModel.prototype.expandOrCollapseAll = function (expand) {
        ...
        function recursiveExpandOrCollapse(rowNodes) {
            ...
            rowNodes.forEach(function (rowNode) {
                var shouldExpandOrCollapse = usingTreeData ? core._.exists(rowNode.childrenAfterGroup) : rowNode.group;
    ...
    ClientSideRowModel.prototype.setRowData = function (rowData) {
        ...
        var rowDataChangedEvent = {
            type: core.Events.EVENT_ROW_DATA_CHANGED,
            api: this.gridApi,
            columnApi: this.columnApi
        };
    ...
    ClientSideRowModel.prototype.onRowHeightChanged = function () {
        ...
        if (this.onRowHeightChangedDebounced == null) {
            this.onRowHeightChangedDebounced = this.animationFrameService.debounce(function () {
                _this.refreshModel({ step: core.ClientSideRowModelSteps.MAP, keepRenderedRows: true, keepEditingRows: true });
            });
        }
    ...
    __decorate([
        core.Autowired('animationFrameService')
...
var SortStage = /** @class */ (function (_super) {
    ...
    SortStage.prototype.execute = function (params) {
        ...
        var noAggregations = core._.missingOrEmpty(this.columnModel.getValueColumns());
        var sortContainsGroupColumns = core._.some(sortOptions, function (opt) { return !!opt.column.getColDef().showRowGroup; });
...
var FlattenStage = /** @class */ (function (_super) {
    ...
    FlattenStage.prototype.ensureFooterNodeExists = function (groupNode) {
        ...
        if (core._.exists(groupNode.sibling)) {
            return;
        }
        var footerNode = new core.RowNode();
        ...
        if (core._.exists(footerNode.id)) {
    ...
    FlattenStage.prototype.createDetailNode = function (masterNode) {
        ...
        var detailNode = new core.RowNode();
...
var SortService = /** @class */ (function (_super) {
    ...
    SortService.prototype.pullDownGroupDataForHideOpenParents = function (rowNodes, clearOperation) {
        var _this = this;
        if (!this.gridOptionsWrapper.isGroupHideOpenParents() || core._.missing(rowNodes)) {
            return;
        }
...
var ImmutableService = /** @class */ (function (_super) {
    ...
    ImmutableService.prototype.createTransactionForRowData = function (data) {
        ...
        if (!getRowNodeIdFunc || core._.missing(getRowNodeIdFunc)) {
