import { Beans, ColumnModel, EventService, RowDataTransaction, RowNode, RowNodeTransaction, SelectionService, GridOptionsService } from "@ag-grid-community/core";
export declare class ClientSideNodeManager {
    ...
    private allNodesMap;
    constructor(rootNode: RowNode, gridOptionsService: GridOptionsService, eventService: EventService, columnModel: ColumnModel, selectionService: SelectionService, beans: Beans);
    postConstruct(): void;
    getCopyOfNodesMap(): {
        [id: string]: RowNode;
    };
