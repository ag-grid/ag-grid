/**
 * @ag-grid-community/client-side-row-model - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components * @version v24.1.1
 ...
 * @link http://www.ag-grid.com/
 * @license MIT
 */function To(t,e,o){t.setAttribute(Ao(e),o.toString())}function _o(t,e){t.removeAttribute(Ao(e))}function Ao(t){return"aria-"+t}function No(t){return t.isSortAscending()?"ascending":t.isSortDescending()?"descending":"none"}function Fo(t){return parseInt(t.getAttribute("aria-posinset"),10)}function Lo(t,e){To(t,"label",e)}function Io(t,e){To(t,"labelledby",e)}function Mo(t,e){To(t,"describedby",e)}function Go(t,e){To(t,"disabled",e)}function xo(t,e){To(t,"expanded",e)}function Vo(t){_o(t,"expanded")}function Wo(t,e){To(t,"setsize",e)}function Ho(t,e){To(t,"posinset",e)}function ko(t,e){To(t,"multiselectable",e)}function Bo(t,e){To(t,"rowcount",e)}function jo(t,e){To(t,"rowindex",e)}function Uo(t,e){To(t,"colcount",e)}function zo(t,e){To(t,"colindex",e)}function Ko(t,e){To(t,"colspan",e)}function Yo(t,e){To(t,"sort",e)}function qo(t){_o(t,"sort")}function Xo(t,e){e?To(t,"selected",e):_o(t,"selected")}function Qo(t,e){To(t,"checked",void 0===e?"mixed":e)}var $o=Object.freeze({__proto__:null,getAriaSortState:No,getAriaLevel:function(t){return parseInt(t.getAttribute("aria-level"),10)},getAriaPosInSet:Fo,setAriaLabel:Lo,setAriaLabelledBy:Io,setAriaDescribedBy:Mo,setAriaLevel:function(t,e){To(t,"level",e)},setAriaDisabled:Go,setAriaExpanded:xo,removeAriaExpanded:Vo,setAriaSetSize:Wo,setAriaPosInSet:Ho,setAriaMultiSelectable:ko,setAriaRowCount:Bo,setAriaRowIndex:jo,setAriaColCount:Uo,setAriaColIndex:zo,setAriaColSpan:Ko,setAriaSort:Yo,removeAriaSort:qo,setAriaSelected:Xo,setAriaChecked:Qo});
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v24.1.1
 * @link http://www.ag-grid.com/
