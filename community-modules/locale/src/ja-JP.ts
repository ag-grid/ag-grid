...
export const AG_GRID_LOCALE_JP = {
    ...
    ariaColumnSelectAll: '「すべての列の可視性を切り替え」',
    ...
    ariaHeaderSelection: '「ヘッダー選択付き列」',
    ariaSelectAllCells: '「スペースを押してすべてのセルを選択」',
    ...
    ariaLabelLoadingContextMenu: 'コンテキストメニューを読み込み中',
