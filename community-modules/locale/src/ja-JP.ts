...
export const AG_GRID_LOCALE_JP = {
    ...
    advancedFilterYesterday: '昨日である',
    advancedFilterToday: '今日である',
    advancedFilterTomorrow: '明日である',
    advancedFilterLast7Days: '過去7日間以内',
    advancedFilterLastWeek: '先週以内',
    advancedFilterThisWeek: '今週以内',
    advancedFilterNextWeek: '来週以内',
    advancedFilterLast30Days: '過去30日間以内',
    advancedFilterLastMonth: '先月以内',
    advancedFilterThisMonth: '今月以内',
    advancedFilterNextMonth: '来月以内',
    advancedFilterLast90Days: '過去90日間以内',
    advancedFilterLastQuarter: '前四半期以内',
    advancedFilterThisQuarter: '今四半期以内',
    advancedFilterNextQuarter: '次四半期以内',
    advancedFilterLastYear: '昨年以内',
    advancedFilterThisYear: '今年以内',
    advancedFilterYearToDate: '年初から今日まで',
    advancedFilterNextYear: '翌年以内',
    advancedFilterLast6Months: '過去6か月以内',
    advancedFilterLast12Months: '過去12か月以内',
    advancedFilterLast24Months: '過去24か月以内',
    advancedFilterTrue: '真',
    advancedFilterFalse: '偽',
    advancedFilterIsAnyOf: 'のいずれか',
    advancedFilterIsNoneOf: 'のいずれでもない',
    advancedFilterSetMore: '他 ${variable} 件',
    ...
    advancedFilterValidationInvalidValue: '値が見つかりません',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable}は${variable}より大きい必要があります',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable}は${variable}以上でなければなりません',
    advancedFilterValidationMustBeAfter: '${variable}は${variable}より後でなければなりません',
    advancedFilterValidationMustBeOnOrAfter: '${variable}は${variable}以降でなければなりません',
