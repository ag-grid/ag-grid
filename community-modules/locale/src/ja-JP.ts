export const AG_GRID_LOCALE_JP = {
    ...
    advancedFilterValidationJoinOperatorMismatch: '条件内の結合オペレーターは同一である必要があります',
    advancedFilterValidationInvalidJoinOperator: '結合オペレーターが見つかりません',
    ...
    advancedFilterValidationMessageAtEnd: '式にエラーがあります。${variable} が式の最後にあります。',
    ...
    advancedFilterBuilderValidationAlreadyApplied: '現在のフィルタは既に適用されています。',
    advancedFilterBuilderValidationIncomplete: 'すべての条件が完了していません。',
    advancedFilterBuilderValidationSelectColumn: 'カラムを選択する必要があります。',
    ...
    pivotChartRequiresPivotMode: 'ピボットチャートはピボットモードが有効である必要があります。',
    ...
    ariaDropZoneColumnValueItemDescription: '集計タイプを変更するにはENTERを押してください',
    ...
    ariaLabelAdvancedFilterBuilderColumnSelectField: '高度なフィルタビルダーでカラムを選択',
    ariaLabelAdvancedFilterBuilderOptionSelectField: '高度なフィルタビルダーでオプションを選択',
    ariaLabelAdvancedFilterBuilderJoinSelectField: '高度なフィルタビルダーで結合オペレーターを選択',
