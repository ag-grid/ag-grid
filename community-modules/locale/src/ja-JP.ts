...
export const AG_GRID_LOCALE_JP = {
    ...
    showValueAs: '計算の種類',
    showValueAsNone: 'なし',
    showValueAsNotApplicable: '現在のビューでは意味がありません',
    showValueAsDefault: '既定',
    showValueAsTopLevel: '最上位',
    ...
    percentOfParentTotal: '親の合計に対する比率',
    ...
    percentOfParentTotalDescription: '各値を指定したグループ化フィールドの上位項目に対する百分率で表します。',
