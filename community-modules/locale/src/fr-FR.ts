...
export const AG_GRID_LOCALE_FR_FR = {
    ...
    advancedFilterInRange: 'est entre',
    advancedFilterYesterday: 'est hier',
    advancedFilterToday: "est aujourd'hui",
    advancedFilterTomorrow: 'est demain',
    advancedFilterLast7Days: 'est dans les 7 derniers jours',
    advancedFilterLastWeek: 'est dans la semaine dernière',
    advancedFilterThisWeek: 'est dans cette semaine',
    advancedFilterNextWeek: 'est dans la semaine prochaine',
    advancedFilterLast30Days: 'est dans les 30 derniers jours',
    advancedFilterLastMonth: 'est dans le mois dernier',
    advancedFilterThisMonth: 'est dans ce mois-ci',
    advancedFilterNextMonth: 'est dans le mois prochain',
    advancedFilterLast90Days: 'est dans les 90 derniers jours',
    advancedFilterLastQuarter: 'est dans le dernier trimestre',
    advancedFilterThisQuarter: 'est dans ce trimestre',
    advancedFilterNextQuarter: 'est dans le prochain trimestre',
    advancedFilterLastYear: "est dans l'année dernière",
    advancedFilterThisYear: 'est dans cette année',
    advancedFilterYearToDate: "est depuis le début de l'année",
    advancedFilterNextYear: "est dans l'année prochaine",
    advancedFilterLast6Months: 'est dans les 6 derniers mois',
    advancedFilterLast12Months: 'est dans les 12 derniers mois',
    advancedFilterLast24Months: 'est dans les 24 derniers mois',
    advancedFilterTrue: 'est vrai',
    advancedFilterFalse: 'est faux',
    advancedFilterIsAnyOf: "est l'un de",
    advancedFilterIsNoneOf: "n'est aucun de",
    advancedFilterSetMore: '+${variable} de plus',
    ...
    advancedFilterValidationInvalidValue: 'Valeur non trouvée',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} doit être supérieur à ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} doit être supérieur ou égal à ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} doit être après ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} doit être le ${variable} ou après',
    ...
    ariaAdvancedFilterBuilderValue: 'Valeur',
    ...
    ariaFullRowValidationError: 'Validation de la ligne complète : ${variable}',
    ariaFullRowEditValidationFailed: 'Impossible de terminer la modification de la ligne. ${variable}',
    ariaRowIndex: 'Ligne ${variable}',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_FR_FR` instead. */
