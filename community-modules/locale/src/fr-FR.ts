...
export const AG_GRID_LOCALE_FR = {
    ...
    noAggregation: 'Aucun',
    showValueAs: 'Afficher les valeurs en tant que',
    showValueAsNone: 'Aucun',
    showValueAsNotApplicable: 'Non pertinent dans la vue actuelle',
    showValueAsDefault: 'Par défaut',
    showValueAsTopLevel: 'Niveau supérieur',
    ...
    percentOfParentTotal: '% du total parent',
    ...
    percentOfParentTotalDescription: 'Chaque valeur en pourcentage de son ancêtre à un champ de regroupement choisi.',
    ...
    ariaColumnShowValueAs: 'Affichage des valeurs en tant que',
