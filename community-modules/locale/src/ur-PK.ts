...
export const AG_GRID_LOCALE_PK = {
    ...
    nextQuarter: 'اگلی سہ ماہی',
    lastYear: 'پچھلے سال',
    thisYear: 'اس سال',
    yearToDate: 'سال بہ تاریخ',
    nextYear: 'اگلے سال',
    last6Months: 'پچھلے 6 ماہ',
    last12Months: 'پچھلے 12 ماہ',
    last24Months: 'پچھلے 24 ماہ',
    ...
    advancedFilterInRange: 'کے درمیان ہے',
    advancedFilterYesterday: 'گزشتہ کل ہے',
    advancedFilterToday: 'آج ہے',
    advancedFilterTomorrow: 'کل ہے',
    advancedFilterLast7Days: 'پچھلے 7 دن میں ہے',
    advancedFilterLastWeek: 'پچھلے ہفتے میں ہے',
    advancedFilterThisWeek: 'اس ہفتے میں ہے',
    advancedFilterNextWeek: 'اگلے ہفتے میں ہے',
    advancedFilterLast30Days: 'پچھلے 30 دن میں ہے',
    advancedFilterLastMonth: 'پچھلے مہینے میں ہے',
    advancedFilterThisMonth: 'اس مہینے میں ہے',
    advancedFilterNextMonth: 'اگلے ماہ میں ہے',
    advancedFilterLast90Days: 'پچھلے 90 دن میں ہے',
    advancedFilterLastQuarter: 'پچھلی سہ ماہی میں ہے',
    advancedFilterThisQuarter: 'اس سہ ماہی میں ہے',
    advancedFilterNextQuarter: 'اگلی سہ ماہی میں ہے',
    advancedFilterLastYear: 'پچھلے سال میں ہے',
    advancedFilterThisYear: 'اس سال میں ہے',
    advancedFilterYearToDate: 'سال بہ تاریخ میں ہے',
    advancedFilterNextYear: 'اگلے سال میں ہے',
    advancedFilterLast6Months: 'پچھلے 6 ماہ میں ہے',
    advancedFilterLast12Months: 'پچھلے 12 ماہ میں ہے',
    advancedFilterLast24Months: 'پچھلے 24 ماہ میں ہے',
    advancedFilterTrue: 'درست ہے',
    advancedFilterFalse: 'غلط ہے',
    advancedFilterIsAnyOf: 'ان میں سے کوئی ایک ہے',
    advancedFilterIsNoneOf: 'ان میں سے کوئی نہیں',
    advancedFilterSetMore: '+${variable} مزید',
    ...
    advancedFilterValidationInvalidValue: 'قدر نہیں ملی',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} ${variable} سے زیادہ ہونا چاہیے',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} ${variable} کے برابر یا اس سے زیادہ ہونا چاہیے',
    advancedFilterValidationMustBeAfter: '${variable} ${variable} کے بعد کی ہونی چاہیے',
    advancedFilterValidationMustBeOnOrAfter: '${variable} ${variable} یا اس کے بعد کی ہونی چاہیے',
    ...
    // Formulas
    invalidFormulaValidation: 'غلط فارمولا۔',
    formulaParseInvalidCellReference: 'غلط سیل حوالہ: ${variable}۔',
    formulaParseInvalidRangeEndReference: 'رینج کے اختتام کا حوالہ غلط ہے۔',
    formulaParseUnterminatedString: 'اسٹرنگ مکمل نہیں ہوئی۔',
    formulaParseUnexpectedCharacter: 'غیر متوقع کریکٹر: ${variable}۔',
    formulaParseOperatorStackUnderflow: 'آپریٹر اسٹیک انڈر فلو۔',
    formulaParseMissingOperand: "'${variable}' کے لیے آپرینڈ موجود نہیں۔",
    formulaParseInternalUnexpectedFrameDuringReduction: 'اندرونی خرابی: ریڈکشن کے دوران غیر متوقع فریم۔',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "اندرونی خرابی: '(' سے پہلے غیر متوقع فریم۔",
    formulaParseMisplacedComma: 'کوما غلط جگہ پر ہے۔',
    formulaParseCommaOutsideFunctionCall: 'فنکشن کال کے باہر کوما موجود ہے۔',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "اندرونی خرابی: ')' سے پہلے غیر متوقع فریم۔",
    formulaParseMismatchedParentheses: 'قوسین میل نہیں کھاتیں۔',
    formulaParseUnsupportedOperand: 'غیر معاون آپرینڈ: ${variable}۔',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'قوسین میل نہیں کھاتیں یا فنکشن کال نامکمل ہے۔',
    formulaParseInvalidExpression: 'غلط اظہار۔',
    formulaParseFormulasMustBeginWithEquals: 'فارمولا = سے شروع ہونا چاہیے۔',
    formulaSerializeStringContainsQuote: 'اسٹرنگ میں ڈبل کوٹ (") موجود ہے، جسے ٹوکنائزر سپورٹ نہیں کرتا۔',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId: "ID '${variable}' سے مطلق کالم لیبل نہیں بنایا جا سکتا۔",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "ID '${variable}' سے مطلق قطار انڈیکس نہیں بنایا جا سکتا۔",
    formulaSerializeCannotProduceRowIndexFromId: "ID '${variable}' سے قطار انڈیکس نہیں بنایا جا سکتا۔",
    formulaSerializeCannotMapColumnIdToA1Label: "کالم ID '${variable}' کو A1 لیبل سے میپ نہیں کیا جا سکتا۔",
    formulaSerializeCannotParseAbsoluteRowIndex: "مطلق قطار انڈیکس '${variable}' کو پارس نہیں کیا جا سکتا۔",
    formulaSerializeCannotMapRowIdToA1Index: "قطار ID '${variable}' کو A1 انڈیکس سے میپ نہیں کیا جا سکتا۔",
    formulaEvalRangeNotAllowedInScalarContext: 'اسکیلر تناظر میں رینج کی اجازت نہیں ہے۔',
    formulaEvalUnknownReferenceToCell: 'سیل کا حوالہ نامعلوم ہے۔',
    formulaEvalUnsupportedOperation: 'غیر معاون عمل ${variable}۔',
    formulaEvalInvalidAbsoluteRow: 'غلط مطلق قطار۔',
    formulaEvalUnrecognisedRowId: 'قطار ID غیر شناخت شدہ ہے۔',
    formulaEvalInvalidAbsoluteColumn: 'غلط مطلق کالم۔',
    formulaEvalUnrecognisedColumnId: 'کالم ID غیر شناخت شدہ ہے۔',
    formulaEvalUnrecognisedRowInRange: 'رینج میں غیر شناخت شدہ قطار۔',
    formulaEvalUnrecognisedReferenceToCell: 'سیل کا حوالہ غیر شناخت شدہ ہے۔',
    formulaEvalIncompleteRangeReference: 'نامکمل رینج حوالہ۔',
    formulaFunctionExpectedExactlyArguments: '${variable}: بالکل ${variable} آرگیومنٹس درکار ہیں۔',
    formulaFunctionExpectedAtMostArguments: '${variable}: زیادہ سے زیادہ ${variable} آرگیومنٹس درکار ہیں۔',
    formulaFunctionExpectedAtLeastArguments: '${variable}: کم از کم ${variable} آرگیومنٹس درکار ہیں۔',
    formulaFunctionInvalidCriteriaWildcardsWithComparator:
        'غلط معیار: وائلڈ کارڈز کو کمپیریٹر کے ساتھ استعمال نہیں کیا جا سکتا۔',
    formulaFunctionNonNumericArgument: '${variable}: غیر عددی آرگیومنٹ۔',
    formulaFunctionDivisionByZero: '${variable}: صفر سے تقسیم۔',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: تاریخوں کو BigInt کے ساتھ یکجا نہیں کیا جا سکتا۔',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: کم از کم ایک عددی قدر درکار ہے۔',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: کم از کم ایک قدر درکار ہے۔',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: تمام قدریں عددی ہونی چاہئیں۔',
    formulaFunctionArgumentMustBeRange: '${variable}: ${variable} آرگیومنٹ رینج ہونا چاہیے۔',
    formulaFunctionArgumentMustBeValue: '${variable}: ${variable} آرگیومنٹ قدر ہونا چاہیے۔',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: رینجز کے سائز مختلف ہیں۔',
    formulaFunctionValuesMustBeNumeric: '${variable}: قدریں عددی ہونی چاہئیں۔',
    formulaFunctionValuesMustBeIntegers: '${variable}: قدریں صحیح عدد ہونی چاہئیں۔',
    formulaFunctionUnsupportedValueType: '${variable}: قدر کی قسم معاون نہیں۔',
    formulaFunctionDivNonNumericArgument: 'DIV: غیر عددی آرگیومنٹ۔',
    formulaFunctionDivDivisionByZero: 'DIV: صفر سے تقسیم۔',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: تاریخوں کو BigInt کے ساتھ یکجا نہیں کیا جا سکتا۔',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: کم از کم ایک عددی قدر درکار ہے۔',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: کم از کم ایک قدر درکار ہے۔',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: تمام قدریں عددی ہونی چاہئیں۔',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: کم از کم ایک قدر درکار ہے۔',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: پہلا آرگیومنٹ رینج ہونا چاہیے۔',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: دوسرا آرگیومنٹ قدر (criteria) ہونا چاہیے۔',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: تیسرا آرگیومنٹ رینج (sum_range) ہونا چاہیے۔',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: رینجز کے سائز مختلف ہیں۔',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: پہلا آرگیومنٹ رینج ہونا چاہیے۔',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: دوسرا آرگیومنٹ قدر (criteria) ہونا چاہیے۔',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: قدر کی قسم معاون نہیں۔',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: کم از کم ایک قدر درکار ہے۔',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: کم از کم ایک قدر درکار ہے۔',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: غیر عددی آرگیومنٹ۔',
    formulaFunctionPowerNonNumericArgument: 'POWER: غیر عددی آرگیومنٹ۔',
    formulaServiceCircularReference: 'دائروی حوالہ۔',
    formulaServiceExpectedParsableFormula: 'قابلِ پارس فارمولا متوقع تھا۔',
    formulaServiceInternalSchedulingError: 'اندرونی شیڈولنگ خرابی۔',
    ...
    fileInputOverlay: 'ڈیٹا درآمد کرنے کے لیے فائل کھینچ کر چھوڑیں',
    ...
    showValuesAs: 'اقدار کو اس طور دکھائیں',
    showValuesAsNone: 'کوئی نہیں',
    percentOfGrandTotal: '% کل میزان کا',
    percentOfColumnTotal: '% کالم میزان کا',
    percentOfRowTotal: '% قطار میزان کا',
    percentOfParentRowTotal: '% بنیادی قطار میزان کا',
    percentOfParentColumnTotal: '% بنیادی کالم میزان کا',
    percentOfGrandTotalDescription: 'ہر قدر کالم کے کل میزان کے فیصد کے طور پر۔',
    percentOfColumnTotalDescription: 'ہر قدر اپنے کالم کے میزان کے فیصد کے طور پر — ہر کالم کا میزان 100% ہوتا ہے۔',
    percentOfRowTotalDescription: 'ہر قدر پیوٹ کالموں میں قطار کے میزان کے فیصد کے طور پر۔',
    percentOfParentRowTotalDescription: 'ہر قدر اپنے بنیادی گروپ کے فیصد کے طور پر۔',
    percentOfParentColumnTotalDescription: 'ہر قدر اپنے بنیادی پیوٹ کالم کے فیصد کے طور پر۔',
    autosizeThisColumn: 'اس کالم کے سائز کو خودکار بنائیں',
    autosizeAllColumns: 'تمام کالم کے سائز کو خودکار بنائیں',
    groupBy: 'گروپ بندی کریں ${variable}',
    ungroupBy: 'غیر گروپ بندی کریں ${variable}',
