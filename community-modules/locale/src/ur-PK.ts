...
export const AG_GRID_LOCALE_PK = {
    ...
    donutTooltip: 'ڈونٹ',
    lineTooltip: 'لائن',
    stackedLineTooltip: 'مرتب کی گئی',
    normalizedLineTooltip: '100% مرتب کی گئی',
    ...
    coneFunnel: 'کون فنل',
    pyramid: 'اہرام',
    funnelGroup: 'فنل گروپ',
    funnelTooltip: 'فنل',
    coneFunnelTooltip: 'کون فنل',
    pyramidTooltip: 'اہرام',
    dropOff: 'گرا دینا',
    stageLabels: 'منزل کے لیبلز',
    reverse: 'الٹا',
    ...
    ariaColumnSelectAll: 'تمام کالموں کی ظاہریت کو تبدیل کریں',
    ...
    ariaHeaderSelection: 'کالم جس میں ہیڈر انتخاب ہو',
    ...
    ariaLabelLoadingContextMenu: 'سیاق و سباق مینو لوڈ ہو رہا ہے',
