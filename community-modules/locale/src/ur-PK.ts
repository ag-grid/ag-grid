...
export const AG_GRID_LOCALE_PK = {
    ...
    showValueAs: 'اقدار کو اس طور دکھائیں',
    showValueAsNone: 'کوئی نہیں',
    showValueAsNotApplicable: 'موجودہ منظر میں بامعنی نہیں',
    showValueAsDefault: 'طے شدہ',
    showValueAsTopLevel: 'اعلیٰ ترین سطح',
    ...
    percentOfParentTotal: '% بنیادی میزان کا',
    ...
    percentOfParentTotalDescription: 'ہر قدر منتخب گروپ بندی فیلڈ پر اپنے جدِ امجد کے فیصد کے طور پر۔',
