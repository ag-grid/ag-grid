...
export const AG_GRID_LOCALE_SE = {
    ...
    stackedLineTooltip: 'Staplad',
    normalizedLineTooltip: '100% Staplad',
    ...
    ariaColumnSelectAll: 'Växla synlighet för alla kolumner',
    ...
    ariaHeaderSelection: 'Kolumn med huvudval',
    ariaSelectAllCells: 'Tryck på mellanslag för att välja alla celler',
