...
export const AG_GRID_LOCALE_SE = {
    ...
    noAggregation: 'Ingen',
    showValueAs: 'Visa värden som',
    showValueAsNone: 'Ingen',
    showValueAsNotApplicable: 'Inte relevant i den aktuella vyn',
    showValueAsDefault: 'Standard',
    showValueAsTopLevel: 'Översta nivån',
    ...
    percentOfParentTotal: '% av överordnad summa',
    ...
    percentOfParentTotalDescription: 'Varje värde som en procentandel av dess förfader vid ett valt grupperingsfält.',
