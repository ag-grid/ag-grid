...
export const AG_GRID_LOCALE_SE = {
    ...
    advancedFilterIsAnyOf: 'är någon av',
    advancedFilterIsNoneOf: 'är ingen av',
    advancedFilterSetMore: '+${variable} till',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} måste vara större än ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} måste vara större än eller lika med ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} måste vara efter ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} måste vara ${variable} eller senare',
    ...
    editColumnName: 'Redigera kolumnnamn',
    ariaColumnHeaderNameEditor: 'Kolumnnamnsredigerare',
    columnHeaderEditApply: 'Verkställ',
