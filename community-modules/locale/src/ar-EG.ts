...
export const AG_GRID_LOCALE_EG = {
    ...
    ariaColumnSelectAll: 'تبديل رؤية كل الأعمدة',
    ...
    ariaHeaderSelection: 'عمود مع اختيار العنوان',
    ariaSelectAllCells: 'اضغط على المسافة لتحديد كل الخلايا',
    ...
    ariaLabelLoadingContextMenu: 'جاري تحميل قائمة السياق',
