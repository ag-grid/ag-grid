...
export const AG_GRID_LOCALE_EG = {
    ...
    showValueAs: 'إظهار القيم كـ',
    showValueAsNone: 'بلا',
    showValueAsNotApplicable: 'غير ذي معنى في العرض الحالي',
    showValueAsDefault: 'افتراضي',
    showValueAsTopLevel: 'المستوى الأعلى',
    ...
    percentOfParentTotal: '% من الإجمالي الأصل',
    ...
    percentOfParentTotalDescription: 'كل قيمة كنسبة مئوية من سلفها عند حقل تجميع محدد.',
