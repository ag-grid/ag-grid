...
export const AG_GRID_LOCALE_EG = {
    ...
    advancedFilterIsAnyOf: 'هو أي من',
    advancedFilterIsNoneOf: 'ليس أياً من',
    advancedFilterSetMore: '+${variable} المزيد',
    advancedFilterAnd: 'و',
    advancedFilterOr: 'أو',
    ...
    advancedFilterValidationInvalidValue: 'القيمة غير موجودة',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} يجب أن يكون أكبر من ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} يجب أن يكون أكبر من أو يساوي ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} يجب أن يكون بعد ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} يجب أن يكون في ${variable} أو بعده',
