...
export const AG_GRID_LOCALE_DE = {
    ...
    noAggregation: 'Keine',
    showValueAs: 'Werte anzeigen als',
    showValueAsNone: 'Keine',
    showValueAsNotApplicable: 'In der aktuellen Ansicht nicht aussagekräftig',
    showValueAsDefault: 'Standard',
    showValueAsTopLevel: 'Oberste Ebene',
    ...
    percentOfParentTotal: '% des übergeordneten Ergebnisses',
    ...
    percentOfParentTotalDescription:
        'Jeder Wert als Prozentsatz seines Vorgängers auf einem ausgewählten Gruppierungsfeld.',
    ...
    ariaColumnShowValueAs: 'Werte werden angezeigt als',
