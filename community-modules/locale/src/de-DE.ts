...
export const AG_GRID_LOCALE_DE_DE = {
    ...
    advancedFilterInRange: 'ist zwischen',
    advancedFilterYesterday: 'ist gestern',
    advancedFilterToday: 'ist heute',
    advancedFilterTomorrow: 'ist morgen',
    advancedFilterLast7Days: 'ist in den letzten 7 Tagen',
    advancedFilterLastWeek: 'ist in der letzten Woche',
    advancedFilterThisWeek: 'ist in dieser Woche',
    advancedFilterNextWeek: 'ist in der nächsten Woche',
    advancedFilterLast30Days: 'ist in den letzten 30 Tagen',
    advancedFilterLastMonth: 'ist im letzten Monat',
    advancedFilterThisMonth: 'ist in diesem Monat',
    advancedFilterNextMonth: 'ist im nächsten Monat',
    advancedFilterLast90Days: 'ist in den letzten 90 Tagen',
    advancedFilterLastQuarter: 'ist im letzten Quartal',
    advancedFilterThisQuarter: 'ist in diesem Quartal',
    advancedFilterNextQuarter: 'ist im nächsten Quartal',
    advancedFilterLastYear: 'ist im letzten Jahr',
    advancedFilterThisYear: 'ist in diesem Jahr',
    advancedFilterYearToDate: 'ist im laufenden Jahr bis heute',
    advancedFilterNextYear: 'ist im nächsten Jahr',
    advancedFilterLast6Months: 'ist in den letzten 6 Monaten',
    advancedFilterLast12Months: 'ist in den letzten 12 Monaten',
    advancedFilterLast24Months: 'ist in den letzten 24 Monaten',
    advancedFilterTrue: 'ist-wahr',
    advancedFilterFalse: 'ist-falsch',
    advancedFilterIsAnyOf: 'ist eines von',
    advancedFilterIsNoneOf: 'ist keines von',
    advancedFilterSetMore: '+${variable} weitere',
    ...
    advancedFilterValidationInvalidValue: 'Wert nicht gefunden',
    ...
    advancedFilterValidationNotABigInt: 'Wert ist kein BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} muss größer als ${variable} sein',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} muss größer oder gleich ${variable} sein',
    advancedFilterValidationMustBeAfter: '${variable} muss nach ${variable} liegen',
    advancedFilterValidationMustBeOnOrAfter: '${variable} muss am ${variable} oder danach liegen',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_DE_DE` instead. */
