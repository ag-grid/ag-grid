...
export const AG_GRID_LOCALE_HU = {
    ...
    today: 'Ma',
    tomorrow: 'Holnap',
    last7Days: 'Előző 7 nap',
    lastWeek: 'Múlt hét',
    thisWeek: 'E hét',
    nextWeek: 'Következő hét',
    last30Days: 'Előző 30 nap',
    lastMonth: 'Múlt hónap',
    thisMonth: 'E hónap',
    nextMonth: 'Következő hónap',
    last90Days: 'Előző 90 nap',
    lastQuarter: 'Múlt negyedév',
    thisQuarter: 'E negyedév',
    nextQuarter: 'Következő negyedév',
    lastYear: 'Tavaly',
    thisYear: 'Idén',
    yearToDate: 'Év elejétől máig',
    nextYear: 'Jövőre',
    last6Months: 'Előző 6 hónap',
    last12Months: 'Előző 12 hónap',
    last24Months: 'Előző 24 hónap',
    ...
    advancedFilterInRange: 'között van',
    advancedFilterYesterday: 'tegnap van',
    advancedFilterToday: 'ma van',
    advancedFilterTomorrow: 'holnap van',
    advancedFilterLast7Days: 'az előző 7 napban van',
    advancedFilterLastWeek: 'a múlt héten van',
    advancedFilterThisWeek: 'ezen a héten van',
    advancedFilterNextWeek: 'a következő héten van',
    advancedFilterLast30Days: 'az előző 30 napban van',
    advancedFilterLastMonth: 'a múlt hónapban van',
    advancedFilterThisMonth: 'ebben a hónapban van',
    advancedFilterNextMonth: 'a következő hónapban van',
    advancedFilterLast90Days: 'az előző 90 napban van',
    advancedFilterLastQuarter: 'a múlt negyedévben van',
    advancedFilterThisQuarter: 'ebben a negyedévben van',
    advancedFilterNextQuarter: 'a következő negyedévben van',
    advancedFilterLastYear: 'tavaly van',
    advancedFilterThisYear: 'idén van',
    advancedFilterYearToDate: 'az év elejétől máig van',
    advancedFilterNextYear: 'jövőre van',
    advancedFilterLast6Months: 'az előző 6 hónapban van',
    advancedFilterLast12Months: 'az előző 12 hónapban van',
    advancedFilterLast24Months: 'az előző 24 hónapban van',
    advancedFilterTrue: 'igaz',
    advancedFilterFalse: 'hamis',
    advancedFilterIsAnyOf: 'bármelyik ezek közül',
    advancedFilterIsNoneOf: 'egyik sem ezek közül',
    advancedFilterSetMore: '+${variable} további',
    ...
    advancedFilterValidationInvalidValue: 'Érték nem található',
    ...
    // Formulas
    invalidFormulaValidation: 'Ervenytelen keplet.',
    formulaParseInvalidCellReference: 'Ervenytelen cellahivatkozas: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Ervenytelen tartomany veg-hivatkozas.',
    formulaParseUnterminatedString: 'Lezaras nelkuli szoveg.',
    formulaParseUnexpectedCharacter: 'Varatlan karakter: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Operator verem alulcsordulas.',
    formulaParseMissingOperand: "Hianyzik operand ehhez: '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Belso hiba: varatlan frame redukcio kozben.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Belso hiba: varatlan frame '(' elott.",
    formulaParseMisplacedComma: 'Rossz helyen levo vesszo.',
    formulaParseCommaOutsideFunctionCall: 'Vesszo fuggvenyhivason kivul.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Belso hiba: varatlan frame ')' elott.",
    formulaParseMismatchedParentheses: 'Nem egyezo zarojelek.',
    formulaParseUnsupportedOperand: 'Nem tamogatott operandus: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'Nem egyezo zarojelek vagy befejezetlen fuggvenyhivas.',
    formulaParseInvalidExpression: 'Ervenytelen kifejezes.',
    formulaParseFormulasMustBeginWithEquals: 'A kepleteknek = jellel kell kezdodniuk.',
    formulaSerializeStringContainsQuote: 'A szoveg idezojelet (") tartalmaz, amit a tokenizalo nem tamogat.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Nem lehet abszolut OSZLOP cimket eloallitani a(z) '${variable}' id-bol.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Nem lehet abszolut SOR indexet eloallitani a(z) '${variable}' id-bol.",
    formulaSerializeCannotProduceRowIndexFromId: "Nem lehet SOR indexet eloallitani a(z) '${variable}' id-bol.",
    formulaSerializeCannotMapColumnIdToA1Label: "A(z) '${variable}' oszlop id nem kepezheto le A1 cimkere.",
    formulaSerializeCannotParseAbsoluteRowIndex: "A(z) '${variable}' abszolut sorindex nem ertelmezheto.",
    formulaSerializeCannotMapRowIdToA1Index: "A(z) '${variable}' sor id nem kepezheto le A1 indexre.",
    formulaEvalRangeNotAllowedInScalarContext: 'Tartomany nem engedelyezett skalaris kontextusban.',
    formulaEvalUnknownReferenceToCell: 'Ismeretlen cellahivatkozas.',
    formulaEvalUnsupportedOperation: 'Nem tamogatott muvelet ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Ervenytelen abszolut sor.',
    formulaEvalUnrecognisedRowId: 'Felismerhetetlen sor-azonosito.',
    formulaEvalInvalidAbsoluteColumn: 'Ervenytelen abszolut oszlop.',
    formulaEvalUnrecognisedColumnId: 'Felismerhetetlen oszlop-azonosito.',
    formulaEvalUnrecognisedRowInRange: 'Felismerhetetlen sor a tartomanyban.',
    formulaEvalUnrecognisedReferenceToCell: 'Felismerhetetlen cellahivatkozas.',
    formulaEvalIncompleteRangeReference: 'Hianyos tartomanyhivatkozas.',
    formulaFunctionExpectedExactlyArguments: '${variable}: pontosan ${variable} argumentum varhato.',
    formulaFunctionExpectedAtMostArguments: '${variable}: legfeljebb ${variable} argumentum varhato.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: legalabb ${variable} argumentum varhato.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator:
        'Ervenytelen kriterium: helyettesito karakterek osszehasonlitoval.',
    formulaFunctionNonNumericArgument: '${variable}: nem numerikus argumentum.',
    formulaFunctionDivisionByZero: '${variable}: nullaval osztas.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: datumok nem kombinalhatok BigInt ertekkel.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: legalabb egy numerikus ertek szukseges.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: legalabb egy ertek szukseges.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: minden erteknek szamnak kell lennie.',
    formulaFunctionArgumentMustBeRange: '${variable}: a(z) ${variable} argumentumnak tartomanynak kell lennie.',
    formulaFunctionArgumentMustBeValue: '${variable}: a(z) ${variable} argumentumnak erteknek kell lennie.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: a tartomanyok merete kulonbozik.',
    formulaFunctionValuesMustBeNumeric: '${variable}: az ertekeknek numerikusnak kell lenniuk.',
    formulaFunctionValuesMustBeIntegers: '${variable}: az ertekeknek egesz szamoknak kell lenniuk.',
    formulaFunctionUnsupportedValueType: '${variable}: nem tamogatott ertektipus.',
    formulaFunctionDivNonNumericArgument: 'DIV: nem numerikus argumentum.',
    formulaFunctionDivDivisionByZero: 'DIV: nullaval osztas.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: datumok nem kombinalhatok BigInt ertekkel.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: legalabb egy numerikus ertek szukseges.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: legalabb egy ertek szukseges.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: minden erteknek szamnak kell lennie.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: legalabb egy ertek szukseges.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: az elso argumentumnak tartomanynak kell lennie.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: a masodik argumentumnak erteknek kell lennie (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange:
        'SUMIF: a harmadik argumentumnak tartomanynak kell lennie (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: a tartomanyok merete kulonbozik.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: az elso argumentumnak tartomanynak kell lennie.',
    formulaFunctionCountifSecondArgumentMustBeValue:
        'COUNTIF: a masodik argumentumnak erteknek kell lennie (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: nem tamogatott ertektipus.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: legalabb egy ertek szukseges.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: legalabb egy ertek szukseges.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: nem numerikus argumentum.',
    formulaFunctionPowerNonNumericArgument: 'POWER: nem numerikus argumentum.',
    formulaServiceCircularReference: 'Korhivatkozas.',
    formulaServiceExpectedParsableFormula: 'Elemezheto keplet vart.',
    formulaServiceInternalSchedulingError: 'Belso utemezesi hiba.',
    ...
    fileInputOverlay: 'Húzza ide a fájlt az adatok importálásához',
    ...
    noAggregation: 'Nincs',
    showValuesAs: 'Értékek megjelenítése mint',
    showValuesAsNone: 'Nincs',
    percentOfGrandTotal: 'A végösszeg %-a',
    percentOfColumnTotal: 'Az oszlopösszeg %-a',
    percentOfRowTotal: 'A sorösszeg %-a',
    percentOfParentRowTotal: 'A szülősor összegének %-a',
    percentOfParentColumnTotal: 'A szülőoszlop összegének %-a',
    percentOfGrandTotalDescription: 'Minden érték az oszlop végösszegének százalékában.',
    percentOfColumnTotalDescription: 'Minden érték a saját oszlopösszegének százalékában — minden oszlop összege 100%.',
    percentOfRowTotalDescription: 'Minden érték a sorösszeg százalékában a pivot oszlopokon keresztül.',
    percentOfParentRowTotalDescription: 'Minden érték a szülőcsoportjának százalékában.',
    percentOfParentColumnTotalDescription: 'Minden érték a szülő pivot oszlopának százalékában.',
    autosizeThisColumn: 'Oszlop automatikus átméretezése',
    autosizeAllColumns: 'Összes oszlop automatikus átméretezése',
    groupBy: 'Csoportosítás: ${variable} szerint',
    ungroupBy: 'Csoportosítás megszüntetése: ${variable} szerint',
    ...
    shiftF2: 'Shift+F2',
    toolbarFind: 'Keresés',
    toolbarFindPreviousMatch: 'Előző találat',
    toolbarFindNextMatch: 'Következő találat',
    toolbarQuickFilter: 'Szűrő',
    toolbarMenu: 'Menü',
    ...
    invalidBigInt: 'Érvénytelen BigInt',
    january: 'Január',
    february: 'Február',
    march: 'Március',
    april: 'Április',
