...
export const AG_GRID_LOCALE_HU = {
    ...
    noAggregation: 'Nincs',
    showValueAs: 'Értékek megjelenítése mint',
    showValueAsNone: 'Nincs',
    showValueAsNotApplicable: 'Nem értelmezhető az aktuális nézetben',
    showValueAsDefault: 'Alapértelmezett',
    showValueAsTopLevel: 'Legfelső szint',
    ...
    percentOfParentTotal: 'A szülőösszeg %-a',
    ...
    percentOfParentTotalDescription: 'Minden érték egy kiválasztott csoportosítási mező szerinti ősének százalékában.',
    ...
    ariaColumnShowValueAs: 'Értékek megjelenítése mint',
