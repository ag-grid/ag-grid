...
export const AG_GRID_LOCALE_HU = {
    ...
    funnel: 'Tölcsér',
    coneFunnel: 'Kúp Tölcsér',
    pyramid: 'Piramis',
    funnelGroup: 'Tölcsér',
    funnelTooltip: 'Tölcsér',
    coneFunnelTooltip: 'Kúp Tölcsér',
    pyramidTooltip: 'Piramis',
    dropOff: 'Lemorzsolódás',
    stageLabels: 'Szakasz Címkék',
    reverse: 'Megfordít',
    ...
    ariaColumnSelectAll: '„Összes oszlop láthatóságának átkapcsolása”',
    ...
    ariaHeaderSelection: '„Fejléc kiválasztásával rendelkező oszlop”',
    ariaSelectAllCells: '„Az összes cella kiválasztásához nyomja meg a Szóközt”',
    ...
    ariaLabelLoadingContextMenu: 'A helyzetérzékeny menü betöltése',
