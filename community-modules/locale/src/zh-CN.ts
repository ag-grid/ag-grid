...
export const AG_GRID_LOCALE_CN = {
    ...
    showValueAs: '值显示方式',
    showValueAsNone: '无',
    showValueAsNotApplicable: '在当前视图中无意义',
    showValueAsDefault: '默认',
    showValueAsTopLevel: '顶层',
    ...
    percentOfParentTotal: '占父级总计的百分比',
    ...
    percentOfParentTotalDescription: '每个值占其在所选分组字段处的上级的百分比。',
    ...
    ariaColumnShowValueAs: '正在以此方式显示值',
