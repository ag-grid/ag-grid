...
export const AG_GRID_LOCALE_CN = {
    ...
    advancedFilterLast7Days: '在最近7天内',
    advancedFilterLastWeek: '在上周内',
    advancedFilterThisWeek: '在本周内',
    advancedFilterNextWeek: '在下周内',
    advancedFilterLast30Days: '在最近30天内',
    advancedFilterLastMonth: '在上个月内',
    advancedFilterThisMonth: '在这个月内',
    advancedFilterNextMonth: '在下个月内',
    advancedFilterLast90Days: '在最近90天内',
    advancedFilterLastQuarter: '在上个季度内',
    advancedFilterThisQuarter: '在这个季度内',
    advancedFilterNextQuarter: '在下个季度内',
    advancedFilterLastYear: '在去年内',
    advancedFilterThisYear: '在今年内',
    advancedFilterYearToDate: '在年初至今',
    advancedFilterNextYear: '在明年内',
    advancedFilterLast6Months: '在最近6个月内',
    advancedFilterLast12Months: '在最近12个月内',
    advancedFilterLast24Months: '在最近24个月内',
    advancedFilterTrue: '为真',
    advancedFilterFalse: '为假',
    advancedFilterIsAnyOf: '是其中之一',
    advancedFilterIsNoneOf: '不是其中任何一个',
    advancedFilterSetMore: '还有 ${variable} 项',
    advancedFilterAnd: '且',
    advancedFilterOr: '或',
    ...
    advancedFilterValidationInvalidValue: '找不到值',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable}必须大于${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable}必须大于或等于 ${variable}',
    advancedFilterValidationMustBeAfter: '${variable}必须在 ${variable} 之后',
    advancedFilterValidationMustBeOnOrAfter: '${variable}必须在 ${variable} 或之后',
    ...
    ariaFullRowValidationError: '整行验证：${variable}',
    ariaFullRowEditValidationFailed: '无法完成行编辑。${variable}',
