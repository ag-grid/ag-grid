...
export const AG_GRID_LOCALE_NO = {
    ...
    ariaColumnSelectAll: 'Veksle synlighet for alle kolonner',
    ...
    ariaHeaderSelection: 'Kolonne med header-utvalg',
    ariaSelectAllCells: 'Trykk på mellomromstasten for å velge alle cellene',
