...
export const AG_GRID_LOCALE_NO = {
    ...
    noAggregation: 'Ingen',
    showValueAs: 'Vis verdier som',
    showValueAsNone: 'Ingen',
    showValueAsNotApplicable: 'Ikke relevant i gjeldende visning',
    showValueAsDefault: 'Standard',
    showValueAsTopLevel: 'Øverste nivå',
    ...
    percentOfParentTotal: '% av overordnet sum',
    ...
    percentOfParentTotalDescription: 'Hver verdi som en prosentandel av forelderen på et valgt grupperingsfelt.',
    ...
    ariaColumnShowValueAs: 'Viser verdier som',
