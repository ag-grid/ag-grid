...
export const AG_GRID_LOCALE_NO = {
    ...
    nextQuarter: 'Neste kvartal',
    lastYear: 'Forrige år',
    thisYear: 'Dette året',
    yearToDate: 'Året til dags dato',
    nextYear: 'Neste år',
    last6Months: 'Siste 6 måneder',
    last12Months: 'Siste 12 måneder',
    last24Months: 'Siste 24 måneder',
    ...
    advancedFilterIsAnyOf: 'er en av',
    advancedFilterIsNoneOf: 'er ingen av',
    advancedFilterSetMore: '+${variable} til',
    ...
    advancedFilterValidationInvalidValue: 'Verdi ikke funnet',
    ...
    advancedFilterValidationNotABigInt: 'Verdi er ikke et BigInt',
    ...
    advancedFilterValidationMessageOnly: 'Uttrykket har en feil. ${variable}.',
    advancedFilterValidationMustBeGreaterThan: '${variable} må være større enn ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} må være større enn eller lik ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} må være etter ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} må være ${variable} eller senere',
    ...
    formulaParseInvalidCellReference: 'Ugyldig cellereferanse: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Ugyldig sluttreferanse for omraade.',
    formulaParseUnterminatedString: 'Uavsluttet streng.',
    formulaParseUnexpectedCharacter: 'Uventet tegn: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Operatorstakk-underflow.',
    formulaParseMissingOperand: "Mangler operand for '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Intern feil: uventet frame under reduksjon.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Intern feil: uventet frame foer '('.",
    formulaParseMisplacedComma: 'Komma paa feil plass.',
    formulaParseCommaOutsideFunctionCall: 'Komma utenfor funksjonskall.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Intern feil: uventet frame foer ')'.",
    formulaParseMismatchedParentheses: 'Parentesene matcher ikke.',
    formulaParseUnsupportedOperand: 'Operand stoettes ikke: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall:
        'Parentesene matcher ikke eller ufullfoert funksjonskall.',
    formulaParseInvalidExpression: 'Ugyldig uttrykk.',
    formulaParseFormulasMustBeginWithEquals: 'Formler ma starte med =.',
    formulaSerializeStringContainsQuote: 'Strengen inneholder et anfoerselstegn (") som tokenizeren ikke stoetter.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Kan ikke lage absolutt KOLONNE-etikett fra id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "Kan ikke lage absolutt RAD-indeks fra id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Kan ikke lage RAD-indeks fra id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Kan ikke mappe kolonne-id '${variable}' til A1-etikett.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Kan ikke parse absolutt radindeks '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Kan ikke mappe rad-id '${variable}' til A1-indeks.",
    formulaEvalRangeNotAllowedInScalarContext: 'Omraade er ikke tillatt i skalaer kontekst.',
    formulaEvalUnknownReferenceToCell: 'Ukjent referanse til celle.',
    formulaEvalUnsupportedOperation: 'Operasjonen stoettes ikke ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Ugyldig absolutt rad.',
    formulaEvalUnrecognisedRowId: 'Ukjent rad-id.',
    formulaEvalInvalidAbsoluteColumn: 'Ugyldig absolutt kolonne.',
    formulaEvalUnrecognisedColumnId: 'Ukjent kolonne-id.',
    formulaEvalUnrecognisedRowInRange: 'Ukjent rad i omraade.',
    formulaEvalUnrecognisedReferenceToCell: 'Ukjent cellereferanse.',
    formulaEvalIncompleteRangeReference: 'Ufullstendig omraadereferanse.',
    formulaFunctionExpectedExactlyArguments: '${variable}: forventet akkurat ${variable} argumenter.',
    formulaFunctionExpectedAtMostArguments: '${variable}: forventet hoeyest ${variable} argumenter.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: forventet minst ${variable} argumenter.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Ugyldig kriterium: jokertegn med sammenligningsoperator.',
    formulaFunctionNonNumericArgument: '${variable}: ikke-numerisk argument.',
    formulaFunctionDivisionByZero: '${variable}: divisjon med null.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: kan ikke kombinere datoer med BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: krever minst en numerisk verdi.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: krever minst en verdi.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: alle verdier ma vaere tall.',
    formulaFunctionArgumentMustBeRange: '${variable}: argument ${variable} ma vaere et omraade.',
    formulaFunctionArgumentMustBeValue: '${variable}: argument ${variable} ma vaere en verdi.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: omraader har ulike storrelser.',
    formulaFunctionValuesMustBeNumeric: '${variable}: verdier ma vaere numeriske.',
    formulaFunctionValuesMustBeIntegers: '${variable}: verdier ma vaere heltall.',
    formulaFunctionUnsupportedValueType: '${variable}: ikke-stoettet verditype.',
    formulaFunctionDivNonNumericArgument: 'DIV: ikke-numerisk argument.',
    formulaFunctionDivDivisionByZero: 'DIV: divisjon med null.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: kan ikke kombinere datoer med BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: krever minst en numerisk verdi.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: krever minst en verdi.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: alle verdier ma vaere tall.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: krever minst en verdi.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: foerste argument ma vaere et omraade.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: andre argument ma vaere en verdi (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: tredje argument ma vaere et omraade (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: omraader har ulike storrelser.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: foerste argument ma vaere et omraade.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: andre argument ma vaere en verdi (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: ikke-stoettet verditype.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: krever minst en verdi.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: krever minst en verdi.',
    ...
    formulaServiceCircularReference: 'Sirkulaer referanse.',
    formulaServiceExpectedParsableFormula: 'Forventet en parsebar formel.',
    formulaServiceInternalSchedulingError: 'Intern planleggingsfeil.',
    ...
    fileInputOverlay: 'Dra og slipp fil for å importere data',
    ...
    noAggregation: 'Ingen',
    showValuesAs: 'Vis verdier som',
    showValuesAsNone: 'Ingen',
    percentOfGrandTotal: '% av totalsum',
    percentOfColumnTotal: '% av kolonnesum',
    percentOfRowTotal: '% av radsum',
    percentOfParentRowTotal: '% av overordnet radsum',
    percentOfParentColumnTotal: '% av overordnet kolonnesum',
    percentOfGrandTotalDescription: 'Hver verdi som en prosentandel av kolonnens totalsum.',
    percentOfColumnTotalDescription: 'Hver verdi som en prosentandel av kolonnesummen — hver kolonne utgjør 100 %.',
    percentOfRowTotalDescription: 'Hver verdi som en prosentandel av radsummen på tvers av pivotkolonnene.',
    percentOfParentRowTotalDescription: 'Hver verdi som en prosentandel av den overordnede gruppen.',
    percentOfParentColumnTotalDescription: 'Hver verdi som en prosentandel av den overordnede pivotkolonnen.',
    autosizeThisColumn: 'Tilpass Denne Kolonnen',
    autosizeAllColumns: 'Tilpass Alle Kolonner',
    groupBy: 'Grupper etter ${variable}',
    ungroupBy: 'Opphev gruppering etter ${variable}',
    ...
    ariaColumnHeaderNameEditor: 'Kolonnenavn-redigerer',
    columnHeaderEditApply: 'Bruk',
