...
export const AG_GRID_LOCALE_ES_ES = {
    ...
    advancedFilterYesterday: 'es ayer',
    advancedFilterToday: 'es hoy',
    advancedFilterTomorrow: 'es mañana',
    advancedFilterLast7Days: 'está en los últimos 7 días',
    advancedFilterLastWeek: 'está en la semana pasada',
    advancedFilterThisWeek: 'está en esta semana',
    advancedFilterNextWeek: 'está en la próxima semana',
    advancedFilterLast30Days: 'está en los últimos 30 días',
    advancedFilterLastMonth: 'está en el mes pasado',
    advancedFilterThisMonth: 'está en este mes',
    advancedFilterNextMonth: 'está en el próximo mes',
    advancedFilterLast90Days: 'está en los últimos 90 días',
    advancedFilterLastQuarter: 'está en el último trimestre',
    advancedFilterThisQuarter: 'está en este trimestre',
    advancedFilterNextQuarter: 'está en el próximo trimestre',
    advancedFilterLastYear: 'está en el año pasado',
    advancedFilterThisYear: 'está en este año',
    advancedFilterYearToDate: 'está en el año hasta la fecha',
    advancedFilterNextYear: 'está en el próximo año',
    advancedFilterLast6Months: 'está en los últimos 6 meses',
    advancedFilterLast12Months: 'está en los últimos 12 meses',
    advancedFilterLast24Months: 'está en los últimos 24 meses',
    advancedFilterTrue: 'es verdadero',
    advancedFilterFalse: 'es falso',
    advancedFilterIsAnyOf: 'es cualquiera de',
    advancedFilterIsNoneOf: 'no es ninguno de',
    advancedFilterSetMore: '+${variable} más',
    advancedFilterAnd: 'Y',
    advancedFilterOr: 'O',
    ...
    advancedFilterValidationInvalidValue: 'Valor no encontrado',
    ...
    advancedFilterValidationNotABigInt: 'El valor no es un BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} debe ser mayor que ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} debe ser mayor o igual a ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} debe ser posterior a ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} debe ser ${variable} o posterior',
    ...
    formulaParseInvalidCellReference: 'Referencia de celda no válida: ${variable}.',
    ...
    formulaParseOperatorStackUnderflow: 'Desbordamiento inferior de pila de operadores.',
    formulaParseMissingOperand: "Falta operando para '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Error interno: marco inesperado durante la reducción.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Error interno: marco inesperado antes de '('.",
    ...
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Error interno: marco inesperado antes de ')'.",
    ...
    formulaSerializeStringContainsQuote: 'La cadena contiene una comilla (") que el tokenizador no admite.',
    ...
    formulaSerializeCannotProduceRowIndexFromId: "No se puede generar índice de FILA desde el id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "No se puede mapear el id de columna '${variable}' a etiqueta A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "No se puede analizar el índice absoluto de fila '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "No se puede mapear el id de fila '${variable}' al índice A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'No se permite un rango en contexto escalar.',
    ...
    formulaFunctionExpectedExactlyArguments: '${variable}: se esperaban exactamente ${variable} argumentos.',
    formulaFunctionExpectedAtMostArguments: '${variable}: se esperaban como máximo ${variable} argumentos.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: se esperaban al menos ${variable} argumentos.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Criterio no válido: comodines con comparador.',
    formulaFunctionNonNumericArgument: '${variable}: argumento no numérico.',
    formulaFunctionDivisionByZero: '${variable}: división por cero.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: no se pueden combinar fechas con BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: requiere al menos un valor numérico.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: requiere al menos un valor.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: todos los valores deben ser números.',
    formulaFunctionArgumentMustBeRange: '${variable}: el argumento ${variable} debe ser un rango.',
    formulaFunctionArgumentMustBeValue: '${variable}: el argumento ${variable} debe ser un valor.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: los rangos tienen tamaños distintos.',
    formulaFunctionValuesMustBeNumeric: '${variable}: los valores deben ser numéricos.',
    formulaFunctionValuesMustBeIntegers: '${variable}: los valores deben ser enteros.',
    formulaFunctionUnsupportedValueType: '${variable}: tipo de valor no compatible.',
    formulaFunctionDivNonNumericArgument: 'DIV: argumento no numérico.',
    formulaFunctionDivDivisionByZero: 'DIV: división por cero.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: no se pueden combinar fechas con BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: requiere al menos un valor numérico.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: requiere al menos un valor.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: todos los valores deben ser números.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: requiere al menos un valor.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: el primer argumento debe ser un rango.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: el segundo argumento debe ser un valor (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: el tercer argumento debe ser un rango (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: los rangos tienen tamaños distintos.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: el primer argumento debe ser un rango.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: el segundo argumento debe ser un valor (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: tipo de valor no compatible.',
    ...
    percentOfGrandTotalDescription: 'Cada valor como porcentaje del total general de la columna.',
    percentOfColumnTotalDescription: 'Cada valor como porcentaje del total de su columna: cada columna suma el 100 %.',
    percentOfRowTotalDescription:
        'Cada valor como porcentaje del total de la fila en las columnas de la tabla dinámica.',
    percentOfParentRowTotalDescription: 'Cada valor como porcentaje de su grupo principal.',
    percentOfParentColumnTotalDescription: 'Cada valor como porcentaje de su columna de tabla dinámica principal.',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_ES_ES` instead. */
