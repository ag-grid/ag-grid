...
export const AG_GRID_LOCALE_ES = {
    ...
    showValueAsNone: 'Ninguno',
    showValueAsNotApplicable: 'No relevante en la vista actual',
    showValueAsDefault: 'Predeterminado',
    ...
    percentOfParentTotal: '% del total principal',
    ...
    percentOfParentTotalDescription: 'Cada valor como porcentaje de su ancestro en un campo de agrupación elegido.',
