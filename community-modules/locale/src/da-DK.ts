...
export const AG_GRID_LOCALE_DK = {
    ...
    noAggregation: 'Ingen',
    showValueAs: 'Vis værdier som',
    showValueAsNone: 'Ingen',
    showValueAsNotApplicable: 'Ikke relevant i den aktuelle visning',
    showValueAsDefault: 'Standard',
    showValueAsTopLevel: 'Øverste niveau',
    ...
    percentOfParentTotal: '% af overordnet total',
    ...
    percentOfParentTotalDescription: 'Hver værdi som en procentdel af dens ophav på et valgt grupperingsfelt.',
    ...
    ariaColumnShowValueAs: 'Viser værdier som',
