...
export const AG_GRID_LOCALE_GR = {
    ...
    noAggregation: 'Καμία',
    showValueAs: 'Εμφάνιση τιμών ως',
    showValueAsNone: 'Καμία',
    showValueAsNotApplicable: 'Δεν ισχύει στην τρέχουσα προβολή',
    showValueAsDefault: 'Προεπιλογή',
    showValueAsTopLevel: 'Ανώτατο επίπεδο',
    ...
    percentOfParentTotal: '% του γονικού συνόλου',
    ...
    percentOfParentTotalDescription: 'Κάθε τιμή ως ποσοστό του προγόνου της σε επιλεγμένο πεδίο ομαδοποίησης.',
    ...
    ariaColumnShowValueAs: 'Εμφάνιση τιμών ως',
