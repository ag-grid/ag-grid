...
export const AG_GRID_LOCALE_GR = {
    ...
    advancedFilterInRange: 'είναι μεταξύ',
    advancedFilterYesterday: 'είναι χθες',
    advancedFilterToday: 'είναι σήμερα',
    advancedFilterTomorrow: 'είναι αύριο',
    advancedFilterLast7Days: 'είναι στις τελευταίες 7 ημέρες',
    advancedFilterLastWeek: 'είναι στην προηγούμενη εβδομάδα',
    advancedFilterThisWeek: 'είναι σε αυτή την εβδομάδα',
    advancedFilterNextWeek: 'είναι στην επόμενη εβδομάδα',
    advancedFilterLast30Days: 'είναι στις τελευταίες 30 ημέρες',
    advancedFilterLastMonth: 'είναι στον προηγούμενο μήνα',
    advancedFilterThisMonth: 'είναι σε αυτόν τον μήνα',
    advancedFilterNextMonth: 'είναι στον επόμενο μήνα',
    advancedFilterLast90Days: 'είναι στις τελευταίες 90 ημέρες',
    advancedFilterLastQuarter: 'είναι στο προηγούμενο τρίμηνο',
    advancedFilterThisQuarter: 'είναι σε αυτό το τρίμηνο',
    advancedFilterNextQuarter: 'είναι στο επόμενο τρίμηνο',
    advancedFilterLastYear: 'είναι στον προηγούμενο χρόνο',
    advancedFilterThisYear: 'είναι σε αυτόν τον χρόνο',
    advancedFilterYearToDate: 'είναι στο έτος έως σήμερα',
    advancedFilterNextYear: 'είναι στον επόμενο χρόνο',
    advancedFilterLast6Months: 'είναι στους τελευταίους 6 μήνες',
    advancedFilterLast12Months: 'είναι στους τελευταίους 12 μήνες',
    advancedFilterLast24Months: 'είναι στους τελευταίους 24 μήνες',
    advancedFilterTrue: 'είναι αληθές',
    advancedFilterFalse: 'είναι ψευδές',
    advancedFilterIsAnyOf: 'είναι οποιοδήποτε από',
    advancedFilterIsNoneOf: 'δεν είναι κανένα από',
    advancedFilterSetMore: '+${variable} ακόμη',
    ...
    advancedFilterValidationInvalidValue: 'Η τιμή δεν βρέθηκε',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} πρέπει να είναι μεγαλύτερο από ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} πρέπει να είναι μεγαλύτερο ή ίσο με ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} πρέπει να είναι μετά από ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} πρέπει να είναι ${variable} ή μεταγενέστερη',
