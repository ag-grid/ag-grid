...
export const AG_GRID_LOCALE_GR = {
    ...
    donut: 'Ντόνατ',
    lineChart: 'Γραμμή',
    stackedLine: 'Σωρευτικό',
    normalizedLine: '100% Σωρευτικό',
    xyChart: 'X Y (Scatter)',
    scatter: 'Διασπορά',
    bubble: 'Φούσκα',
    areaChart: 'Περιοχή',
    ...
    normalizedLineTooltip: '100% Συσσωρευμένο',
    ...
    funnel: 'Χωνί',
    coneFunnel: 'Κωνικό Χωνί',
    pyramid: 'Πυραμίδα',
    funnelGroup: 'Χωνί',
    funnelTooltip: 'Χωνί',
    coneFunnelTooltip: 'Κωνικό Χωνί',
    ...
    ariaColumnSelectAll: 'Εναλλαγή ορατότητας όλων των στηλών',
    ...
    ariaHeaderSelection: 'Στήλη με επιλογή κεφαλίδας',
    ariaSelectAllCells: 'Πατήστε το Space για να επιλέξετε όλα τα κελιά',
