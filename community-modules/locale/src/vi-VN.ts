...
export const AG_GRID_LOCALE_VN = {
    ...
    noAggregation: 'Không',
    showValueAs: 'Hiển thị giá trị dưới dạng',
    showValueAsNone: 'Không có',
    showValueAsNotApplicable: 'Không có ý nghĩa trong chế độ xem hiện tại',
    showValueAsDefault: 'Mặc định',
    showValueAsTopLevel: 'Cấp cao nhất',
    ...
    percentOfParentTotal: '% của tổng cha',
    ...
    percentOfParentTotalDescription:
        'Mỗi giá trị tính theo phần trăm của tổ tiên của nó tại một trường nhóm được chọn.',
    ...
    ariaColumnShowValueAs: 'Đang hiển thị giá trị dưới dạng',
