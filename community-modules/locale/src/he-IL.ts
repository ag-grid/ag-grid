...
export const AG_GRID_LOCALE_IL = {
    ...
    advancedFilterInRange: 'נמצא בין',
    advancedFilterYesterday: 'הוא אתמול',
    advancedFilterToday: 'הוא היום',
    advancedFilterTomorrow: 'הוא מחר',
    advancedFilterLast7Days: 'נמצא ב-7 הימים האחרונים',
    advancedFilterLastWeek: 'נמצא בשבוע שעבר',
    advancedFilterThisWeek: 'נמצא בשבוע הזה',
    advancedFilterNextWeek: 'נמצא בשבוע הבא',
    advancedFilterLast30Days: 'נמצא ב-30 הימים האחרונים',
    advancedFilterLastMonth: 'נמצא בחודש שעבר',
    advancedFilterThisMonth: 'נמצא בחודש הזה',
    advancedFilterNextMonth: 'נמצא בחודש הבא',
    advancedFilterLast90Days: 'נמצא ב-90 הימים האחרונים',
    advancedFilterLastQuarter: 'נמצא ברבעון האחרון',
    advancedFilterThisQuarter: 'נמצא ברבעון הזה',
    advancedFilterNextQuarter: 'נמצא ברבעון הבא',
    advancedFilterLastYear: 'נמצא בשנה שעברה',
    advancedFilterThisYear: 'נמצא בשנה הזאת',
    advancedFilterYearToDate: 'נמצא מראשית השנה',
    advancedFilterNextYear: 'נמצא בשנה הבאה',
    advancedFilterLast6Months: 'נמצא ב-6 החודשים האחרונים',
    advancedFilterLast12Months: 'נמצא ב-12 החודשים האחרונים',
    advancedFilterLast24Months: 'נמצא ב-24 החודשים האחרונים',
    advancedFilterTrue: 'אמת',
    advancedFilterFalse: 'שקר',
    advancedFilterIsAnyOf: 'הוא אחד מ',
    advancedFilterIsNoneOf: 'אינו אף אחד מ',
    advancedFilterSetMore: '+${variable} נוספים',
    ...
    advancedFilterValidationInvalidValue: 'ערך לא נמצא',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} חייב להיות גדול מ-${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} חייב להיות גדול או שווה ל-${variable}',
    advancedFilterValidationMustBeAfter: '${variable} חייב להיות אחרי ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} חייב להיות ${variable} או אחריו',
