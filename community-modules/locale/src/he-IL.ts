...
export const AG_GRID_LOCALE_IL = {
    ...
    noAggregation: 'ללא',
    showValueAs: 'הצג ערכים בתור',
    showValueAsNone: 'ללא',
    showValueAsNotApplicable: 'לא רלוונטי בתצוגה הנוכחית',
    showValueAsDefault: 'ברירת מחדל',
    showValueAsTopLevel: 'רמה עליונה',
    ...
    percentOfParentTotalDescription: 'כל ערך כאחוז מאב הקדמון שלו בשדה קיבוץ נבחר.',
    ...
    ariaColumnShowValueAs: 'מציג ערכים בתור',
