...
export const AG_GRID_LOCALE_IL = {
    ...
    donut: 'דונאט',
    lineChart: 'קו',
    stackedLine: 'קו מוערם',
    normalizedLine: 'קו 100% מוערם',
    xyChart: 'X Y (Scatter)',
    scatter: 'פיזור',
    bubble: 'בועה',
    areaChart: 'אזור',
    ...
    ariaColumnSelectAll: 'החלף את נראות כל העמודות',
    ...
    ariaSelectAllCells: 'לחץ על מקש הרווח כדי לבחור את כל התאים',
    ...
    ariaLabelLoadingContextMenu: 'טוען תפריט הקשר',
