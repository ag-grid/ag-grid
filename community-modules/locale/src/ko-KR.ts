...
export const AG_GRID_LOCALE_KR = {
    ...
    showValueAs: '값 표시 형식',
    showValueAsNone: '없음',
    showValueAsNotApplicable: '현재 보기에서는 의미가 없습니다',
    showValueAsDefault: '기본값',
    showValueAsTopLevel: '최상위',
    ...
    percentOfParentTotal: '상위 합계의 백분율',
    ...
    percentOfParentTotalDescription: '각 값을 선택한 그룹화 필드의 상위 항목에 대한 백분율로 표시합니다.',
