...
export const AG_GRID_LOCALE_KR = {
    ...
    advancedFilterInRange: '사이에 있음',
    advancedFilterYesterday: '어제임',
    advancedFilterToday: '오늘임',
    advancedFilterTomorrow: '내일임',
    advancedFilterLast7Days: '지난 7일 이내',
    advancedFilterLastWeek: '지난 주 이내',
    advancedFilterThisWeek: '이번 주 이내',
    advancedFilterNextWeek: '다음 주 이내',
    advancedFilterLast30Days: '지난 30일 이내',
    advancedFilterLastMonth: '지난 달 이내',
    advancedFilterThisMonth: '이번 달 이내',
    advancedFilterNextMonth: '다음 달 이내',
    advancedFilterLast90Days: '지난 90일 이내',
    advancedFilterLastQuarter: '지난 분기 이내',
    advancedFilterThisQuarter: '이번 분기 이내',
    advancedFilterNextQuarter: '다음 분기 이내',
    advancedFilterLastYear: '작년 이내',
    advancedFilterThisYear: '올해 이내',
    advancedFilterYearToDate: '올해 연초부터 오늘까지',
    advancedFilterNextYear: '내년 이내',
    advancedFilterLast6Months: '지난 6개월 이내',
    advancedFilterLast12Months: '지난 12개월 이내',
    advancedFilterLast24Months: '지난 24개월 이내',
    advancedFilterTrue: '참임',
    advancedFilterFalse: '거짓임',
    advancedFilterIsAnyOf: '다음 중 하나임',
    advancedFilterIsNoneOf: '다음 중 어느 것도 아님',
    advancedFilterSetMore: '외 ${variable}개',
    ...
    advancedFilterValidationInvalidValue: '값을 찾을 수 없습니다',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable}은(는) ${variable} 보다 커야 합니다.',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable}은(는) ${variable}보다 크거나 같아야 합니다.',
    advancedFilterValidationMustBeAfter: '${variable}은(는) ${variable} 이후여야 합니다.',
    advancedFilterValidationMustBeOnOrAfter: '${variable}은(는) ${variable} 또는 그 이후여야 합니다.',
