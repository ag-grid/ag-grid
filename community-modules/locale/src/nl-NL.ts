...
export const AG_GRID_LOCALE_NL = {
    ...
    applyColumnToolPanel: 'Toepassen',
    ...
    advancedFilterInRange: 'is tussen',
    advancedFilterYesterday: 'is gisteren',
    advancedFilterToday: 'is vandaag',
    advancedFilterTomorrow: 'is morgen',
    advancedFilterLast7Days: 'is in de laatste 7 dagen',
    advancedFilterLastWeek: 'is in vorige week',
    advancedFilterThisWeek: 'is in deze week',
    advancedFilterNextWeek: 'is in volgende week',
    advancedFilterLast30Days: 'is in de laatste 30 dagen',
    advancedFilterLastMonth: 'is in vorige maand',
    advancedFilterThisMonth: 'is in deze maand',
    advancedFilterNextMonth: 'is in volgende maand',
    advancedFilterLast90Days: 'is in de laatste 90 dagen',
    advancedFilterLastQuarter: 'is in vorig kwartaal',
    advancedFilterThisQuarter: 'is in dit kwartaal',
    advancedFilterNextQuarter: 'is in volgend kwartaal',
    advancedFilterLastYear: 'is in vorig jaar',
    advancedFilterThisYear: 'is in dit jaar',
    advancedFilterYearToDate: 'is in jaar tot nu toe',
    advancedFilterNextYear: 'is in volgend jaar',
    advancedFilterLast6Months: 'is in de laatste 6 maanden',
    advancedFilterLast12Months: 'is in de laatste 12 maanden',
    advancedFilterLast24Months: 'is in de laatste 24 maanden',
    advancedFilterTrue: 'is-waar',
    advancedFilterFalse: 'is-niet-waar',
    advancedFilterIsAnyOf: 'is een van',
    advancedFilterIsNoneOf: 'is geen van',
    advancedFilterSetMore: '+${variable} meer',
    ...
    advancedFilterValidationInvalidValue: 'Waarde niet gevonden',
    ...
    advancedFilterValidationNotABigInt: 'Waarde is geen BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} moet groter zijn dan ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} moet groter dan of gelijk aan ${variable} zijn',
    advancedFilterValidationMustBeAfter: '${variable} moet na ${variable} zijn',
    advancedFilterValidationMustBeOnOrAfter: '${variable} moet ${variable} of later zijn',
    ...
    // Formulas
    invalidFormulaValidation: 'Ongeldige formule.',
    formulaParseInvalidCellReference: 'Ongeldige celverwijzing: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Ongeldige eindverwijzing van bereik.',
    formulaParseUnterminatedString: 'Niet-afgesloten tekenreeks.',
    formulaParseUnexpectedCharacter: 'Onverwacht teken: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Operatorstack-underflow.',
    formulaParseMissingOperand: "Ontbrekende operand voor '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Interne fout: onverwacht frame tijdens reductie.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Interne fout: onverwacht frame voor '('.",
    formulaParseMisplacedComma: 'Komma op verkeerde plaats.',
    formulaParseCommaOutsideFunctionCall: 'Komma buiten een functieaanroep.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Interne fout: onverwacht frame voor ')'.",
    formulaParseMismatchedParentheses: 'Niet-overeenkomende haakjes.',
    formulaParseUnsupportedOperand: 'Niet-ondersteunde operand: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall:
        'Niet-overeenkomende haakjes of onvoltooide functieaanroep.',
    formulaParseInvalidExpression: 'Ongeldige expressie.',
    formulaParseFormulasMustBeginWithEquals: 'Formules moeten beginnen met =.',
    formulaSerializeStringContainsQuote: 'Tekenreeks bevat een aanhalingsteken (") dat de tokenizer niet ondersteunt.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId: "Kan geen absoluut KOLOM-label maken van id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "Kan geen absolute RIJ-index maken van id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Kan geen RIJ-index maken van id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Kan kolom-id '${variable}' niet toewijzen aan A1-label.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Kan absolute rij-index '${variable}' niet parseren.",
    formulaSerializeCannotMapRowIdToA1Index: "Kan rij-id '${variable}' niet toewijzen aan A1-index.",
    formulaEvalRangeNotAllowedInScalarContext: 'Bereik is niet toegestaan in scalaire context.',
    formulaEvalUnknownReferenceToCell: 'Onbekende verwijzing naar cel.',
    formulaEvalUnsupportedOperation: 'Niet-ondersteunde bewerking ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Ongeldige absolute rij.',
    formulaEvalUnrecognisedRowId: 'Niet-herkende rij-id.',
    formulaEvalInvalidAbsoluteColumn: 'Ongeldige absolute kolom.',
    formulaEvalUnrecognisedColumnId: 'Niet-herkende kolom-id.',
    formulaEvalUnrecognisedRowInRange: 'Niet-herkende rij in bereik.',
    formulaEvalUnrecognisedReferenceToCell: 'Niet-herkende verwijzing naar cel.',
    formulaEvalIncompleteRangeReference: 'Onvolledige bereikverwijzing.',
    formulaFunctionExpectedExactlyArguments: '${variable}: verwacht precies ${variable} argumenten.',
    formulaFunctionExpectedAtMostArguments: '${variable}: verwacht hoogstens ${variable} argumenten.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: verwacht minstens ${variable} argumenten.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Ongeldig criterium: jokertekens met vergelijkingsoperator.',
    formulaFunctionNonNumericArgument: '${variable}: niet-numeriek argument.',
    formulaFunctionDivisionByZero: '${variable}: deling door nul.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: kan datums niet combineren met BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: vereist minstens een numerieke waarde.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: vereist minstens een waarde.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: alle waarden moeten getallen zijn.',
    formulaFunctionArgumentMustBeRange: '${variable}: argument ${variable} moet een bereik zijn.',
    formulaFunctionArgumentMustBeValue: '${variable}: argument ${variable} moet een waarde zijn.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: bereiken hebben verschillende groottes.',
    formulaFunctionValuesMustBeNumeric: '${variable}: waarden moeten numeriek zijn.',
    formulaFunctionValuesMustBeIntegers: '${variable}: waarden moeten gehele getallen zijn.',
    formulaFunctionUnsupportedValueType: '${variable}: niet-ondersteund waardetype.',
    formulaFunctionDivNonNumericArgument: 'DIV: niet-numeriek argument.',
    formulaFunctionDivDivisionByZero: 'DIV: deling door nul.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: kan datums niet combineren met BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: vereist minstens een numerieke waarde.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: vereist minstens een waarde.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: alle waarden moeten getallen zijn.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: vereist minstens een waarde.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: eerste argument moet een bereik zijn.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: tweede argument moet een waarde zijn (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: derde argument moet een bereik zijn (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: bereiken hebben verschillende groottes.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: eerste argument moet een bereik zijn.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: tweede argument moet een waarde zijn (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: niet-ondersteund waardetype.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: vereist minstens een waarde.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: vereist minstens een waarde.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: niet-numeriek argument.',
    formulaFunctionPowerNonNumericArgument: 'POWER: niet-numeriek argument.',
    formulaServiceCircularReference: 'Circulaire verwijzing.',
    formulaServiceExpectedParsableFormula: 'Verwachtte een parsebare formule.',
    formulaServiceInternalSchedulingError: 'Interne planningsfout.',
    ...
    fileInputOverlay: 'Sleep een bestand hierheen om gegevens te importeren',
    ...
    noAggregation: 'Geen',
    showValuesAs: 'Waarden weergeven als',
    showValuesAsNone: 'Geen',
    percentOfGrandTotal: '% van eindtotaal',
    percentOfColumnTotal: '% van kolomtotaal',
    percentOfRowTotal: '% van rijtotaal',
    percentOfParentRowTotal: '% van bovenliggend rijtotaal',
    percentOfParentColumnTotal: '% van bovenliggend kolomtotaal',
    percentOfGrandTotalDescription: 'Elke waarde als percentage van het eindtotaal van de kolom.',
    percentOfColumnTotalDescription:
        'Elke waarde als percentage van het bijbehorende kolomtotaal — elke kolom telt op tot 100%.',
    percentOfRowTotalDescription: 'Elke waarde als percentage van het rijtotaal over de pivotkolommen.',
    percentOfParentRowTotalDescription: 'Elke waarde als percentage van de bovenliggende groep.',
    percentOfParentColumnTotalDescription: 'Elke waarde als percentage van de bovenliggende pivotkolom.',
    autosizeThisColumn: 'Deze kolom automatisch aanpassen',
    autosizeAllColumns: 'Alle kolommen automatisch aanpassen',
    groupBy: 'Groepeer op ${variable}',
    ungroupBy: 'Groepering opheffen van ${variable}',
    ...
    ariaSelectAllCells: 'Druk op Spatie of Enter om alle cellen te selecteren',
    ariaSelectAllRowCells: 'Druk op Enter om alle cellen in deze rij te selecteren',
    ariaColumnCellSelection: 'Druk op Enter om de selectie van alle zichtbare cellen in deze kolom te wisselen',
    ...
    ariaSortableColumnWithCellSelection: 'Druk op ALT ENTER om te sorteren',
    ...
    columnHeaderEditApply: 'Toepassen',
