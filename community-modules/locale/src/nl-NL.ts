...
export const AG_GRID_LOCALE_NL = {
    ...
    dropOff: 'Afvalpercentage',
    stageLabels: 'Fase Labels',
    reverse: 'Omgekeerd',
    ...
    ariaColumnSelectAll: 'Schakel de zichtbaarheid van alle kolommen in/uit',
    ...
    ariaHeaderSelection: 'Kolom met koptekstselectie',
    ariaSelectAllCells: 'Druk op Spatie om alle cellen te selecteren',
