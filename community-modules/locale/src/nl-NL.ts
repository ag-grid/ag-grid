...
export const AG_GRID_LOCALE_NL = {
    ...
    noAggregation: 'Geen',
    showValueAs: 'Waarden weergeven als',
    showValueAsNone: 'Geen',
    showValueAsNotApplicable: 'Niet zinvol in de huidige weergave',
    showValueAsDefault: 'Standaard',
    showValueAsTopLevel: 'Hoogste niveau',
    ...
    percentOfParentTotal: '% van bovenliggend totaal',
    ...
    percentOfParentTotalDescription:
        'Elke waarde als percentage van het hoger gelegen niveau bij een gekozen groeperingsveld.',
    ...
    ariaColumnShowValueAs: 'Waarden worden weergegeven als',
