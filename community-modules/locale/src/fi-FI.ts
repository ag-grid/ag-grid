...
export const AG_GRID_LOCALE_FI = {
    ...
    advancedFilterInRange: 'on välillä',
    advancedFilterYesterday: 'on eilen',
    advancedFilterToday: 'on tänään',
    advancedFilterTomorrow: 'on huomenna',
    advancedFilterLast7Days: 'on viimeisten 7 päivän aikana',
    advancedFilterLastWeek: 'on viime viikolla',
    advancedFilterThisWeek: 'on tällä viikolla',
    advancedFilterNextWeek: 'on ensi viikolla',
    advancedFilterLast30Days: 'on viimeisten 30 päivän aikana',
    advancedFilterLastMonth: 'on viime kuussa',
    advancedFilterThisMonth: 'on tässä kuussa',
    advancedFilterNextMonth: 'on ensi kuussa',
    advancedFilterLast90Days: 'on viimeisten 90 päivän aikana',
    advancedFilterLastQuarter: 'on viime neljänneksellä',
    advancedFilterThisQuarter: 'on tällä neljänneksellä',
    advancedFilterNextQuarter: 'on ensi neljänneksellä',
    advancedFilterLastYear: 'on viime vuonna',
    advancedFilterThisYear: 'on tänä vuonna',
    advancedFilterYearToDate: 'on kuluvana vuonna',
    advancedFilterNextYear: 'on ensi vuonna',
    advancedFilterLast6Months: 'on viimeisten 6 kuukauden aikana',
    advancedFilterLast12Months: 'on viimeisten 12 kuukauden aikana',
    advancedFilterLast24Months: 'on viimeisten 24 kuukauden aikana',
    advancedFilterTrue: 'on tosi',
    advancedFilterFalse: 'on epätosi',
    advancedFilterIsAnyOf: 'on jokin seuraavista',
    advancedFilterIsNoneOf: 'ei ole mikään seuraavista',
    advancedFilterSetMore: '+${variable} lisää',
    ...
    advancedFilterValidationInvalidValue: 'Arvoa ei löydy',
