...
export const AG_GRID_LOCALE_FI = {
    ...
    ariaColumnSelectAll: 'Vaihda kaikkien sarakkeiden näkyvyyttä',
    ...
    ariaHeaderSelection: 'Sarake, jossa on otsikon valinta',
