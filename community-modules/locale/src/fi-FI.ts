...
export const AG_GRID_LOCALE_FI = {
    ...
    showValueAs: 'Näytä arvot muodossa',
    showValueAsNone: 'Ei mitään',
    showValueAsNotApplicable: 'Ei merkityksellinen nykyisessä näkymässä',
    showValueAsDefault: 'Oletus',
    showValueAsTopLevel: 'Ylin taso',
    ...
    percentOfParentTotal: '% ylemmästä summasta',
    ...
    percentOfParentTotalDescription: 'Jokainen arvo prosenttiosuutena esivanhemmastaan valitussa ryhmittelykentässä.',
