...
export const AG_GRID_LOCALE_CZ = {
    ...
    funnel: 'Lievik',
    coneFunnel: 'Kuželový Lievik',
    pyramid: 'Pyramida',
    funnelGroup: 'Lievik',
    funnelTooltip: 'Lievik',
    coneFunnelTooltip: 'Kuželový Lievik',
    pyramidTooltip: 'Pyramida',
    dropOff: 'Úbytek',
    stageLabels: 'Popisky Fáze',
    reverse: 'Obrátit',
    ...
    ariaHeaderSelection: 'Sloupec s výběrem hlaviček',
    ...
    ariaLabelLoadingContextMenu: 'Načítání kontextového menu',
