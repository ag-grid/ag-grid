...
export const AG_GRID_LOCALE_CZ = {
    ...
    noAggregation: 'Žádná',
    showValueAs: 'Zobrazit hodnoty jako',
    showValueAsNone: 'Žádné',
    showValueAsNotApplicable: 'V aktuálním zobrazení nemá smysl',
    showValueAsDefault: 'Výchozí',
    showValueAsTopLevel: 'Nejvyšší úroveň',
    ...
    percentOfParentTotal: '% nadřazeného součtu',
    ...
    percentOfParentTotalDescription: 'Každá hodnota jako procento jejího předka ve zvoleném poli seskupení.',
    ...
    ariaColumnShowValueAs: 'Zobrazování hodnot jako',
