...
export const AG_GRID_LOCALE_CZ = {
    ...
    advancedFilterInRange: 'je mezi',
    advancedFilterYesterday: 'je včera',
    advancedFilterToday: 'je dnes',
    advancedFilterTomorrow: 'je zítra',
    advancedFilterLast7Days: 'je v posledních 7 dnech',
    advancedFilterLastWeek: 'je v minulém týdnu',
    advancedFilterThisWeek: 'je v tomto týdnu',
    advancedFilterNextWeek: 'je v příštím týdnu',
    advancedFilterLast30Days: 'je v posledních 30 dnech',
    advancedFilterLastMonth: 'je v minulém měsíci',
    advancedFilterThisMonth: 'je v tomto měsíci',
    advancedFilterNextMonth: 'je v příštím měsíci',
    advancedFilterLast90Days: 'je v posledních 90 dnech',
    advancedFilterLastQuarter: 'je v minulém čtvrtletí',
    advancedFilterThisQuarter: 'je v tomto čtvrtletí',
    advancedFilterNextQuarter: 'je v příštím čtvrtletí',
    advancedFilterLastYear: 'je v minulém roce',
    advancedFilterThisYear: 'je v tomto roce',
    advancedFilterYearToDate: 'je od začátku roku',
    advancedFilterNextYear: 'je v příštím roce',
    advancedFilterLast6Months: 'je v posledních 6 měsících',
    advancedFilterLast12Months: 'je v posledních 12 měsících',
    advancedFilterLast24Months: 'je v posledních 24 měsících',
    advancedFilterTrue: 'je pravda',
    advancedFilterFalse: 'je nepravda',
    advancedFilterIsAnyOf: 'je kterákoli z',
    advancedFilterIsNoneOf: 'není žádná z',
    advancedFilterSetMore: '+${variable} další',
    advancedFilterAnd: 'A',
    ...
    advancedFilterValidationInvalidValue: 'Hodnota nenalezena',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} musí být větší než ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} musí být větší nebo rovno ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} musí být po ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} musí být ${variable} nebo pozdější',
