...
export const AG_GRID_LOCALE_TR = {
    ...
    showValueAs: 'Değerleri Şu Şekilde Göster',
    showValueAsNone: 'Yok',
    showValueAsNotApplicable: 'Geçerli görünümde anlamlı değil',
    showValueAsDefault: 'Varsayılan',
    showValueAsTopLevel: 'Üst düzey',
    ...
    percentOfParentTotal: "Üst Toplamın %'si",
    ...
    percentOfParentTotalDescription: 'Her değer, seçilen bir gruplama alanındaki üst öğesinin yüzdesi olarak.',
    ...
    ariaColumnShowValueAs: 'Değerler Şu Şekilde Gösteriliyor',
