...
export const AG_GRID_LOCALE_HK = {
    ...
    sortAscending: '升序排序',
    sortDescending: '降序排序',
    sortAbsoluteAscending: '絕對值升序排序',
    sortAbsoluteDescending: '絕對值降序排序',
    sortUnSort: '清除排序',
    ...
    ariaDropZoneColumnComponentSortAbsoluteAscending: '絕對值升序',
    ariaDropZoneColumnComponentSortAbsoluteDescending: '絕對值降序',
    ariaLabelDialog: '對話框',
