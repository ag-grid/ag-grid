...
export const AG_GRID_LOCALE_HK = {
    ...
    showValueAs: '值顯示方式',
    showValueAsNone: '無',
    showValueAsNotApplicable: '在目前檢視中無意義',
    showValueAsDefault: '預設',
    showValueAsTopLevel: '頂層',
    ...
    percentOfParentTotal: '佔父項總計的百分比',
    ...
    percentOfParentTotalDescription: '每個值佔其在所選分組欄位處的上層項目的百分比。',
    ...
    ariaColumnShowValueAs: '正在以此方式顯示值',
