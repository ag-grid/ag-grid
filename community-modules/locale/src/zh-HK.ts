...
export const AG_GRID_LOCALE_ZH_HK = {
    ...
    advancedFilterYesterday: '是昨天',
    advancedFilterToday: '是今天',
    advancedFilterTomorrow: '是明天',
    advancedFilterLast7Days: '在過去7天內',
    advancedFilterLastWeek: '在上週內',
    advancedFilterThisWeek: '在本週內',
    advancedFilterNextWeek: '在下週內',
    advancedFilterLast30Days: '在過去30天內',
    advancedFilterLastMonth: '在上個月內',
    advancedFilterThisMonth: '在本月內',
    advancedFilterNextMonth: '在下個月內',
    advancedFilterLast90Days: '在過去90天內',
    advancedFilterLastQuarter: '在上季度內',
    advancedFilterThisQuarter: '在本季度內',
    advancedFilterNextQuarter: '在下季度內',
    advancedFilterLastYear: '在去年內',
    advancedFilterThisYear: '在今年內',
    advancedFilterYearToDate: '在年初至今',
    advancedFilterNextYear: '在明年內',
    advancedFilterLast6Months: '在過去6個月內',
    advancedFilterLast12Months: '在過去12個月內',
    advancedFilterLast24Months: '在過去24個月內',
    advancedFilterTrue: '為真',
    advancedFilterFalse: '為假',
    advancedFilterIsAnyOf: '是其中之一',
    advancedFilterIsNoneOf: '不是其中任何一個',
    advancedFilterSetMore: '還有 ${variable} 項',
    advancedFilterAnd: '和',
    advancedFilterOr: '或',
    ...
    advancedFilterValidationInvalidValue: '未找到值',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable}必須大於${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable}必須大於或等於 ${variable}',
    advancedFilterValidationMustBeAfter: '${variable}必須在 ${variable} 之後',
    advancedFilterValidationMustBeOnOrAfter: '${variable}必須在 ${variable} 或之後',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_ZH_HK` instead. */
