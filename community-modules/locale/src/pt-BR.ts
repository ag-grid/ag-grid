...
export const AG_GRID_LOCALE_BR = {
    ...
    showValueAs: 'Mostrar valores como',
    showValueAsNone: 'Nenhum',
    showValueAsNotApplicable: 'Não se aplica à visualização atual',
    showValueAsDefault: 'Padrão',
    showValueAsTopLevel: 'Nível superior',
    ...
    percentOfParentTotal: '% do total pai',
    ...
    percentOfParentTotalDescription:
        'Cada valor como uma porcentagem do seu ancestral em um campo de agrupamento escolhido.',
