...
export const AG_GRID_LOCALE_BR = {
    ...
    advancedFilterInRange: 'está entre',
    advancedFilterYesterday: 'é ontem',
    advancedFilterToday: 'é hoje',
    advancedFilterTomorrow: 'é amanhã',
    advancedFilterLast7Days: 'está nos últimos 7 dias',
    advancedFilterLastWeek: 'está na semana passada',
    advancedFilterThisWeek: 'está nesta semana',
    advancedFilterNextWeek: 'está na próxima semana',
    advancedFilterLast30Days: 'está nos últimos 30 dias',
    advancedFilterLastMonth: 'está no mês passado',
    advancedFilterThisMonth: 'está neste mês',
    advancedFilterNextMonth: 'está no próximo mês',
    advancedFilterLast90Days: 'está nos últimos 90 dias',
    advancedFilterLastQuarter: 'está no último trimestre',
    advancedFilterThisQuarter: 'está neste trimestre',
    advancedFilterNextQuarter: 'está no próximo trimestre',
    advancedFilterLastYear: 'está no ano passado',
    advancedFilterThisYear: 'está neste ano',
    advancedFilterYearToDate: 'está no ano até hoje',
    advancedFilterNextYear: 'está no próximo ano',
    advancedFilterLast6Months: 'está nos últimos 6 meses',
    advancedFilterLast12Months: 'está nos últimos 12 meses',
    advancedFilterLast24Months: 'está nos últimos 24 meses',
    advancedFilterTrue: 'é verdadeiro',
    advancedFilterFalse: 'é falso',
    advancedFilterIsAnyOf: 'é qualquer um de',
    advancedFilterIsNoneOf: 'não é nenhum de',
    advancedFilterSetMore: '+${variable} mais',
    advancedFilterAnd: 'E',
    advancedFilterOr: 'OU',
    ...
    advancedFilterValidationInvalidValue: 'Valor não encontrado',
    ...
    advancedFilterValidationNotABigInt: 'Valor não é um BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} deve ser maior que ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} deve ser maior ou igual a ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} deve ser após ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} deve ser ${variable} ou posterior',
    ...
    ariaFullRowValidationError: 'Validação da linha completa: ${variable}',
    ariaFullRowEditValidationFailed: 'Não é possível concluir a edição da linha. ${variable}',
    ariaRowIndex: 'Linha ${variable}',
    ...
    ariaColumnHeaderNameEditor: 'Editor de nome da coluna',
    columnHeaderEditApply: 'Aplicar',
