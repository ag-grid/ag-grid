...
export const AG_GRID_LOCALE_HR = {
    ...
    advancedFilterValidationMustBeAfter: '${variable} mora biti nakon ${variable}',
    ...
    // Formulas
    invalidFormulaValidation: 'Neispravna formula.',
    formulaParseInvalidCellReference: 'Neispravna referenca celije: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Neispravna zavrsna referenca raspona.',
    formulaParseUnterminatedString: 'Nedovrseni niz znakova.',
    formulaParseUnexpectedCharacter: 'Neocekivani znak: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Podljev stoga operatora.',
    formulaParseMissingOperand: "Nedostaje operand za '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Interna greska: neocekivani okvir tijekom redukcije.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Interna greska: neocekivani okvir prije '('.",
    formulaParseMisplacedComma: 'Zarez na pogresnom mjestu.',
    formulaParseCommaOutsideFunctionCall: 'Zarez izvan poziva funkcije.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Interna greska: neocekivani okvir prije ')'.",
    formulaParseMismatchedParentheses: 'Neusklađene zagrade.',
    formulaParseUnsupportedOperand: 'Nepodrzan operand: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'Neusklađene zagrade ili nedovrsen poziv funkcije.',
    formulaParseInvalidExpression: 'Neispravan izraz.',
    formulaParseFormulasMustBeginWithEquals: 'Formule moraju poceti sa =.',
    formulaSerializeStringContainsQuote: 'Niz znakova sadrzi navodnik (") koji tokenizator ne podrzava.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Nije moguce proizvesti apsolutnu oznaku STUPCA iz id-a '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Nije moguce proizvesti apsolutni indeks RETKA iz id-a '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Nije moguce proizvesti indeks RETKA iz id-a '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Nije moguce mapirati id stupca '${variable}' na A1 oznaku.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Nije moguce parsirati apsolutni indeks retka '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Nije moguce mapirati id retka '${variable}' na A1 indeks.",
    formulaEvalRangeNotAllowedInScalarContext: 'Raspon nije dopusten u skalarnom kontekstu.',
    formulaEvalUnknownReferenceToCell: 'Nepoznata referenca na celiju.',
    formulaEvalUnsupportedOperation: 'Nepodrzana operacija ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Neispravan apsolutni redak.',
    formulaEvalUnrecognisedRowId: 'Neprepoznat id retka.',
    formulaEvalInvalidAbsoluteColumn: 'Neispravan apsolutni stupac.',
    formulaEvalUnrecognisedColumnId: 'Neprepoznat id stupca.',
    formulaEvalUnrecognisedRowInRange: 'Neprepoznat redak u rasponu.',
    formulaEvalUnrecognisedReferenceToCell: 'Neprepoznata referenca na celiju.',
    formulaEvalIncompleteRangeReference: 'Nepotpuna referenca raspona.',
    formulaFunctionExpectedExactlyArguments: '${variable}: ocekivano je tocno ${variable} argumenata.',
    formulaFunctionExpectedAtMostArguments: '${variable}: ocekivano je najvise ${variable} argumenata.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: ocekivano je najmanje ${variable} argumenata.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Neispravan kriterij: zamjenski znakovi s komparatorom.',
    formulaFunctionNonNumericArgument: '${variable}: nenumericki argument.',
    formulaFunctionDivisionByZero: '${variable}: dijeljenje s nulom.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: nije moguce kombinirati datume s BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: zahtijeva barem jednu numericku vrijednost.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: zahtijeva barem jednu vrijednost.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: sve vrijednosti moraju biti brojevi.',
    formulaFunctionArgumentMustBeRange: '${variable}: argument ${variable} mora biti raspon.',
    formulaFunctionArgumentMustBeValue: '${variable}: argument ${variable} mora biti vrijednost.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: rasponi imaju razlicite velicine.',
    formulaFunctionValuesMustBeNumeric: '${variable}: vrijednosti moraju biti numericke.',
    formulaFunctionValuesMustBeIntegers: '${variable}: vrijednosti moraju biti cijeli brojevi.',
    formulaFunctionUnsupportedValueType: '${variable}: nepodrzana vrsta vrijednosti.',
    formulaFunctionDivNonNumericArgument: 'DIV: nenumericki argument.',
    formulaFunctionDivDivisionByZero: 'DIV: dijeljenje s nulom.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: nije moguce kombinirati datume s BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: zahtijeva barem jednu numericku vrijednost.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: zahtijeva barem jednu vrijednost.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: sve vrijednosti moraju biti brojevi.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: zahtijeva barem jednu vrijednost.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: prvi argument mora biti raspon.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: drugi argument mora biti vrijednost (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: treci argument mora biti raspon (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: rasponi imaju razlicite velicine.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: prvi argument mora biti raspon.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: drugi argument mora biti vrijednost (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: nepodrzana vrsta vrijednosti.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: zahtijeva barem jednu vrijednost.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: zahtijeva barem jednu vrijednost.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: nenumericki argument.',
    formulaFunctionPowerNonNumericArgument: 'POWER: nenumericki argument.',
    formulaServiceCircularReference: 'Kruzna referenca.',
    formulaServiceExpectedParsableFormula: 'Ocekivana je formula koju je moguce parsirati.',
    formulaServiceInternalSchedulingError: 'Interna greska raspoređivanja.',
    ...
    exportingOoo: 'Izvoz...',
    fileInputOverlay: 'Povucite i ispustite datoteku za uvoz podataka',
    ...
    percentOfGrandTotal: '% ukupnog zbroja',
    percentOfColumnTotal: '% zbroja stupca',
    percentOfRowTotal: '% zbroja retka',
    percentOfParentRowTotal: '% zbroja nadređenog retka',
    percentOfParentColumnTotal: '% zbroja nadređenog stupca',
    percentOfGrandTotalDescription: 'Svaka vrijednost kao postotak ukupnog zbroja stupca.',
    percentOfColumnTotalDescription:
        'Svaka vrijednost kao postotak zbroja svog stupca — svaki stupac ukupno čini 100 %.',
    percentOfRowTotalDescription: 'Svaka vrijednost kao postotak zbroja retka kroz zaokretne stupce.',
    percentOfParentRowTotalDescription: 'Svaka vrijednost kao postotak svoje nadređene grupe.',
    percentOfParentColumnTotalDescription: 'Svaka vrijednost kao postotak svog nadređenog zaokretnog stupca.',
    autosizeThisColumn: 'Automatski prilagodi ovaj stupac',
    autosizeAllColumns: 'Automatski prilagodi sve stupce',
    groupBy: 'Grupiraj po ${variable}',
    ungroupBy: 'Razgrupiraj po ${variable}',
