...
export const AG_GRID_LOCALE_HR = {
    ...
    noAggregation: 'Nema',
    showValueAs: 'Prikaži vrijednosti kao',
    showValueAsNone: 'Ništa',
    showValueAsNotApplicable: 'Nije primjenjivo u trenutnom prikazu',
    showValueAsDefault: 'Zadano',
    showValueAsTopLevel: 'Najviša razina',
    ...
    percentOfParentTotal: '% nadređenog zbroja',
    ...
    percentOfParentTotalDescription: 'Svaka vrijednost kao postotak svog pretka na odabranom polju grupiranja.',
