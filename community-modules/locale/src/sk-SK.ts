...
export const AG_GRID_LOCALE_SK = {
    ...
    showValueAs: 'Zobraziť hodnoty ako',
    showValueAsNone: 'Žiadne',
    showValueAsNotApplicable: 'V aktuálnom zobrazení nemá zmysel',
    showValueAsDefault: 'Predvolené',
    showValueAsTopLevel: 'Najvyššia úroveň',
    ...
    percentOfParentTotal: '% nadradeného súčtu',
    ...
    percentOfParentTotalDescription: 'Každá hodnota ako percento jej predka vo zvolenom poli zoskupenia.',
    ...
    ariaColumnShowValueAs: 'Zobrazovanie hodnôt ako',
