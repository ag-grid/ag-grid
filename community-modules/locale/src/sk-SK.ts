...
export const AG_GRID_LOCALE_SK = {
    ...
    donutTooltip: 'Donut',
    lineTooltip: 'Línia',
    stackedLineTooltip: 'Naskladaný',
    normalizedLineTooltip: '100% Naskladaný',
    ...
    funnel: 'Lievik',
    coneFunnel: 'Kónický lievik',
    pyramid: 'Pyramída',
    funnelGroup: 'Lievik',
    funnelTooltip: 'Lievik',
    coneFunnelTooltip: 'Kónický lievik',
    pyramidTooltip: 'Pyramída',
    dropOff: 'Pokles',
    stageLabels: 'Štítky etáp',
    reverse: 'Opačný',
    ...
    ariaColumnSelectAll: 'Prepnúť viditeľnosť všetkých stĺpcov',
    ...
    ariaLabelLoadingContextMenu: 'Načítanie kontextovej ponuky',
