...
export const AG_GRID_LOCALE_SK = {
    ...
    lastYear: 'Minulý rok',
    thisYear: 'Tento rok',
    yearToDate: 'Od začiatku roka do dnes',
    nextYear: 'Budúci rok',
    last6Months: 'Posledných 6 mesiacov',
    last12Months: 'Posledných 12 mesiacov',
    last24Months: 'Posledných 24 mesiacov',
    ...
    advancedFilterInRange: 'je medzi',
    advancedFilterYesterday: 'je včera',
    advancedFilterToday: 'je dnes',
    advancedFilterTomorrow: 'je zajtra',
    advancedFilterLast7Days: 'je v posledných 7 dňoch',
    advancedFilterLastWeek: 'je v minulom týždni',
    advancedFilterThisWeek: 'je v tomto týždni',
    advancedFilterNextWeek: 'je v budúcom týždni',
    advancedFilterLast30Days: 'je v posledných 30 dňoch',
    advancedFilterLastMonth: 'je v minulom mesiaci',
    advancedFilterThisMonth: 'je v tomto mesiaci',
    advancedFilterNextMonth: 'je v budúcom mesiaci',
    advancedFilterLast90Days: 'je v posledných 90 dňoch',
    advancedFilterLastQuarter: 'je v minulom štvrťroku',
    advancedFilterThisQuarter: 'je v tomto štvrťroku',
    advancedFilterNextQuarter: 'je v budúcom štvrťroku',
    advancedFilterLastYear: 'je v minulom roku',
    advancedFilterThisYear: 'je v tomto roku',
    advancedFilterYearToDate: 'je od začiatku roka do dnes',
    advancedFilterNextYear: 'je v budúcom roku',
    advancedFilterLast6Months: 'je v posledných 6 mesiacoch',
    advancedFilterLast12Months: 'je v posledných 12 mesiacoch',
    advancedFilterLast24Months: 'je v posledných 24 mesiacoch',
    advancedFilterTrue: 'je pravdivé',
    advancedFilterFalse: 'je nepravdivé',
    advancedFilterIsAnyOf: 'je ktorákoľvek z',
    advancedFilterIsNoneOf: 'nie je žiadna z',
    advancedFilterSetMore: '+${variable} ďalších',
    advancedFilterAnd: 'A',
    ...
    advancedFilterValidationInvalidValue: 'Hodnota sa nenašla',
    ...
    advancedFilterValidationNotABigInt: 'Hodnota nie je BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} musí byť väčšie ako ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} musí byť väčšie alebo rovné ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} musí byť po ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} musí byť ${variable} alebo neskorší',
    ...
    formulaParseInvalidRangeEndReference: 'Neplatny koncovy odkaz rozsahu.',
    formulaParseUnterminatedString: 'Neukonceny retazec.',
    formulaParseUnexpectedCharacter: 'Neocakavany znak: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Podtecenie zasobnika operatorov.',
    formulaParseMissingOperand: "Chyba operand pre '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Interna chyba: neocakavany ramec pocas redukcie.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Interna chyba: neocakavany ramec pred '('.",
    formulaParseMisplacedComma: 'Ciarka na nespravnom mieste.',
    formulaParseCommaOutsideFunctionCall: 'Ciarka mimo volania funkcie.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Interna chyba: neocakavany ramec pred ')'.",
    formulaParseMismatchedParentheses: 'Nesulad zatievoriek.',
    formulaParseUnsupportedOperand: 'Nepodporovany operand: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'Nesulad zatievoriek alebo nedokoncene volanie funkcie.',
    formulaParseInvalidExpression: 'Neplatny vyraz.',
    formulaParseFormulasMustBeginWithEquals: 'Vzorce musia zacinať znakom =.',
    formulaSerializeStringContainsQuote: 'Retazec obsahuje uvodzovku (") ktoru tokenizer nepodporuje.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Neda sa vytvorit absolutny stitok STLPCA z id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "Neda sa vytvorit absolutny index RIADKU z id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Neda sa vytvorit index RIADKU z id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Neda sa mapovat id stlpca '${variable}' na stitok A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Neda sa parsovat absolutny index riadku '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Neda sa mapovat id riadku '${variable}' na index A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'Rozsah nie je povoleny v skalarnom kontexte.',
    formulaEvalUnknownReferenceToCell: 'Neznamy odkaz na bunku.',
    formulaEvalUnsupportedOperation: 'Nepodporovana operacia ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Neplatny absolutny riadok.',
    formulaEvalUnrecognisedRowId: 'Nerozpoznane id riadku.',
    formulaEvalInvalidAbsoluteColumn: 'Neplatny absolutny stlpec.',
    formulaEvalUnrecognisedColumnId: 'Nerozpoznane id stlpca.',
    formulaEvalUnrecognisedRowInRange: 'Nerozpoznany riadok v rozsahu.',
    ...
    formulaFunctionExpectedExactlyArguments: '${variable}: ocakavane presne ${variable} argumenty.',
    formulaFunctionExpectedAtMostArguments: '${variable}: ocakavane najviac ${variable} argumentov.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: ocakavane aspon ${variable} argumentov.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Neplatne kriterium: zastupne znaky s komparatorom.',
    formulaFunctionNonNumericArgument: '${variable}: nenumericky argument.',
    formulaFunctionDivisionByZero: '${variable}: delenie nulou.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: nie je mozne kombinovat datumy s BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: vyzaduje aspon jednu numericku hodnotu.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: vyzaduje aspon jednu hodnotu.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: vsetky hodnoty musia byt cisla.',
    ...
    formulaFunctionRangesHaveDifferentSizes: '${variable}: rozsahy maju rozne velkosti.',
    formulaFunctionValuesMustBeNumeric: '${variable}: hodnoty musia byt numericke.',
    formulaFunctionValuesMustBeIntegers: '${variable}: hodnoty musia byt cele cisla.',
    ...
    formulaFunctionDivDivisionByZero: 'DIV: delenie nulou.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: nie je mozne kombinovat datumy s BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: vyzaduje aspon jednu numericku hodnotu.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: vyzaduje aspon jednu hodnotu.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: vsetky hodnoty musia byt cisla.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: vyzaduje aspon jednu hodnotu.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: prvy argument musi byt rozsah.',
    ...
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: rozsahy maju rozne velkosti.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: prvy argument musi byt rozsah.',
    ...
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: vyzaduje aspon jednu hodnotu.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: vyzaduje aspon jednu hodnotu.',
    ...
    formulaServiceExpectedParsableFormula: 'Ocakavany parsovatelny vzorec.',
    formulaServiceInternalSchedulingError: 'Interna chyba planovania.',
    ...
    fileInputOverlay: 'Presuňte súbor sem na import údajov',
    ...
    showValuesAs: 'Zobraziť hodnoty ako',
    showValuesAsNone: 'Žiadne',
    percentOfGrandTotal: '% celkového súčtu',
    percentOfColumnTotal: '% súčtu stĺpca',
    percentOfRowTotal: '% súčtu riadka',
    percentOfParentRowTotal: '% súčtu nadradeného riadka',
    percentOfParentColumnTotal: '% súčtu nadradeného stĺpca',
    percentOfGrandTotalDescription: 'Každá hodnota ako percento celkového súčtu stĺpca.',
    percentOfColumnTotalDescription: 'Každá hodnota ako percento súčtu jej stĺpca — každý stĺpec dáva dokopy 100 %.',
    percentOfRowTotalDescription: 'Každá hodnota ako percento súčtu riadka naprieč kontingenčnými stĺpcami.',
    percentOfParentRowTotalDescription: 'Každá hodnota ako percento jej nadradenej skupiny.',
    percentOfParentColumnTotalDescription: 'Každá hodnota ako percento jej nadradeného kontingenčného stĺpca.',
    ...
    groupBy: 'Zoskupiť podľa ${variable}',
    ungroupBy: 'Rozoskupiť podľa ${variable}',
