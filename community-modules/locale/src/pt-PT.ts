...
export const AG_GRID_LOCALE_PT = {
    ...
    showValueAsNotApplicable: 'Não se aplica à vista atual',
    showValueAsDefault: 'Predefinição',
    ...
    percentOfParentTotal: '% do total principal',
    ...
    percentOfParentTotalDescription:
        'Cada valor como uma percentagem do respetivo antecessor num campo de agrupamento escolhido.',
    ...
    ariaColumnShowValueAs: 'A mostrar valores como',
