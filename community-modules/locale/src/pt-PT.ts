...
export const AG_GRID_LOCALE_PT_PT = {
    ...
    advancedFilterLastQuarter: 'está no trimestre passado',
    ...
    advancedFilterYearToDate: 'está no ano até à data',
    ...
    advancedFilterValidationMessageOnly: 'Expressão contém um erro. ${variable}.',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_PT_PT` instead. */
