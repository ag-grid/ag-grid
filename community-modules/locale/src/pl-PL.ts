...
export const AG_GRID_LOCALE_PL_PL = {
    ...
    advancedFilterIsAnyOf: 'jest jednym z',
    advancedFilterIsNoneOf: 'nie jest żadnym z',
    advancedFilterSetMore: '+${variable} więcej',
    ...
    advancedFilterValidationInvalidValue: 'Wartość nie istnieje',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} musi być większa niż ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} musi być większa lub równa ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} musi być po ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} musi być ${variable} lub późniejsza',
    ...
    // Formulas
    invalidFormulaValidation: 'Nieprawidlowa formula.',
    formulaParseInvalidCellReference: 'Nieprawidlowe odwolanie do komorki: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Nieprawidlowe zakonczenie zakresu.',
    formulaParseUnterminatedString: 'Niezakonczony ciag znakow.',
    formulaParseUnexpectedCharacter: 'Nieoczekiwany znak: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Niedomiar stosu operatorow.',
    formulaParseMissingOperand: "Brak operandu dla '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Blad wewnetrzny: nieoczekiwana ramka podczas redukcji.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Blad wewnetrzny: nieoczekiwana ramka przed '('.",
    formulaParseMisplacedComma: 'Przecinek w nieprawidlowym miejscu.',
    formulaParseCommaOutsideFunctionCall: 'Przecinek poza wywolaniem funkcji.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Blad wewnetrzny: nieoczekiwana ramka przed ')'.",
    formulaParseMismatchedParentheses: 'Niedopasowane nawiasy.',
    formulaParseUnsupportedOperand: 'Nieobslugiwany operand: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall:
        'Niedopasowane nawiasy lub niedokonczone wywolanie funkcji.',
    formulaParseInvalidExpression: 'Nieprawidlowe wyrazenie.',
    formulaParseFormulasMustBeginWithEquals: 'Formuly musza zaczynac sie od =.',
    formulaSerializeStringContainsQuote: 'Ciag znakow zawiera cudzyslow (") nieobslugiwany przez tokenizator.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Nie mozna utworzyc bezwzglednej etykiety KOLUMNY z id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Nie mozna utworzyc bezwzglednego indeksu WIERSZA z id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Nie mozna utworzyc indeksu WIERSZA z id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Nie mozna zmapowac id kolumny '${variable}' do etykiety A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Nie mozna sparsowac bezwzglednego indeksu wiersza '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Nie mozna zmapowac id wiersza '${variable}' do indeksu A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'Zakres nie jest dozwolony w kontekscie skalarnym.',
    formulaEvalUnknownReferenceToCell: 'Nieznane odwolanie do komorki.',
    formulaEvalUnsupportedOperation: 'Nieobslugiwana operacja ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Nieprawidlowy bezwzgledny wiersz.',
    formulaEvalUnrecognisedRowId: 'Nierozpoznane id wiersza.',
    formulaEvalInvalidAbsoluteColumn: 'Nieprawidlowa bezwzgledna kolumna.',
    formulaEvalUnrecognisedColumnId: 'Nierozpoznane id kolumny.',
    formulaEvalUnrecognisedRowInRange: 'Nierozpoznany wiersz w zakresie.',
    formulaEvalUnrecognisedReferenceToCell: 'Nierozpoznane odwolanie do komorki.',
    formulaEvalIncompleteRangeReference: 'Niepelne odwolanie do zakresu.',
    formulaFunctionExpectedExactlyArguments: '${variable}: oczekiwano dokladnie ${variable} argumentow.',
    formulaFunctionExpectedAtMostArguments: '${variable}: oczekiwano co najwyzej ${variable} argumentow.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: oczekiwano co najmniej ${variable} argumentow.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator:
        'Nieprawidlowe kryterium: symbole wieloznaczne z operatorem porownania.',
    formulaFunctionNonNumericArgument: '${variable}: argument nienumeryczny.',
    formulaFunctionDivisionByZero: '${variable}: dzielenie przez zero.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: nie mozna laczyc dat z BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: wymaga co najmniej jednej wartosci numerycznej.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: wymaga co najmniej jednej wartosci.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: wszystkie wartosci musza byc liczbami.',
    formulaFunctionArgumentMustBeRange: '${variable}: argument ${variable} musi byc zakresem.',
    formulaFunctionArgumentMustBeValue: '${variable}: argument ${variable} musi byc wartoscia.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: zakresy maja rozne rozmiary.',
    formulaFunctionValuesMustBeNumeric: '${variable}: wartosci musza byc numeryczne.',
    formulaFunctionValuesMustBeIntegers: '${variable}: wartosci musza byc liczbami calkowitymi.',
    formulaFunctionUnsupportedValueType: '${variable}: nieobslugiwany typ wartosci.',
    formulaFunctionDivNonNumericArgument: 'DIV: argument nienumeryczny.',
    formulaFunctionDivDivisionByZero: 'DIV: dzielenie przez zero.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: nie mozna laczyc dat z BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: wymaga co najmniej jednej wartosci numerycznej.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: wymaga co najmniej jednej wartosci.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: wszystkie wartosci musza byc liczbami.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: wymaga co najmniej jednej wartosci.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: pierwszy argument musi byc zakresem.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: drugi argument musi byc wartoscia (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: trzeci argument musi byc zakresem (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: zakresy maja rozne rozmiary.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: pierwszy argument musi byc zakresem.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: drugi argument musi byc wartoscia (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: nieobslugiwany typ wartosci.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: wymaga co najmniej jednej wartosci.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: wymaga co najmniej jednej wartosci.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: argument nienumeryczny.',
    formulaFunctionPowerNonNumericArgument: 'POWER: argument nienumeryczny.',
    formulaServiceCircularReference: 'Odwolanie cykliczne.',
    formulaServiceExpectedParsableFormula: 'Oczekiwano parsowalnej formuly.',
    formulaServiceInternalSchedulingError: 'Wewnetrzny blad harmonogramowania.',
    ...
    fileInputOverlay: 'Przeciągnij i upuść plik, aby zaimportować dane',
    fileInputOverlayBrowse: 'Przeglądaj pliki',
    fileInputProcessing: 'Przetwarzanie ${variable}',
    fileInputProcessingFailed: 'Błąd przetwarzania ${variable}',
    enabled: 'Włączone',
    ...
    noAggregation: 'Brak',
    showValuesAs: 'Pokaż wartości jako',
    showValuesAsNone: 'Brak',
    ...
    percentOfGrandTotalDescription: 'Każda wartość jako procent sumy końcowej kolumny.',
    percentOfColumnTotalDescription: 'Każda wartość jako procent sumy jej kolumny — każda kolumna daje w sumie 100%.',
    percentOfRowTotalDescription: 'Każda wartość jako procent sumy wiersza w kolumnach przestawnych.',
    percentOfParentRowTotalDescription: 'Każda wartość jako procent jej grupy nadrzędnej.',
    percentOfParentColumnTotalDescription: 'Każda wartość jako procent jej nadrzędnej kolumny przestawnej.',
    autosizeThisColumn: 'Autoszerokość tej Kolumny',
    autosizeAllColumns: 'Autoszerokość wszystkich Kolumn',
    groupBy: 'Grupuj według ${variable}',
    ungroupBy: 'Rozgrupuj według ${variable}',
    ...
    // Data types
    dataTypeText: 'Tekst',
    dataTypeNumber: 'Liczba',
    dataTypeBigInt: 'BigInt',
    dataTypeBoolean: 'Wartość logiczna',
    dataTypeDate: 'Data',
    dataTypeDateString: 'Ciąg daty',
    dataTypeDateTime: 'Data i godzina',
    dataTypeDateTimeString: 'Ciąg daty i godziny',
    dataTypeObject: 'Obiekt',
    true: 'Prawda',
    false: 'Fałsz',
    ...
    editColumnName: 'Edytuj nazwę kolumny',
    ariaColumnHeaderNameEditor: 'Edytor nazwy kolumny',
    columnHeaderEditApply: 'Zastosuj',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_PL_PL` instead. */
