...
export const AG_GRID_LOCALE_PL = {
    ...
    noAggregation: 'Brak',
    showValueAs: 'Pokaż wartości jako',
    showValueAsNone: 'Brak',
    showValueAsNotApplicable: 'Nieistotne w bieżącym widoku',
    showValueAsDefault: 'Domyślne',
    showValueAsTopLevel: 'Najwyższy poziom',
    ...
    percentOfParentTotal: '% sumy nadrzędnej',
    ...
    percentOfParentTotalDescription: 'Każda wartość jako procent jej przodka w wybranym polu grupowania.',
    ...
    ariaColumnShowValueAs: 'Pokazywanie wartości jako',
