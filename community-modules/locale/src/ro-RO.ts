...
export const AG_GRID_LOCALE_RO = {
    ...
    showValueAs: 'Afișați valorile ca',
    showValueAsNone: 'Niciuna',
    showValueAsNotApplicable: 'Nu este relevant în vizualizarea curentă',
    showValueAsDefault: 'Implicit',
    showValueAsTopLevel: 'Nivel superior',
    ...
    percentOfParentTotal: '% din totalul părinte',
    ...
    percentOfParentTotalDescription: 'Fiecare valoare ca procent din strămoșul său la un câmp de grupare ales.',
