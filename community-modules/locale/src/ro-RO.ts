...
export const AG_GRID_LOCALE_RO = {
    ...
    nextQuarter: 'Trimestrul viitor',
    lastYear: 'Anul trecut',
    thisYear: 'Acest an',
    yearToDate: 'De la începutul anului până în prezent',
    nextYear: 'Anul viitor',
    last6Months: 'Ultimele 6 luni',
    last12Months: 'Ultimele 12 luni',
    last24Months: 'Ultimele 24 de luni',
    ...
    advancedFilterInRange: 'este între',
    advancedFilterYesterday: 'este ieri',
    advancedFilterToday: 'este astăzi',
    advancedFilterTomorrow: 'este mâine',
    advancedFilterLast7Days: 'este în ultimele 7 zile',
    advancedFilterLastWeek: 'este în săptămâna trecută',
    advancedFilterThisWeek: 'este în această săptămână',
    advancedFilterNextWeek: 'este în săptămâna viitoare',
    advancedFilterLast30Days: 'este în ultimele 30 de zile',
    advancedFilterLastMonth: 'este în luna trecută',
    advancedFilterThisMonth: 'este în această lună',
    advancedFilterNextMonth: 'este în luna viitoare',
    advancedFilterLast90Days: 'este în ultimele 90 de zile',
    advancedFilterLastQuarter: 'este în trimestrul trecut',
    advancedFilterThisQuarter: 'este în acest trimestru',
    advancedFilterNextQuarter: 'este în trimestrul viitor',
    advancedFilterLastYear: 'este în anul trecut',
    advancedFilterThisYear: 'este în acest an',
    advancedFilterYearToDate: 'este de la începutul anului până în prezent',
    advancedFilterNextYear: 'este în anul viitor',
    advancedFilterLast6Months: 'este în ultimele 6 luni',
    advancedFilterLast12Months: 'este în ultimele 12 luni',
    advancedFilterLast24Months: 'este în ultimele 24 de luni',
    advancedFilterTrue: 'este adevărat',
    advancedFilterFalse: 'este fals',
    advancedFilterIsAnyOf: 'este oricare dintre',
    advancedFilterIsNoneOf: 'nu este niciunul dintre',
    advancedFilterSetMore: '+${variable} mai multe',
    ...
    advancedFilterValidationInvalidValue: 'Valoare negăsită',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} trebuie să fie mai mare decât ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} trebuie să fie mai mare sau egal cu ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} trebuie să fie după ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} trebuie să fie ${variable} sau ulterioară',
    ...
    formulaParseInvalidCellReference: 'Referinta de celula invalida: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Referinta de sfarsit de interval invalida.',
    formulaParseUnterminatedString: 'Sir neterminat.',
    formulaParseUnexpectedCharacter: 'Caracter neasteptat: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Subdepasire a stivei de operatori.',
    formulaParseMissingOperand: "Operand lipsa pentru '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Eroare interna: frame neasteptat in timpul reducerii.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Eroare interna: frame neasteptat inainte de '('.",
    formulaParseMisplacedComma: 'Virgula plasata gresit.',
    formulaParseCommaOutsideFunctionCall: 'Virgula in afara unui apel de functie.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Eroare interna: frame neasteptat inainte de ')'.",
    formulaParseMismatchedParentheses: 'Paranteze necorespunzatoare.',
    formulaParseUnsupportedOperand: 'Operand neacceptat: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall:
        'Paranteze necorespunzatoare sau apel de functie neterminat.',
    formulaParseInvalidExpression: 'Expresie invalida.',
    formulaParseFormulasMustBeginWithEquals: 'Formulele trebuie sa inceapa cu =.',
    formulaSerializeStringContainsQuote: 'Sirul contine ghilimele (") pe care tokenizatorul nu le accepta.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Nu se poate produce eticheta absoluta de COLOANA din id-ul '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Nu se poate produce indexul absolut de RAND din id-ul '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Nu se poate produce indexul de RAND din id-ul '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Nu se poate mapa id-ul coloanei '${variable}' la eticheta A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Nu se poate parsa indexul absolut de rand '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Nu se poate mapa id-ul randului '${variable}' la indexul A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'Intervalul nu este permis in context scalar.',
    formulaEvalUnknownReferenceToCell: 'Referinta necunoscuta la celula.',
    formulaEvalUnsupportedOperation: 'Operatie neacceptata ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Rand absolut invalid.',
    formulaEvalUnrecognisedRowId: 'Id de rand nerecunoscut.',
    formulaEvalInvalidAbsoluteColumn: 'Coloana absoluta invalida.',
    formulaEvalUnrecognisedColumnId: 'Id de coloana nerecunoscut.',
    formulaEvalUnrecognisedRowInRange: 'Rand nerecunoscut in interval.',
    formulaEvalUnrecognisedReferenceToCell: 'Referinta la celula nerecunoscuta.',
    formulaEvalIncompleteRangeReference: 'Referinta de interval incompleta.',
    formulaFunctionExpectedExactlyArguments: '${variable}: se asteptau exact ${variable} argumente.',
    formulaFunctionExpectedAtMostArguments: '${variable}: se asteptau cel mult ${variable} argumente.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: se asteptau cel putin ${variable} argumente.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Criteriu invalid: wildcard-uri cu comparator.',
    formulaFunctionNonNumericArgument: '${variable}: argument nenumeric.',
    formulaFunctionDivisionByZero: '${variable}: impartire la zero.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: nu se pot combina datele cu BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: necesita cel putin o valoare numerica.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: necesita cel putin o valoare.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: toate valorile trebuie sa fie numere.',
    formulaFunctionArgumentMustBeRange: '${variable}: argumentul ${variable} trebuie sa fie un interval.',
    formulaFunctionArgumentMustBeValue: '${variable}: argumentul ${variable} trebuie sa fie o valoare.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: intervalele au dimensiuni diferite.',
    formulaFunctionValuesMustBeNumeric: '${variable}: valorile trebuie sa fie numerice.',
    formulaFunctionValuesMustBeIntegers: '${variable}: valorile trebuie sa fie intregi.',
    formulaFunctionUnsupportedValueType: '${variable}: tip de valoare neacceptat.',
    formulaFunctionDivNonNumericArgument: 'DIV: argument nenumeric.',
    formulaFunctionDivDivisionByZero: 'DIV: impartire la zero.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: nu se pot combina datele cu BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: necesita cel putin o valoare numerica.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: necesita cel putin o valoare.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: toate valorile trebuie sa fie numere.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: necesita cel putin o valoare.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: primul argument trebuie sa fie un interval.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: al doilea argument trebuie sa fie o valoare (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: al treilea argument trebuie sa fie un interval (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: intervalele au dimensiuni diferite.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: primul argument trebuie sa fie un interval.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: al doilea argument trebuie sa fie o valoare (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: tip de valoare neacceptat.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: necesita cel putin o valoare.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: necesita cel putin o valoare.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: argument nenumeric.',
    formulaFunctionPowerNonNumericArgument: 'POWER: argument nenumeric.',
    ...
    fileInputOverlay: 'Trageți și plasați fișierul pentru a importa date',
    ...
    showValuesAs: 'Afișați valorile ca',
    showValuesAsNone: 'Niciuna',
    percentOfGrandTotal: '% din totalul general',
    percentOfColumnTotal: '% din totalul coloanei',
    percentOfRowTotal: '% din totalul rândului',
    percentOfParentRowTotal: '% din totalul rândului părinte',
    percentOfParentColumnTotal: '% din totalul coloanei părinte',
    percentOfGrandTotalDescription: 'Fiecare valoare ca procent din totalul general al coloanei.',
    percentOfColumnTotalDescription:
        'Fiecare valoare ca procent din totalul coloanei sale — fiecare coloană însumează 100%.',
    percentOfRowTotalDescription: 'Fiecare valoare ca procent din totalul rândului pe coloanele pivot.',
    percentOfParentRowTotalDescription: 'Fiecare valoare ca procent din grupul său părinte.',
    percentOfParentColumnTotalDescription: 'Fiecare valoare ca procent din coloana sa pivot părinte.',
    autosizeThisColumn: 'Auto redimensiona această coloană',
    autosizeAllColumns: 'Auto redimensiona toate coloanele',
    groupBy: 'Grupați după ${variable}',
    ungroupBy: 'Degrupați după ${variable}',
    ...
    ariaColumnShowValuesAs: 'Se afișează valorile ca',
