...
export const AG_GRID_LOCALE_RO = {
    ...
    normalizedLineTooltip: '100% Suprapus',
    ...
    funnel: 'Pâlnie',
    coneFunnel: 'Pâlnie Conică',
    pyramid: 'Piramidă',
    funnelGroup: 'Pâlnie',
    funnelTooltip: 'Pâlnie',
    coneFunnelTooltip: 'Pâlnie Conică',
    pyramidTooltip: 'Piramidă',
    dropOff: 'Scădere',
    stageLabels: 'Etichete Stage',
    reverse: 'Inversare',
    ...
    ariaSelectAllCells: 'Apasă Space pentru a selecta toate celulele',
    ...
    ariaLabelLoadingContextMenu: 'Se încarcă meniul contextual',
