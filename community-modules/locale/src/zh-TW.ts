...
export const AG_GRID_LOCALE_ZH_TW = {
    ...
    advancedFilterLastQuarter: '在上一季內',
    advancedFilterThisQuarter: '在本季內',
    advancedFilterNextQuarter: '在下一季內',
    ...
    ariaSparklineChartDescription:
        '迷你圖 - ${chartType} 顯示 ${count} 個值，介於 ${min} 和 ${max} 之間。從 ${start} 開始，到 ${end} 結束。',
    ...
    calculatedColumnColumns: '欄位',
    calculatedColumnFunctions: '函式',
    calculatedColumnOperators: '運算子',
    calculatedColumnSuggestions: '計算欄位建議',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_ZH_TW` instead. */
