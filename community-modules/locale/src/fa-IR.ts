...
export const AG_GRID_LOCALE_IR = {
    ...
    donutTooltip: 'دونات',
    lineTooltip: 'خط',
    stackedLineTooltip: 'پشته ای',
    normalizedLineTooltip: '100% پشته ای',
    ...
    ariaColumnSelectAll: 'تغییر قابلیت مشاهده همه ستون‌ها',
    ...
    ariaSelectAllCells: 'برای انتخاب همه سلول‌ها فاصله را فشار دهید',
    ...
    ariaLabelLoadingContextMenu: 'در حال بارگذاری منوی زمینه',
