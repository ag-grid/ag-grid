...
export const AG_GRID_LOCALE_IR = {
    ...
    advancedFilterIsAnyOf: 'هر یک از',
    advancedFilterIsNoneOf: 'هیچ‌یک از',
    advancedFilterSetMore: '+${variable} مورد دیگر',
    advancedFilterAnd: 'و',
    advancedFilterOr: 'یا',
    ...
    advancedFilterValidationInvalidValue: 'مقدار یافت نشد',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} باید بیشتر از ${variable} باشد',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} باید بیشتر یا مساوی با ${variable} باشد',
    advancedFilterValidationMustBeAfter: '${variable} باید بعد از ${variable} باشد',
    advancedFilterValidationMustBeOnOrAfter: '${variable} باید ${variable} یا بعد از آن باشد',
    ...
    // Formulas
    invalidFormulaValidation: 'فرمول نامعتبر است.',
    formulaParseInvalidCellReference: 'ارجاع سلول نامعتبر: ${variable}.',
    formulaParseInvalidRangeEndReference: 'ارجاع پايان بازه نامعتبر است.',
    formulaParseUnterminatedString: 'رشته پايان نيافته است.',
    formulaParseUnexpectedCharacter: 'کاراکتر غيرمنتظره: ${variable}.',
    formulaParseOperatorStackUnderflow: 'کمبود در پشته عملگرها.',
    formulaParseMissingOperand: "عملوند براي '${variable}' وجود ندارد.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'خطاي داخلي: فريم غيرمنتظره هنگام کاهش.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "خطاي داخلي: فريم غيرمنتظره قبل از '('.",
    formulaParseMisplacedComma: 'ويرگول در جاي نادرست است.',
    formulaParseCommaOutsideFunctionCall: 'ويرگول خارج از فراخواني تابع است.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "خطاي داخلي: فريم غيرمنتظره قبل از ')'.",
    formulaParseMismatchedParentheses: 'پرانتزها مطابق نيستند.',
    formulaParseUnsupportedOperand: 'عملوند پشتيباني نمي‌شود: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'پرانتزها مطابق نيستند يا فراخواني تابع کامل نشده است.',
    formulaParseInvalidExpression: 'عبارت نامعتبر است.',
    formulaParseFormulasMustBeginWithEquals: 'فرمول بايد با = شروع شود.',
    formulaSerializeStringContainsQuote: 'رشته شامل علامت نقل‌قول (") است که توسط تجزيه‌گر توکن پشتيباني نمي‌شود.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "نمي‌توان برچسب مطلق ستون را از شناسه '${variable}' توليد کرد.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "نمي‌توان انديس مطلق سطر را از شناسه '${variable}' توليد کرد.",
    formulaSerializeCannotProduceRowIndexFromId: "نمي‌توان انديس سطر را از شناسه '${variable}' توليد کرد.",
    formulaSerializeCannotMapColumnIdToA1Label: "نمي‌توان شناسه ستون '${variable}' را به برچسب A1 نگاشت کرد.",
    formulaSerializeCannotParseAbsoluteRowIndex: "نمي‌توان انديس مطلق سطر '${variable}' را تحليل کرد.",
    formulaSerializeCannotMapRowIdToA1Index: "نمي‌توان شناسه سطر '${variable}' را به انديس A1 نگاشت کرد.",
    formulaEvalRangeNotAllowedInScalarContext: 'بازه در متن اسکالر مجاز نيست.',
    formulaEvalUnknownReferenceToCell: 'ارجاع سلول ناشناخته است.',
    formulaEvalUnsupportedOperation: 'عمليات پشتيباني‌نشده ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'سطر مطلق نامعتبر است.',
    formulaEvalUnrecognisedRowId: 'شناسه سطر شناخته نشد.',
    formulaEvalInvalidAbsoluteColumn: 'ستون مطلق نامعتبر است.',
    formulaEvalUnrecognisedColumnId: 'شناسه ستون شناخته نشد.',
    formulaEvalUnrecognisedRowInRange: 'سطر شناخته‌نشده در بازه.',
    formulaEvalUnrecognisedReferenceToCell: 'ارجاع سلول شناخته‌نشده.',
    formulaEvalIncompleteRangeReference: 'ارجاع بازه ناقص است.',
    formulaFunctionExpectedExactlyArguments: '${variable}: دقيقا ${variable} آرگومان لازم است.',
    formulaFunctionExpectedAtMostArguments: '${variable}: حداکثر ${variable} آرگومان مجاز است.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: حداقل ${variable} آرگومان لازم است.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'معيار نامعتبر: استفاده از وايلدکارد همراه مقايسه‌گر.',
    formulaFunctionNonNumericArgument: '${variable}: آرگومان غيرعددي.',
    formulaFunctionDivisionByZero: '${variable}: تقسيم بر صفر.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: ترکيب تاريخ با BigInt مجاز نيست.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: حداقل يک مقدار عددي لازم است.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: حداقل يک مقدار لازم است.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: همه مقادير بايد عدد باشند.',
    formulaFunctionArgumentMustBeRange: '${variable}: آرگومان ${variable} بايد بازه باشد.',
    formulaFunctionArgumentMustBeValue: '${variable}: آرگومان ${variable} بايد مقدار باشد.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: اندازه بازه‌ها متفاوت است.',
    formulaFunctionValuesMustBeNumeric: '${variable}: مقادير بايد عددي باشند.',
    formulaFunctionValuesMustBeIntegers: '${variable}: مقادير بايد صحيح باشند.',
    formulaFunctionUnsupportedValueType: '${variable}: نوع مقدار پشتيباني نمي‌شود.',
    formulaFunctionDivNonNumericArgument: 'DIV: آرگومان غيرعددي.',
    formulaFunctionDivDivisionByZero: 'DIV: تقسيم بر صفر.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: ترکيب تاريخ با BigInt مجاز نيست.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: حداقل يک مقدار عددي لازم است.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: حداقل يک مقدار لازم است.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: همه مقادير بايد عدد باشند.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: حداقل يک مقدار لازم است.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: آرگومان اول بايد بازه باشد.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: آرگومان دوم بايد مقدار باشد (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: آرگومان سوم بايد بازه باشد (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: اندازه بازه‌ها متفاوت است.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: آرگومان اول بايد بازه باشد.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: آرگومان دوم بايد مقدار باشد (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: نوع مقدار پشتيباني نمي‌شود.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: حداقل يک مقدار لازم است.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: حداقل يک مقدار لازم است.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: آرگومان غيرعددي.',
    formulaFunctionPowerNonNumericArgument: 'POWER: آرگومان غيرعددي.',
    formulaServiceCircularReference: 'ارجاع حلقوي.',
    formulaServiceExpectedParsableFormula: 'فرمول قابل تجزيه مورد انتظار بود.',
    formulaServiceInternalSchedulingError: 'خطاي داخلي زمان‌بندي.',
    ...
    fileInputOverlay: 'برای وارد کردن داده‌ها، فایل را بکشید و رها کنید',
    ...
    noAggregation: 'هیچ',
    showValuesAs: 'نمایش مقادیر به‌صورت',
    showValuesAsNone: 'هیچ‌کدام',
    percentOfGrandTotal: '% از مجموع کل',
    percentOfColumnTotal: '% از مجموع ستون',
    percentOfRowTotal: '% از مجموع سطر',
    percentOfParentRowTotal: '% از مجموع سطر والد',
    percentOfParentColumnTotal: '% از مجموع ستون والد',
    percentOfGrandTotalDescription: 'هر مقدار به‌صورت درصدی از مجموع کل ستون.',
    percentOfColumnTotalDescription: 'هر مقدار به‌صورت درصدی از مجموع ستون خود — مجموع هر ستون ۱۰۰٪ می‌شود.',
    percentOfRowTotalDescription: 'هر مقدار به‌صورت درصدی از مجموع سطر در سراسر ستون‌های محوری.',
    percentOfParentRowTotalDescription: 'هر مقدار به‌صورت درصدی از گروه والد خود.',
    percentOfParentColumnTotalDescription: 'هر مقدار به‌صورت درصدی از ستون محوری والد خود.',
    autosizeThisColumn: 'اندازه خودکار این ستون',
    autosizeAllColumns: 'اندازه خودکار همه ستون‌ها',
    groupBy: 'گروه‌بندی بر اساس ${variable}',
    ungroupBy: 'لغو گروه‌بندی بر اساس ${variable}',
