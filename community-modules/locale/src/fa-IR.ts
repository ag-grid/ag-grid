...
export const AG_GRID_LOCALE_IR = {
    ...
    noAggregation: 'هیچ',
    showValueAs: 'نمایش مقادیر به‌صورت',
    showValueAsNone: 'هیچ‌کدام',
    showValueAsNotApplicable: 'در نمای فعلی معنادار نیست',
    showValueAsDefault: 'پیش‌فرض',
    showValueAsTopLevel: 'سطح بالا',
    ...
    percentOfParentTotal: '% از مجموع والد',
    ...
    percentOfParentTotalDescription: 'هر مقدار به‌صورت درصدی از جد خود در یک فیلد گروه‌بندی انتخاب‌شده.',
    ...
    ariaColumnShowValueAs: 'در حال نمایش مقادیر به‌صورت',
