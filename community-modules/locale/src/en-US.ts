export const AG_GRID_LOCALE_EN = {
    ...
    noAggregation: 'None',
    showValueAs: 'Show Values As',
    showValueAsNone: 'None',
    showValueAsNotApplicable: 'Not meaningful in the current view',
    showValueAsDefault: 'Default',
    showValueAsTopLevel: 'Top level',
    showValueAsPreviousItem: '(Previous)',
    showValueAsNextItem: '(Next)',
    showValueAsPreviousRow: '(Previous row)',
    showValueAsNextRow: '(Next row)',
    showValueAsCustomValue: 'Custom value…',
    showValueAsAnotherColumn: 'Another column',
    showValueAsValuePrompt: "Compare each '${variable}' value against the number below.",
    showValueAsApply: 'Apply',
    showValueAsCancel: 'Cancel',
    ...
    percentOfParentTotal: '% of Parent Total',
    ...
    percentOfDescription: 'Each value as a percentage of a chosen base field and item.',
    ...
    percentOfParentTotalDescription: 'Each value as a percentage of its ancestor at a chosen grouping field.',
    differenceFromDescription: 'The difference from a chosen base field and item.',
    percentDifferenceFromDescription: 'The percentage difference from a chosen base field and item.',
    ...
    ariaColumnShowValueAs: 'Showing Values As',
