export const AG_GRID_LOCALE_EN = {
    ...
    advancedFilterSetMore: '+${variable} more',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} must be greater than ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} must be greater than or equal to ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} must be after ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} must be on or after ${variable}',
