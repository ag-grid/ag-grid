...
export const AG_GRID_LOCALE_IT = {
    ...
    showValueAs: 'Mostra valori come',
    showValueAsNone: 'Nessuno',
    showValueAsNotApplicable: 'Non significativo nella vista corrente',
    showValueAsDefault: 'Predefinito',
    showValueAsTopLevel: 'Livello superiore',
    ...
    percentOfParentTotal: '% del totale principale',
    ...
    percentOfParentTotalDescription:
        'Ogni valore come percentuale del suo antenato in un campo di raggruppamento scelto.',
    ...
    ariaColumnShowValueAs: 'Visualizzazione valori come',
