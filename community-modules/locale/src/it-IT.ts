...
export const AG_GRID_LOCALE_IT = {
    ...
    ariaCellHasNote: 'Questa cella ha una nota.',
    ...
    // Cell Notes
    cellNote: 'Nota della cella',
    addCellNote: 'Aggiungi nota alla cella',
    viewCellNote: 'Visualizza nota',
    editCellNote: 'Modifica nota',
