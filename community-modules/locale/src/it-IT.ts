...
export const AG_GRID_LOCALE_IT = {
    ...
    lineTooltip: 'Linea',
    stackedLineTooltip: 'Sovrapposto',
    normalizedLineTooltip: '100% Sovrapposto',
    ...
    pyramid: 'Piramide',
    funnelGroup: 'Imbutone',
    funnelTooltip: 'Imbutone',
    coneFunnelTooltip: 'Imbuto Conico',
    pyramidTooltip: 'Piramide',
    dropOff: 'Abbandono',
    stageLabels: 'Etichette Fase',
    reverse: 'Inverti',
    ...
    ariaHeaderSelection: 'Colonna con selezione dell\'intestazione',
