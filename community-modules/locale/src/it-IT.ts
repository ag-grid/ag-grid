...
export const AG_GRID_LOCALE_IT_IT = {
    ...
    advancedFilterInRange: 'è tra',
    advancedFilterYesterday: 'è ieri',
    advancedFilterToday: 'è oggi',
    advancedFilterTomorrow: 'è domani',
    advancedFilterLast7Days: 'è negli ultimi 7 giorni',
    advancedFilterLastWeek: 'è nella settimana scorsa',
    advancedFilterThisWeek: 'è in questa settimana',
    advancedFilterNextWeek: 'è nella prossima settimana',
    advancedFilterLast30Days: 'è negli ultimi 30 giorni',
    advancedFilterLastMonth: 'è nel mese scorso',
    advancedFilterThisMonth: 'è in questo mese',
    advancedFilterNextMonth: 'è nel prossimo mese',
    advancedFilterLast90Days: 'è negli ultimi 90 giorni',
    advancedFilterLastQuarter: "è nell'ultimo trimestre",
    advancedFilterThisQuarter: 'è in questo trimestre',
    advancedFilterNextQuarter: 'è nel prossimo trimestre',
    advancedFilterLastYear: "è nell'anno scorso",
    advancedFilterThisYear: "è in quest'anno",
    advancedFilterYearToDate: "è nell'anno in corso",
    advancedFilterNextYear: 'è nel prossimo anno',
    advancedFilterLast6Months: 'è negli ultimi 6 mesi',
    advancedFilterLast12Months: 'è negli ultimi 12 mesi',
    advancedFilterLast24Months: 'è negli ultimi 24 mesi',
    advancedFilterTrue: 'è vero',
    advancedFilterFalse: 'è falso',
    advancedFilterIsAnyOf: 'è uno di',
    advancedFilterIsNoneOf: 'non è nessuno di',
    advancedFilterSetMore: '+${variable} altri',
    advancedFilterAnd: 'E',
    advancedFilterOr: 'O',
    ...
    advancedFilterValidationInvalidValue: 'Valore non trovato',
    ...
    advancedFilterValidationNotABigInt: 'Il valore non è un BigInt',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} deve essere maggiore di ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} deve essere maggiore o uguale a ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} deve essere successiva a ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} deve essere ${variable} o successiva',
    ...
    ariaAdvancedFilterBuilderValue: 'Valore',
    ...
    ariaColumnHeaderNameEditor: 'Editor nome colonna',
    columnHeaderEditApply: 'Applica',
...
/** @deprecated v36.2 Use `AG_GRID_LOCALE_IT_IT` instead. */
