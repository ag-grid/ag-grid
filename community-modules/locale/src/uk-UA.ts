...
export const AG_GRID_LOCALE_UA = {
    ...
    advancedFilterInRange: 'є між',
    advancedFilterYesterday: 'є вчора',
    advancedFilterToday: 'є сьогодні',
    advancedFilterTomorrow: 'є завтра',
    advancedFilterLast7Days: 'є в останніх 7 днях',
    advancedFilterLastWeek: 'є в минулому тижні',
    advancedFilterThisWeek: 'є в цьому тижні',
    advancedFilterNextWeek: 'є в наступному тижні',
    advancedFilterLast30Days: 'є в останніх 30 днях',
    advancedFilterLastMonth: 'є в минулому місяці',
    advancedFilterThisMonth: 'є в цьому місяці',
    advancedFilterNextMonth: 'є в наступному місяці',
    advancedFilterLast90Days: 'є в останніх 90 днях',
    advancedFilterLastQuarter: 'є в минулому кварталі',
    advancedFilterThisQuarter: 'є в цьому кварталі',
    advancedFilterNextQuarter: 'є в наступному кварталі',
    advancedFilterLastYear: 'є в минулому році',
    advancedFilterThisYear: 'є в цьому році',
    advancedFilterYearToDate: 'є з початку року до сьогодні',
    advancedFilterNextYear: 'є в наступному році',
    advancedFilterLast6Months: 'є в останніх 6 місяцях',
    advancedFilterLast12Months: 'є в останніх 12 місяцях',
    advancedFilterLast24Months: 'є в останніх 24 місяцях',
    advancedFilterTrue: 'є істинним',
    advancedFilterFalse: 'є хибним',
    advancedFilterIsAnyOf: 'є будь-яким з',
    advancedFilterIsNoneOf: 'не є жодним з',
    advancedFilterSetMore: '+ще ${variable}',
    advancedFilterAnd: 'І',
    ...
    advancedFilterValidationInvalidValue: 'Значення не знайдено',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} має бути більшим за ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} повинно бути більше або дорівнювати ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} повинна бути після ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} повинна бути ${variable} або пізніше',
    ...
    // Formulas
    invalidFormulaValidation: 'Недійсна формула.',
    formulaParseInvalidCellReference: 'Недійсне посилання на комірку: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Недійсне кінцеве посилання діапазону.',
    formulaParseUnterminatedString: 'Незавершений рядок.',
    formulaParseUnexpectedCharacter: 'Неочікуваний символ: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Недоповнення стека операторів.',
    formulaParseMissingOperand: "Відсутній операнд для '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Внутрішня помилка: неочікуваний фрейм під час редукції.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Внутрішня помилка: неочікуваний фрейм перед '('.",
    formulaParseMisplacedComma: 'Кома в неправильному місці.',
    formulaParseCommaOutsideFunctionCall: 'Кома поза викликом функції.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Внутрішня помилка: неочікуваний фрейм перед ')'.",
    formulaParseMismatchedParentheses: 'Невідповідні дужки.',
    formulaParseUnsupportedOperand: 'Непідтримуваний операнд: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'Невідповідні дужки або незавершений виклик функції.',
    formulaParseInvalidExpression: 'Недійсний вираз.',
    formulaParseFormulasMustBeginWithEquals: 'Формули мають починатися з =.',
    formulaSerializeStringContainsQuote: 'Рядок містить лапки (") які токенізатор не підтримує.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Неможливо створити абсолютну мітку СТОВПЦЯ з id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Неможливо створити абсолютний індекс РЯДКА з id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Неможливо створити індекс РЯДКА з id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Неможливо відобразити id стовпця '${variable}' на мітку A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Неможливо розпізнати абсолютний індекс рядка '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Неможливо відобразити id рядка '${variable}' на індекс A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'Діапазон не дозволено у скалярному контексті.',
    formulaEvalUnknownReferenceToCell: 'Невідоме посилання на комірку.',
    formulaEvalUnsupportedOperation: 'Непідтримувана операція ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Недійсний абсолютний рядок.',
    formulaEvalUnrecognisedRowId: 'Нерозпізнаний id рядка.',
    formulaEvalInvalidAbsoluteColumn: 'Недійсний абсолютний стовпець.',
    formulaEvalUnrecognisedColumnId: 'Нерозпізнаний id стовпця.',
    formulaEvalUnrecognisedRowInRange: 'Нерозпізнаний рядок у діапазоні.',
    formulaEvalUnrecognisedReferenceToCell: 'Нерозпізнане посилання на комірку.',
    formulaEvalIncompleteRangeReference: 'Неповне посилання на діапазон.',
    formulaFunctionExpectedExactlyArguments: '${variable}: очікувалося рівно ${variable} аргументів.',
    formulaFunctionExpectedAtMostArguments: '${variable}: очікувалося не більше ${variable} аргументів.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: очікувалося щонайменше ${variable} аргументів.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Недійсний критерій: шаблони з компаратором.',
    formulaFunctionNonNumericArgument: '${variable}: нечисловий аргумент.',
    formulaFunctionDivisionByZero: '${variable}: ділення на нуль.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: неможливо поєднати дати з BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: потрібно щонайменше одне числове значення.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: потрібно щонайменше одне значення.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: усі значення мають бути числами.',
    formulaFunctionArgumentMustBeRange: '${variable}: аргумент ${variable} має бути діапазоном.',
    formulaFunctionArgumentMustBeValue: '${variable}: аргумент ${variable} має бути значенням.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: діапазони мають різні розміри.',
    formulaFunctionValuesMustBeNumeric: '${variable}: значення мають бути числовими.',
    formulaFunctionValuesMustBeIntegers: '${variable}: значення мають бути цілими числами.',
    formulaFunctionUnsupportedValueType: '${variable}: непідтримуваний тип значення.',
    formulaFunctionDivNonNumericArgument: 'DIV: нечисловий аргумент.',
    formulaFunctionDivDivisionByZero: 'DIV: ділення на нуль.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: неможливо поєднати дати з BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: потрібно щонайменше одне числове значення.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: потрібно щонайменше одне значення.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: усі значення мають бути числами.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: потрібно щонайменше одне значення.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: перший аргумент має бути діапазоном.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: другий аргумент має бути значенням (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: третій аргумент має бути діапазоном (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: діапазони мають різні розміри.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: перший аргумент має бути діапазоном.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: другий аргумент має бути значенням (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: непідтримуваний тип значення.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: потрібно щонайменше одне значення.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: потрібно щонайменше одне значення.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: нечисловий аргумент.',
    formulaFunctionPowerNonNumericArgument: 'POWER: нечисловий аргумент.',
    formulaServiceCircularReference: 'Циклічне посилання.',
    formulaServiceExpectedParsableFormula: 'Очікувалася формула, яку можна розпізнати.',
    formulaServiceInternalSchedulingError: 'Внутрішня помилка планування.',
    ...
    fileInputOverlay: 'Перетягніть файл сюди, щоб імпортувати дані',
    ...
    noAggregation: 'Жодна',
    showValuesAs: 'Показати значення як',
    showValuesAsNone: 'Немає',
    percentOfGrandTotal: '% від загального підсумку',
    percentOfColumnTotal: '% від підсумку стовпця',
    percentOfRowTotal: '% від підсумку рядка',
    percentOfParentRowTotal: '% від підсумку батьківського рядка',
    percentOfParentColumnTotal: '% від підсумку батьківського стовпця',
    percentOfGrandTotalDescription: 'Кожне значення як відсоток від загального підсумку стовпця.',
    percentOfColumnTotalDescription:
        'Кожне значення як відсоток від підсумку його стовпця — кожен стовпець у сумі дає 100%.',
    percentOfRowTotalDescription: 'Кожне значення як відсоток від підсумку рядка по зведених стовпцях.',
    percentOfParentRowTotalDescription: 'Кожне значення як відсоток від його батьківської групи.',
    percentOfParentColumnTotalDescription: 'Кожне значення як відсоток від його батьківського зведеного стовпця.',
    autosizeThisColumn: 'Автоматично Змінити Розмір Цього Стовпця',
    autosizeAllColumns: 'Автоматично Змінити Розмір Усіх Стовпців',
    groupBy: 'Групувати за ${variable}',
    ungroupBy: 'Розгрупувати за ${variable}',
