...
export const AG_GRID_LOCALE_UA = {
    ...
    lineChart: 'Лінійний',
    stackedLine: 'Штабельований',
    normalizedLine: '100% Штабельований',
    ...
    lineTooltip: 'Лінія',
    stackedLineTooltip: 'Складений',
    normalizedLineTooltip: '100% Складений',
    ...
    funnel: 'Лійка',
    coneFunnel: 'Конічна лійка',
    pyramid: 'Піраміда',
    funnelGroup: 'Лійка',
    funnelTooltip: 'Лійка',
    coneFunnelTooltip: 'Конічна лійка',
    ...
    ariaColumnSelectAll: 'Переключити видимість усіх колонок',
    ...
    ariaHeaderSelection: 'Колонка з вибором заголовків',
