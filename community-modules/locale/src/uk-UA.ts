...
export const AG_GRID_LOCALE_UA = {
    ...
    noAggregation: 'Жодна',
    showValueAs: 'Показати значення як',
    showValueAsNone: 'Немає',
    showValueAsNotApplicable: 'Незастосовно в поточному поданні',
    showValueAsDefault: 'За замовчуванням',
    showValueAsTopLevel: 'Верхній рівень',
    ...
    percentOfParentTotal: '% від батьківського підсумку',
    ...
    percentOfParentTotalDescription: 'Кожне значення як відсоток від його предка у вибраному полі групування.',
