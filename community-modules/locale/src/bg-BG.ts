...
export const AG_GRID_LOCALE_BG = {
    ...
    noAggregation: 'Няма',
    showValueAs: 'Показване на стойностите като',
    showValueAsNone: 'Няма',
    showValueAsNotApplicable: 'Неприложимо в текущия изглед',
    showValueAsDefault: 'По подразбиране',
    showValueAsTopLevel: 'Най-високо ниво',
    ...
    percentOfParentTotal: '% от родителската сума',
    ...
    percentOfParentTotalDescription:
        'Всяка стойност като процент от нейния предшественик при избрано поле за групиране.',
    ...
    ariaColumnShowValueAs: 'Показване на стойностите като',
