...
export const AG_GRID_LOCALE_BG = {
    ...
    advancedFilterIsAnyOf: 'е някое от',
    advancedFilterIsNoneOf: 'не е никое от',
    advancedFilterSetMore: '+още ${variable}',
    advancedFilterAnd: 'И',
    ...
    advancedFilterValidationInvalidValue: 'Стойността не е намерена',
    ...
    advancedFilterValidationMustBeGreaterThan: '${variable} трябва да бъде по-голямо от ${variable}',
    advancedFilterValidationMustBeGreaterThanOrEqualTo: '${variable} трябва да бъде по-голямо или равно на ${variable}',
    advancedFilterValidationMustBeAfter: '${variable} трябва да е след ${variable}',
    advancedFilterValidationMustBeOnOrAfter: '${variable} трябва да е на или след ${variable}',
    ...
    // Formulas
    invalidFormulaValidation: 'Невалидна формула.',
    formulaParseInvalidCellReference: 'Невалидна препратка към клетка: ${variable}.',
    formulaParseInvalidRangeEndReference: 'Невалидна крайна препратка на диапазон.',
    formulaParseUnterminatedString: 'Незавършен низ.',
    formulaParseUnexpectedCharacter: 'Неочакван символ: ${variable}.',
    formulaParseOperatorStackUnderflow: 'Недостиг в стека с оператори.',
    formulaParseMissingOperand: "Липсва операнд за '${variable}'.",
    formulaParseInternalUnexpectedFrameDuringReduction: 'Вътрешна грешка: неочаквана рамка по време на редукция.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "Вътрешна грешка: неочаквана рамка преди '('.",
    formulaParseMisplacedComma: 'Запетая на грешно място.',
    formulaParseCommaOutsideFunctionCall: 'Запетая извън извикване на функция.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "Вътрешна грешка: неочаквана рамка преди ')'.",
    formulaParseMismatchedParentheses: 'Несъответстващи скоби.',
    formulaParseUnsupportedOperand: 'Неподдържан операнд: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall:
        'Несъответстващи скоби или недовършено извикване на функция.',
    formulaParseInvalidExpression: 'Невалиден израз.',
    formulaParseFormulasMustBeginWithEquals: 'Формулите трябва да започват с =.',
    formulaSerializeStringContainsQuote: 'Низът съдържа кавичка (") която токенизаторът не поддържа.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId:
        "Не може да се създаде абсолютен етикет за КОЛОНА от id '${variable}'.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId:
        "Не може да се създаде абсолютен индекс на РЕД от id '${variable}'.",
    formulaSerializeCannotProduceRowIndexFromId: "Не може да се създаде индекс на РЕД от id '${variable}'.",
    formulaSerializeCannotMapColumnIdToA1Label: "Не може да се съпостави id на колона '${variable}' към етикет A1.",
    formulaSerializeCannotParseAbsoluteRowIndex: "Не може да се парсне абсолютен индекс на ред '${variable}'.",
    formulaSerializeCannotMapRowIdToA1Index: "Не може да се съпостави id на ред '${variable}' към индекс A1.",
    formulaEvalRangeNotAllowedInScalarContext: 'Диапазон не е разрешен в скаларен контекст.',
    formulaEvalUnknownReferenceToCell: 'Неизвестна препратка към клетка.',
    formulaEvalUnsupportedOperation: 'Неподдържана операция ${variable}.',
    formulaEvalInvalidAbsoluteRow: 'Невалиден абсолютен ред.',
    formulaEvalUnrecognisedRowId: 'Неразпознат id на ред.',
    formulaEvalInvalidAbsoluteColumn: 'Невалидна абсолютна колона.',
    formulaEvalUnrecognisedColumnId: 'Неразпознат id на колона.',
    formulaEvalUnrecognisedRowInRange: 'Неразпознат ред в диапазон.',
    formulaEvalUnrecognisedReferenceToCell: 'Неразпозната препратка към клетка.',
    formulaEvalIncompleteRangeReference: 'Непълна препратка към диапазон.',
    formulaFunctionExpectedExactlyArguments: '${variable}: очакват се точно ${variable} аргумента.',
    formulaFunctionExpectedAtMostArguments: '${variable}: очакват се най-много ${variable} аргумента.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: очакват се поне ${variable} аргумента.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator: 'Невалиден критерий: заместващи символи с компаратор.',
    formulaFunctionNonNumericArgument: '${variable}: нечислов аргумент.',
    formulaFunctionDivisionByZero: '${variable}: деление на нула.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: датите не могат да се комбинират с BigInt.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: изисква поне една числова стойност.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: изисква поне една стойност.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: всички стойности трябва да са числа.',
    formulaFunctionArgumentMustBeRange: '${variable}: аргументът ${variable} трябва да е диапазон.',
    formulaFunctionArgumentMustBeValue: '${variable}: аргументът ${variable} трябва да е стойност.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: диапазоните са с различни размери.',
    formulaFunctionValuesMustBeNumeric: '${variable}: стойностите трябва да са числови.',
    formulaFunctionValuesMustBeIntegers: '${variable}: стойностите трябва да са цели числа.',
    formulaFunctionUnsupportedValueType: '${variable}: неподдържан тип стойност.',
    formulaFunctionDivNonNumericArgument: 'DIV: нечислов аргумент.',
    formulaFunctionDivDivisionByZero: 'DIV: деление на нула.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: датите не могат да се комбинират с BigInt.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: изисква поне една числова стойност.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: изисква поне една стойност.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: всички стойности трябва да са числа.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: изисква поне една стойност.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: първият аргумент трябва да е диапазон.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: вторият аргумент трябва да е стойност (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: третият аргумент трябва да е диапазон (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: диапазоните са с различни размери.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: първият аргумент трябва да е диапазон.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: вторият аргумент трябва да е стойност (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: неподдържан тип стойност.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: изисква поне една стойност.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: изисква поне една стойност.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: нечислов аргумент.',
    formulaFunctionPowerNonNumericArgument: 'POWER: нечислов аргумент.',
    formulaServiceCircularReference: 'Циклична препратка.',
    formulaServiceExpectedParsableFormula: 'Очакваше се формула, която може да се парсне.',
    formulaServiceInternalSchedulingError: 'Вътрешна грешка при планиране.',
    ...
    fileInputOverlay: 'Плъзнете и пуснете файл за импортиране на данни',
    ...
    noAggregation: 'Няма',
    showValuesAs: 'Показване на стойностите като',
    showValuesAsNone: 'Няма',
    percentOfGrandTotal: '% от общата сума',
    percentOfColumnTotal: '% от сумата на колоната',
    percentOfRowTotal: '% от сумата на реда',
    percentOfParentRowTotal: '% от сумата на родителския ред',
    percentOfParentColumnTotal: '% от сумата на родителската колона',
    percentOfGrandTotalDescription: 'Всяка стойност като процент от общата сума на колоната.',
    percentOfColumnTotalDescription:
        'Всяка стойност като процент от сумата на нейната колона — всяка колона дава общо 100%.',
    percentOfRowTotalDescription: 'Всяка стойност като процент от сумата на реда през осевите колони.',
    percentOfParentRowTotalDescription: 'Всяка стойност като процент от родителската ѝ група.',
    percentOfParentColumnTotalDescription: 'Всяка стойност като процент от родителската ѝ осева колона.',
    ...
    invalidBigInt: 'Невалиден BigInt',
    january: 'Януари',
    february: 'Февруари',
    march: 'Март',
    april: 'Април',
