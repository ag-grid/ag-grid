...
export const AG_GRID_LOCALE_BG = {
    ...
    filterSummaryTextEquals: 'е равно на',
    ...
    agTextColumnFilterDisplayName: 'Обикновен филтър',
    agNumberColumnFilterDisplayName: 'Обикновен филтър',
    agDateColumnFilterDisplayName: 'Обикновен филтър',
    agSetColumnFilterDisplayName: 'Филтър по избор',
    agMultiColumnFilterDisplayName: 'Комбиниран филтър',
    addFilterPlaceholder: 'Търси в колоните...',
    ...
    ariaDeferSkeletonCellLoading: 'Зареждане на клетката',
    ...
    ariaValidationErrorPrefix: 'Проверка на валидността на редактора на клетка',
